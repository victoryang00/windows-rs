...
impl IErrorInfo {
    ...
    pub unsafe fn GetSource(&self) -> ::windows_core::Result<BSTR> {
        let mut result__ = ::core::mem::MaybeUninit::<::core::mem::ManuallyDrop<BSTR>>::zeroed();
        (::windows_core::Interface::vtable(self).GetSource)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<BSTR>(result__)
    }
    pub unsafe fn GetDescription(&self) -> ::windows_core::Result<BSTR> {
        let mut result__ = ::core::mem::MaybeUninit::<::core::mem::ManuallyDrop<BSTR>>::zeroed();
        (::windows_core::Interface::vtable(self).GetDescription)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<BSTR>(result__)
    }
    pub unsafe fn GetHelpFile(&self) -> ::windows_core::Result<BSTR> {
        let mut result__ = ::core::mem::MaybeUninit::<::core::mem::ManuallyDrop<BSTR>>::zeroed();
        (::windows_core::Interface::vtable(self).GetHelpFile)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<BSTR>(result__)
    }
...
pub struct IErrorInfo_Vtbl {
    ...
    pub GetSource: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pbstrsource: *mut BSTR) -> ::windows_core::HRESULT,
    pub GetDescription: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pbstrdescription: *mut BSTR) -> ::windows_core::HRESULT,
    pub GetHelpFile: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pbstrhelpfile: *mut BSTR) -> ::windows_core::HRESULT,
...
unsafe impl ::windows_core::Abi for FORMAT_MESSAGE_OPTIONS {
    type Abi = Self;
}
...
pub unsafe fn FormatMessageW(dwflags: FORMAT_MESSAGE_OPTIONS, lpsource: *const ::core::ffi::c_void, dwmessageid: u32, dwlanguageid: u32, lpbuffer: ::windows_core::PWSTR, nsize: u32, arguments: *const *const i8) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn FormatMessageW(dwflags: FORMAT_MESSAGE_OPTIONS, lpsource: *const ::core::ffi::c_void, dwmessageid: u32, dwlanguageid: u32, lpbuffer: ::windows_core::PWSTR, nsize: u32, arguments: *const *const i8) -> u32;
        }
...
#[inline]
pub unsafe fn FreeLibrary<'a, Param0: ::windows_core::IntoParam<'a, HINSTANCE>>(hlibmodule: Param0) -> BOOL {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
...
#[inline]
pub unsafe fn GetProcAddress<'a, Param0: ::windows_core::IntoParam<'a, HINSTANCE>, Param1: ::windows_core::IntoParam<'a, ::windows_core::PCSTR>>(hmodule: Param0, lpprocname: Param1) -> FARPROC {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn GetProcAddress(hmodule: HINSTANCE, lpprocname: ::windows_core::PCSTR) -> FARPROC;
        }
...
#[inline]
pub unsafe fn LoadLibraryA<'a, Param0: ::windows_core::IntoParam<'a, ::windows_core::PCSTR>>(lplibfilename: Param0) -> ::windows_core::Result<HINSTANCE> {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn LoadLibraryA(lplibfilename: ::windows_core::PCSTR) -> HINSTANCE;
        }
...
#[inline]
pub unsafe fn HeapFree<'a, Param0: ::windows_core::IntoParam<'a, HeapHandle>>(hheap: Param0, dwflags: HEAP_FLAGS, lpmem: *const ::core::ffi::c_void) -> BOOL {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
...
#[inline]
pub unsafe fn CreateEventA<'a, Param1: ::windows_core::IntoParam<'a, BOOL>, Param2: ::windows_core::IntoParam<'a, BOOL>, Param3: ::windows_core::IntoParam<'a, ::windows_core::PCSTR>>(lpeventattributes: *const SECURITY_ATTRIBUTES, bmanualreset: Param1, binitialstate: Param2, lpname: Param3) -> ::windows_core::Result<HANDLE> {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn CreateEventA(lpeventattributes: *const SECURITY_ATTRIBUTES, bmanualreset: BOOL, binitialstate: BOOL, lpname: ::windows_core::PCSTR) -> HANDLE;
        }
...
#[inline]
pub unsafe fn SetEvent<'a, Param0: ::windows_core::IntoParam<'a, HANDLE>>(hevent: Param0) -> BOOL {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
...
#[inline]
pub unsafe fn WaitForSingleObject<'a, Param0: ::windows_core::IntoParam<'a, HANDLE>>(hhandle: Param0, dwmilliseconds: u32) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
...
impl IRestrictedErrorInfo {
    pub unsafe fn GetErrorDetails(&self, description: *mut BSTR, error: *mut ::windows_core::HRESULT, restricteddescription: *mut BSTR, capabilitysid: *mut BSTR) -> ::windows_core::Result<()> {
    ...
    pub unsafe fn GetReference(&self) -> ::windows_core::Result<BSTR> {
        let mut result__ = ::core::mem::MaybeUninit::<::core::mem::ManuallyDrop<BSTR>>::zeroed();
        (::windows_core::Interface::vtable(self).GetReference)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<BSTR>(result__)
    }
}
...
pub struct IRestrictedErrorInfo_Vtbl {
    pub base__: ::windows_core::IUnknownVtbl,
    pub GetErrorDetails: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, description: *mut BSTR, error: *mut ::windows_core::HRESULT, restricteddescription: *mut BSTR, capabilitysid: *mut BSTR) -> ::windows_core::HRESULT,
    pub GetReference: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, reference: *mut BSTR) -> ::windows_core::HRESULT,
}
#[repr(transparent)]
