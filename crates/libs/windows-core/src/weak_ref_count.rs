...
impl WeakRefCount {
    ...
    /// # Safety
    pub unsafe fn query(&self, iid: &::windows_core::GUID, object: RawPtr) -> RawPtr {
...
impl TearOff {
    ...
    unsafe fn new(object: RawPtr, strong_count: u32) -> IWeakReferenceSource {
        core::mem::transmute(windows_core::alloc::boxed::Box::new(TearOff {
    ...
    unsafe extern "system" fn StrongAddRef(ptr: ::windows_core::RawPtr) -> u32 {
        let this = Self::from_strong_ptr(ptr);
    ...
    unsafe extern "system" fn WeakAddRef(ptr: ::windows_core::RawPtr) -> u32 {
        let this = Self::from_weak_ptr(ptr);
    ...
    unsafe extern "system" fn StrongRelease(ptr: ::windows_core::RawPtr) -> u32 {
        let this = Self::from_strong_ptr(ptr);
    ...
    unsafe extern "system" fn WeakRelease(ptr: ::windows_core::RawPtr) -> u32 {
        let this = Self::from_weak_ptr(ptr);
