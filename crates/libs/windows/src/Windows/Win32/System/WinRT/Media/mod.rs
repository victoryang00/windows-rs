...
impl IAudioFrameNativeFactory {
    ...
    pub unsafe fn CreateFromMFSample<'a, Param0: ::windows_core::IntoParam<'a, super::super::super::Media::MediaFoundation::IMFSample>, Param1: ::windows_core::IntoParam<'a, super::super::super::Foundation::BOOL>, T: ::windows_core::Interface>(&self, data: Param0, forcereadonly: Param1) -> ::windows_core::Result<T> {
        let mut result__ = ::core::option::Option::None;
...
pub struct IAudioFrameNativeFactory_Vtbl {
    pub base__: ::windows_core::IInspectableVtbl,
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_Media_MediaFoundation"))]
    pub CreateFromMFSample: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, data: ::windows_core::RawPtr, forcereadonly: super::super::super::Foundation::BOOL, riid: *const ::windows_core::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
...
impl IVideoFrameNativeFactory {
    #[doc = "*Required features: `\"Win32_System_WinRT_Media\"`, `\"Win32_Foundation\"`, `\"Win32_Media_MediaFoundation\"`*"]
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_Media_MediaFoundation"))]
    pub unsafe fn CreateFromMFSample<'a, Param0: ::windows_core::IntoParam<'a, super::super::super::Media::MediaFoundation::IMFSample>, Param4: ::windows_core::IntoParam<'a, super::super::super::Foundation::BOOL>, Param6: ::windows_core::IntoParam<'a, super::super::super::Media::MediaFoundation::IMFDXGIDeviceManager>, T: ::windows_core::Interface>(&self, data: Param0, subtype: *const ::windows_core::GUID, width: u32, height: u32, forcereadonly: Param4, mindisplayaperture: *const super::super::super::Media::MediaFoundation::MFVideoArea, device: Param6) -> ::windows_core::Result<T> {
        let mut result__ = ::core::option::Option::None;
...
pub struct IVideoFrameNativeFactory_Vtbl {
    pub base__: ::windows_core::IInspectableVtbl,
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_Media_MediaFoundation"))]
    pub CreateFromMFSample: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, data: ::windows_core::RawPtr, subtype: *const ::windows_core::GUID, width: u32, height: u32, forcereadonly: super::super::super::Foundation::BOOL, mindisplayaperture: *const super::super::super::Media::MediaFoundation::MFVideoArea, device: ::windows_core::RawPtr, riid: *const ::windows_core::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    #[cfg(not(all(feature = "Win32_Foundation", feature = "Win32_Media_MediaFoundation")))]
    CreateFromMFSample: usize,
}
