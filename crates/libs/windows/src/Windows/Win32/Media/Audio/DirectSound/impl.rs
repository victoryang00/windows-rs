...
pub trait IDirectSound_Impl: Sized {
    ...
    fn GetCaps(&self) -> ::windows_core::Result<DSCAPS>;
...
impl IDirectSound_Vtbl {
    pub const fn new<Identity: ::windows_core::IUnknownImpl<Impl = Impl>, Impl: IDirectSound_Impl, const OFFSET: isize>() -> IDirectSound_Vtbl {
        unsafe extern "system" fn CreateSoundBuffer<Identity: ::windows_core::IUnknownImpl<Impl = Impl>, Impl: IDirectSound_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, pcdsbufferdesc: *const DSBUFFERDESC, ppdsbuffer: *mut ::windows_core::RawPtr, punkouter: *mut ::core::ffi::c_void) -> ::windows_core::HRESULT {
        ...
        unsafe extern "system" fn DuplicateSoundBuffer<Identity: ::windows_core::IUnknownImpl<Impl = Impl>, Impl: IDirectSound_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, pdsbufferoriginal: ::windows_core::RawPtr, ppdsbufferduplicate: *mut ::windows_core::RawPtr) -> ::windows_core::HRESULT {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
...
pub trait IDirectSound3DBuffer_Impl: Sized {
    fn GetAllParameters(&self) -> ::windows_core::Result<DS3DBUFFER>;
...
pub trait IDirectSound3DListener_Impl: Sized {
    fn GetAllParameters(&self) -> ::windows_core::Result<DS3DLISTENER>;
...
pub trait IDirectSoundBuffer_Impl: Sized {
    fn GetCaps(&self) -> ::windows_core::Result<DSBCAPS>;
...
impl IDirectSoundBuffer_Vtbl {
    pub const fn new<Identity: ::windows_core::IUnknownImpl<Impl = Impl>, Impl: IDirectSoundBuffer_Impl, const OFFSET: isize>() -> IDirectSoundBuffer_Vtbl {
        ...
        unsafe extern "system" fn Initialize<Identity: ::windows_core::IUnknownImpl<Impl = Impl>, Impl: IDirectSoundBuffer_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, pdirectsound: ::windows_core::RawPtr, pcdsbufferdesc: *const DSBUFFERDESC) -> ::windows_core::HRESULT {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
...
impl IDirectSoundCapture_Vtbl {
    pub const fn new<Identity: ::windows_core::IUnknownImpl<Impl = Impl>, Impl: IDirectSoundCapture_Impl, const OFFSET: isize>() -> IDirectSoundCapture_Vtbl {
        unsafe extern "system" fn CreateCaptureBuffer<Identity: ::windows_core::IUnknownImpl<Impl = Impl>, Impl: IDirectSoundCapture_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, pcdscbufferdesc: *const DSCBUFFERDESC, ppdscbuffer: *mut ::windows_core::RawPtr, punkouter: *mut ::core::ffi::c_void) -> ::windows_core::HRESULT {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
...
impl IDirectSoundCaptureBuffer_Vtbl {
    pub const fn new<Identity: ::windows_core::IUnknownImpl<Impl = Impl>, Impl: IDirectSoundCaptureBuffer_Impl, const OFFSET: isize>() -> IDirectSoundCaptureBuffer_Vtbl {
        ...
        unsafe extern "system" fn Initialize<Identity: ::windows_core::IUnknownImpl<Impl = Impl>, Impl: IDirectSoundCaptureBuffer_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, pdirectsoundcapture: ::windows_core::RawPtr, pcdscbufferdesc: *const DSCBUFFERDESC) -> ::windows_core::HRESULT {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
...
pub trait IDirectSoundFXChorus_Impl: Sized {
    ...
    fn GetAllParameters(&self) -> ::windows_core::Result<DSFXChorus>;
}
...
pub trait IDirectSoundFXCompressor_Impl: Sized {
    ...
    fn GetAllParameters(&self) -> ::windows_core::Result<DSFXCompressor>;
}
...
pub trait IDirectSoundFXDistortion_Impl: Sized {
    ...
    fn GetAllParameters(&self) -> ::windows_core::Result<DSFXDistortion>;
}
...
pub trait IDirectSoundFXEcho_Impl: Sized {
    ...
    fn GetAllParameters(&self) -> ::windows_core::Result<DSFXEcho>;
}
...
pub trait IDirectSoundFXFlanger_Impl: Sized {
    ...
    fn GetAllParameters(&self) -> ::windows_core::Result<DSFXFlanger>;
}
...
pub trait IDirectSoundFXI3DL2Reverb_Impl: Sized {
    ...
    fn GetAllParameters(&self) -> ::windows_core::Result<DSFXI3DL2Reverb>;
...
impl IDirectSoundFullDuplex_Vtbl {
    pub const fn new<Identity: ::windows_core::IUnknownImpl<Impl = Impl>, Impl: IDirectSoundFullDuplex_Impl, const OFFSET: isize>() -> IDirectSoundFullDuplex_Vtbl {
        unsafe extern "system" fn Initialize<Identity: ::windows_core::IUnknownImpl<Impl = Impl>, Impl: IDirectSoundFullDuplex_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, pcaptureguid: *const ::windows_core::GUID, prenderguid: *const ::windows_core::GUID, lpdscbufferdesc: *const DSCBUFFERDESC, lpdsbufferdesc: *const DSBUFFERDESC, hwnd: super::super::super::Foundation::HWND, dwlevel: u32, lplpdirectsoundcapturebuffer8: *mut ::windows_core::RawPtr, lplpdirectsoundbuffer8: *mut ::windows_core::RawPtr) -> ::windows_core::HRESULT {
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
...
impl IDirectSoundNotify_Vtbl {
    pub const fn new<Identity: ::windows_core::IUnknownImpl<Impl = Impl>, Impl: IDirectSoundNotify_Impl, const OFFSET: isize>() -> IDirectSoundNotify_Vtbl {
        ...
        Self { base__: ::windows_core::IUnknownVtbl::new::<Identity, OFFSET>(), SetNotificationPositions: SetNotificationPositions::<Identity, Impl, OFFSET> }
    }
    pub fn matches(iid: &windows_core::GUID) -> bool {
