...
extern "system" {
    ...
    #[doc = "*Required features: `\"Win32_System_ComponentServices\"`*"]
    pub fn GetManagedExtensions(dwexts: *mut u32) -> ::windows_core_sys::HRESULT;
    #[doc = "*Required features: `\"Win32_System_ComponentServices\"`*"]
    pub fn MTSCreateActivity(riid: *const ::windows_core_sys::GUID, ppobj: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    #[doc = "*Required features: `\"Win32_System_ComponentServices\"`*"]
    pub fn RecycleSurrogate(lreasoncode: i32) -> ::windows_core_sys::HRESULT;
    #[doc = "*Required features: `\"Win32_System_ComponentServices\"`*"]
    pub fn SafeRef(rid: *const ::windows_core_sys::GUID, punk: ::windows_core_sys::IUnknown) -> *mut ::core::ffi::c_void;
}
...
pub struct ApplicationProcessSummary {
    ...
    pub ApplicationInstanceId: ::windows_core_sys::GUID,
    pub ProcessId: u32,
...
pub const ByotServerEx: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3970674858, data2: 32537, data3: 4562, data4: [151, 142, 0, 0, 248, 117, 126, 42] };
#[repr(C)]
#[doc = "*Required features: `\"Win32_System_ComponentServices\"`*"]
pub struct CAppData {
    pub m_idApp: u32,
...
pub struct CCLSIDData {
    pub m_clsid: ::windows_core_sys::GUID,
...
pub struct CCLSIDData2 {
    pub m_clsid: ::windows_core_sys::GUID,
    pub m_appid: ::windows_core_sys::GUID,
    pub m_partid: ::windows_core_sys::GUID,
    pub m_pwszAppName: ::windows_core_sys::PWSTR,
    pub m_pwszCtxName: ::windows_core_sys::PWSTR,
...
pub const COMAdminCatalog: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4128818452, data2: 57272, data3: 4561, data4: [162, 207, 0, 128, 95, 199, 146, 53] };
pub const COMAdminCatalogCollection: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4128818454, data2: 57272, data3: 4561, data4: [162, 207, 0, 128, 95, 199, 146, 53] };
pub const COMAdminCatalogObject: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4128818453, data2: 57272, data3: 4561, data4: [162, 207, 0, 128, 95, 199, 146, 53] };
#[doc = "*Required features: `\"Win32_System_ComponentServices\"`*"]
...
pub const COMEvents: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3970674859, data2: 32537, data3: 4562, data4: [151, 142, 0, 0, 248, 117, 126, 42] };
#[doc = "*Required features: `\"Win32_System_ComponentServices\"`*"]
...
pub struct COMSVCSEVENTINFO {
    ...
    pub lMicroTime: i32,
    pub perfCount: i64,
    pub guidApp: ::windows_core_sys::GUID,
    pub sMachineName: ::windows_core_sys::PWSTR,
}
...
pub const CRMClerk: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3970674877, data2: 32537, data3: 4562, data4: [151, 142, 0, 0, 248, 117, 126, 42] };
#[doc = "*Required features: `\"Win32_System_ComponentServices\"`*"]
...
pub const CRMRecoveryClerk: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3970674878, data2: 32537, data3: 4562, data4: [151, 142, 0, 0, 248, 117, 126, 42] };
#[doc = "*Required features: `\"Win32_System_ComponentServices\"`*"]
...
pub const CServiceConfig: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3970674888, data2: 32537, data3: 4562, data4: [151, 142, 0, 0, 248, 117, 126, 42] };
pub const ClrAssemblyLocator: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1166713781, data2: 9818, data3: 19317, data4: [188, 5, 155, 234, 70, 48, 207, 24] };
pub const CoMTSLocator: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3970674860, data2: 32537, data3: 4562, data4: [151, 142, 0, 0, 248, 117, 126, 42] };
...
pub const DispenserManager: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3970674880, data2: 32537, data3: 4562, data4: [151, 142, 0, 0, 248, 117, 126, 42] };
pub const Dummy30040732: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3970674857, data2: 32537, data3: 4562, data4: [151, 142, 0, 0, 248, 117, 126, 42] };
pub const EventServer: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3970674620, data2: 32537, data3: 4562, data4: [151, 142, 0, 0, 248, 117, 126, 42] };
#[doc = "*Required features: `\"Win32_System_ComponentServices\"`*"]
...
pub const LBEvents: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3970674881, data2: 32537, data3: 4562, data4: [151, 142, 0, 0, 248, 117, 126, 42] };
#[doc = "*Required features: `\"Win32_System_ComponentServices\"`*"]
...
pub const MessageMover: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3970674879, data2: 32537, data3: 4562, data4: [151, 142, 0, 0, 248, 117, 126, 42] };
pub const MtsGrp: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1261344141, data2: 915, data3: 4561, data4: [177, 171, 0, 170, 0, 186, 50, 88] };
pub type ObjectContext = *mut ::core::ffi::c_void;
pub type ObjectControl = *mut ::core::ffi::c_void;
pub const PoolMgr: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3970674613, data2: 32537, data3: 4562, data4: [151, 142, 0, 0, 248, 117, 126, 42] };
#[repr(C)]
#[doc = "*Required features: `\"Win32_System_ComponentServices\"`*"]
pub struct RECYCLE_INFO {
    pub guidCombaseProcessIdentifier: ::windows_core_sys::GUID,
...
pub const SecurityCallContext: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3970674855, data2: 32537, data3: 4562, data4: [151, 142, 0, 0, 248, 117, 126, 42] };
pub const SecurityCallers: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3970674854, data2: 32537, data3: 4562, data4: [151, 142, 0, 0, 248, 117, 126, 42] };
pub const SecurityIdentity: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3970674853, data2: 32537, data3: 4562, data4: [151, 142, 0, 0, 248, 117, 126, 42] };
pub type SecurityProperty = *mut ::core::ffi::c_void;
pub const ServicePool: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3970674889, data2: 32537, data3: 4562, data4: [151, 142, 0, 0, 248, 117, 126, 42] };
pub const ServicePoolConfig: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3970674890, data2: 32537, data3: 4562, data4: [151, 142, 0, 0, 248, 117, 126, 42] };
pub const SharedProperty: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 704666629, data2: 42462, data3: 4559, data4: [158, 102, 0, 170, 0, 163, 244, 100] };
pub const SharedPropertyGroup: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 704666635, data2: 42462, data3: 4559, data4: [158, 102, 0, 170, 0, 163, 244, 100] };
pub const SharedPropertyGroupManager: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 704666641, data2: 42462, data3: 4559, data4: [158, 102, 0, 170, 0, 163, 244, 100] };
#[doc = "*Required features: `\"Win32_System_ComponentServices\"`*"]
...
pub const TrackerServer: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3970674617, data2: 32537, data3: 4562, data4: [151, 142, 0, 0, 248, 117, 126, 42] };
pub const TransactionContext: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2040134693, data2: 54214, data3: 4559, data4: [172, 171, 0, 160, 36, 165, 90, 239] };
pub const TransactionContextEx: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1555457648, data2: 54228, data3: 4559, data4: [172, 171, 0, 160, 36, 165, 90, 239] };
#[doc = "*Required features: `\"Win32_System_ComponentServices\"`*"]
