...
#[doc = "*Required features: `\"Win32_System_MessageQueuing\"`*"]
pub const MQ_ERROR_MESSAGE_LOCKED_UNDER_TRANSACTION: ::windows_sys_core::HRESULT = -1072824164i32;
#[doc = "*Required features: `\"Win32_System_MessageQueuing\"`*"]
pub const MQ_ERROR_MESSAGE_NOT_AUTHENTICATED: ::windows_sys_core::HRESULT = -1072824165i32;
#[doc = "*Required features: `\"Win32_System_MessageQueuing\"`*"]
pub const MQ_ERROR_RESOLVE_ADDRESS: ::windows_sys_core::HRESULT = -1072824167i32;
#[doc = "*Required features: `\"Win32_System_MessageQueuing\"`*"]
pub const MQ_ERROR_TOO_MANY_PROPERTIES: ::windows_sys_core::HRESULT = -1072824166i32;
#[doc = "*Required features: `\"Win32_System_MessageQueuing\"`*"]
...
#[doc = "*Required features: `\"Win32_System_MessageQueuing\"`*"]
pub const MQ_OK: ::windows_sys_core::HRESULT = 0i32;
pub const MSMQApplication: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3621183622, data2: 56525, data3: 4560, data4: [170, 75, 0, 96, 151, 13, 235, 174] };
pub const MSMQCollection: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 4146827313, data2: 12044, data3: 17384, data4: [146, 78, 230, 5, 44, 220, 73, 63] };
pub const MSMQCoordinatedTransactionDispenser: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3621183618, data2: 56525, data3: 4560, data4: [170, 75, 0, 96, 151, 13, 235, 174] };
pub const MSMQDestination: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3953748760, data2: 8552, data3: 4563, data4: [137, 140, 0, 224, 44, 7, 79, 107] };
pub const MSMQEvent: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3621183610, data2: 56525, data3: 4560, data4: [170, 75, 0, 96, 151, 13, 235, 174] };
pub const MSMQManagement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 969840382, data2: 62661, data3: 17540, data4: [161, 67, 76, 45, 93, 50, 66, 41] };
pub const MSMQMessage: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3621183605, data2: 56525, data3: 4560, data4: [170, 75, 0, 96, 151, 13, 235, 174] };
pub const MSMQOutgoingQueueManagement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 25706524, data2: 9338, data3: 20461, data4: [153, 198, 191, 20, 17, 157, 112, 85] };
pub const MSMQQuery: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3621183603, data2: 56525, data3: 4560, data4: [170, 75, 0, 96, 151, 13, 235, 174] };
pub const MSMQQueue: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3621183609, data2: 56525, data3: 4560, data4: [170, 75, 0, 96, 151, 13, 235, 174] };
pub const MSMQQueueInfo: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3621183612, data2: 56525, data3: 4560, data4: [170, 75, 0, 96, 151, 13, 235, 174] };
pub const MSMQQueueInfos: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3621183614, data2: 56525, data3: 4560, data4: [170, 75, 0, 96, 151, 13, 235, 174] };
pub const MSMQQueueManagement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 867618942, data2: 62077, data3: 17146, data4: [178, 215, 191, 130, 225, 30, 147, 116] };
pub const MSMQTransaction: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3621183616, data2: 56525, data3: 4560, data4: [170, 75, 0, 96, 151, 13, 235, 174] };
pub const MSMQTransactionDispenser: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3621183620, data2: 56525, data3: 4560, data4: [170, 75, 0, 96, 151, 13, 235, 174] };
#[doc = "*Required features: `\"Win32_System_MessageQueuing\"`*"]
