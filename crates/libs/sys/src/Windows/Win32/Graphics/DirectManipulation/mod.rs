pub const CLSID_AutoScrollBehavior: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 638741073, data2: 15472, data3: 19610, data4: [174, 194, 148, 136, 73, 238, 176, 147] };
pub const CLSID_DeferContactService: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3619060980, data2: 33979, data3: 17230, data4: [134, 174, 101, 146, 187, 201, 171, 217] };
pub const CLSID_DragDropConfigurationBehavior: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 162536254, data2: 47724, data3: 17741, data4: [130, 232, 149, 227, 82, 50, 159, 35] };
pub const CLSID_HorizontalIndicatorContent: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3889270005, data2: 16071, data3: 17621, data4: [167, 107, 55, 112, 243, 207, 144, 61] };
pub const CLSID_VerticalIndicatorContent: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2701877015, data2: 45024, data3: 19106, data4: [145, 233, 62, 112, 1, 210, 230, 180] };
pub const CLSID_VirtualViewportContent: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 839295386, data2: 34544, data3: 19636, data4: [167, 243, 22, 227, 183, 226, 216, 82] };
pub const DCompManipulationCompositor: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2044634663, data2: 41098, data3: 17324, data4: [142, 245, 105, 0, 185, 41, 145, 38] };
...
pub const DirectManipulationManager: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1424101814, data2: 13904, data3: 20341, data4: [131, 52, 250, 53, 149, 152, 225, 197] };
pub const DirectManipulationPrimaryContent: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3399493217, data2: 54686, data3: 16839, data4: [131, 147, 59, 163, 186, 203, 107, 87] };
pub const DirectManipulationSharedManager: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2574856838, data2: 30668, data3: 19287, data4: [150, 219, 59, 53, 79, 111, 159, 181] };
pub const DirectManipulationUpdateManager: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2680274901, data2: 6197, data3: 17434, data4: [179, 177, 182, 204, 116, 183, 39, 208] };
pub const DirectManipulationViewport: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 887230902, data2: 13904, data3: 20341, data4: [131, 52, 250, 53, 149, 152, 225, 197] };
