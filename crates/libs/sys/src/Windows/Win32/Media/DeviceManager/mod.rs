...
pub const EVENT_WMDM_CONTENT_TRANSFER: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 865901556, data2: 48382, data3: 20184, data4: [148, 223, 234, 248, 194, 106, 182, 27] };
...
pub const MediaDevMgr: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 632991105, data2: 13664, data3: 4563, data4: [132, 113, 0, 192, 79, 121, 219, 192] };
pub const MediaDevMgrClassFactory: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1342442525, data2: 48575, data3: 18724, data4: [184, 115, 241, 77, 108, 91, 253, 102] };
#[repr(C)]
#[doc = "*Required features: `\"Win32_Media_DeviceManager\"`*"]
pub struct OPAQUECOMMAND {
    pub guidCommand: ::windows_core_sys::GUID,
    pub dwDataLen: u32,
    pub pData: *mut u8,
    pub abMAC: [u8; 20],
}
...
pub const SCP_EVENTID_ACQSECURECLOCK: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2250542281, data2: 19033, data3: 17378, data4: [145, 70, 72, 167, 243, 244, 20, 12] };
pub const SCP_EVENTID_DRMINFO: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 557699719, data2: 16850, data3: 17195, data4: [158, 63, 59, 79, 123, 53, 129, 221] };
pub const SCP_EVENTID_NEEDTOINDIV: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2275739591, data2: 46185, data3: 17286, data4: [185, 118, 213, 209, 206, 83, 138, 111] };
pub const SCP_PARAMID_DRMVERSION: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1104155997, data2: 31943, data3: 16919, data4: [173, 169, 0, 80, 116, 98, 77, 164] };
#[repr(C)]
#[doc = "*Required features: `\"Win32_Media_DeviceManager\"`*"]
...
pub const WMDMDevice: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2155560159, data2: 13690, data3: 4563, data4: [132, 113, 0, 192, 79, 121, 219, 192] };
pub const WMDMDeviceEnum: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1125004719, data2: 14705, data3: 4563, data4: [132, 116, 0, 192, 79, 121, 219, 192] };
#[repr(C)]
#[doc = "*Required features: `\"Win32_Media_DeviceManager\"`*"]
pub struct WMDMID {
    pub cbSize: u32,
...
pub const WMDMLogger: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 285880834, data2: 23161, data3: 4563, data4: [141, 120, 68, 69, 83, 84, 0, 0] };
#[doc = "*Required features: `\"Win32_Media_DeviceManager\"`*"]
...
pub struct WMDMMetadataView {
    pub pwszViewName: ::windows_core_sys::PWSTR,
    pub nDepth: u32,
...
pub const WMDMStorage: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2155560160, data2: 13690, data3: 4563, data4: [132, 113, 0, 192, 79, 121, 219, 192] };
pub const WMDMStorageEnum: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3946846779, data2: 15095, data3: 4563, data4: [132, 116, 0, 192, 79, 121, 219, 192] };
pub const WMDMStorageGlobal: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2155560161, data2: 13690, data3: 4563, data4: [132, 113, 0, 192, 79, 121, 219, 192] };
#[doc = "*Required features: `\"Win32_Media_DeviceManager\"`*"]
...
pub const WMDM_DEVICE_PROTOCOL_MSC: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2765275756, data2: 43137, data3: 17595, data4: [189, 93, 31, 112, 60, 113, 247, 169] };
pub const WMDM_DEVICE_PROTOCOL_MTP: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2543736037, data2: 2812, data3: 17924, data4: [141, 147, 220, 121, 138, 75, 207, 69] };
pub const WMDM_DEVICE_PROTOCOL_RAPI: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 705818001, data2: 35983, data3: 16868, data4: [130, 209, 131, 134, 224, 3, 86, 28] };
#[doc = "*Required features: `\"Win32_Media_DeviceManager\"`*"]
...
pub const WMDM_SERVICE_PROVIDER_VENDOR_MICROSOFT: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2112383085, data2: 30958, data3: 17386, data4: [164, 150, 198, 37, 172, 145, 204, 93] };
#[doc = "*Required features: `\"Win32_Media_DeviceManager\"`*"]
