...
pub struct CALLFRAMEINFO {
    pub iMethod: u32,
    pub fHasInValues: ::win32_foundation::BOOL,
    pub fHasInOutValues: ::win32_foundation::BOOL,
    pub fHasOutValues: ::win32_foundation::BOOL,
    pub fDerivesFromIDispatch: ::win32_foundation::BOOL,
...
pub struct CALLFRAMEPARAMINFO {
    pub fIn: ::win32_foundation::BOOLEAN,
    pub fOut: ::win32_foundation::BOOLEAN,
    pub stackOffset: u32,
    pub cbParam: u32,
}
...
impl ICallFrameWalker {
    pub unsafe fn OnWalkInterface<'a, Param2: ::windows_core::IntoParam<'a, ::win32_foundation::BOOL>, Param3: ::windows_core::IntoParam<'a, ::win32_foundation::BOOL>>(&self, iid: *const ::windows_core::GUID, ppvinterface: *const *const ::core::ffi::c_void, fin: Param2, fout: Param3) -> ::windows_core::Result<()> {
...
pub struct ICallFrameWalker_Vtbl {
    pub base__: ::windows_core::IUnknownVtbl,
    pub OnWalkInterface: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, iid: *const ::windows_core::GUID, ppvinterface: *const *const ::core::ffi::c_void, fin: ::win32_foundation::BOOL, fout: ::win32_foundation::BOOL) -> ::windows_core::HRESULT,
}
#[repr(transparent)]
...
impl ICallIndirect {
    ...
    pub unsafe fn GetIID(&self, piid: *mut ::windows_core::GUID, pfderivesfromidispatch: *mut ::win32_foundation::BOOL, pcmethod: *mut u32, pwszinterface: *mut ::windows_core::PWSTR) -> ::windows_core::Result<()> {
...
pub struct ICallIndirect_Vtbl {
    ...
    pub GetIID: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, piid: *mut ::windows_core::GUID, pfderivesfromidispatch: *mut ::win32_foundation::BOOL, pcmethod: *mut u32, pwszinterface: *mut ::windows_core::PWSTR) -> ::windows_core::HRESULT,
}
#[repr(transparent)]
...
impl ICallUnmarshal {
    pub unsafe fn Unmarshal<'a, Param3: ::windows_core::IntoParam<'a, ::win32_foundation::BOOL>>(&self, imethod: u32, pbuffer: &[u8], fforcebuffercopy: Param3, datarep: u32, pcontext: *const CALLFRAME_MARSHALCONTEXT, pcbunmarshalled: *mut u32, ppframe: *mut ::core::option::Option<ICallFrame>) -> ::windows_core::Result<()> {
...
pub struct ICallUnmarshal_Vtbl {
    pub base__: ::windows_core::IUnknownVtbl,
    pub Unmarshal: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, imethod: u32, pbuffer: *const ::core::ffi::c_void, cbbuffer: u32, fforcebuffercopy: ::win32_foundation::BOOL, datarep: u32, pcontext: *const CALLFRAME_MARSHALCONTEXT, pcbunmarshalled: *mut u32, ppframe: *mut ::windows_core::RawPtr) -> ::windows_core::HRESULT,
