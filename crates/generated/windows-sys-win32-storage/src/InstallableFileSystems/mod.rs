#[link(name = "windows")]
extern "system" {
    pub fn FilterAttach(lpfiltername: ::windows_sys_core::PCWSTR, lpvolumename: ::windows_sys_core::PCWSTR, lpinstancename: ::windows_sys_core::PCWSTR, dwcreatedinstancenamelength: u32, lpcreatedinstancename: ::windows_sys_core::PWSTR) -> ::windows_sys_core::HRESULT;
    pub fn FilterAttachAtAltitude(lpfiltername: ::windows_sys_core::PCWSTR, lpvolumename: ::windows_sys_core::PCWSTR, lpaltitude: ::windows_sys_core::PCWSTR, lpinstancename: ::windows_sys_core::PCWSTR, dwcreatedinstancenamelength: u32, lpcreatedinstancename: ::windows_sys_core::PWSTR) -> ::windows_sys_core::HRESULT;
    pub fn FilterClose(hfilter: HFILTER) -> ::windows_sys_core::HRESULT;
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
    pub fn FilterConnectCommunicationPort(lpportname: ::windows_sys_core::PCWSTR, dwoptions: u32, lpcontext: *const ::core::ffi::c_void, wsizeofcontext: u16, lpsecurityattributes: *const super::super::Security::SECURITY_ATTRIBUTES, hport: *mut super::super::Foundation::HANDLE) -> ::windows_sys_core::HRESULT;
    pub fn FilterCreate(lpfiltername: ::windows_sys_core::PCWSTR, hfilter: *mut HFILTER) -> ::windows_sys_core::HRESULT;
    pub fn FilterDetach(lpfiltername: ::windows_sys_core::PCWSTR, lpvolumename: ::windows_sys_core::PCWSTR, lpinstancename: ::windows_sys_core::PCWSTR) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn FilterFindClose(hfilterfind: super::super::Foundation::HANDLE) -> ::windows_sys_core::HRESULT;
    pub fn FilterFindFirst(dwinformationclass: FILTER_INFORMATION_CLASS, lpbuffer: *mut ::core::ffi::c_void, dwbuffersize: u32, lpbytesreturned: *mut u32, lpfilterfind: *mut FilterFindHandle) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn FilterFindNext(hfilterfind: super::super::Foundation::HANDLE, dwinformationclass: FILTER_INFORMATION_CLASS, lpbuffer: *mut ::core::ffi::c_void, dwbuffersize: u32, lpbytesreturned: *mut u32) -> ::windows_sys_core::HRESULT;
    pub fn FilterGetDosName(lpvolumename: ::windows_sys_core::PCWSTR, lpdosname: ::windows_sys_core::PWSTR, dwdosnamebuffersize: u32) -> ::windows_sys_core::HRESULT;
    pub fn FilterGetInformation(hfilter: HFILTER, dwinformationclass: FILTER_INFORMATION_CLASS, lpbuffer: *mut ::core::ffi::c_void, dwbuffersize: u32, lpbytesreturned: *mut u32) -> ::windows_sys_core::HRESULT;
    #[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_IO"))]
    pub fn FilterGetMessage(hport: super::super::Foundation::HANDLE, lpmessagebuffer: *mut FILTER_MESSAGE_HEADER, dwmessagebuffersize: u32, lpoverlapped: *mut super::super::System::IO::OVERLAPPED) -> ::windows_sys_core::HRESULT;
    pub fn FilterInstanceClose(hinstance: HFILTER_INSTANCE) -> ::windows_sys_core::HRESULT;
    pub fn FilterInstanceCreate(lpfiltername: ::windows_sys_core::PCWSTR, lpvolumename: ::windows_sys_core::PCWSTR, lpinstancename: ::windows_sys_core::PCWSTR, hinstance: *mut HFILTER_INSTANCE) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn FilterInstanceFindClose(hfilterinstancefind: super::super::Foundation::HANDLE) -> ::windows_sys_core::HRESULT;
    pub fn FilterInstanceFindFirst(lpfiltername: ::windows_sys_core::PCWSTR, dwinformationclass: INSTANCE_INFORMATION_CLASS, lpbuffer: *mut ::core::ffi::c_void, dwbuffersize: u32, lpbytesreturned: *mut u32, lpfilterinstancefind: *mut FilterInstanceFindHandle) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn FilterInstanceFindNext(hfilterinstancefind: super::super::Foundation::HANDLE, dwinformationclass: INSTANCE_INFORMATION_CLASS, lpbuffer: *mut ::core::ffi::c_void, dwbuffersize: u32, lpbytesreturned: *mut u32) -> ::windows_sys_core::HRESULT;
    pub fn FilterInstanceGetInformation(hinstance: HFILTER_INSTANCE, dwinformationclass: INSTANCE_INFORMATION_CLASS, lpbuffer: *mut ::core::ffi::c_void, dwbuffersize: u32, lpbytesreturned: *mut u32) -> ::windows_sys_core::HRESULT;
    pub fn FilterLoad(lpfiltername: ::windows_sys_core::PCWSTR) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn FilterReplyMessage(hport: super::super::Foundation::HANDLE, lpreplybuffer: *const FILTER_REPLY_HEADER, dwreplybuffersize: u32) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn FilterSendMessage(hport: super::super::Foundation::HANDLE, lpinbuffer: *const ::core::ffi::c_void, dwinbuffersize: u32, lpoutbuffer: *mut ::core::ffi::c_void, dwoutbuffersize: u32, lpbytesreturned: *mut u32) -> ::windows_sys_core::HRESULT;
    pub fn FilterUnload(lpfiltername: ::windows_sys_core::PCWSTR) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn FilterVolumeFindClose(hvolumefind: super::super::Foundation::HANDLE) -> ::windows_sys_core::HRESULT;
    pub fn FilterVolumeFindFirst(dwinformationclass: FILTER_VOLUME_INFORMATION_CLASS, lpbuffer: *mut ::core::ffi::c_void, dwbuffersize: u32, lpbytesreturned: *mut u32, lpvolumefind: *mut FilterVolumeFindHandle) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn FilterVolumeFindNext(hvolumefind: super::super::Foundation::HANDLE, dwinformationclass: FILTER_VOLUME_INFORMATION_CLASS, lpbuffer: *mut ::core::ffi::c_void, dwbuffersize: u32, lpbytesreturned: *mut u32) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn FilterVolumeInstanceFindClose(hvolumeinstancefind: super::super::Foundation::HANDLE) -> ::windows_sys_core::HRESULT;
    pub fn FilterVolumeInstanceFindFirst(lpvolumename: ::windows_sys_core::PCWSTR, dwinformationclass: INSTANCE_INFORMATION_CLASS, lpbuffer: *mut ::core::ffi::c_void, dwbuffersize: u32, lpbytesreturned: *mut u32, lpvolumeinstancefind: *mut FilterVolumeInstanceFindHandle) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn FilterVolumeInstanceFindNext(hvolumeinstancefind: super::super::Foundation::HANDLE, dwinformationclass: INSTANCE_INFORMATION_CLASS, lpbuffer: *mut ::core::ffi::c_void, dwbuffersize: u32, lpbytesreturned: *mut u32) -> ::windows_sys_core::HRESULT;
}
#[repr(C)]
