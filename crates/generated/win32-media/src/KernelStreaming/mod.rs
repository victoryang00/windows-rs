...
pub struct AUDIORESOURCEMANAGEMENT_RESOURCEGROUP {
    pub ResourceGroupAcquired: ::win32_foundation::BOOL,
...
impl IKsFormatSupport {
    pub unsafe fn IsFormatSupported(&self, pksformat: *mut KSDATAFORMAT, cbformat: u32, pbsupported: *mut ::win32_foundation::BOOL) -> ::windows_core::Result<()> {
...
pub struct IKsFormatSupport_Vtbl {
    pub base__: ::windows_core::IUnknownVtbl,
    pub IsFormatSupported: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pksformat: *mut KSDATAFORMAT, cbformat: u32, pbsupported: *mut ::win32_foundation::BOOL) -> ::windows_core::HRESULT,
...
pub struct KSAC3_ALTERNATE_AUDIO {
    pub fStereo: ::win32_foundation::BOOL,
    pub DualMode: u32,
}
...
pub struct KSAC3_DOWNMIX {
    pub fDownMix: ::win32_foundation::BOOL,
    pub fDolbySurround: ::win32_foundation::BOOL,
}
...
pub struct KSAC3_ERROR_CONCEALMENT {
    pub fRepeatPreviousBlock: ::win32_foundation::BOOL,
    pub fErrorInCurrentBlock: ::win32_foundation::BOOL,
}
...
pub struct KSAC3_ROOM_TYPE {
    pub fLargeRoom: ::win32_foundation::BOOL,
}
...
pub struct KSAUDIO_COPY_PROTECTION {
    pub fCopyrighted: ::win32_foundation::BOOL,
    pub fOriginal: ::win32_foundation::BOOL,
}
...
pub struct KSAUDIO_MIXLEVEL {
    pub Mute: ::win32_foundation::BOOL,
    pub Level: i32,
}
...
pub struct KSCAMERA_EXTENDEDPROP_BACKGROUNDSEGMENTATION_CONFIGCAPS {
    pub Resolution: ::win32_foundation::SIZE,
    pub MaxFrameRate: KSCAMERA_EXTENDEDPROP_BACKGROUNDSEGMENTATION_CONFIGCAPS_0,
    pub MaskResolution: ::win32_foundation::SIZE,
...
pub struct KSCAMERA_EXTENDEDPROP_ROI_INFO {
    pub Region: ::win32_foundation::RECT,
    pub Flags: u64,
    pub Weight: i32,
...
pub struct KSCAMERA_METADATA_BACKGROUNDSEGMENTATIONMASK {
    ...
    pub MaskCoverageBoundingBox: ::win32_foundation::RECT,
    pub MaskResolution: ::win32_foundation::SIZE,
    pub ForegroundBoundingBox: ::win32_foundation::RECT,
    pub MaskData: [u8; 1],
}
...
pub struct KSDS3D_HRTF_PARAMS_MSG {
    pub Size: u32,
    pub Enabled: u32,
    pub SwapChannels: ::win32_foundation::BOOL,
    pub ZeroAzimuth: ::win32_foundation::BOOL,
    pub CrossFadeOutput: ::win32_foundation::BOOL,
    pub FilterSize: u32,
}
...
pub struct KSEVENTDATA_0_1 {
    pub Event: ::win32_foundation::HANDLE,
...
pub struct KSEVENTDATA_0_2 {
    pub Semaphore: ::win32_foundation::HANDLE,
    pub Reserved: u32,
    pub Adjustment: i32,
}
...
pub struct KSGOP_USERDATA {
    ...
    pub reserved1: u32,
    pub cFields: u8,
    pub l21Data: [::win32_foundation::CHAR; 3],
}
...
pub struct KSJACK_DESCRIPTION {
    ...
    pub IsConnected: ::win32_foundation::BOOL,
}
...
pub struct KSJACK_SINK_INFORMATION {
    ...
    pub HDCPCapable: ::win32_foundation::BOOL,
    pub AICapable: ::win32_foundation::BOOL,
    pub SinkDescriptionLength: u8,
    pub SinkDescription: [u16; 32],
    pub PortId: ::win32_foundation::LUID,
}
...
pub struct KSPIN_CONNECT {
    ...
    pub PinId: u32,
    pub PinToHandle: ::win32_foundation::HANDLE,
...
pub struct KSPROPERTY_CAMERACONTROL_REGION_OF_INTEREST_S {
    pub FocusRect: ::win32_foundation::RECT,
    pub AutoFocusLock: ::win32_foundation::BOOL,
    pub AutoExposureLock: ::win32_foundation::BOOL,
    pub AutoWhitebalanceLock: ::win32_foundation::BOOL,
...
pub struct KSPROPERTY_NETWORKCAMERACONTROL_METADATA_INFO {
    ...
    pub Size: u32,
    pub PTZStatus: ::win32_foundation::BOOL,
    pub Events: ::win32_foundation::BOOL,
    pub Analytics: ::win32_foundation::BOOL,
    pub Reserved: ::win32_foundation::BOOL,
}
...
pub struct KSPROPERTY_TUNER_SCAN_CAPS_S {
    pub Property: KSIDENTIFIER,
    pub fSupportsHardwareAssistedScanning: ::win32_foundation::BOOL,
...
pub struct KSPROPERTY_TUNER_STANDARD_MODE_S {
    pub Property: KSIDENTIFIER,
    pub AutoDetect: ::win32_foundation::BOOL,
}
...
pub struct KSPROPERTY_VIDEOCONTROL_ACTUAL_FRAME_RATE_S {
    ...
    pub StreamIndex: u32,
    pub RangeIndex: u32,
    pub Dimensions: ::win32_foundation::SIZE,
...
pub struct KSQUALITY_MANAGER {
    pub QualityManager: ::win32_foundation::HANDLE,
    pub Context: *mut ::core::ffi::c_void,
}
...
pub union KSRELATIVEEVENT_0 {
    pub ObjectHandle: ::win32_foundation::HANDLE,
...
pub struct KSRTAUDIO_BUFFER {
    ...
    pub CallMemoryBarrier: ::win32_foundation::BOOL,
}
...
pub struct KSRTAUDIO_GETREADPACKET_INFO {
    ...
    pub MoreData: ::win32_foundation::BOOL,
}
...
pub struct KSRTAUDIO_NOTIFICATION_EVENT_PROPERTY {
    pub Property: KSIDENTIFIER,
    pub NotificationEvent: ::win32_foundation::HANDLE,
}
...
pub struct KSWAVETABLE_WAVE_DESC {
    ...
    pub Size: u32,
    pub Looped: ::win32_foundation::BOOL,
    pub LoopPoint: u32,
    pub InROM: ::win32_foundation::BOOL,
...
pub struct KS_AMVPDATAINFO {
    ...
    pub bEnableDoubleClock: ::win32_foundation::BOOL,
    pub bEnableVACT: ::win32_foundation::BOOL,
    pub bDataIsInterlaced: ::win32_foundation::BOOL,
    pub lHalfLinesOdd: i32,
    pub bFieldPolarityInverted: ::win32_foundation::BOOL,
...
pub struct KS_AMVPDIMINFO {
    ...
    pub dwVBIWidth: u32,
    pub dwVBIHeight: u32,
    pub rcValidRegion: ::win32_foundation::RECT,
}
...
pub struct KS_FRAME_INFO {
    ...
    pub PictureNumber: i64,
    pub DropCount: i64,
    pub hDirectDraw: ::win32_foundation::HANDLE,
    pub hSurfaceHandle: ::win32_foundation::HANDLE,
    pub DirectDrawRect: ::win32_foundation::RECT,
...
pub struct KS_VIDEO_STREAM_CONFIG_CAPS {
    ...
    pub VideoStandard: u32,
    pub InputSize: ::win32_foundation::SIZE,
    pub MinCroppingSize: ::win32_foundation::SIZE,
    pub MaxCroppingSize: ::win32_foundation::SIZE,
    pub CropGranularityX: i32,
    pub CropGranularityY: i32,
    pub CropAlignX: i32,
    pub CropAlignY: i32,
    pub MinOutputSize: ::win32_foundation::SIZE,
    pub MaxOutputSize: ::win32_foundation::SIZE,
...
#[inline]
pub unsafe fn KsCreateAllocator<'a, Param0: ::windows_core::IntoParam<'a, ::win32_foundation::HANDLE>>(connectionhandle: Param0, allocatorframing: *const KSALLOCATOR_FRAMING, allocatorhandle: *mut ::win32_foundation::HANDLE) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn KsCreateAllocator(connectionhandle: ::win32_foundation::HANDLE, allocatorframing: *const KSALLOCATOR_FRAMING, allocatorhandle: *mut ::win32_foundation::HANDLE) -> u32;
        }
...
#[inline]
pub unsafe fn KsCreateAllocator2<'a, Param0: ::windows_core::IntoParam<'a, ::win32_foundation::HANDLE>>(connectionhandle: Param0, allocatorframing: *const KSALLOCATOR_FRAMING) -> ::windows_core::Result<::win32_foundation::HANDLE> {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn KsCreateAllocator2(connectionhandle: ::win32_foundation::HANDLE, allocatorframing: *const KSALLOCATOR_FRAMING, allocatorhandle: *mut ::win32_foundation::HANDLE) -> ::windows_core::HRESULT;
        }
        let mut result__ = ::core::mem::MaybeUninit::<::win32_foundation::HANDLE>::zeroed();
        KsCreateAllocator2(connectionhandle.into_param().abi(), ::core::mem::transmute(allocatorframing), ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<::win32_foundation::HANDLE>(result__)
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
#[inline]
pub unsafe fn KsCreateClock<'a, Param0: ::windows_core::IntoParam<'a, ::win32_foundation::HANDLE>>(connectionhandle: Param0, clockcreate: *const KSCLOCK_CREATE, clockhandle: *mut ::win32_foundation::HANDLE) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn KsCreateClock(connectionhandle: ::win32_foundation::HANDLE, clockcreate: *const KSCLOCK_CREATE, clockhandle: *mut ::win32_foundation::HANDLE) -> u32;
        }
...
#[inline]
pub unsafe fn KsCreateClock2<'a, Param0: ::windows_core::IntoParam<'a, ::win32_foundation::HANDLE>>(connectionhandle: Param0, clockcreate: *const KSCLOCK_CREATE) -> ::windows_core::Result<::win32_foundation::HANDLE> {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn KsCreateClock2(connectionhandle: ::win32_foundation::HANDLE, clockcreate: *const KSCLOCK_CREATE, clockhandle: *mut ::win32_foundation::HANDLE) -> ::windows_core::HRESULT;
        }
        let mut result__ = ::core::mem::MaybeUninit::<::win32_foundation::HANDLE>::zeroed();
        KsCreateClock2(connectionhandle.into_param().abi(), ::core::mem::transmute(clockcreate), ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<::win32_foundation::HANDLE>(result__)
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
#[inline]
pub unsafe fn KsCreatePin<'a, Param0: ::windows_core::IntoParam<'a, ::win32_foundation::HANDLE>>(filterhandle: Param0, connect: *const KSPIN_CONNECT, desiredaccess: u32, connectionhandle: *mut ::win32_foundation::HANDLE) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn KsCreatePin(filterhandle: ::win32_foundation::HANDLE, connect: *const KSPIN_CONNECT, desiredaccess: u32, connectionhandle: *mut ::win32_foundation::HANDLE) -> u32;
        }
...
#[inline]
pub unsafe fn KsCreatePin2<'a, Param0: ::windows_core::IntoParam<'a, ::win32_foundation::HANDLE>>(filterhandle: Param0, connect: *const KSPIN_CONNECT, desiredaccess: u32) -> ::windows_core::Result<::win32_foundation::HANDLE> {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn KsCreatePin2(filterhandle: ::win32_foundation::HANDLE, connect: *const KSPIN_CONNECT, desiredaccess: u32, connectionhandle: *mut ::win32_foundation::HANDLE) -> ::windows_core::HRESULT;
        }
        let mut result__ = ::core::mem::MaybeUninit::<::win32_foundation::HANDLE>::zeroed();
        KsCreatePin2(filterhandle.into_param().abi(), ::core::mem::transmute(connect), ::core::mem::transmute(desiredaccess), ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<::win32_foundation::HANDLE>(result__)
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
#[inline]
pub unsafe fn KsCreateTopologyNode<'a, Param0: ::windows_core::IntoParam<'a, ::win32_foundation::HANDLE>>(parenthandle: Param0, nodecreate: *const KSNODE_CREATE, desiredaccess: u32, nodehandle: *mut ::win32_foundation::HANDLE) -> u32 {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn KsCreateTopologyNode(parenthandle: ::win32_foundation::HANDLE, nodecreate: *const KSNODE_CREATE, desiredaccess: u32, nodehandle: *mut ::win32_foundation::HANDLE) -> u32;
        }
...
#[inline]
pub unsafe fn KsCreateTopologyNode2<'a, Param0: ::windows_core::IntoParam<'a, ::win32_foundation::HANDLE>>(parenthandle: Param0, nodecreate: *const KSNODE_CREATE, desiredaccess: u32) -> ::windows_core::Result<::win32_foundation::HANDLE> {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn KsCreateTopologyNode2(parenthandle: ::win32_foundation::HANDLE, nodecreate: *const KSNODE_CREATE, desiredaccess: u32, nodehandle: *mut ::win32_foundation::HANDLE) -> ::windows_core::HRESULT;
        }
        let mut result__ = ::core::mem::MaybeUninit::<::win32_foundation::HANDLE>::zeroed();
        KsCreateTopologyNode2(parenthandle.into_param().abi(), ::core::mem::transmute(nodecreate), ::core::mem::transmute(desiredaccess), ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<::win32_foundation::HANDLE>(result__)
    }
    #[cfg(not(windows))]
    unimplemented!("Unsupported target OS");
}
...
pub struct MEDIUM_INFO {
    pub MediaPresent: ::win32_foundation::BOOL,
    pub MediaType: u32,
    pub RecordInhibit: ::win32_foundation::BOOL,
}
