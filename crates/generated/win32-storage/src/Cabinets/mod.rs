...
pub struct CCAB {
    ...
    pub setID: u16,
    pub szDisk: [::win32_foundation::CHAR; 256],
    pub szCab: [::win32_foundation::CHAR; 256],
    pub szCabPath: [::win32_foundation::CHAR; 256],
}
...
unsafe impl ::windows_core::Abi for CCAB {
    type Abi = Self;
}
impl ::core::cmp::PartialEq for CCAB {
    fn eq(&self, other: &Self) -> bool {
        unsafe { ::windows_core::memcmp(self as *const _ as _, other as *const _ as _, core::mem::size_of::<CCAB>()) == 0 }
    }
}
...
pub struct ERF {
    pub erfOper: i32,
    pub erfType: i32,
    pub fError: ::win32_foundation::BOOL,
}
...
unsafe impl ::windows_core::Abi for ERF {
    type Abi = Self;
}
impl ::core::cmp::PartialEq for ERF {
    fn eq(&self, other: &Self) -> bool {
        unsafe { ::windows_core::memcmp(self as *const _ as _, other as *const _ as _, core::mem::size_of::<ERF>()) == 0 }
    }
}
...
#[inline]
pub unsafe fn FCIAddFile<'a, Param1: ::windows_core::IntoParam<'a, ::windows_core::PCSTR>, Param2: ::windows_core::IntoParam<'a, ::windows_core::PCSTR>, Param3: ::windows_core::IntoParam<'a, ::win32_foundation::BOOL>>(hfci: *const ::core::ffi::c_void, pszsourcefile: Param1, pszfilename: Param2, fexecute: Param3, pfnfcignc: PFNFCIGETNEXTCABINET, pfnfcis: PFNFCISTATUS, pfnfcigoi: PFNFCIGETOPENINFO, typecompress: u16) -> ::win32_foundation::BOOL {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn FCIAddFile(hfci: *const ::core::ffi::c_void, pszsourcefile: ::windows_core::PCSTR, pszfilename: ::windows_core::PCSTR, fexecute: ::win32_foundation::BOOL, pfnfcignc: ::windows_core::RawPtr, pfnfcis: ::windows_core::RawPtr, pfnfcigoi: ::windows_core::RawPtr, typecompress: u16) -> ::win32_foundation::BOOL;
        }
...
pub unsafe fn FCICreate(perf: *const ERF, pfnfcifp: PFNFCIFILEPLACED, pfna: PFNFCIALLOC, pfnf: PFNFCIFREE, pfnopen: PFNFCIOPEN, pfnread: PFNFCIREAD, pfnwrite: PFNFCIWRITE, pfnclose: PFNFCICLOSE, pfnseek: PFNFCISEEK, pfndelete: PFNFCIDELETE, pfnfcigtf: PFNFCIGETTEMPFILE, pccab: *const CCAB, pv: *const ::core::ffi::c_void) -> *mut ::core::ffi::c_void {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn FCICreate(perf: *const ERF, pfnfcifp: ::windows_core::RawPtr, pfna: ::windows_core::RawPtr, pfnf: ::windows_core::RawPtr, pfnopen: ::windows_core::RawPtr, pfnread: ::windows_core::RawPtr, pfnwrite: ::windows_core::RawPtr, pfnclose: ::windows_core::RawPtr, pfnseek: ::windows_core::RawPtr, pfndelete: ::windows_core::RawPtr, pfnfcigtf: ::windows_core::RawPtr, pccab: *const CCAB, pv: *const ::core::ffi::c_void) -> *mut ::core::ffi::c_void;
        }
...
#[inline]
pub unsafe fn FCIDestroy(hfci: *const ::core::ffi::c_void) -> ::win32_foundation::BOOL {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn FCIDestroy(hfci: *const ::core::ffi::c_void) -> ::win32_foundation::BOOL;
        }
...
unsafe impl ::windows_core::Abi for FCIERROR {
    type Abi = Self;
}
...
#[inline]
pub unsafe fn FCIFlushCabinet<'a, Param1: ::windows_core::IntoParam<'a, ::win32_foundation::BOOL>>(hfci: *const ::core::ffi::c_void, fgetnextcab: Param1, pfnfcignc: PFNFCIGETNEXTCABINET, pfnfcis: PFNFCISTATUS) -> ::win32_foundation::BOOL {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn FCIFlushCabinet(hfci: *const ::core::ffi::c_void, fgetnextcab: ::win32_foundation::BOOL, pfnfcignc: ::windows_core::RawPtr, pfnfcis: ::windows_core::RawPtr) -> ::win32_foundation::BOOL;
        }
...
#[inline]
pub unsafe fn FCIFlushFolder(hfci: *const ::core::ffi::c_void, pfnfcignc: PFNFCIGETNEXTCABINET, pfnfcis: PFNFCISTATUS) -> ::win32_foundation::BOOL {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn FCIFlushFolder(hfci: *const ::core::ffi::c_void, pfnfcignc: ::windows_core::RawPtr, pfnfcis: ::windows_core::RawPtr) -> ::win32_foundation::BOOL;
        }
...
pub struct FDICABINETINFO {
    ...
    pub setID: u16,
    pub iCabinet: u16,
    pub fReserve: ::win32_foundation::BOOL,
    pub hasprev: ::win32_foundation::BOOL,
    pub hasnext: ::win32_foundation::BOOL,
}
...
unsafe impl ::windows_core::Abi for FDICABINETINFO {
    type Abi = Self;
}
impl ::core::cmp::PartialEq for FDICABINETINFO {
    fn eq(&self, other: &Self) -> bool {
        unsafe { ::windows_core::memcmp(self as *const _ as _, other as *const _ as _, core::mem::size_of::<FDICABINETINFO>()) == 0 }
    }
}
...
unsafe impl ::windows_core::Abi for FDICREATE_CPU_TYPE {
    type Abi = Self;
}
...
#[inline]
pub unsafe fn FDICopy<'a, Param1: ::windows_core::IntoParam<'a, ::windows_core::PCSTR>, Param2: ::windows_core::IntoParam<'a, ::windows_core::PCSTR>>(hfdi: *const ::core::ffi::c_void, pszcabinet: Param1, pszcabpath: Param2, flags: i32, pfnfdin: PFNFDINOTIFY, pfnfdid: PFNFDIDECRYPT, pvuser: *const ::core::ffi::c_void) -> ::win32_foundation::BOOL {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn FDICopy(hfdi: *const ::core::ffi::c_void, pszcabinet: ::windows_core::PCSTR, pszcabpath: ::windows_core::PCSTR, flags: i32, pfnfdin: ::windows_core::RawPtr, pfnfdid: ::windows_core::RawPtr, pvuser: *const ::core::ffi::c_void) -> ::win32_foundation::BOOL;
        }
...
pub unsafe fn FDICreate(pfnalloc: PFNALLOC, pfnfree: PFNFREE, pfnopen: PFNOPEN, pfnread: PFNREAD, pfnwrite: PFNWRITE, pfnclose: PFNCLOSE, pfnseek: PFNSEEK, cputype: FDICREATE_CPU_TYPE, perf: *mut ERF) -> *mut ::core::ffi::c_void {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn FDICreate(pfnalloc: ::windows_core::RawPtr, pfnfree: ::windows_core::RawPtr, pfnopen: ::windows_core::RawPtr, pfnread: ::windows_core::RawPtr, pfnwrite: ::windows_core::RawPtr, pfnclose: ::windows_core::RawPtr, pfnseek: ::windows_core::RawPtr, cputype: FDICREATE_CPU_TYPE, perf: *mut ERF) -> *mut ::core::ffi::c_void;
        }
...
unsafe impl ::windows_core::Abi for FDIDECRYPT {
    type Abi = Self;
}
impl ::core::cmp::PartialEq for FDIDECRYPT {
    fn eq(&self, other: &Self) -> bool {
        unsafe { ::windows_core::memcmp(self as *const _ as _, other as *const _ as _, core::mem::size_of::<FDIDECRYPT>()) == 0 }
    }
}
...
unsafe impl ::windows_core::Abi for FDIDECRYPT_0 {
    type Abi = Self;
}
impl ::core::cmp::PartialEq for FDIDECRYPT_0 {
    fn eq(&self, other: &Self) -> bool {
        unsafe { ::windows_core::memcmp(self as *const _ as _, other as *const _ as _, core::mem::size_of::<FDIDECRYPT_0>()) == 0 }
    }
}
...
unsafe impl ::windows_core::Abi for FDIDECRYPT_0_0 {
    type Abi = Self;
}
impl ::core::cmp::PartialEq for FDIDECRYPT_0_0 {
    fn eq(&self, other: &Self) -> bool {
        unsafe { ::windows_core::memcmp(self as *const _ as _, other as *const _ as _, core::mem::size_of::<FDIDECRYPT_0_0>()) == 0 }
    }
}
...
pub struct FDIDECRYPT_0_1 {
    ...
    pub cbData: u16,
    pub fSplit: ::win32_foundation::BOOL,
    pub cbPartial: u16,
}
...
unsafe impl ::windows_core::Abi for FDIDECRYPT_0_1 {
    type Abi = Self;
}
impl ::core::cmp::PartialEq for FDIDECRYPT_0_1 {
    fn eq(&self, other: &Self) -> bool {
        unsafe { ::windows_core::memcmp(self as *const _ as _, other as *const _ as _, core::mem::size_of::<FDIDECRYPT_0_1>()) == 0 }
    }
}
...
unsafe impl ::windows_core::Abi for FDIDECRYPT_0_2 {
    type Abi = Self;
}
impl ::core::cmp::PartialEq for FDIDECRYPT_0_2 {
    fn eq(&self, other: &Self) -> bool {
        unsafe { ::windows_core::memcmp(self as *const _ as _, other as *const _ as _, core::mem::size_of::<FDIDECRYPT_0_2>()) == 0 }
    }
}
...
unsafe impl ::windows_core::Abi for FDIDECRYPTTYPE {
    type Abi = Self;
}
...
#[inline]
pub unsafe fn FDIDestroy(hfdi: *const ::core::ffi::c_void) -> ::win32_foundation::BOOL {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn FDIDestroy(hfdi: *const ::core::ffi::c_void) -> ::win32_foundation::BOOL;
        }
...
unsafe impl ::windows_core::Abi for FDIERROR {
    type Abi = Self;
}
...
#[inline]
pub unsafe fn FDIIsCabinet(hfdi: *const ::core::ffi::c_void, hf: isize, pfdici: *mut FDICABINETINFO) -> ::win32_foundation::BOOL {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn FDIIsCabinet(hfdi: *const ::core::ffi::c_void, hf: isize, pfdici: *mut FDICABINETINFO) -> ::win32_foundation::BOOL;
        }
...
unsafe impl ::windows_core::Abi for FDINOTIFICATION {
    type Abi = Self;
}
impl ::core::cmp::PartialEq for FDINOTIFICATION {
    fn eq(&self, other: &Self) -> bool {
        unsafe { ::windows_core::memcmp(self as *const _ as _, other as *const _ as _, core::mem::size_of::<FDINOTIFICATION>()) == 0 }
    }
}
...
unsafe impl ::windows_core::Abi for FDINOTIFICATIONTYPE {
    type Abi = Self;
}
...
pub struct FDISPILLFILE {
    pub ach: [::win32_foundation::CHAR; 2],
    pub cbFile: i32,
}
#[cfg(any(target_arch = "aarch64", target_arch = "x86_64"))]
...
#[cfg(any(target_arch = "aarch64", target_arch = "x86_64"))]
unsafe impl ::windows_core::Abi for FDISPILLFILE {
    type Abi = Self;
}
#[cfg(any(target_arch = "aarch64", target_arch = "x86_64"))]
impl ::core::cmp::PartialEq for FDISPILLFILE {
    fn eq(&self, other: &Self) -> bool {
        unsafe { ::windows_core::memcmp(self as *const _ as _, other as *const _ as _, core::mem::size_of::<FDISPILLFILE>()) == 0 }
    }
}
#[cfg(any(target_arch = "aarch64", target_arch = "x86_64"))]
...
#[inline]
pub unsafe fn FDITruncateCabinet<'a, Param1: ::windows_core::IntoParam<'a, ::windows_core::PCSTR>>(hfdi: *const ::core::ffi::c_void, pszcabinetname: Param1, ifoldertodelete: u16) -> ::win32_foundation::BOOL {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn FDITruncateCabinet(hfdi: *const ::core::ffi::c_void, pszcabinetname: ::windows_core::PCSTR, ifoldertodelete: u16) -> ::win32_foundation::BOOL;
        }
...
pub type PFNFCIFILEPLACED = ::core::option::Option<unsafe extern "system" fn(pccab: *mut CCAB, pszfile: ::windows_core::PCSTR, cbfile: i32, fcontinuation: ::win32_foundation::BOOL, pv: *mut ::core::ffi::c_void) -> i32>;
pub type PFNFCIFREE = ::core::option::Option<unsafe extern "system" fn(memory: *mut ::core::ffi::c_void)>;
pub type PFNFCIGETNEXTCABINET = ::core::option::Option<unsafe extern "system" fn(pccab: *mut CCAB, cbprevcab: u32, pv: *mut ::core::ffi::c_void) -> ::win32_foundation::BOOL>;
...
pub type PFNFCIGETTEMPFILE = ::core::option::Option<unsafe extern "system" fn(psztempname: ::windows_core::PSTR, cbtempname: i32, pv: *mut ::core::ffi::c_void) -> ::win32_foundation::BOOL>;
