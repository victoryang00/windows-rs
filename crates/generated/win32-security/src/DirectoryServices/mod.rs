...
pub unsafe fn DSCreateISecurityInfoObject<'a, Param0: ::windows_core::IntoParam<'a, ::windows_core::PCWSTR>, Param1: ::windows_core::IntoParam<'a, ::windows_core::PCWSTR>, Param6: ::windows_core::IntoParam<'a, ::win32_foundation::LPARAM>>(pwszobjectpath: Param0, pwszobjectclass: Param1, dwflags: u32, ppsi: *mut ::core::option::Option<super::Authorization::UI::ISecurityInformation>, pfnreadsd: PFNREADOBJECTSECURITY, pfnwritesd: PFNWRITEOBJECTSECURITY, lpcontext: Param6) -> ::windows_core::Result<()> {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn DSCreateISecurityInfoObject(pwszobjectpath: ::windows_core::PCWSTR, pwszobjectclass: ::windows_core::PCWSTR, dwflags: u32, ppsi: *mut ::windows_core::RawPtr, pfnreadsd: ::windows_core::RawPtr, pfnwritesd: ::windows_core::RawPtr, lpcontext: ::win32_foundation::LPARAM) -> ::windows_core::HRESULT;
        }
...
pub unsafe fn DSCreateSecurityPage<'a, Param0: ::windows_core::IntoParam<'a, ::windows_core::PCWSTR>, Param1: ::windows_core::IntoParam<'a, ::windows_core::PCWSTR>, Param6: ::windows_core::IntoParam<'a, ::win32_foundation::LPARAM>>(pwszobjectpath: Param0, pwszobjectclass: Param1, dwflags: u32, phpage: *mut ::win32_ui::Controls::HPROPSHEETPAGE, pfnreadsd: PFNREADOBJECTSECURITY, pfnwritesd: PFNWRITEOBJECTSECURITY, lpcontext: Param6) -> ::windows_core::Result<()> {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn DSCreateSecurityPage(pwszobjectpath: ::windows_core::PCWSTR, pwszobjectclass: ::windows_core::PCWSTR, dwflags: u32, phpage: *mut ::win32_ui::Controls::HPROPSHEETPAGE, pfnreadsd: ::windows_core::RawPtr, pfnwritesd: ::windows_core::RawPtr, lpcontext: ::win32_foundation::LPARAM) -> ::windows_core::HRESULT;
        }
...
#[inline]
pub unsafe fn DSEditSecurity<'a, Param0: ::windows_core::IntoParam<'a, ::win32_foundation::HWND>, Param1: ::windows_core::IntoParam<'a, ::windows_core::PCWSTR>, Param2: ::windows_core::IntoParam<'a, ::windows_core::PCWSTR>, Param4: ::windows_core::IntoParam<'a, ::windows_core::PCWSTR>, Param7: ::windows_core::IntoParam<'a, ::win32_foundation::LPARAM>>(hwndowner: Param0, pwszobjectpath: Param1, pwszobjectclass: Param2, dwflags: u32, pwszcaption: Param4, pfnreadsd: PFNREADOBJECTSECURITY, pfnwritesd: PFNWRITEOBJECTSECURITY, lpcontext: Param7) -> ::windows_core::Result<()> {
    #[cfg(windows)]
    {
        #[link(name = "windows")]
        extern "system" {
            fn DSEditSecurity(hwndowner: ::win32_foundation::HWND, pwszobjectpath: ::windows_core::PCWSTR, pwszobjectclass: ::windows_core::PCWSTR, dwflags: u32, pwszcaption: ::windows_core::PCWSTR, pfnreadsd: ::windows_core::RawPtr, pfnwritesd: ::windows_core::RawPtr, lpcontext: ::win32_foundation::LPARAM) -> ::windows_core::HRESULT;
        }
...
pub type PFNWRITEOBJECTSECURITY = ::core::option::Option<unsafe extern "system" fn(param0: ::windows_core::PCWSTR, param1: u32, param2: super::PSECURITY_DESCRIPTOR, param3: ::win32_foundation::LPARAM) -> ::windows_core::HRESULT>;
