...
impl IRadialControllerIndependentInputSourceInterop {
    pub unsafe fn CreateForWindow<'a, Param0: ::windows_core::IntoParam<'a, ::win32_foundation::HWND>, T: ::windows_core::Interface>(&self, hwnd: Param0) -> ::windows_core::Result<T> {
        let mut result__ = ::core::option::Option::None;
...
pub struct IRadialControllerIndependentInputSourceInterop_Vtbl {
    pub base__: ::windows_core::IInspectableVtbl,
    pub CreateForWindow: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, hwnd: ::win32_foundation::HWND, riid: *const ::windows_core::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
}
#[repr(transparent)]
