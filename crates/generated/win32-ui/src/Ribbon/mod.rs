...
impl IUIApplication {
    pub unsafe fn OnViewChanged<'a, Param2: ::windows_core::IntoParam<'a, ::windows_core::IUnknown>>(&self, viewid: u32, typeid: UI_VIEWTYPE, view: Param2, verb: UI_VIEWVERB, ureasoncode: i32) -> ::windows_core::Result<()> {
        (::windows_core::Interface::vtable(self).OnViewChanged)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(viewid), ::core::mem::transmute(typeid), view.into_param().abi(), ::core::mem::transmute(verb), ::core::mem::transmute(ureasoncode)).ok()
    }
    pub unsafe fn OnCreateUICommand(&self, commandid: u32, typeid: UI_COMMANDTYPE) -> ::windows_core::Result<IUICommandHandler> {
        ...
        (::windows_core::Interface::vtable(self).OnCreateUICommand)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(commandid), ::core::mem::transmute(typeid), ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<IUICommandHandler>(result__)
    }
    pub unsafe fn OnDestroyUICommand<'a, Param2: ::windows_core::IntoParam<'a, IUICommandHandler>>(&self, commandid: u32, typeid: UI_COMMANDTYPE, commandhandler: Param2) -> ::windows_core::Result<()> {
        (::windows_core::Interface::vtable(self).OnDestroyUICommand)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(commandid), ::core::mem::transmute(typeid), commandhandler.into_param().abi()).ok()
    }
}
impl ::core::convert::From<IUIApplication> for ::windows_core::IUnknown {
...
impl<'a> ::windows_core::IntoParam<'a, ::windows_core::IUnknown> for IUIApplication {
    fn into_param(self) -> ::windows_core::Param<'a, ::windows_core::IUnknown> {
        ::windows_core::Param::Owned(unsafe { ::core::mem::transmute(self) })
    }
}
impl<'a> ::windows_core::IntoParam<'a, ::windows_core::IUnknown> for &'a IUIApplication {
    fn into_param(self) -> ::windows_core::Param<'a, ::windows_core::IUnknown> {
...
pub struct IUIApplication_Vtbl {
    ...
    pub OnCreateUICommand: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, commandid: u32, typeid: UI_COMMANDTYPE, commandhandler: *mut ::windows_core::RawPtr) -> ::windows_core::HRESULT,
    pub OnDestroyUICommand: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, commandid: u32, typeid: UI_COMMANDTYPE, commandhandler: ::windows_core::RawPtr) -> ::windows_core::HRESULT,
}
#[repr(transparent)]
...
impl IUICollection {
    ...
    pub unsafe fn GetItem(&self, index: u32) -> ::windows_core::Result<::windows_core::IUnknown> {
        ...
        (::windows_core::Interface::vtable(self).GetItem)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(index), ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<::windows_core::IUnknown>(result__)
    }
    pub unsafe fn Add<'a, Param0: ::windows_core::IntoParam<'a, ::windows_core::IUnknown>>(&self, item: Param0) -> ::windows_core::Result<()> {
        (::windows_core::Interface::vtable(self).Add)(::windows_core::Interface::as_raw(self), item.into_param().abi()).ok()
    }
    pub unsafe fn Insert<'a, Param1: ::windows_core::IntoParam<'a, ::windows_core::IUnknown>>(&self, index: u32, item: Param1) -> ::windows_core::Result<()> {
        (::windows_core::Interface::vtable(self).Insert)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(index), item.into_param().abi()).ok()
    }
    ...
    pub unsafe fn Replace<'a, Param1: ::windows_core::IntoParam<'a, ::windows_core::IUnknown>>(&self, indexreplaced: u32, itemreplacewith: Param1) -> ::windows_core::Result<()> {
        (::windows_core::Interface::vtable(self).Replace)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(indexreplaced), itemreplacewith.into_param().abi()).ok()
    }
    pub unsafe fn Clear(&self) -> ::windows_core::Result<()> {
        (::windows_core::Interface::vtable(self).Clear)(::windows_core::Interface::as_raw(self)).ok()
    }
}
impl ::core::convert::From<IUICollection> for ::windows_core::IUnknown {
...
impl<'a> ::windows_core::IntoParam<'a, ::windows_core::IUnknown> for IUICollection {
    fn into_param(self) -> ::windows_core::Param<'a, ::windows_core::IUnknown> {
        ::windows_core::Param::Owned(unsafe { ::core::mem::transmute(self) })
    }
}
impl<'a> ::windows_core::IntoParam<'a, ::windows_core::IUnknown> for &'a IUICollection {
    fn into_param(self) -> ::windows_core::Param<'a, ::windows_core::IUnknown> {
        ::windows_core::Param::Borrowed(unsafe { ::core::mem::transmute(self) })
    }
}
...
impl IUICollectionChangedEvent {
    pub unsafe fn OnChanged<'a, Param2: ::windows_core::IntoParam<'a, ::windows_core::IUnknown>, Param4: ::windows_core::IntoParam<'a, ::windows_core::IUnknown>>(&self, action: UI_COLLECTIONCHANGE, oldindex: u32, olditem: Param2, newindex: u32, newitem: Param4) -> ::windows_core::Result<()> {
        (::windows_core::Interface::vtable(self).OnChanged)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(action), ::core::mem::transmute(oldindex), olditem.into_param().abi(), ::core::mem::transmute(newindex), newitem.into_param().abi()).ok()
    }
}
impl ::core::convert::From<IUICollectionChangedEvent> for ::windows_core::IUnknown {
...
impl<'a> ::windows_core::IntoParam<'a, ::windows_core::IUnknown> for IUICollectionChangedEvent {
    fn into_param(self) -> ::windows_core::Param<'a, ::windows_core::IUnknown> {
        ::windows_core::Param::Owned(unsafe { ::core::mem::transmute(self) })
    }
}
impl<'a> ::windows_core::IntoParam<'a, ::windows_core::IUnknown> for &'a IUICollectionChangedEvent {
    fn into_param(self) -> ::windows_core::Param<'a, ::windows_core::IUnknown> {
        ::windows_core::Param::Borrowed(unsafe { ::core::mem::transmute(self) })
    }
}
...
impl IUICommandHandler {
    ...
    pub unsafe fn Execute<'a, Param4: ::windows_core::IntoParam<'a, IUISimplePropertySet>>(&self, commandid: u32, verb: UI_EXECUTIONVERB, key: *const super::Shell::PropertiesSystem::PROPERTYKEY, currentvalue: *const ::win32_system::Com::StructuredStorage::PROPVARIANT, commandexecutionproperties: Param4) -> ::windows_core::Result<()> {
        (::windows_core::Interface::vtable(self).Execute)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(commandid), ::core::mem::transmute(verb), ::core::mem::transmute(key), ::core::mem::transmute(currentvalue), commandexecutionproperties.into_param().abi()).ok()
    }
    #[cfg(all(feature = "win32-system", feature = "win32-ui"))]
    pub unsafe fn UpdateProperty(&self, commandid: u32, key: *const super::Shell::PropertiesSystem::PROPERTYKEY, currentvalue: *const ::win32_system::Com::StructuredStorage::PROPVARIANT) -> ::windows_core::Result<::win32_system::Com::StructuredStorage::PROPVARIANT> {
        let mut result__ = ::core::mem::MaybeUninit::<::core::mem::ManuallyDrop<::win32_system::Com::StructuredStorage::PROPVARIANT>>::zeroed();
        (::windows_core::Interface::vtable(self).UpdateProperty)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(commandid), ::core::mem::transmute(key), ::core::mem::transmute(currentvalue), ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<::win32_system::Com::StructuredStorage::PROPVARIANT>(result__)
    }
}
impl ::core::convert::From<IUICommandHandler> for ::windows_core::IUnknown {
...
impl<'a> ::windows_core::IntoParam<'a, ::windows_core::IUnknown> for IUICommandHandler {
    fn into_param(self) -> ::windows_core::Param<'a, ::windows_core::IUnknown> {
        ::windows_core::Param::Owned(unsafe { ::core::mem::transmute(self) })
    }
}
impl<'a> ::windows_core::IntoParam<'a, ::windows_core::IUnknown> for &'a IUICommandHandler {
    fn into_param(self) -> ::windows_core::Param<'a, ::windows_core::IUnknown> {
        ::windows_core::Param::Borrowed(unsafe { ::core::mem::transmute(self) })
    }
}
...
pub struct IUICommandHandler_Vtbl {
    pub base__: ::windows_core::IUnknownVtbl,
    #[cfg(all(feature = "win32-system", feature = "win32-ui"))]
    pub Execute: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, commandid: u32, verb: UI_EXECUTIONVERB, key: *const super::Shell::PropertiesSystem::PROPERTYKEY, currentvalue: *const ::win32_system::Com::StructuredStorage::PROPVARIANT, commandexecutionproperties: ::windows_core::RawPtr) -> ::windows_core::HRESULT,
    #[cfg(not(all(feature = "win32-system", feature = "win32-ui")))]
    Execute: usize,
    #[cfg(all(feature = "win32-system", feature = "win32-ui"))]
    pub UpdateProperty: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, commandid: u32, key: *const super::Shell::PropertiesSystem::PROPERTYKEY, currentvalue: *const ::win32_system::Com::StructuredStorage::PROPVARIANT, newvalue: *mut ::win32_system::Com::StructuredStorage::PROPVARIANT) -> ::windows_core::HRESULT,
    #[cfg(not(all(feature = "win32-system", feature = "win32-ui")))]
...
impl ::core::convert::From<IUIContextualUI> for ::windows_core::IUnknown {
...
impl<'a> ::windows_core::IntoParam<'a, ::windows_core::IUnknown> for IUIContextualUI {
    fn into_param(self) -> ::windows_core::Param<'a, ::windows_core::IUnknown> {
        ::windows_core::Param::Owned(unsafe { ::core::mem::transmute(self) })
    }
}
impl<'a> ::windows_core::IntoParam<'a, ::windows_core::IUnknown> for &'a IUIContextualUI {
    fn into_param(self) -> ::windows_core::Param<'a, ::windows_core::IUnknown> {
        ::windows_core::Param::Borrowed(unsafe { ::core::mem::transmute(self) })
    }
}
...
impl ::core::convert::From<IUIEventLogger> for ::windows_core::IUnknown {
...
impl<'a> ::windows_core::IntoParam<'a, ::windows_core::IUnknown> for IUIEventLogger {
    fn into_param(self) -> ::windows_core::Param<'a, ::windows_core::IUnknown> {
        ::windows_core::Param::Owned(unsafe { ::core::mem::transmute(self) })
    }
}
impl<'a> ::windows_core::IntoParam<'a, ::windows_core::IUnknown> for &'a IUIEventLogger {
    fn into_param(self) -> ::windows_core::Param<'a, ::windows_core::IUnknown> {
        ::windows_core::Param::Borrowed(unsafe { ::core::mem::transmute(self) })
    }
}
...
impl IUIEventingManager {
    pub unsafe fn SetEventLogger<'a, Param0: ::windows_core::IntoParam<'a, IUIEventLogger>>(&self, eventlogger: Param0) -> ::windows_core::Result<()> {
        (::windows_core::Interface::vtable(self).SetEventLogger)(::windows_core::Interface::as_raw(self), eventlogger.into_param().abi()).ok()
    }
}
impl ::core::convert::From<IUIEventingManager> for ::windows_core::IUnknown {
...
impl<'a> ::windows_core::IntoParam<'a, ::windows_core::IUnknown> for IUIEventingManager {
    fn into_param(self) -> ::windows_core::Param<'a, ::windows_core::IUnknown> {
        ::windows_core::Param::Owned(unsafe { ::core::mem::transmute(self) })
    }
}
impl<'a> ::windows_core::IntoParam<'a, ::windows_core::IUnknown> for &'a IUIEventingManager {
    fn into_param(self) -> ::windows_core::Param<'a, ::windows_core::IUnknown> {
        ::windows_core::Param::Borrowed(unsafe { ::core::mem::transmute(self) })
    }
}
...
pub struct IUIEventingManager_Vtbl {
    pub base__: ::windows_core::IUnknownVtbl,
    pub SetEventLogger: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, eventlogger: ::windows_core::RawPtr) -> ::windows_core::HRESULT,
}
#[repr(transparent)]
pub struct IUIFramework(::windows_core::IUnknown);
impl IUIFramework {
    pub unsafe fn Initialize<'a, Param0: ::windows_core::IntoParam<'a, ::win32_foundation::HWND>, Param1: ::windows_core::IntoParam<'a, IUIApplication>>(&self, framewnd: Param0, application: Param1) -> ::windows_core::Result<()> {
    ...
    pub unsafe fn LoadUI<'a, Param0: ::windows_core::IntoParam<'a, ::win32_foundation::HINSTANCE>, Param1: ::windows_core::IntoParam<'a, ::windows_core::PCWSTR>>(&self, instance: Param0, resourcename: Param1) -> ::windows_core::Result<()> {
    ...
    #[cfg(all(feature = "win32-system", feature = "win32-ui"))]
    pub unsafe fn GetUICommandProperty(&self, commandid: u32, key: *const super::Shell::PropertiesSystem::PROPERTYKEY) -> ::windows_core::Result<::win32_system::Com::StructuredStorage::PROPVARIANT> {
        let mut result__ = ::core::mem::MaybeUninit::<::core::mem::ManuallyDrop<::win32_system::Com::StructuredStorage::PROPVARIANT>>::zeroed();
        (::windows_core::Interface::vtable(self).GetUICommandProperty)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(commandid), ::core::mem::transmute(key), ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<::win32_system::Com::StructuredStorage::PROPVARIANT>(result__)
    }
    #[cfg(all(feature = "win32-system", feature = "win32-ui"))]
    pub unsafe fn SetUICommandProperty(&self, commandid: u32, key: *const super::Shell::PropertiesSystem::PROPERTYKEY, value: *const ::win32_system::Com::StructuredStorage::PROPVARIANT) -> ::windows_core::Result<()> {
    ...
    pub unsafe fn InvalidateUICommand(&self, commandid: u32, flags: UI_INVALIDATIONS, key: *const super::Shell::PropertiesSystem::PROPERTYKEY) -> ::windows_core::Result<()> {
        (::windows_core::Interface::vtable(self).InvalidateUICommand)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(commandid), ::core::mem::transmute(flags), ::core::mem::transmute(key)).ok()
    }
...
impl ::core::convert::From<IUIFramework> for ::windows_core::IUnknown {
...
impl<'a> ::windows_core::IntoParam<'a, ::windows_core::IUnknown> for IUIFramework {
    fn into_param(self) -> ::windows_core::Param<'a, ::windows_core::IUnknown> {
        ::windows_core::Param::Owned(unsafe { ::core::mem::transmute(self) })
    }
}
impl<'a> ::windows_core::IntoParam<'a, ::windows_core::IUnknown> for &'a IUIFramework {
    fn into_param(self) -> ::windows_core::Param<'a, ::windows_core::IUnknown> {
        ::windows_core::Param::Borrowed(unsafe { ::core::mem::transmute(self) })
    }
}
...
pub struct IUIFramework_Vtbl {
    pub base__: ::windows_core::IUnknownVtbl,
    pub Initialize: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, framewnd: ::win32_foundation::HWND, application: ::windows_core::RawPtr) -> ::windows_core::HRESULT,
    pub Destroy: unsafe extern "system" fn(this: *mut ::core::ffi::c_void) -> ::windows_core::HRESULT,
    pub LoadUI: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, instance: ::win32_foundation::HINSTANCE, resourcename: ::windows_core::PCWSTR) -> ::windows_core::HRESULT,
    ...
    #[cfg(all(feature = "win32-system", feature = "win32-ui"))]
    pub GetUICommandProperty: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, commandid: u32, key: *const super::Shell::PropertiesSystem::PROPERTYKEY, value: *mut ::win32_system::Com::StructuredStorage::PROPVARIANT) -> ::windows_core::HRESULT,
    #[cfg(not(all(feature = "win32-system", feature = "win32-ui")))]
    GetUICommandProperty: usize,
    #[cfg(all(feature = "win32-system", feature = "win32-ui"))]
    pub SetUICommandProperty: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, commandid: u32, key: *const super::Shell::PropertiesSystem::PROPERTYKEY, value: *const ::win32_system::Com::StructuredStorage::PROPVARIANT) -> ::windows_core::HRESULT,
    #[cfg(not(all(feature = "win32-system", feature = "win32-ui")))]
...
impl IUIImage {
    ...
    pub unsafe fn GetBitmap(&self) -> ::windows_core::Result<::win32_graphics::Gdi::HBITMAP> {
        let mut result__ = ::core::mem::MaybeUninit::<::win32_graphics::Gdi::HBITMAP>::zeroed();
        (::windows_core::Interface::vtable(self).GetBitmap)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<::win32_graphics::Gdi::HBITMAP>(result__)
    }
}
impl ::core::convert::From<IUIImage> for ::windows_core::IUnknown {
...
impl<'a> ::windows_core::IntoParam<'a, ::windows_core::IUnknown> for IUIImage {
    fn into_param(self) -> ::windows_core::Param<'a, ::windows_core::IUnknown> {
        ::windows_core::Param::Owned(unsafe { ::core::mem::transmute(self) })
    }
}
impl<'a> ::windows_core::IntoParam<'a, ::windows_core::IUnknown> for &'a IUIImage {
    fn into_param(self) -> ::windows_core::Param<'a, ::windows_core::IUnknown> {
        ::windows_core::Param::Borrowed(unsafe { ::core::mem::transmute(self) })
    }
}
...
pub struct IUIImage_Vtbl {
    pub base__: ::windows_core::IUnknownVtbl,
    #[cfg(feature = "win32-graphics")]
    pub GetBitmap: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, bitmap: *mut ::win32_graphics::Gdi::HBITMAP) -> ::windows_core::HRESULT,
...
impl IUIImageFromBitmap {
    #[cfg(feature = "win32-graphics")]
    pub unsafe fn CreateImage<'a, Param0: ::windows_core::IntoParam<'a, ::win32_graphics::Gdi::HBITMAP>>(&self, bitmap: Param0, options: UI_OWNERSHIP) -> ::windows_core::Result<IUIImage> {
        let mut result__ = ::core::mem::MaybeUninit::<::windows_core::RawPtr>::zeroed();
        (::windows_core::Interface::vtable(self).CreateImage)(::windows_core::Interface::as_raw(self), bitmap.into_param().abi(), ::core::mem::transmute(options), ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<IUIImage>(result__)
    }
}
impl ::core::convert::From<IUIImageFromBitmap> for ::windows_core::IUnknown {
...
impl<'a> ::windows_core::IntoParam<'a, ::windows_core::IUnknown> for IUIImageFromBitmap {
    fn into_param(self) -> ::windows_core::Param<'a, ::windows_core::IUnknown> {
        ::windows_core::Param::Owned(unsafe { ::core::mem::transmute(self) })
    }
}
impl<'a> ::windows_core::IntoParam<'a, ::windows_core::IUnknown> for &'a IUIImageFromBitmap {
    fn into_param(self) -> ::windows_core::Param<'a, ::windows_core::IUnknown> {
        ::windows_core::Param::Borrowed(unsafe { ::core::mem::transmute(self) })
    }
}
...
pub struct IUIImageFromBitmap_Vtbl {
    pub base__: ::windows_core::IUnknownVtbl,
    #[cfg(feature = "win32-graphics")]
    pub CreateImage: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, bitmap: ::win32_graphics::Gdi::HBITMAP, options: UI_OWNERSHIP, image: *mut ::windows_core::RawPtr) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "win32-graphics"))]
    CreateImage: usize,
}
#[repr(transparent)]
...
impl IUIRibbon {
    pub unsafe fn GetHeight(&self) -> ::windows_core::Result<u32> {
        let mut result__ = ::core::mem::MaybeUninit::<u32>::zeroed();
        (::windows_core::Interface::vtable(self).GetHeight)(::windows_core::Interface::as_raw(self), ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<u32>(result__)
    }
    #[cfg(feature = "win32-system")]
    pub unsafe fn LoadSettingsFromStream<'a, Param0: ::windows_core::IntoParam<'a, ::win32_system::Com::IStream>>(&self, pstream: Param0) -> ::windows_core::Result<()> {
        (::windows_core::Interface::vtable(self).LoadSettingsFromStream)(::windows_core::Interface::as_raw(self), pstream.into_param().abi()).ok()
    }
    #[cfg(feature = "win32-system")]
    pub unsafe fn SaveSettingsToStream<'a, Param0: ::windows_core::IntoParam<'a, ::win32_system::Com::IStream>>(&self, pstream: Param0) -> ::windows_core::Result<()> {
        (::windows_core::Interface::vtable(self).SaveSettingsToStream)(::windows_core::Interface::as_raw(self), pstream.into_param().abi()).ok()
    }
}
impl ::core::convert::From<IUIRibbon> for ::windows_core::IUnknown {
...
impl<'a> ::windows_core::IntoParam<'a, ::windows_core::IUnknown> for IUIRibbon {
    fn into_param(self) -> ::windows_core::Param<'a, ::windows_core::IUnknown> {
        ::windows_core::Param::Owned(unsafe { ::core::mem::transmute(self) })
    }
}
impl<'a> ::windows_core::IntoParam<'a, ::windows_core::IUnknown> for &'a IUIRibbon {
    fn into_param(self) -> ::windows_core::Param<'a, ::windows_core::IUnknown> {
        ::windows_core::Param::Borrowed(unsafe { ::core::mem::transmute(self) })
    }
}
...
pub struct IUIRibbon_Vtbl {
    ...
    #[cfg(feature = "win32-system")]
    pub LoadSettingsFromStream: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pstream: ::windows_core::RawPtr) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "win32-system"))]
    LoadSettingsFromStream: usize,
    #[cfg(feature = "win32-system")]
    pub SaveSettingsToStream: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, pstream: ::windows_core::RawPtr) -> ::windows_core::HRESULT,
    #[cfg(not(feature = "win32-system"))]
...
impl IUISimplePropertySet {
    #[cfg(all(feature = "win32-system", feature = "win32-ui"))]
    pub unsafe fn GetValue(&self, key: *const super::Shell::PropertiesSystem::PROPERTYKEY) -> ::windows_core::Result<::win32_system::Com::StructuredStorage::PROPVARIANT> {
        let mut result__ = ::core::mem::MaybeUninit::<::core::mem::ManuallyDrop<::win32_system::Com::StructuredStorage::PROPVARIANT>>::zeroed();
...
impl ::core::convert::From<IUISimplePropertySet> for ::windows_core::IUnknown {
...
impl<'a> ::windows_core::IntoParam<'a, ::windows_core::IUnknown> for IUISimplePropertySet {
    fn into_param(self) -> ::windows_core::Param<'a, ::windows_core::IUnknown> {
        ::windows_core::Param::Owned(unsafe { ::core::mem::transmute(self) })
    }
}
impl<'a> ::windows_core::IntoParam<'a, ::windows_core::IUnknown> for &'a IUISimplePropertySet {
    fn into_param(self) -> ::windows_core::Param<'a, ::windows_core::IUnknown> {
        ::windows_core::Param::Borrowed(unsafe { ::core::mem::transmute(self) })
    }
}
...
pub struct IUISimplePropertySet_Vtbl {
    pub base__: ::windows_core::IUnknownVtbl,
    #[cfg(all(feature = "win32-system", feature = "win32-ui"))]
    pub GetValue: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, key: *const super::Shell::PropertiesSystem::PROPERTYKEY, value: *mut ::win32_system::Com::StructuredStorage::PROPVARIANT) -> ::windows_core::HRESULT,
    #[cfg(not(all(feature = "win32-system", feature = "win32-ui")))]
    GetValue: usize,
}
...
unsafe impl ::windows_core::Abi for UI_COLLECTIONCHANGE {
    type Abi = Self;
}
...
unsafe impl ::windows_core::Abi for UI_COMMANDTYPE {
    type Abi = Self;
}
...
unsafe impl ::windows_core::Abi for UI_CONTEXTAVAILABILITY {
    type Abi = Self;
}
...
unsafe impl ::windows_core::Abi for UI_CONTROLDOCK {
    type Abi = Self;
}
...
unsafe impl ::windows_core::Abi for UI_EVENTLOCATION {
    type Abi = Self;
}
...
unsafe impl ::windows_core::Abi for UI_EVENTPARAMS {
    type Abi = Self;
}
impl ::core::cmp::PartialEq for UI_EVENTPARAMS {
    fn eq(&self, other: &Self) -> bool {
        unsafe { ::windows_core::memcmp(self as *const _ as _, other as *const _ as _, core::mem::size_of::<UI_EVENTPARAMS>()) == 0 }
    }
}
...
unsafe impl ::windows_core::Abi for UI_EVENTPARAMS_0 {
    type Abi = Self;
}
impl ::core::cmp::PartialEq for UI_EVENTPARAMS_0 {
    fn eq(&self, other: &Self) -> bool {
        unsafe { ::windows_core::memcmp(self as *const _ as _, other as *const _ as _, core::mem::size_of::<UI_EVENTPARAMS_0>()) == 0 }
    }
}
...
unsafe impl ::windows_core::Abi for UI_EVENTPARAMS_COMMAND {
    type Abi = Self;
}
impl ::core::cmp::PartialEq for UI_EVENTPARAMS_COMMAND {
    fn eq(&self, other: &Self) -> bool {
        unsafe { ::windows_core::memcmp(self as *const _ as _, other as *const _ as _, core::mem::size_of::<UI_EVENTPARAMS_COMMAND>()) == 0 }
    }
}
...
unsafe impl ::windows_core::Abi for UI_EVENTTYPE {
    type Abi = Self;
}
...
unsafe impl ::windows_core::Abi for UI_EXECUTIONVERB {
    type Abi = Self;
}
...
unsafe impl ::windows_core::Abi for UI_FONTDELTASIZE {
    type Abi = Self;
}
...
unsafe impl ::windows_core::Abi for UI_FONTPROPERTIES {
    type Abi = Self;
}
...
unsafe impl ::windows_core::Abi for UI_FONTUNDERLINE {
    type Abi = Self;
}
...
unsafe impl ::windows_core::Abi for UI_FONTVERTICALPOSITION {
    type Abi = Self;
}
...
unsafe impl ::windows_core::Abi for UI_INVALIDATIONS {
    type Abi = Self;
}
...
unsafe impl ::windows_core::Abi for UI_OWNERSHIP {
    type Abi = Self;
}
...
unsafe impl ::windows_core::Abi for UI_SWATCHCOLORMODE {
    type Abi = Self;
}
...
unsafe impl ::windows_core::Abi for UI_SWATCHCOLORTYPE {
    type Abi = Self;
}
...
unsafe impl ::windows_core::Abi for UI_VIEWTYPE {
    type Abi = Self;
}
...
unsafe impl ::windows_core::Abi for UI_VIEWVERB {
    type Abi = Self;
}
