...
extern "system" {
    ...
    pub fn ComputeInvCMAP(prgbcolors: *const super::super::Graphics::Gdi::RGBQUAD, ncolors: u32, pinvtable: *mut u8, cbtable: u32) -> ::windows_sys_core::HRESULT;
    #[cfg(all(feature = "Win32_Graphics_DirectDraw", feature = "Win32_Graphics_Gdi"))]
    pub fn CreateDDrawSurfaceOnDIB(hbmdib: super::super::Graphics::Gdi::HBITMAP, ppsurface: *mut super::super::Graphics::DirectDraw::IDirectDrawSurface) -> ::windows_sys_core::HRESULT;
    pub fn CreateMIMEMap(ppmap: *mut IMapMIMEToCLSID) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_System_Com")]
    pub fn DecodeImage(pstream: super::super::System::Com::IStream, pmap: IMapMIMEToCLSID, peventsink: ::windows_sys_core::IUnknown) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_System_Com")]
    pub fn DecodeImageEx(pstream: super::super::System::Com::IStream, pmap: IMapMIMEToCLSID, peventsink: ::windows_sys_core::IUnknown, pszmimetypeparam: ::windows_sys_core::PCWSTR) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Graphics_Gdi")]
    pub fn DitherTo8(pdestbits: *mut u8, ndestpitch: i32, psrcbits: *mut u8, nsrcpitch: i32, bfidsrc: *const ::windows_sys_core::GUID, prgbdestcolors: *mut super::super::Graphics::Gdi::RGBQUAD, prgbsrccolors: *mut super::super::Graphics::Gdi::RGBQUAD, pbdestinvmap: *mut u8, x: i32, y: i32, cx: i32, cy: i32, ldesttrans: i32, lsrctrans: i32) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn DoPrivacyDlg(hwndowner: super::super::Foundation::HWND, pszurl: ::windows_sys_core::PCWSTR, pprivacyenum: IEnumPrivacyRecords, freportallsites: super::super::Foundation::BOOL) -> ::windows_sys_core::HRESULT;
    pub fn GetMaxMIMEIDBytes(pnmaxbytes: *mut u32) -> ::windows_sys_core::HRESULT;
    pub fn IdentifyMIMEType(pbbytes: *const u8, nbytes: u32, pnformat: *mut u32) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn RatingAccessDeniedDialog(hdlg: super::super::Foundation::HWND, pszusername: ::windows_sys_core::PCSTR, pszcontentdescription: ::windows_sys_core::PCSTR, pratingdetails: *mut ::core::ffi::c_void) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn RatingAccessDeniedDialog2(hdlg: super::super::Foundation::HWND, pszusername: ::windows_sys_core::PCSTR, pratingdetails: *mut ::core::ffi::c_void) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn RatingAccessDeniedDialog2W(hdlg: super::super::Foundation::HWND, pszusername: ::windows_sys_core::PCWSTR, pratingdetails: *mut ::core::ffi::c_void) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn RatingAccessDeniedDialogW(hdlg: super::super::Foundation::HWND, pszusername: ::windows_sys_core::PCWSTR, pszcontentdescription: ::windows_sys_core::PCWSTR, pratingdetails: *mut ::core::ffi::c_void) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn RatingAddToApprovedSites(hdlg: super::super::Foundation::HWND, cbpasswordblob: u32, pbpasswordblob: *mut u8, lpszurl: ::windows_sys_core::PCWSTR, falwaysnever: super::super::Foundation::BOOL, fsitepage: super::super::Foundation::BOOL, fapprovedsitesenforced: super::super::Foundation::BOOL) -> ::windows_sys_core::HRESULT;
    pub fn RatingCheckUserAccess(pszusername: ::windows_sys_core::PCSTR, pszurl: ::windows_sys_core::PCSTR, pszratinginfo: ::windows_sys_core::PCSTR, pdata: *const u8, cbdata: u32, ppratingdetails: *mut *mut ::core::ffi::c_void) -> ::windows_sys_core::HRESULT;
    pub fn RatingCheckUserAccessW(pszusername: ::windows_sys_core::PCWSTR, pszurl: ::windows_sys_core::PCWSTR, pszratinginfo: ::windows_sys_core::PCWSTR, pdata: *const u8, cbdata: u32, ppratingdetails: *mut *mut ::core::ffi::c_void) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn RatingClickedOnPRFInternal(hwndowner: super::super::Foundation::HWND, param1: super::super::Foundation::HINSTANCE, lpszfilename: ::windows_sys_core::PCSTR, nshow: i32) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn RatingClickedOnRATInternal(hwndowner: super::super::Foundation::HWND, param1: super::super::Foundation::HINSTANCE, lpszfilename: ::windows_sys_core::PCSTR, nshow: i32) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn RatingEnable(hwndparent: super::super::Foundation::HWND, pszusername: ::windows_sys_core::PCSTR, fenable: super::super::Foundation::BOOL) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn RatingEnableW(hwndparent: super::super::Foundation::HWND, pszusername: ::windows_sys_core::PCWSTR, fenable: super::super::Foundation::BOOL) -> ::windows_sys_core::HRESULT;
    pub fn RatingEnabledQuery() -> ::windows_sys_core::HRESULT;
    pub fn RatingFreeDetails(pratingdetails: *const ::core::ffi::c_void) -> ::windows_sys_core::HRESULT;
    pub fn RatingInit() -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn RatingObtainCancel(hratingobtainquery: super::super::Foundation::HANDLE) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn RatingObtainQuery(psztargeturl: ::windows_sys_core::PCSTR, dwuserdata: u32, fcallback: isize, phratingobtainquery: *mut super::super::Foundation::HANDLE) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn RatingObtainQueryW(psztargeturl: ::windows_sys_core::PCWSTR, dwuserdata: u32, fcallback: isize, phratingobtainquery: *mut super::super::Foundation::HANDLE) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn RatingSetupUI(hdlg: super::super::Foundation::HWND, pszusername: ::windows_sys_core::PCSTR) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn RatingSetupUIW(hdlg: super::super::Foundation::HWND, pszusername: ::windows_sys_core::PCWSTR) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_System_Com")]
    pub fn SniffStream(pinstream: super::super::System::Com::IStream, pnformat: *mut u32, ppoutstream: *mut super::super::System::Com::IStream) -> ::windows_sys_core::HRESULT;
}
...
pub const AnchorClick: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 332742972, data2: 13241, data3: 4562, data4: [149, 167, 0, 192, 79, 142, 203, 2] };
pub const ApplicationCache: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616873, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
...
pub const BlockFormats: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612785, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
...
pub const CATID_MSOfficeAntiVirus: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 1459604528, data2: 54168, data3: 4560, data4: [178, 174, 0, 160, 201, 8, 250, 73] };
pub const CClientCaps: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 2123088974, data2: 44799, data3: 4561, data4: [137, 194, 0, 192, 79, 182, 191, 196] };
pub const CDeviceRect: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612436, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const CDownloadBehavior: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612158, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const CEventObj: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611850, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const CGID_DocHostCommandHandler: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 4086022722, data2: 47440, data3: 4561, data4: [137, 24, 0, 192, 79, 194, 200, 54] };
pub const CGID_EditStateCommands: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611894, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const CHeaderFooter: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612429, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const CLayoutRect: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612324, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
...
pub const CMimeTypes: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611710, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
...
pub const COpsProfile: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611714, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const CPersistDataPeer: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611847, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const CPersistHistory: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611912, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const CPersistShortcut: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611910, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const CPersistSnapshot: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611913, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const CPersistUserData: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611854, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const CPlugins: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611711, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const CPrintManagerTemplatePrinter: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 1667342164, data2: 40305, data3: 19491, data4: [160, 141, 80, 215, 241, 141, 178, 233] };
pub const CTemplatePrinter: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612403, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const CanvasGradient: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616597, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const CanvasImageData: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616603, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const CanvasPattern: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616599, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const CanvasRenderingContext2D: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616576, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const CanvasTextMetrics: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616601, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const CoDitherToRGB8: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 2824916560, data2: 14608, data3: 4560, data4: [134, 252, 0, 160, 201, 19, 247, 80] };
pub const CoMapMIMEToCLSID: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 818131072, data2: 12539, data3: 4560, data4: [183, 36, 0, 170, 0, 108, 26, 1] };
pub const CoSniffStream: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 1778515360, data2: 12511, data3: 4560, data4: [183, 36, 0, 170, 0, 108, 26, 1] };
...
pub struct DOCHOSTUIINFO {
    ...
    pub pchHostCss: ::windows_sys_core::PWSTR,
    pub pchHostNS: ::windows_sys_core::PWSTR,
}
...
pub const DOMBeforeUnloadEvent: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616676, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMChildrenCollection: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612138, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMCloseEvent: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616832, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMCompositionEvent: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616537, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMCustomEvent: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616543, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMDocumentType: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616633, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMDragEvent: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616674, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMEvent: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810615995, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMException: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616620, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMFocusEvent: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616525, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMKeyboardEvent: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616535, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMMSAnimationEvent: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616760, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMMSManipulationEvent: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616855, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMMSTransitionEvent: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616758, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMMessageEvent: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616609, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMMouseEvent: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616527, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMMouseWheelEvent: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616529, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMMutationEvent: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616539, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMParser: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616706, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMParserFactory: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616708, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMProcessingInstruction: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616643, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMProgressEvent: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616607, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMSiteModeEvent: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616678, data2: 39094, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMStorageEvent: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616611, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMTextEvent: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616533, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMUIEvent: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616523, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const DOMWheelEvent: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616531, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
...
pub const EventException: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616635, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
...
pub const FontNames: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612794, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const FramesCollection: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612726, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTCAttachBehavior: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612213, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTCDefaultDispatch: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611964, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTCDescBehavior: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612189, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTCEventBehavior: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611966, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTCMethodBehavior: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612272, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTCPropertyBehavior: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612190, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLAnchorElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611272, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub type HTMLAnchorEvents = *mut ::core::ffi::c_void;
pub type HTMLAnchorEvents2 = *mut ::core::ffi::c_void;
pub const HTMLAppBehavior: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612171, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
...
pub const HTMLAreaElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611331, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub type HTMLAreaEvents = *mut ::core::ffi::c_void;
pub type HTMLAreaEvents2 = *mut ::core::ffi::c_void;
pub const HTMLAreasCollection: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611914, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLAttributeCollection: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611916, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLAudioElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616590, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLAudioElementFactory: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616812, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLBGsound: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611568, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLBRElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611328, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLBaseElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611318, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLBaseFontElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611330, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLBlockElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611329, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLBody: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611274, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
...
pub const HTMLButtonElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611398, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub type HTMLButtonElementEvents = *mut ::core::ffi::c_void;
pub type HTMLButtonElementEvents2 = *mut ::core::ffi::c_void;
pub const HTMLCSSImportRule: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616560, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLCSSMediaList: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616626, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLCSSMediaRule: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616561, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLCSSNamespaceRule: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616562, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLCSSRule: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616559, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLCSSStyleDeclaration: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616641, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLCanvasElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616549, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
...
pub const HTMLCommentElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611479, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub type HTMLControlElementEvents = *mut ::core::ffi::c_void;
pub type HTMLControlElementEvents2 = *mut ::core::ffi::c_void;
pub const HTMLCurrentStyle: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611676, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLDDElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611327, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
...
pub const HTMLDListElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611325, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLDOMAttribute: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611890, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLDOMImplementation: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612750, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLDOMRange: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616515, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLDOMTextNode: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611898, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLDOMXmlSerializerFactory: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616704, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLDTElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611324, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLDefaults: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612424, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLDialog: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611338, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLDivElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611326, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLDivPosition: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611273, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
...
pub const HTMLDocument: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 624126240, data2: 1017, data3: 4559, data4: [143, 208, 0, 170, 0, 104, 111, 19] };
pub const HTMLDocumentCompatibleInfo: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810615835, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLDocumentCompatibleInfoCollection: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810615833, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
...
pub const HTMLElementCollection: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611915, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
...
pub const HTMLEmbed: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611293, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLFieldSetElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611688, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLFontElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611323, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLFormElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611281, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub type HTMLFormElementEvents = *mut ::core::ffi::c_void;
pub type HTMLFormElementEvents2 = *mut ::core::ffi::c_void;
pub const HTMLFrameBase: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611474, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLFrameElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611476, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLFrameSetSite: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611482, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub type HTMLFrameSiteEvents = *mut ::core::ffi::c_void;
pub type HTMLFrameSiteEvents2 = *mut ::core::ffi::c_void;
pub const HTMLGenericElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611896, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLHRElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611282, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLHeadElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611859, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLHeaderElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611322, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLHistory: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 4274956963, data2: 33797, data3: 4559, data4: [139, 161, 0, 170, 0, 71, 109, 166] };
pub const HTMLHtmlElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611857, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLIFrame: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611478, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLImageElementFactory: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611599, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLImg: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611265, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub type HTMLImgEvents = *mut ::core::ffi::c_void;
pub type HTMLImgEvents2 = *mut ::core::ffi::c_void;
pub const HTMLInputButtonElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611380, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLInputElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612184, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLInputFileElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611374, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub type HTMLInputFileElementEvents = *mut ::core::ffi::c_void;
pub type HTMLInputFileElementEvents2 = *mut ::core::ffi::c_void;
pub const HTMLInputImage: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611396, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub type HTMLInputImageEvents = *mut ::core::ffi::c_void;
pub type HTMLInputImageEvents2 = *mut ::core::ffi::c_void;
pub const HTMLInputTextElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611371, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub type HTMLInputTextElementEvents = *mut ::core::ffi::c_void;
pub type HTMLInputTextElementEvents2 = *mut ::core::ffi::c_void;
pub const HTMLIsIndexElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611320, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLLIElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611315, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLLabelElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611499, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub type HTMLLabelEvents = *mut ::core::ffi::c_void;
pub type HTMLLabelEvents2 = *mut ::core::ffi::c_void;
pub const HTMLLegendElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611689, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLLinkElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611319, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub type HTMLLinkElementEvents = *mut ::core::ffi::c_void;
pub type HTMLLinkElementEvents2 = *mut ::core::ffi::c_void;
pub const HTMLListElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611314, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLLocation: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 373010913, data2: 28160, data3: 4559, data4: [131, 122, 72, 220, 4, 193, 0, 0] };
pub const HTMLMSCSSKeyframeRule: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616846, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLMSCSSKeyframesRule: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616847, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLMapElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611313, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub type HTMLMapEvents = *mut ::core::ffi::c_void;
pub type HTMLMapEvents2 = *mut ::core::ffi::c_void;
pub const HTMLMarqueeElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611385, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
...
pub const HTMLMediaElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616588, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLMediaError: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616586, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLMetaElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611317, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
...
pub const HTMLNamespace: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612412, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLNamespaceCollection: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612409, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub type HTMLNamespaceEvents = *mut ::core::ffi::c_void;
pub const HTMLNavigator: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 4274956966, data2: 33797, data3: 4559, data4: [139, 161, 0, 170, 0, 71, 109, 166] };
pub const HTMLNextIdElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611321, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLNoShowElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611595, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLOListElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611312, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLObjectElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611278, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub type HTMLObjectElementEvents = *mut ::core::ffi::c_void;
pub type HTMLObjectElementEvents2 = *mut ::core::ffi::c_void;
pub const HTMLOptionButtonElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611390, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub type HTMLOptionButtonElementEvents = *mut ::core::ffi::c_void;
pub type HTMLOptionButtonElementEvents2 = *mut ::core::ffi::c_void;
pub const HTMLOptionElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611277, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLOptionElementFactory: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611597, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLParaElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611311, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLParamElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612798, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLPerformance: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616655, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLPerformanceNavigation: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616657, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLPerformanceTiming: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616659, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
#[repr(C)]
pub struct HTMLPersistEvents(pub u8);
pub const HTMLPhraseElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611310, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLPopup: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612327, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLProgressElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611413, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLRenderStyle: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612394, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLRichtextElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611423, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLRuleStyle: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611664, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLScreen: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611549, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLScriptElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611340, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub type HTMLScriptEvents = *mut ::core::ffi::c_void;
pub type HTMLScriptEvents2 = *mut ::core::ffi::c_void;
pub const HTMLSelectElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611269, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub type HTMLSelectElementEvents = *mut ::core::ffi::c_void;
pub type HTMLSelectElementEvents2 = *mut ::core::ffi::c_void;
pub const HTMLSemanticElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616752, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLSourceElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616589, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLSpanElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611701, data2: 39092, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLSpanFlow: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611686, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLStorage: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810615925, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLStyle: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611333, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLStyleElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611581, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub type HTMLStyleElementEvents = *mut ::core::ffi::c_void;
pub type HTMLStyleElementEvents2 = *mut ::core::ffi::c_void;
pub const HTMLStyleFontFace: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611668, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLStyleMedia: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616652, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLStyleSheet: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611428, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLStyleSheetPage: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612719, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLStyleSheetPagesCollection: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612721, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLStyleSheetRule: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611662, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLStyleSheetRulesAppliedCollection: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3946248261, data2: 9109, data3: 18201, data4: [184, 92, 208, 216, 14, 24, 75, 217] };
pub const HTMLStyleSheetRulesCollection: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611661, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLStyleSheetsCollection: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611583, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
...
pub const HTMLTable: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611307, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLTableCaption: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611436, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLTableCell: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611270, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLTableCol: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611308, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub type HTMLTableEvents = *mut ::core::ffi::c_void;
pub type HTMLTableEvents2 = *mut ::core::ffi::c_void;
pub const HTMLTableRow: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611309, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLTableSection: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611433, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLTextAreaElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611372, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub type HTMLTextContainerEvents = *mut ::core::ffi::c_void;
pub type HTMLTextContainerEvents2 = *mut ::core::ffi::c_void;
pub const HTMLTextElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611306, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLTimeRanges: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616587, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLTitleElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611332, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLUListElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611305, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLUnknownElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611304, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLUrnCollection: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612096, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLVideoElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616591, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLW3CComputedStyle: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616520, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLWindow2: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3565842118, data2: 27210, data3: 4559, data4: [148, 167, 68, 69, 83, 84, 0, 0] };
...
pub const HTMLWindowProxy: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611601, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
...
pub const HTMLWndOptionElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611408, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLWndSelectElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611407, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const HTMLXMLHttpRequest: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810615819, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub type HTMLXMLHttpRequestEvents = *mut ::core::ffi::c_void;
pub const HTMLXMLHttpRequestFactory: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810615821, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
...
pub struct HTML_PAINTER_INFO {
    pub lFlags: i32,
    pub lZOrder: i32,
    pub iidDrawObject: ::windows_sys_core::GUID,
...
pub const HomePage: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 1986785966, data2: 54864, data3: 4561, data4: [152, 17, 0, 192, 79, 195, 29, 46] };
pub const HomePageSetting: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 927788512, data2: 34618, data3: 19535, data4: [188, 134, 188, 200, 207, 81, 22, 163] };
#[repr(C)]
pub struct HostDialogHelper(pub u8);
pub const HtmlDlgSafeHelper: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612761, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
...
pub type IEISXMLNSREGISTEREDFN = ::core::option::Option<unsafe extern "system" fn(lpszuri: ::windows_sys_core::PCWSTR, pclsid: *mut ::windows_sys_core::GUID) -> ::windows_sys_core::HRESULT>;
...
#[cfg(feature = "Win32_Foundation")]
pub type IEREGISTERXMLNSFN = ::core::option::Option<unsafe extern "system" fn(lpszuri: ::windows_sys_core::PCWSTR, clsid: ::windows_sys_core::GUID, fmachine: super::super::Foundation::BOOL) -> ::windows_sys_core::HRESULT>;
pub const IEWebDriverManager: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 2419149554, data2: 21072, data3: 18355, data4: [137, 216, 98, 149, 252, 35, 188, 34] };
...
pub const IntelliForms: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 1631238446, data2: 5823, data3: 4562, data4: [188, 165, 0, 192, 79, 217, 41, 219] };
pub const InternetExplorerManager: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3746548788, data2: 1658, data3: 19978, data4: [131, 82, 74, 26, 80, 149, 52, 110] };
...
pub const NodeIterator: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616645, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const OldHTMLDocument: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3565842121, data2: 27210, data3: 4559, data4: [148, 167, 68, 69, 83, 84, 0, 0] };
pub const OldHTMLFormElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 218419845, data2: 27628, data3: 4559, data4: [139, 151, 0, 170, 0, 71, 109, 166] };
...
pub const OpenServiceActivityManager: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3320829955, data2: 20728, data3: 17357, data4: [154, 184, 170, 252, 19, 148, 201, 224] };
...
pub const OpenServiceManager: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 159936694, data2: 14826, data3: 18443, data4: [184, 181, 221, 1, 103, 196, 219, 89] };
...
pub const PeerFactory: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611919, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
...
pub const RangeException: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616622, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const RulesApplied: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 2088778016, data2: 31315, data3: 19750, data4: [152, 172, 253, 210, 62, 107, 158, 1] };
pub const RulesAppliedCollection: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 1729701614, data2: 50127, data3: 16559, data4: [190, 143, 28, 186, 238, 100, 134, 232] };
...
pub type SHOWHTMLDIALOGEXFN = ::core::option::Option<unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, pmk: super::super::System::Com::IMoniker, dwdialogflags: u32, pvarargin: *mut super::super::System::Com::VARIANT, pchoptions: ::windows_sys_core::PCWSTR, pvargout: *mut super::super::System::Com::VARIANT) -> ::windows_sys_core::HRESULT>;
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
pub type SHOWHTMLDIALOGFN = ::core::option::Option<unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, pmk: super::super::System::Com::IMoniker, pvarargin: *mut super::super::System::Com::VARIANT, pchoptions: ::windows_sys_core::PCWSTR, pvargout: *mut super::super::System::Com::VARIANT) -> ::windows_sys_core::HRESULT>;
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Com", feature = "Win32_System_Ole"))]
pub type SHOWMODELESSHTMLDIALOGFN = ::core::option::Option<unsafe extern "system" fn(hwndparent: super::super::Foundation::HWND, pmk: super::super::System::Com::IMoniker, pvarargin: *mut super::super::System::Com::VARIANT, pvaroptions: *mut super::super::System::Com::VARIANT, ppwindow: *mut IHTMLWindow2) -> ::windows_sys_core::HRESULT>;
pub const SID_SEditCommandTarget: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810611893, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SID_SHTMLEditHost: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612384, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SID_SHTMLEditServices: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612729, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
#[repr(C)]
#[cfg(feature = "Win32_Foundation")]
pub struct STATURL {
    pub cbSize: u32,
    pub pwcsUrl: ::windows_sys_core::PWSTR,
    pub pwcsTitle: ::windows_sys_core::PWSTR,
...
pub const SVGAElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616283, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGAngle: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616196, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGAnimatedAngle: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616292, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGAnimatedBoolean: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616203, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGAnimatedEnumeration: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616206, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGAnimatedInteger: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616207, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGAnimatedLength: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616193, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGAnimatedLengthList: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616194, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGAnimatedNumber: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616200, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGAnimatedNumberList: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616202, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGAnimatedPreserveAspectRatio: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616270, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGAnimatedRect: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616198, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGAnimatedString: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616204, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGAnimatedTransformList: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616241, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGCircleElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616184, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGClipPathElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616294, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGDefsElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616176, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGDescElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616178, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616164, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGElementInstance: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616181, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGElementInstanceList: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616182, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGEllipseElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616185, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGException: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616624, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGGElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616175, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGGradientElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616278, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGImageElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616271, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGLength: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616190, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGLengthList: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616192, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGLineElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616186, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGLinearGradientElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616274, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGMarkerElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616286, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGMaskElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616295, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGMatrix: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616238, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGMetadataElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616279, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGNumber: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616199, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGNumberList: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616201, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPathElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616242, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPathSeg: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616243, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPathSegArcAbs: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616251, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPathSegArcRel: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616252, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPathSegClosePath: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616253, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPathSegCurvetoCubicAbs: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616254, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPathSegCurvetoCubicRel: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616255, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPathSegCurvetoCubicSmoothAbs: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616256, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPathSegCurvetoCubicSmoothRel: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616257, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPathSegCurvetoQuadraticAbs: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616258, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPathSegCurvetoQuadraticRel: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616259, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPathSegCurvetoQuadraticSmoothAbs: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616260, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPathSegCurvetoQuadraticSmoothRel: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616261, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPathSegLinetoAbs: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616262, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPathSegLinetoHorizontalAbs: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616263, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPathSegLinetoHorizontalRel: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616264, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPathSegLinetoRel: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616265, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPathSegLinetoVerticalAbs: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616266, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPathSegLinetoVerticalRel: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616267, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPathSegList: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616244, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPathSegMovetoAbs: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616268, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPathSegMovetoRel: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616269, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPatternElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616276, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPoint: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616250, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPointList: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616249, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPolygonElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616187, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPolylineElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616188, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGPreserveAspectRatio: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616272, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGRadialGradientElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616275, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGRect: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616195, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGRectElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616183, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGSVGElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616180, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGScriptElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616289, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGStopElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616277, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGStringList: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616205, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGStyleElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616273, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGSwitchElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616280, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGSymbolElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616177, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGTSpanElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616290, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGTextContentElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616285, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGTextElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616287, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGTextPathElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616299, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGTextPositioningElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616288, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGTitleElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616179, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGTransform: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616239, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGTransformList: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616240, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGUseElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616208, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGViewElement: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616284, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const SVGZoomEvent: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616281, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
...
pub const Scriptlet: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 2921659822, data2: 966, data3: 4561, data4: [139, 118, 0, 128, 199, 68, 243, 137] };
pub const StaticNodeList: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810615911, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
...
pub const ThreadDialogProcParam: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810612203, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const TreeWalker: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616647, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
...
pub const WebGeocoordinates: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616776, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const WebGeolocation: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616774, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const WebGeoposition: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616782, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const WebGeopositionError: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616778, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const XDomainRequest: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810615893, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const XDomainRequestFactory: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810615895, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const XMLHttpRequestEventTarget: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616881, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const XMLSerializer: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 810616702, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
...
pub const wfolders: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3135446938, data2: 7041, data3: 4562, data4: [169, 122, 0, 192, 79, 142, 203, 2] };
