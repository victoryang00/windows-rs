...
extern "system" {
    ...
    pub fn DRMActivate(hclient: u32, uflags: u32, ulangid: u32, pactservinfo: *mut DRM_ACTSERV_INFO, pvcontext: *mut ::core::ffi::c_void, hparentwnd: super::super::Foundation::HWND) -> ::windows_core_sys::HRESULT;
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub fn DRMCreateRight(wszrightname: ::windows_core_sys::PCWSTR, pstfrom: *mut super::super::Foundation::SYSTEMTIME, pstuntil: *mut super::super::Foundation::SYSTEMTIME, cextendedinfo: u32, pwszextendedinfoname: *const ::windows_core_sys::PWSTR, pwszextendedinfovalue: *const ::windows_core_sys::PWSTR, phright: *mut u32) -> ::windows_core_sys::HRESULT;
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub fn DRMEnumerateLicense(hsession: u32, uflags: u32, uindex: u32, pfsharedflag: *mut super::super::Foundation::BOOL, pucertificatedatalen: *mut u32, wszcertificatedata: ::windows_core_sys::PWSTR) -> ::windows_core_sys::HRESULT;
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub fn DRMGetProcAddress(hlibrary: u32, wszprocname: ::windows_core_sys::PCWSTR, ppfnprocaddress: *mut super::super::Foundation::FARPROC) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn DRMGetRevocationPoint(hissuancelicense: u32, puidlength: *mut u32, wszid: ::windows_core_sys::PWSTR, puidtypelength: *mut u32, wszidtype: ::windows_core_sys::PWSTR, puurllength: *mut u32, wszrl: ::windows_core_sys::PWSTR, pstfrequency: *mut super::super::Foundation::SYSTEMTIME, punamelength: *mut u32, wszname: ::windows_core_sys::PWSTR, pupublickeylength: *mut u32, wszpublickey: ::windows_core_sys::PWSTR) -> ::windows_core_sys::HRESULT;
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub fn DRMGetRightInfo(hright: u32, purightnamelength: *mut u32, wszrightname: ::windows_core_sys::PWSTR, pstfrom: *mut super::super::Foundation::SYSTEMTIME, pstuntil: *mut super::super::Foundation::SYSTEMTIME) -> ::windows_core_sys::HRESULT;
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub fn DRMGetTime(henv: u32, etimeridtype: DRMTIMETYPE, potimeobject: *mut super::super::Foundation::SYSTEMTIME) -> ::windows_core_sys::HRESULT;
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub fn DRMGetUsagePolicy(hissuancelicense: u32, uindex: u32, peusagepolicytype: *mut DRM_USAGEPOLICY_TYPE, pfexclusion: *mut super::super::Foundation::BOOL, punamelength: *mut u32, wszname: ::windows_core_sys::PWSTR, puminversionlength: *mut u32, wszminversion: ::windows_core_sys::PWSTR, pumaxversionlength: *mut u32, wszmaxversion: ::windows_core_sys::PWSTR, pupublickeylength: *mut u32, wszpublickey: ::windows_core_sys::PWSTR, pudigestalgorithmlength: *mut u32, wszdigestalgorithm: ::windows_core_sys::PWSTR, pcbdigest: *mut u32, pbdigest: *mut u8) -> ::windows_core_sys::HRESULT;
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub fn DRMIsWindowProtected(hwnd: super::super::Foundation::HWND, pfprotected: *mut super::super::Foundation::BOOL) -> ::windows_core_sys::HRESULT;
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub fn DRMRegisterContent(fregister: super::super::Foundation::BOOL) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn DRMRegisterProtectedWindow(henv: u32, hwnd: super::super::Foundation::HWND) -> ::windows_core_sys::HRESULT;
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub fn DRMSetApplicationSpecificData(hissuancelicense: u32, fdelete: super::super::Foundation::BOOL, wszname: ::windows_core_sys::PCWSTR, wszvalue: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::HRESULT;
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub fn DRMSetNameAndDescription(hissuancelicense: u32, fdelete: super::super::Foundation::BOOL, lcid: u32, wszname: ::windows_core_sys::PCWSTR, wszdescription: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn DRMSetRevocationPoint(hissuancelicense: u32, fdelete: super::super::Foundation::BOOL, wszid: ::windows_core_sys::PCWSTR, wszidtype: ::windows_core_sys::PCWSTR, wszurl: ::windows_core_sys::PCWSTR, pstfrequency: *mut super::super::Foundation::SYSTEMTIME, wszname: ::windows_core_sys::PCWSTR, wszpublickey: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn DRMSetUsagePolicy(hissuancelicense: u32, eusagepolicytype: DRM_USAGEPOLICY_TYPE, fdelete: super::super::Foundation::BOOL, fexclusion: super::super::Foundation::BOOL, wszname: ::windows_core_sys::PCWSTR, wszminversion: ::windows_core_sys::PCWSTR, wszmaxversion: ::windows_core_sys::PCWSTR, wszpublickey: ::windows_core_sys::PCWSTR, wszdigestalgorithm: ::windows_core_sys::PCWSTR, pbdigest: *mut u8, cbdigest: u32) -> ::windows_core_sys::HRESULT;
