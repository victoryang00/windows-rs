pub const CLSID_IITCmdInt: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1180883618, data2: 54163, data3: 4560, data4: [154, 86, 0, 192, 79, 182, 139, 247] };
pub const CLSID_IITDatabase: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1718039634, data2: 35875, data3: 4560, data4: [168, 78, 0, 170, 0, 108, 125, 1] };
pub const CLSID_IITDatabaseLocal: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1180883625, data2: 54163, data3: 4560, data4: [154, 86, 0, 192, 79, 182, 139, 247] };
pub const CLSID_IITGroupUpdate: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1180883620, data2: 54163, data3: 4560, data4: [154, 86, 0, 192, 79, 182, 139, 247] };
pub const CLSID_IITIndexBuild: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2409682346, data2: 57055, data3: 4560, data4: [154, 97, 0, 192, 79, 182, 139, 247] };
pub const CLSID_IITPropList: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1180883630, data2: 54163, data3: 4560, data4: [154, 86, 0, 192, 79, 182, 139, 247] };
pub const CLSID_IITResultSet: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1180883623, data2: 54163, data3: 4560, data4: [154, 86, 0, 192, 79, 182, 139, 247] };
pub const CLSID_IITSvMgr: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1180883619, data2: 54163, data3: 4560, data4: [154, 86, 0, 192, 79, 182, 139, 247] };
pub const CLSID_IITWWFilterBuild: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2409682347, data2: 57055, data3: 4560, data4: [154, 97, 0, 192, 79, 182, 139, 247] };
pub const CLSID_IITWordWheel: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3610715586, data2: 35858, data3: 4560, data4: [168, 78, 0, 170, 0, 108, 125, 1] };
pub const CLSID_IITWordWheelLocal: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1180883624, data2: 54163, data3: 4560, data4: [154, 86, 0, 192, 79, 182, 139, 247] };
pub const CLSID_IITWordWheelUpdate: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1180883621, data2: 54163, data3: 4560, data4: [154, 86, 0, 192, 79, 182, 139, 247] };
pub const CLSID_ITEngStemmer: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2409682344, data2: 57055, data3: 4560, data4: [154, 97, 0, 192, 79, 182, 139, 247] };
pub const CLSID_ITStdBreaker: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1180883631, data2: 54163, data3: 4560, data4: [154, 86, 0, 192, 79, 182, 139, 247] };
#[repr(C)]
...
pub const E_ALL_WILD: ::windows_core_sys::HRESULT = -2147479467i32;
pub const E_ALREADYINIT: ::windows_core_sys::HRESULT = -2147479421i32;
pub const E_ALREADYOPEN: ::windows_core_sys::HRESULT = -2147479533i32;
pub const E_ASSERT: ::windows_core_sys::HRESULT = -2147479546i32;
pub const E_BADBREAKER: ::windows_core_sys::HRESULT = -2147479469i32;
pub const E_BADFILE: ::windows_core_sys::HRESULT = -2147479549i32;
pub const E_BADFILTERSIZE: ::windows_core_sys::HRESULT = -2147479528i32;
pub const E_BADFORMAT: ::windows_core_sys::HRESULT = -2147479548i32;
pub const E_BADINDEXFLAGS: ::windows_core_sys::HRESULT = -2147479456i32;
pub const E_BADPARAM: ::windows_core_sys::HRESULT = -2147479535i32;
pub const E_BADRANGEOP: ::windows_core_sys::HRESULT = -2147479459i32;
pub const E_BADVALUE: ::windows_core_sys::HRESULT = -2147479468i32;
pub const E_BADVERSION: ::windows_core_sys::HRESULT = -2147479550i32;
pub const E_CANTFINDDLL: ::windows_core_sys::HRESULT = -2147479538i32;
pub const E_DISKFULL: ::windows_core_sys::HRESULT = -2147479496i32;
pub const E_DUPLICATE: ::windows_core_sys::HRESULT = -2147479551i32;
pub const E_EXPECTEDTERM: ::windows_core_sys::HRESULT = -2147479465i32;
pub const E_FILECLOSE: ::windows_core_sys::HRESULT = -2147479503i32;
pub const E_FILECREATE: ::windows_core_sys::HRESULT = -2147479504i32;
pub const E_FILEDELETE: ::windows_core_sys::HRESULT = -2147479499i32;
pub const E_FILEINVALID: ::windows_core_sys::HRESULT = -2147479498i32;
pub const E_FILENOTFOUND: ::windows_core_sys::HRESULT = -2147479497i32;
pub const E_FILEREAD: ::windows_core_sys::HRESULT = -2147479502i32;
pub const E_FILESEEK: ::windows_core_sys::HRESULT = -2147479501i32;
pub const E_FILEWRITE: ::windows_core_sys::HRESULT = -2147479500i32;
pub const E_GETLASTERROR: ::windows_core_sys::HRESULT = -2147479536i32;
pub const E_GROUPIDTOOBIG: ::windows_core_sys::HRESULT = -2147479542i32;
pub const E_INTERRUPT: ::windows_core_sys::HRESULT = -2147479545i32;
pub const E_INVALIDSTATE: ::windows_core_sys::HRESULT = -2147479534i32;
pub const E_MISSINGPROP: ::windows_core_sys::HRESULT = -2147479424i32;
pub const E_MISSLPAREN: ::windows_core_sys::HRESULT = -2147479464i32;
pub const E_MISSQUOTE: ::windows_core_sys::HRESULT = -2147479462i32;
pub const E_MISSRPAREN: ::windows_core_sys::HRESULT = -2147479463i32;
pub const E_NAMETOOLONG: ::windows_core_sys::HRESULT = -2147479520i32;
pub const E_NOHANDLE: ::windows_core_sys::HRESULT = -2147479537i32;
pub const E_NOKEYPROP: ::windows_core_sys::HRESULT = -2147479417i32;
pub const E_NOMERGEDDATA: ::windows_core_sys::HRESULT = -2147479540i32;
pub const E_NOPERMISSION: ::windows_core_sys::HRESULT = -2147479547i32;
pub const E_NOSTEMMER: ::windows_core_sys::HRESULT = -2147479454i32;
pub const E_NOTEXIST: ::windows_core_sys::HRESULT = -2147479552i32;
pub const E_NOTFOUND: ::windows_core_sys::HRESULT = -2147479539i32;
pub const E_NOTINIT: ::windows_core_sys::HRESULT = -2147479420i32;
pub const E_NOTOPEN: ::windows_core_sys::HRESULT = -2147479533i32;
pub const E_NOTSUPPORTED: ::windows_core_sys::HRESULT = -2147479544i32;
pub const E_NULLQUERY: ::windows_core_sys::HRESULT = -2147479461i32;
pub const E_OUTOFRANGE: ::windows_core_sys::HRESULT = -2147479543i32;
pub const E_PROPLISTEMPTY: ::windows_core_sys::HRESULT = -2147479422i32;
pub const E_PROPLISTNOTEMPTY: ::windows_core_sys::HRESULT = -2147479423i32;
pub const E_RESULTSETEMPTY: ::windows_core_sys::HRESULT = -2147479419i32;
pub const E_STOPWORD: ::windows_core_sys::HRESULT = -2147479460i32;
pub const E_TOODEEP: ::windows_core_sys::HRESULT = -2147479466i32;
pub const E_TOOMANYCOLUMNS: ::windows_core_sys::HRESULT = -2147479418i32;
pub const E_TOOMANYDUPS: ::windows_core_sys::HRESULT = -2147479471i32;
pub const E_TOOMANYOBJECTS: ::windows_core_sys::HRESULT = -2147479527i32;
pub const E_TOOMANYTITLES: ::windows_core_sys::HRESULT = -2147479541i32;
pub const E_TOOMANYTOPICS: ::windows_core_sys::HRESULT = -2147479472i32;
pub const E_TREETOOBIG: ::windows_core_sys::HRESULT = -2147479470i32;
pub const E_UNKNOWN_TRANSPORT: ::windows_core_sys::HRESULT = -2147479530i32;
pub const E_UNMATCHEDTYPE: ::windows_core_sys::HRESULT = -2147479458i32;
pub const E_UNSUPPORTED_TRANSPORT: ::windows_core_sys::HRESULT = -2147479529i32;
pub const E_WILD_IN_DTYPE: ::windows_core_sys::HRESULT = -2147479455i32;
pub const E_WORDTOOLONG: ::windows_core_sys::HRESULT = -2147479457i32;
...
pub struct HH_ENUM_CAT {
    pub cbStruct: i32,
    pub pszCatName: ::windows_core_sys::PCSTR,
    pub pszCatDescription: ::windows_core_sys::PCSTR,
}
...
pub struct HH_ENUM_IT {
    ...
    pub iType: i32,
    pub pszCatName: ::windows_core_sys::PCSTR,
    pub pszITName: ::windows_core_sys::PCSTR,
    pub pszITDescription: ::windows_core_sys::PCSTR,
}
...
pub struct HH_SET_INFOTYPE {
    pub cbStruct: i32,
    pub pszCatName: ::windows_core_sys::PCSTR,
    pub pszInfoTypeName: ::windows_core_sys::PCSTR,
}
