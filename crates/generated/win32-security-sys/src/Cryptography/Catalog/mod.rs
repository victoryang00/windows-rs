...
pub struct CRYPTCATMEMBER {
    pub cbStruct: u32,
    pub pwszReferenceTag: ::windows_core_sys::PWSTR,
    pub pwszFileName: ::windows_core_sys::PWSTR,
    pub gSubjectType: ::windows_core_sys::GUID,
...
pub struct CRYPTCATSTORE {
    ...
    pub pwszP7File: ::windows_core_sys::PWSTR,
    pub hProv: usize,
...
pub type PFN_CDF_PARSE_ERROR_CALLBACK = ::core::option::Option<unsafe extern "system" fn(dwerrorarea: u32, dwlocalerror: u32, pwszline: ::windows_core_sys::PCWSTR)>;
