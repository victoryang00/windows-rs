...
extern "system" {
    ...
    pub fn BrowseForGPO(lpbrowseinfo: *mut GPOBROWSEINFO) -> ::windows_core_sys::HRESULT;
    pub fn CommandLineFromMsiDescriptor(descriptor: ::windows_core_sys::PCWSTR, commandline: ::windows_core_sys::PWSTR, commandlinelength: *mut u32) -> u32;
    #[cfg(feature = "Win32_Foundation")]
    pub fn CreateGPOLink(lpgpo: ::windows_core_sys::PCWSTR, lpcontainer: ::windows_core_sys::PCWSTR, fhighpriority: super::super::Foundation::BOOL) -> ::windows_core_sys::HRESULT;
    pub fn DeleteAllGPOLinks(lpcontainer: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::HRESULT;
    pub fn DeleteGPOLink(lpgpo: ::windows_core_sys::PCWSTR, lpcontainer: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn EnterCriticalPolicySection(bmachine: super::super::Foundation::BOOL) -> super::super::Foundation::HANDLE;
    pub fn ExportRSoPData(lpnamespace: ::windows_core_sys::PCWSTR, lpfilename: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub fn GenerateGPNotification(bmachine: super::super::Foundation::BOOL, lpwszmgmtproduct: ::windows_core_sys::PCWSTR, dwmgmtproductoptions: u32) -> u32;
    #[cfg(feature = "Win32_Foundation")]
    pub fn GetAppliedGPOListA(dwflags: u32, pmachinename: ::windows_core_sys::PCSTR, psiduser: super::super::Foundation::PSID, pguidextension: *const ::windows_core_sys::GUID, ppgpolist: *mut *mut GROUP_POLICY_OBJECTA) -> u32;
    #[cfg(feature = "Win32_Foundation")]
    pub fn GetAppliedGPOListW(dwflags: u32, pmachinename: ::windows_core_sys::PCWSTR, psiduser: super::super::Foundation::PSID, pguidextension: *const ::windows_core_sys::GUID, ppgpolist: *mut *mut GROUP_POLICY_OBJECTW) -> u32;
    #[cfg(feature = "Win32_Foundation")]
    pub fn GetGPOListA(htoken: super::super::Foundation::HANDLE, lpname: ::windows_core_sys::PCSTR, lphostname: ::windows_core_sys::PCSTR, lpcomputername: ::windows_core_sys::PCSTR, dwflags: u32, pgpolist: *mut *mut GROUP_POLICY_OBJECTA) -> super::super::Foundation::BOOL;
    #[cfg(feature = "Win32_Foundation")]
    pub fn GetGPOListW(htoken: super::super::Foundation::HANDLE, lpname: ::windows_core_sys::PCWSTR, lphostname: ::windows_core_sys::PCWSTR, lpcomputername: ::windows_core_sys::PCWSTR, dwflags: u32, pgpolist: *mut *mut GROUP_POLICY_OBJECTW) -> super::super::Foundation::BOOL;
    ...
    pub fn ProcessGroupPolicyCompleted(extensionid: *const ::windows_core_sys::GUID, pasynchandle: usize, dwstatus: u32) -> u32;
    pub fn ProcessGroupPolicyCompletedEx(extensionid: *const ::windows_core_sys::GUID, pasynchandle: usize, dwstatus: u32, rsopstatus: ::windows_core_sys::HRESULT) -> u32;
    #[cfg(feature = "Win32_Foundation")]
...
pub const CLSID_GPESnapIn: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2411771700, data2: 41185, data3: 4561, data4: [167, 211, 0, 0, 248, 117, 113, 227] };
pub const CLSID_GroupPolicyObject: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3931121442, data2: 41533, data3: 4561, data4: [167, 211, 0, 0, 248, 117, 113, 227] };
pub const CLSID_RSOPSnapIn: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1841528907, data2: 29202, data3: 17805, data4: [173, 176, 154, 7, 226, 174, 31, 162] };
...
pub const GPM: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4117317384, data2: 35070, data3: 19253, data4: [186, 191, 229, 97, 98, 213, 251, 200] };
pub const GPMAsyncCancel: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 925341353, data2: 30444, data3: 18333, data4: [173, 108, 85, 99, 24, 237, 95, 157] };
pub const GPMBackup: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3977925816, data2: 24314, data3: 18474, data4: [147, 192, 138, 216, 111, 13, 104, 195] };
pub const GPMBackupCollection: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3952018267, data2: 28891, data3: 19103, data4: [150, 118, 55, 194, 89, 148, 233, 220] };
pub const GPMBackupDir: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4242843037, data2: 3873, data3: 19194, data4: [184, 89, 230, 208, 198, 44, 209, 12] };
pub const GPMBackupDirEx: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3904936074, data2: 52995, data3: 19547, data4: [139, 226, 42, 169, 173, 50, 170, 218] };
pub type GPMBackupType = i32;
pub const typeGPO: GPMBackupType = 0i32;
pub const typeStarterGPO: GPMBackupType = 1i32;
pub const GPMCSECollection: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3482499112, data2: 11588, data3: 19297, data4: [177, 10, 179, 39, 175, 212, 45, 168] };
pub const GPMClientSideExtension: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3248678670, data2: 26012, data3: 19226, data4: [148, 11, 248, 139, 10, 249, 200, 164] };
pub const GPMConstants: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 945154176, data2: 52638, data3: 19724, data4: [158, 175, 21, 121, 40, 58, 24, 136] };
...
pub const GPMDomain: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1896415678, data2: 4176, data3: 19633, data4: [131, 138, 197, 207, 242, 89, 225, 131] };
...
pub const GPMGPO: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3536726420, data2: 22965, data3: 16484, data4: [181, 129, 77, 104, 72, 106, 22, 196] };
pub const GPMGPOCollection: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2047177509, data2: 33581, data3: 19939, data4: [164, 31, 199, 128, 67, 106, 78, 9] };
pub const GPMGPOLink: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3252656256, data2: 21251, data3: 17094, data4: [138, 60, 4, 136, 225, 191, 115, 100] };
pub const GPMGPOLinksCollection: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4142749722, data2: 18853, data3: 18402, data4: [183, 113, 253, 141, 192, 43, 98, 89] };
pub const GPMMapEntry: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2358727251, data2: 21553, data3: 17521, data4: [179, 93, 6, 38, 201, 40, 37, 138] };
pub const GPMMapEntryCollection: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 217537883, data2: 41889, data3: 19541, data4: [180, 254, 158, 20, 156, 65, 246, 109] };
pub const GPMMigrationTable: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1437548611, data2: 10758, data3: 20338, data4: [171, 239, 99, 27, 68, 7, 156, 118] };
pub const GPMPermission: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1483842570, data2: 59840, data3: 18156, data4: [145, 62, 148, 78, 249, 34, 90, 148] };
...
pub const GPMRSOP: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1218120879, data2: 40642, data3: 20151, data4: [145, 245, 182, 247, 29, 67, 218, 140] };
...
pub const GPMResult: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2450528960, data2: 37511, data3: 16902, data4: [163, 178, 75, 219, 115, 210, 37, 246] };
pub const GPMSOM: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 853098412, data2: 17678, data3: 17615, data4: [130, 156, 139, 34, 255, 107, 218, 225] };
pub const GPMSOMCollection: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 616689991, data2: 14112, data3: 20315, data4: [169, 195, 6, 180, 228, 249, 49, 210] };
...
pub const GPMSearchCriteria: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 397068838, data2: 23776, data3: 17658, data4: [140, 192, 82, 89, 230, 72, 53, 102] };
...
pub const GPMSecurityInfo: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1417305743, data2: 37218, data3: 17686, data4: [164, 223, 157, 219, 150, 134, 216, 70] };
pub const GPMSitesContainer: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 580869186, data2: 34092, data3: 19248, data4: [148, 95, 197, 34, 190, 155, 211, 134] };
pub const GPMStarterGPOBackup: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 949895178, data2: 55535, data3: 17755, data4: [168, 97, 95, 156, 163, 74, 106, 2] };
pub const GPMStarterGPOBackupCollection: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3881739677, data2: 6891, data3: 19637, data4: [167, 138, 40, 29, 170, 88, 36, 6] };
pub const GPMStarterGPOCollection: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2197334667, data2: 18874, data3: 17330, data4: [149, 110, 51, 151, 249, 185, 76, 58] };
pub type GPMStarterGPOType = i32;
pub const typeSystem: GPMStarterGPOType = 0i32;
pub const typeCustom: GPMStarterGPOType = 1i32;
pub const GPMStatusMessage: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1266142356, data2: 53845, data3: 16539, data4: [188, 98, 55, 8, 129, 113, 90, 25] };
pub const GPMStatusMsgCollection: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 673506494, data2: 19404, data3: 19628, data4: [158, 96, 14, 62, 215, 241, 36, 150] };
pub const GPMTemplate: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3975271508, data2: 29146, data3: 20015, data4: [168, 192, 129, 133, 70, 89, 17, 217] };
pub const GPMTrustee: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3309989901, data2: 6582, data3: 16913, data4: [188, 176, 232, 226, 71, 94, 71, 30] };
pub const GPMWMIFilter: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1650935256, data2: 3562, data3: 16482, data4: [191, 96, 207, 197, 177, 202, 18, 134] };
pub const GPMWMIFilterCollection: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1960602920, data2: 59424, data3: 18390, data4: [160, 184, 240, 141, 147, 215, 250, 51] };
...
pub struct GPOBROWSEINFO {
    ...
    pub lpInitialOU: ::windows_core_sys::PWSTR,
    pub lpDSPath: ::windows_core_sys::PWSTR,
...
pub struct GROUP_POLICY_OBJECTA {
    pub dwOptions: u32,
    pub dwVersion: u32,
    pub lpDSPath: ::windows_core_sys::PSTR,
    pub lpFileSysPath: ::windows_core_sys::PSTR,
    ...
    pub lpExtensions: ::windows_core_sys::PSTR,
    pub lParam2: super::super::Foundation::LPARAM,
    pub lpLink: ::windows_core_sys::PSTR,
}
#[cfg(feature = "Win32_Foundation")]
...
pub struct GROUP_POLICY_OBJECTW {
    ...
    pub dwVersion: u32,
    pub lpDSPath: ::windows_core_sys::PWSTR,
    pub lpFileSysPath: ::windows_core_sys::PWSTR,
    ...
    pub lpExtensions: ::windows_core_sys::PWSTR,
    pub lParam2: super::super::Foundation::LPARAM,
    pub lpLink: ::windows_core_sys::PWSTR,
}
#[cfg(feature = "Win32_Foundation")]
...
pub union INSTALLSPEC {
    ...
    pub FileExt: ::windows_core_sys::PWSTR,
    pub ProgId: ::windows_core_sys::PWSTR,
...
pub struct INSTALLSPEC_0 {
    ...
    pub GPOId: ::windows_core_sys::GUID,
}
...
pub struct LOCALMANAGEDAPPLICATION {
    pub pszDeploymentName: ::windows_core_sys::PWSTR,
    pub pszPolicyName: ::windows_core_sys::PWSTR,
...
pub struct MANAGEDAPPLICATION {
    pub pszPackageName: ::windows_core_sys::PWSTR,
    ...
    pub Language: u16,
    pub pszOwner: ::windows_core_sys::PWSTR,
    pub pszCompany: ::windows_core_sys::PWSTR,
...
pub const NODEID_Machine: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2411771703, data2: 41185, data3: 4561, data4: [167, 211, 0, 0, 248, 117, 113, 227] };
pub const NODEID_MachineSWSettings: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2411771706, data2: 41185, data3: 4561, data4: [167, 211, 0, 0, 248, 117, 113, 227] };
pub const NODEID_RSOPMachine: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3175881262, data2: 2938, data3: 19042, data4: [166, 176, 192, 87, 117, 57, 201, 126] };
pub const NODEID_RSOPMachineSWSettings: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1786128190, data2: 60302, data3: 17883, data4: [148, 197, 37, 102, 58, 95, 44, 26] };
pub const NODEID_RSOPUser: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2877765199, data2: 3308, data3: 19672, data4: [155, 248, 137, 143, 52, 98, 143, 184] };
...
pub type PFNGENERATEGROUPPOLICY = ::core::option::Option<unsafe extern "system" fn(dwflags: u32, pbabort: *mut super::super::Foundation::BOOL, pwszsite: ::windows_core_sys::PCWSTR, pcomputertarget: *const RSOP_TARGET, pusertarget: *const RSOP_TARGET) -> u32>;
...
#[cfg(feature = "Win32_Foundation")]
pub type PFNSTATUSMESSAGECALLBACK = ::core::option::Option<unsafe extern "system" fn(bverbose: super::super::Foundation::BOOL, lpmessage: ::windows_core_sys::PCWSTR) -> u32>;
pub const PI_APPLYPOLICY: u32 = 2u32;
pub const PI_NOUI: u32 = 1u32;
#[repr(C)]
#[cfg(feature = "Win32_Foundation")]
pub struct POLICYSETTINGSTATUSINFO {
    pub szKey: ::windows_core_sys::PWSTR,
    pub szEventSource: ::windows_core_sys::PWSTR,
    pub szEventLogName: ::windows_core_sys::PWSTR,
    pub dwEventID: u32,
    pub dwErrorCode: u32,
