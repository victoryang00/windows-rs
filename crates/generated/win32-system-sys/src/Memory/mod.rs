...
#[link(name = "windows")]
extern "system" {
    pub fn AddSecureMemoryCacheCallback(pfncallback: PSECURE_MEMORY_CACHE_CALLBACK) -> ::win32_foundation_sys::BOOL;
    ...
    pub fn FlushViewOfFile(lpbaseaddress: *const ::core::ffi::c_void, dwnumberofbytestoflush: usize) -> ::win32_foundation_sys::BOOL;
    pub fn FreeUserPhysicalPages(hprocess: ::win32_foundation_sys::HANDLE, numberofpages: *mut usize, pagearray: *const usize) -> ::win32_foundation_sys::BOOL;
    pub fn GetLargePageMinimum() -> usize;
    pub fn GetMemoryErrorHandlingCapabilities(capabilities: *mut u32) -> ::win32_foundation_sys::BOOL;
    pub fn GetProcessHeap() -> HeapHandle;
    pub fn GetProcessHeaps(numberofheaps: u32, processheaps: *mut HeapHandle) -> u32;
    pub fn GetProcessWorkingSetSizeEx(hprocess: ::win32_foundation_sys::HANDLE, lpminimumworkingsetsize: *mut usize, lpmaximumworkingsetsize: *mut usize, flags: *mut u32) -> ::win32_foundation_sys::BOOL;
    pub fn GetSystemFileCacheSize(lpminimumfilecachesize: *mut usize, lpmaximumfilecachesize: *mut usize, lpflags: *mut u32) -> ::win32_foundation_sys::BOOL;
    ...
    pub fn GlobalUnlock(hmem: isize) -> ::win32_foundation_sys::BOOL;
    ...
    pub fn HeapDestroy(hheap: HeapHandle) -> ::win32_foundation_sys::BOOL;
    pub fn HeapFree(hheap: HeapHandle, dwflags: HEAP_FLAGS, lpmem: *const ::core::ffi::c_void) -> ::win32_foundation_sys::BOOL;
    pub fn HeapLock(hheap: HeapHandle) -> ::win32_foundation_sys::BOOL;
    pub fn HeapQueryInformation(heaphandle: HeapHandle, heapinformationclass: HEAP_INFORMATION_CLASS, heapinformation: *mut ::core::ffi::c_void, heapinformationlength: usize, returnlength: *mut usize) -> ::win32_foundation_sys::BOOL;
    pub fn HeapReAlloc(hheap: HeapHandle, dwflags: HEAP_FLAGS, lpmem: *const ::core::ffi::c_void, dwbytes: usize) -> *mut ::core::ffi::c_void;
    pub fn HeapSetInformation(heaphandle: HeapHandle, heapinformationclass: HEAP_INFORMATION_CLASS, heapinformation: *const ::core::ffi::c_void, heapinformationlength: usize) -> ::win32_foundation_sys::BOOL;
    pub fn HeapSize(hheap: HeapHandle, dwflags: HEAP_FLAGS, lpmem: *const ::core::ffi::c_void) -> usize;
    pub fn HeapSummary(hheap: ::win32_foundation_sys::HANDLE, dwflags: u32, lpsummary: *mut HEAP_SUMMARY) -> ::win32_foundation_sys::BOOL;
    pub fn HeapUnlock(hheap: HeapHandle) -> ::win32_foundation_sys::BOOL;
    pub fn HeapValidate(hheap: HeapHandle, dwflags: HEAP_FLAGS, lpmem: *const ::core::ffi::c_void) -> ::win32_foundation_sys::BOOL;
    pub fn HeapWalk(hheap: HeapHandle, lpentry: *mut PROCESS_HEAP_ENTRY) -> ::win32_foundation_sys::BOOL;
    pub fn IsBadCodePtr(lpfn: ::win32_foundation_sys::FARPROC) -> ::win32_foundation_sys::BOOL;
    pub fn IsBadReadPtr(lp: *const ::core::ffi::c_void, ucb: usize) -> ::win32_foundation_sys::BOOL;
    pub fn IsBadStringPtrA(lpsz: ::windows_core_sys::PCSTR, ucchmax: usize) -> ::win32_foundation_sys::BOOL;
    pub fn IsBadStringPtrW(lpsz: ::windows_core_sys::PCWSTR, ucchmax: usize) -> ::win32_foundation_sys::BOOL;
    pub fn IsBadWritePtr(lp: *const ::core::ffi::c_void, ucb: usize) -> ::win32_foundation_sys::BOOL;
    ...
    pub fn LocalUnlock(hmem: isize) -> ::win32_foundation_sys::BOOL;
    pub fn MapUserPhysicalPages(virtualaddress: *const ::core::ffi::c_void, numberofpages: usize, pagearray: *const usize) -> ::win32_foundation_sys::BOOL;
    pub fn MapUserPhysicalPagesScatter(virtualaddresses: *const *const ::core::ffi::c_void, numberofpages: usize, pagearray: *const usize) -> ::win32_foundation_sys::BOOL;
    pub fn MapViewOfFile(hfilemappingobject: ::win32_foundation_sys::HANDLE, dwdesiredaccess: FILE_MAP, dwfileoffsethigh: u32, dwfileoffsetlow: u32, dwnumberofbytestomap: usize) -> *mut ::core::ffi::c_void;
    pub fn MapViewOfFile3(filemapping: ::win32_foundation_sys::HANDLE, process: ::win32_foundation_sys::HANDLE, baseaddress: *const ::core::ffi::c_void, offset: u64, viewsize: usize, allocationtype: VIRTUAL_ALLOCATION_TYPE, pageprotection: u32, extendedparameters: *mut MEM_EXTENDED_PARAMETER, parametercount: u32) -> *mut ::core::ffi::c_void;
    pub fn MapViewOfFile3FromApp(filemapping: ::win32_foundation_sys::HANDLE, process: ::win32_foundation_sys::HANDLE, baseaddress: *const ::core::ffi::c_void, offset: u64, viewsize: usize, allocationtype: VIRTUAL_ALLOCATION_TYPE, pageprotection: u32, extendedparameters: *mut MEM_EXTENDED_PARAMETER, parametercount: u32) -> *mut ::core::ffi::c_void;
    pub fn MapViewOfFileEx(hfilemappingobject: ::win32_foundation_sys::HANDLE, dwdesiredaccess: FILE_MAP, dwfileoffsethigh: u32, dwfileoffsetlow: u32, dwnumberofbytestomap: usize, lpbaseaddress: *const ::core::ffi::c_void) -> *mut ::core::ffi::c_void;
    pub fn MapViewOfFileExNuma(hfilemappingobject: ::win32_foundation_sys::HANDLE, dwdesiredaccess: FILE_MAP, dwfileoffsethigh: u32, dwfileoffsetlow: u32, dwnumberofbytestomap: usize, lpbaseaddress: *const ::core::ffi::c_void, nndpreferred: u32) -> *mut ::core::ffi::c_void;
    pub fn MapViewOfFileFromApp(hfilemappingobject: ::win32_foundation_sys::HANDLE, desiredaccess: FILE_MAP, fileoffset: u64, numberofbytestomap: usize) -> *mut ::core::ffi::c_void;
    pub fn MapViewOfFileNuma2(filemappinghandle: ::win32_foundation_sys::HANDLE, processhandle: ::win32_foundation_sys::HANDLE, offset: u64, baseaddress: *const ::core::ffi::c_void, viewsize: usize, allocationtype: u32, pageprotection: u32, preferrednode: u32) -> *mut ::core::ffi::c_void;
    pub fn OfferVirtualMemory(virtualaddress: *mut ::core::ffi::c_void, size: usize, priority: OFFER_PRIORITY) -> u32;
    pub fn OpenDedicatedMemoryPartition(partition: ::win32_foundation_sys::HANDLE, dedicatedmemorytypeid: u64, desiredaccess: u32, inherithandle: ::win32_foundation_sys::BOOL) -> ::win32_foundation_sys::HANDLE;
    pub fn OpenFileMappingA(dwdesiredaccess: u32, binherithandle: ::win32_foundation_sys::BOOL, lpname: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::HANDLE;
    pub fn OpenFileMappingFromApp(desiredaccess: u32, inherithandle: ::win32_foundation_sys::BOOL, name: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::HANDLE;
    pub fn OpenFileMappingW(dwdesiredaccess: u32, binherithandle: ::win32_foundation_sys::BOOL, lpname: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::HANDLE;
    pub fn PrefetchVirtualMemory(hprocess: ::win32_foundation_sys::HANDLE, numberofentries: usize, virtualaddresses: *const WIN32_MEMORY_RANGE_ENTRY, flags: u32) -> ::win32_foundation_sys::BOOL;
    pub fn QueryMemoryResourceNotification(resourcenotificationhandle: ::win32_foundation_sys::HANDLE, resourcestate: *mut ::win32_foundation_sys::BOOL) -> ::win32_foundation_sys::BOOL;
    pub fn QueryPartitionInformation(partition: ::win32_foundation_sys::HANDLE, partitioninformationclass: WIN32_MEMORY_PARTITION_INFORMATION_CLASS, partitioninformation: *mut ::core::ffi::c_void, partitioninformationlength: u32) -> ::win32_foundation_sys::BOOL;
    pub fn QueryVirtualMemoryInformation(process: ::win32_foundation_sys::HANDLE, virtualaddress: *const ::core::ffi::c_void, memoryinformationclass: WIN32_MEMORY_INFORMATION_CLASS, memoryinformation: *mut ::core::ffi::c_void, memoryinformationsize: usize, returnsize: *mut usize) -> ::win32_foundation_sys::BOOL;
    ...
    pub fn RemoveSecureMemoryCacheCallback(pfncallback: PSECURE_MEMORY_CACHE_CALLBACK) -> ::win32_foundation_sys::BOOL;
    ...
    pub fn RtlIsZeroMemory(buffer: *const ::core::ffi::c_void, length: usize) -> ::win32_foundation_sys::BOOLEAN;
    pub fn SetProcessValidCallTargets(hprocess: ::win32_foundation_sys::HANDLE, virtualaddress: *const ::core::ffi::c_void, regionsize: usize, numberofoffsets: u32, offsetinformation: *mut CFG_CALL_TARGET_INFO) -> ::win32_foundation_sys::BOOL;
    pub fn SetProcessValidCallTargetsForMappedView(process: ::win32_foundation_sys::HANDLE, virtualaddress: *const ::core::ffi::c_void, regionsize: usize, numberofoffsets: u32, offsetinformation: *mut CFG_CALL_TARGET_INFO, section: ::win32_foundation_sys::HANDLE, expectedfileoffset: u64) -> ::win32_foundation_sys::BOOL;
    pub fn SetProcessWorkingSetSizeEx(hprocess: ::win32_foundation_sys::HANDLE, dwminimumworkingsetsize: usize, dwmaximumworkingsetsize: usize, flags: u32) -> ::win32_foundation_sys::BOOL;
    pub fn SetSystemFileCacheSize(minimumfilecachesize: usize, maximumfilecachesize: usize, flags: u32) -> ::win32_foundation_sys::BOOL;
    pub fn UnmapViewOfFile(lpbaseaddress: *const ::core::ffi::c_void) -> ::win32_foundation_sys::BOOL;
    pub fn UnmapViewOfFile2(process: ::win32_foundation_sys::HANDLE, baseaddress: *const ::core::ffi::c_void, unmapflags: UNMAP_VIEW_OF_FILE_FLAGS) -> ::win32_foundation_sys::BOOL;
    pub fn UnmapViewOfFileEx(baseaddress: *const ::core::ffi::c_void, unmapflags: UNMAP_VIEW_OF_FILE_FLAGS) -> ::win32_foundation_sys::BOOL;
    pub fn UnregisterBadMemoryNotification(registrationhandle: *const ::core::ffi::c_void) -> ::win32_foundation_sys::BOOL;
    ...
    pub fn VirtualAlloc2(process: ::win32_foundation_sys::HANDLE, baseaddress: *const ::core::ffi::c_void, size: usize, allocationtype: VIRTUAL_ALLOCATION_TYPE, pageprotection: u32, extendedparameters: *mut MEM_EXTENDED_PARAMETER, parametercount: u32) -> *mut ::core::ffi::c_void;
    pub fn VirtualAlloc2FromApp(process: ::win32_foundation_sys::HANDLE, baseaddress: *const ::core::ffi::c_void, size: usize, allocationtype: VIRTUAL_ALLOCATION_TYPE, pageprotection: u32, extendedparameters: *mut MEM_EXTENDED_PARAMETER, parametercount: u32) -> *mut ::core::ffi::c_void;
    pub fn VirtualAllocEx(hprocess: ::win32_foundation_sys::HANDLE, lpaddress: *const ::core::ffi::c_void, dwsize: usize, flallocationtype: VIRTUAL_ALLOCATION_TYPE, flprotect: PAGE_PROTECTION_FLAGS) -> *mut ::core::ffi::c_void;
    pub fn VirtualAllocExNuma(hprocess: ::win32_foundation_sys::HANDLE, lpaddress: *const ::core::ffi::c_void, dwsize: usize, flallocationtype: VIRTUAL_ALLOCATION_TYPE, flprotect: u32, nndpreferred: u32) -> *mut ::core::ffi::c_void;
    ...
    pub fn VirtualFree(lpaddress: *mut ::core::ffi::c_void, dwsize: usize, dwfreetype: VIRTUAL_FREE_TYPE) -> ::win32_foundation_sys::BOOL;
    pub fn VirtualFreeEx(hprocess: ::win32_foundation_sys::HANDLE, lpaddress: *mut ::core::ffi::c_void, dwsize: usize, dwfreetype: VIRTUAL_FREE_TYPE) -> ::win32_foundation_sys::BOOL;
    pub fn VirtualLock(lpaddress: *const ::core::ffi::c_void, dwsize: usize) -> ::win32_foundation_sys::BOOL;
    pub fn VirtualProtect(lpaddress: *const ::core::ffi::c_void, dwsize: usize, flnewprotect: PAGE_PROTECTION_FLAGS, lpfloldprotect: *mut PAGE_PROTECTION_FLAGS) -> ::win32_foundation_sys::BOOL;
    pub fn VirtualProtectEx(hprocess: ::win32_foundation_sys::HANDLE, lpaddress: *const ::core::ffi::c_void, dwsize: usize, flnewprotect: PAGE_PROTECTION_FLAGS, lpfloldprotect: *mut PAGE_PROTECTION_FLAGS) -> ::win32_foundation_sys::BOOL;
    pub fn VirtualProtectFromApp(address: *const ::core::ffi::c_void, size: usize, newprotection: u32, oldprotection: *mut u32) -> ::win32_foundation_sys::BOOL;
    pub fn VirtualQuery(lpaddress: *const ::core::ffi::c_void, lpbuffer: *mut MEMORY_BASIC_INFORMATION, dwlength: usize) -> usize;
    pub fn VirtualQueryEx(hprocess: ::win32_foundation_sys::HANDLE, lpaddress: *const ::core::ffi::c_void, lpbuffer: *mut MEMORY_BASIC_INFORMATION, dwlength: usize) -> usize;
    pub fn VirtualUnlock(lpaddress: *const ::core::ffi::c_void, dwsize: usize) -> ::win32_foundation_sys::BOOL;
    pub fn VirtualUnlockEx(process: ::win32_foundation_sys::HANDLE, address: *const ::core::ffi::c_void, size: usize) -> ::win32_foundation_sys::BOOL;
}
#[repr(C)]
...
pub struct PROCESS_HEAP_ENTRY_0_0 {
    pub hMem: ::win32_foundation_sys::HANDLE,
...
pub type PSECURE_MEMORY_CACHE_CALLBACK = ::core::option::Option<unsafe extern "system" fn(addr: *const ::core::ffi::c_void, range: usize) -> ::win32_foundation_sys::BOOLEAN>;
