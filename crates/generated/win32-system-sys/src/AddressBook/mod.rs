...
extern "system" {
    ...
    pub fn CreateTable(lpinterface: *mut ::windows_core_sys::GUID, lpallocatebuffer: LPALLOCATEBUFFER, lpallocatemore: LPALLOCATEMORE, lpfreebuffer: LPFREEBUFFER, lpvreserved: *mut ::core::ffi::c_void, ultabletype: u32, ulproptagindexcolumn: u32, lpsproptagarraycolumns: *mut SPropTagArray, lpptabledata: *mut ITableData) -> i32;
    ...
    pub fn FtMulDwDw(ftmultiplicand: u32, ftmultiplier: u32) -> ::win32_foundation_sys::FILETIME;
    pub fn FtNegFt(ft: ::win32_foundation_sys::FILETIME) -> ::win32_foundation_sys::FILETIME;
    pub fn FtSubFt(ftminuend: ::win32_foundation_sys::FILETIME, ftsubtrahend: ::win32_foundation_sys::FILETIME) -> ::win32_foundation_sys::FILETIME;
...
pub const E_IMAPI_BURN_VERIFICATION_FAILED: ::windows_core_sys::HRESULT = -1062600697i32;
pub const E_IMAPI_DF2DATA_CLIENT_NAME_IS_NOT_VALID: ::windows_core_sys::HRESULT = -1062599672i32;
pub const E_IMAPI_DF2DATA_INVALID_MEDIA_STATE: ::windows_core_sys::HRESULT = -1062599678i32;
pub const E_IMAPI_DF2DATA_MEDIA_IS_NOT_SUPPORTED: ::windows_core_sys::HRESULT = -1062599674i32;
pub const E_IMAPI_DF2DATA_MEDIA_NOT_BLANK: ::windows_core_sys::HRESULT = -1062599675i32;
pub const E_IMAPI_DF2DATA_RECORDER_NOT_SUPPORTED: ::windows_core_sys::HRESULT = -1062599673i32;
pub const E_IMAPI_DF2DATA_STREAM_NOT_SUPPORTED: ::windows_core_sys::HRESULT = -1062599677i32;
pub const E_IMAPI_DF2DATA_STREAM_TOO_LARGE_FOR_CURRENT_MEDIA: ::windows_core_sys::HRESULT = -1062599676i32;
pub const E_IMAPI_DF2DATA_WRITE_IN_PROGRESS: ::windows_core_sys::HRESULT = -1062599680i32;
pub const E_IMAPI_DF2DATA_WRITE_NOT_IN_PROGRESS: ::windows_core_sys::HRESULT = -1062599679i32;
pub const E_IMAPI_DF2RAW_CLIENT_NAME_IS_NOT_VALID: ::windows_core_sys::HRESULT = -1062599164i32;
pub const E_IMAPI_DF2RAW_DATA_BLOCK_TYPE_NOT_SUPPORTED: ::windows_core_sys::HRESULT = -1062599154i32;
pub const E_IMAPI_DF2RAW_MEDIA_IS_NOT_BLANK: ::windows_core_sys::HRESULT = -1062599162i32;
pub const E_IMAPI_DF2RAW_MEDIA_IS_NOT_PREPARED: ::windows_core_sys::HRESULT = -1062599166i32;
pub const E_IMAPI_DF2RAW_MEDIA_IS_NOT_SUPPORTED: ::windows_core_sys::HRESULT = -1062599161i32;
pub const E_IMAPI_DF2RAW_MEDIA_IS_PREPARED: ::windows_core_sys::HRESULT = -1062599165i32;
pub const E_IMAPI_DF2RAW_NOT_ENOUGH_SPACE: ::windows_core_sys::HRESULT = -1062599159i32;
pub const E_IMAPI_DF2RAW_NO_RECORDER_SPECIFIED: ::windows_core_sys::HRESULT = -1062599158i32;
pub const E_IMAPI_DF2RAW_RECORDER_NOT_SUPPORTED: ::windows_core_sys::HRESULT = -1062599152i32;
pub const E_IMAPI_DF2RAW_STREAM_LEADIN_TOO_SHORT: ::windows_core_sys::HRESULT = -1062599153i32;
pub const E_IMAPI_DF2RAW_STREAM_NOT_SUPPORTED: ::windows_core_sys::HRESULT = -1062599155i32;
pub const E_IMAPI_DF2RAW_WRITE_IN_PROGRESS: ::windows_core_sys::HRESULT = -1062599168i32;
pub const E_IMAPI_DF2RAW_WRITE_NOT_IN_PROGRESS: ::windows_core_sys::HRESULT = -1062599167i32;
pub const E_IMAPI_DF2TAO_CLIENT_NAME_IS_NOT_VALID: ::windows_core_sys::HRESULT = -1062599409i32;
pub const E_IMAPI_DF2TAO_INVALID_ISRC: ::windows_core_sys::HRESULT = -1062599413i32;
pub const E_IMAPI_DF2TAO_INVALID_MCN: ::windows_core_sys::HRESULT = -1062599412i32;
pub const E_IMAPI_DF2TAO_MEDIA_IS_NOT_BLANK: ::windows_core_sys::HRESULT = -1062599418i32;
pub const E_IMAPI_DF2TAO_MEDIA_IS_NOT_PREPARED: ::windows_core_sys::HRESULT = -1062599422i32;
pub const E_IMAPI_DF2TAO_MEDIA_IS_NOT_SUPPORTED: ::windows_core_sys::HRESULT = -1062599417i32;
pub const E_IMAPI_DF2TAO_MEDIA_IS_PREPARED: ::windows_core_sys::HRESULT = -1062599421i32;
pub const E_IMAPI_DF2TAO_NOT_ENOUGH_SPACE: ::windows_core_sys::HRESULT = -1062599415i32;
pub const E_IMAPI_DF2TAO_NO_RECORDER_SPECIFIED: ::windows_core_sys::HRESULT = -1062599414i32;
pub const E_IMAPI_DF2TAO_PROPERTY_FOR_BLANK_MEDIA_ONLY: ::windows_core_sys::HRESULT = -1062599420i32;
pub const E_IMAPI_DF2TAO_RECORDER_NOT_SUPPORTED: ::windows_core_sys::HRESULT = -1062599410i32;
pub const E_IMAPI_DF2TAO_STREAM_NOT_SUPPORTED: ::windows_core_sys::HRESULT = -1062599411i32;
pub const E_IMAPI_DF2TAO_TABLE_OF_CONTENTS_EMPTY_DISC: ::windows_core_sys::HRESULT = -1062599419i32;
pub const E_IMAPI_DF2TAO_TRACK_LIMIT_REACHED: ::windows_core_sys::HRESULT = -1062599416i32;
pub const E_IMAPI_DF2TAO_WRITE_IN_PROGRESS: ::windows_core_sys::HRESULT = -1062599424i32;
pub const E_IMAPI_DF2TAO_WRITE_NOT_IN_PROGRESS: ::windows_core_sys::HRESULT = -1062599423i32;
pub const E_IMAPI_ERASE_CLIENT_NAME_IS_NOT_VALID: ::windows_core_sys::HRESULT = -1062598389i32;
pub const E_IMAPI_ERASE_DISC_INFORMATION_TOO_SMALL: ::windows_core_sys::HRESULT = -2136340222i32;
pub const E_IMAPI_ERASE_DRIVE_FAILED_ERASE_COMMAND: ::windows_core_sys::HRESULT = -2136340219i32;
pub const E_IMAPI_ERASE_DRIVE_FAILED_SPINUP_COMMAND: ::windows_core_sys::HRESULT = -2136340216i32;
pub const E_IMAPI_ERASE_MEDIA_IS_NOT_ERASABLE: ::windows_core_sys::HRESULT = -2136340220i32;
pub const E_IMAPI_ERASE_MEDIA_IS_NOT_SUPPORTED: ::windows_core_sys::HRESULT = -1062598391i32;
pub const E_IMAPI_ERASE_MODE_PAGE_2A_TOO_SMALL: ::windows_core_sys::HRESULT = -2136340221i32;
pub const E_IMAPI_ERASE_ONLY_ONE_RECORDER_SUPPORTED: ::windows_core_sys::HRESULT = -2136340223i32;
pub const E_IMAPI_ERASE_RECORDER_IN_USE: ::windows_core_sys::HRESULT = -2136340224i32;
pub const E_IMAPI_ERASE_RECORDER_NOT_SUPPORTED: ::windows_core_sys::HRESULT = -1062598390i32;
pub const E_IMAPI_ERASE_TOOK_LONGER_THAN_ONE_HOUR: ::windows_core_sys::HRESULT = -2136340218i32;
pub const E_IMAPI_ERASE_UNEXPECTED_DRIVE_RESPONSE_DURING_ERASE: ::windows_core_sys::HRESULT = -2136340217i32;
pub const E_IMAPI_LOSS_OF_STREAMING: ::windows_core_sys::HRESULT = -1062599936i32;
pub const E_IMAPI_RAW_IMAGE_INSUFFICIENT_SPACE: ::windows_core_sys::HRESULT = -2136339963i32;
pub const E_IMAPI_RAW_IMAGE_IS_READ_ONLY: ::windows_core_sys::HRESULT = -2136339968i32;
pub const E_IMAPI_RAW_IMAGE_NO_TRACKS: ::windows_core_sys::HRESULT = -2136339965i32;
pub const E_IMAPI_RAW_IMAGE_SECTOR_TYPE_NOT_SUPPORTED: ::windows_core_sys::HRESULT = -2136339966i32;
pub const E_IMAPI_RAW_IMAGE_TOO_MANY_TRACKS: ::windows_core_sys::HRESULT = -2136339967i32;
pub const E_IMAPI_RAW_IMAGE_TOO_MANY_TRACK_INDEXES: ::windows_core_sys::HRESULT = -2136339962i32;
pub const E_IMAPI_RAW_IMAGE_TRACKS_ALREADY_ADDED: ::windows_core_sys::HRESULT = -2136339964i32;
pub const E_IMAPI_RAW_IMAGE_TRACK_INDEX_NOT_FOUND: ::windows_core_sys::HRESULT = -2136339961i32;
pub const E_IMAPI_RAW_IMAGE_TRACK_INDEX_OFFSET_ZERO_CANNOT_BE_CLEARED: ::windows_core_sys::HRESULT = -2136339959i32;
pub const E_IMAPI_RAW_IMAGE_TRACK_INDEX_TOO_CLOSE_TO_OTHER_INDEX: ::windows_core_sys::HRESULT = -2136339958i32;
pub const E_IMAPI_RECORDER_CLIENT_NAME_IS_NOT_VALID: ::windows_core_sys::HRESULT = -1062600175i32;
pub const E_IMAPI_RECORDER_COMMAND_TIMEOUT: ::windows_core_sys::HRESULT = -1062600179i32;
pub const E_IMAPI_RECORDER_DVD_STRUCTURE_NOT_PRESENT: ::windows_core_sys::HRESULT = -1062600178i32;
pub const E_IMAPI_RECORDER_FEATURE_IS_NOT_CURRENT: ::windows_core_sys::HRESULT = -1062600181i32;
pub const E_IMAPI_RECORDER_GET_CONFIGURATION_NOT_SUPPORTED: ::windows_core_sys::HRESULT = -1062600180i32;
pub const E_IMAPI_RECORDER_INVALID_MODE_PARAMETERS: ::windows_core_sys::HRESULT = -1062600184i32;
pub const E_IMAPI_RECORDER_INVALID_RESPONSE_FROM_DEVICE: ::windows_core_sys::HRESULT = -1062599937i32;
pub const E_IMAPI_RECORDER_LOCKED: ::windows_core_sys::HRESULT = -1062600176i32;
pub const E_IMAPI_RECORDER_MEDIA_BECOMING_READY: ::windows_core_sys::HRESULT = -1062600187i32;
pub const E_IMAPI_RECORDER_MEDIA_BUSY: ::windows_core_sys::HRESULT = -1062600185i32;
pub const E_IMAPI_RECORDER_MEDIA_FORMAT_IN_PROGRESS: ::windows_core_sys::HRESULT = -1062600186i32;
pub const E_IMAPI_RECORDER_MEDIA_INCOMPATIBLE: ::windows_core_sys::HRESULT = -1062600189i32;
pub const E_IMAPI_RECORDER_MEDIA_NOT_FORMATTED: ::windows_core_sys::HRESULT = -1062600174i32;
pub const E_IMAPI_RECORDER_MEDIA_NO_MEDIA: ::windows_core_sys::HRESULT = -1062600190i32;
pub const E_IMAPI_RECORDER_MEDIA_SPEED_MISMATCH: ::windows_core_sys::HRESULT = -1062600177i32;
pub const E_IMAPI_RECORDER_MEDIA_UPSIDE_DOWN: ::windows_core_sys::HRESULT = -1062600188i32;
pub const E_IMAPI_RECORDER_MEDIA_WRITE_PROTECTED: ::windows_core_sys::HRESULT = -1062600183i32;
pub const E_IMAPI_RECORDER_NO_SUCH_FEATURE: ::windows_core_sys::HRESULT = -1062600182i32;
pub const E_IMAPI_RECORDER_NO_SUCH_MODE_PAGE: ::windows_core_sys::HRESULT = -1062600191i32;
pub const E_IMAPI_RECORDER_REQUIRED: ::windows_core_sys::HRESULT = -1062600701i32;
pub const E_IMAPI_REQUEST_CANCELLED: ::windows_core_sys::HRESULT = -1062600702i32;
pub const E_IMAPI_UNEXPECTED_RESPONSE_FROM_DEVICE: ::windows_core_sys::HRESULT = -1062599935i32;
...
pub const IMAPI_E_BAD_MULTISESSION_PARAMETER: ::windows_core_sys::HRESULT = -1062555294i32;
pub const IMAPI_E_BOOT_EMULATION_IMAGE_SIZE_MISMATCH: ::windows_core_sys::HRESULT = -1062555318i32;
pub const IMAPI_E_BOOT_IMAGE_DATA: ::windows_core_sys::HRESULT = -1062555320i32;
pub const IMAPI_E_BOOT_OBJECT_CONFLICT: ::windows_core_sys::HRESULT = -1062555319i32;
pub const IMAPI_E_DATA_STREAM_CREATE_FAILURE: ::windows_core_sys::HRESULT = -1062555350i32;
pub const IMAPI_E_DATA_STREAM_INCONSISTENCY: ::windows_core_sys::HRESULT = -1062555352i32;
pub const IMAPI_E_DATA_STREAM_READ_FAILURE: ::windows_core_sys::HRESULT = -1062555351i32;
pub const IMAPI_E_DATA_TOO_BIG: ::windows_core_sys::HRESULT = -1062555342i32;
pub const IMAPI_E_DIRECTORY_READ_FAILURE: ::windows_core_sys::HRESULT = -1062555349i32;
pub const IMAPI_E_DIR_NOT_EMPTY: ::windows_core_sys::HRESULT = -1062555382i32;
pub const IMAPI_E_DIR_NOT_FOUND: ::windows_core_sys::HRESULT = -1062555366i32;
pub const IMAPI_E_DISC_MISMATCH: ::windows_core_sys::HRESULT = -1062555304i32;
pub const IMAPI_E_DUP_NAME: ::windows_core_sys::HRESULT = -1062555374i32;
pub const IMAPI_E_EMPTY_DISC: ::windows_core_sys::HRESULT = -1062555312i32;
pub const IMAPI_E_FILE_NOT_FOUND: ::windows_core_sys::HRESULT = -1062555367i32;
pub const IMAPI_E_FILE_SYSTEM_CHANGE_NOT_ALLOWED: ::windows_core_sys::HRESULT = -1062555293i32;
pub const IMAPI_E_FILE_SYSTEM_FEATURE_NOT_SUPPORTED: ::windows_core_sys::HRESULT = -1062555308i32;
pub const IMAPI_E_FILE_SYSTEM_NOT_EMPTY: ::windows_core_sys::HRESULT = -1062555386i32;
pub const IMAPI_E_FILE_SYSTEM_NOT_FOUND: ::windows_core_sys::HRESULT = -1062555310i32;
pub const IMAPI_E_FILE_SYSTEM_READ_CONSISTENCY_ERROR: ::windows_core_sys::HRESULT = -1062555309i32;
pub const IMAPI_E_FSI_INTERNAL_ERROR: ::windows_core_sys::HRESULT = -1062555392i32;
pub const IMAPI_E_IMAGEMANAGER_IMAGE_NOT_ALIGNED: ::windows_core_sys::HRESULT = -1062555136i32;
pub const IMAPI_E_IMAGEMANAGER_IMAGE_TOO_BIG: ::windows_core_sys::HRESULT = -1062555133i32;
pub const IMAPI_E_IMAGEMANAGER_NO_IMAGE: ::windows_core_sys::HRESULT = -1062555134i32;
pub const IMAPI_E_IMAGEMANAGER_NO_VALID_VD_FOUND: ::windows_core_sys::HRESULT = -1062555135i32;
pub const IMAPI_E_IMAGE_SIZE_LIMIT: ::windows_core_sys::HRESULT = -1062555360i32;
pub const IMAPI_E_IMAGE_TOO_BIG: ::windows_core_sys::HRESULT = -1062555359i32;
pub const IMAPI_E_IMPORT_MEDIA_NOT_ALLOWED: ::windows_core_sys::HRESULT = -1062555303i32;
pub const IMAPI_E_IMPORT_READ_FAILURE: ::windows_core_sys::HRESULT = -1062555305i32;
pub const IMAPI_E_IMPORT_SEEK_FAILURE: ::windows_core_sys::HRESULT = -1062555306i32;
pub const IMAPI_E_IMPORT_TYPE_COLLISION_DIRECTORY_EXISTS_AS_FILE: ::windows_core_sys::HRESULT = -1062555298i32;
pub const IMAPI_E_IMPORT_TYPE_COLLISION_FILE_EXISTS_AS_DIRECTORY: ::windows_core_sys::HRESULT = -1062555307i32;
pub const IMAPI_E_INCOMPATIBLE_MULTISESSION_TYPE: ::windows_core_sys::HRESULT = -1062555301i32;
pub const IMAPI_E_INCOMPATIBLE_PREVIOUS_SESSION: ::windows_core_sys::HRESULT = -1062555341i32;
pub const IMAPI_E_INVALID_DATE: ::windows_core_sys::HRESULT = -1062555387i32;
pub const IMAPI_E_INVALID_PARAM: ::windows_core_sys::HRESULT = -1062555391i32;
pub const IMAPI_E_INVALID_PATH: ::windows_core_sys::HRESULT = -1062555376i32;
pub const IMAPI_E_INVALID_VOLUME_NAME: ::windows_core_sys::HRESULT = -1062555388i32;
pub const IMAPI_E_INVALID_WORKING_DIRECTORY: ::windows_core_sys::HRESULT = -1062555328i32;
pub const IMAPI_E_ISO9660_LEVELS: ::windows_core_sys::HRESULT = -1062555343i32;
pub const IMAPI_E_ITEM_NOT_FOUND: ::windows_core_sys::HRESULT = -1062555368i32;
pub const IMAPI_E_MULTISESSION_NOT_SET: ::windows_core_sys::HRESULT = -1062555299i32;
pub const IMAPI_E_NOT_DIR: ::windows_core_sys::HRESULT = -1062555383i32;
pub const IMAPI_E_NOT_FILE: ::windows_core_sys::HRESULT = -1062555384i32;
pub const IMAPI_E_NOT_IN_FILE_SYSTEM: ::windows_core_sys::HRESULT = -1062555381i32;
pub const IMAPI_E_NO_COMPATIBLE_MULTISESSION_TYPE: ::windows_core_sys::HRESULT = -1062555300i32;
pub const IMAPI_E_NO_OUTPUT: ::windows_core_sys::HRESULT = -1062555389i32;
pub const IMAPI_E_NO_SUPPORTED_FILE_SYSTEM: ::windows_core_sys::HRESULT = -1062555311i32;
pub const IMAPI_E_NO_UNIQUE_NAME: ::windows_core_sys::HRESULT = -1062555373i32;
pub const IMAPI_E_PROPERTY_NOT_ACCESSIBLE: ::windows_core_sys::HRESULT = -1062555296i32;
pub const IMAPI_E_READONLY: ::windows_core_sys::HRESULT = -1062555390i32;
pub const IMAPI_E_RESTRICTED_NAME_VIOLATION: ::windows_core_sys::HRESULT = -1062555375i32;
pub const IMAPI_E_STASHFILE_MOVE: ::windows_core_sys::HRESULT = -1062555326i32;
pub const IMAPI_E_STASHFILE_OPEN_FAILURE: ::windows_core_sys::HRESULT = -1062555336i32;
pub const IMAPI_E_STASHFILE_READ_FAILURE: ::windows_core_sys::HRESULT = -1062555333i32;
pub const IMAPI_E_STASHFILE_SEEK_FAILURE: ::windows_core_sys::HRESULT = -1062555335i32;
pub const IMAPI_E_STASHFILE_WRITE_FAILURE: ::windows_core_sys::HRESULT = -1062555334i32;
pub const IMAPI_E_TOO_MANY_DIRS: ::windows_core_sys::HRESULT = -1062555344i32;
pub const IMAPI_E_UDF_NOT_WRITE_COMPATIBLE: ::windows_core_sys::HRESULT = -1062555302i32;
pub const IMAPI_E_UDF_REVISION_CHANGE_NOT_ALLOWED: ::windows_core_sys::HRESULT = -1062555295i32;
pub const IMAPI_E_WORKING_DIRECTORY_SPACE: ::windows_core_sys::HRESULT = -1062555327i32;
pub const IMAPI_S_IMAGE_FEATURE_NOT_SUPPORTED: ::windows_core_sys::HRESULT = 11186527i32;
...
pub type IWABOBJECT_AllocateBuffer_METHOD = ::core::option::Option<unsafe extern "system" fn(cbsize: u32, lppbuffer: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT>;
pub type IWABOBJECT_AllocateMore_METHOD = ::core::option::Option<unsafe extern "system" fn(cbsize: u32, lpobject: *const ::core::ffi::c_void, lppbuffer: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT>;
pub type IWABOBJECT_Backup_METHOD = ::core::option::Option<unsafe extern "system" fn(lpfilename: ::windows_core_sys::PCSTR) -> ::windows_core_sys::HRESULT>;
pub type IWABOBJECT_Find_METHOD = ::core::option::Option<unsafe extern "system" fn(lpiab: IAddrBook, hwnd: ::win32_foundation_sys::HWND) -> ::windows_core_sys::HRESULT>;
pub type IWABOBJECT_FreeBuffer_METHOD = ::core::option::Option<unsafe extern "system" fn(lpbuffer: *const ::core::ffi::c_void) -> ::windows_core_sys::HRESULT>;
pub type IWABOBJECT_GetLastError_METHOD = ::core::option::Option<unsafe extern "system" fn(hresult: ::windows_core_sys::HRESULT, ulflags: u32, lppmapierror: *mut *mut MAPIERROR) -> ::windows_core_sys::HRESULT>;
pub type IWABOBJECT_GetMe_METHOD = ::core::option::Option<unsafe extern "system" fn(lpiab: IAddrBook, ulflags: u32, lpdwaction: *mut u32, lpsbeid: *mut SBinary, hwnd: ::win32_foundation_sys::HWND) -> ::windows_core_sys::HRESULT>;
pub type IWABOBJECT_Import_METHOD = ::core::option::Option<unsafe extern "system" fn(lpwip: ::windows_core_sys::PCSTR) -> ::windows_core_sys::HRESULT>;
pub type IWABOBJECT_LDAPUrl_METHOD = ::core::option::Option<unsafe extern "system" fn(lpiab: IAddrBook, hwnd: ::win32_foundation_sys::HWND, ulflags: u32, lpszurl: ::windows_core_sys::PCSTR, lppmailuser: *mut IMailUser) -> ::windows_core_sys::HRESULT>;
pub type IWABOBJECT_QueryInterface_METHOD = ::core::option::Option<unsafe extern "system" fn(riid: *const ::windows_core_sys::GUID, ppvobj: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT>;
pub type IWABOBJECT_Release_METHOD = ::core::option::Option<unsafe extern "system" fn() -> u32>;
pub type IWABOBJECT_SetMe_METHOD = ::core::option::Option<unsafe extern "system" fn(lpiab: IAddrBook, ulflags: u32, sbeid: SBinary, hwnd: ::win32_foundation_sys::HWND) -> ::windows_core_sys::HRESULT>;
pub type IWABOBJECT_VCardCreate_METHOD = ::core::option::Option<unsafe extern "system" fn(lpiab: IAddrBook, ulflags: u32, lpszvcard: ::windows_core_sys::PCSTR, lpmailuser: IMailUser) -> ::windows_core_sys::HRESULT>;
pub type IWABOBJECT_VCardDisplay_METHOD = ::core::option::Option<unsafe extern "system" fn(lpiab: IAddrBook, hwnd: ::win32_foundation_sys::HWND, lpszfilename: ::windows_core_sys::PCSTR) -> ::windows_core_sys::HRESULT>;
pub type IWABOBJECT_VCardRetrieve_METHOD = ::core::option::Option<unsafe extern "system" fn(lpiab: IAddrBook, ulflags: u32, lpszvcard: ::windows_core_sys::PCSTR, lppmailuser: *mut IMailUser) -> ::windows_core_sys::HRESULT>;
...
pub type LPDISPATCHNOTIFICATIONS = ::core::option::Option<unsafe extern "system" fn(ulflags: u32) -> ::windows_core_sys::HRESULT>;
pub type LPFNABSDI = ::core::option::Option<unsafe extern "system" fn(uluiparam: usize, lpvmsg: *mut ::core::ffi::c_void) -> ::win32_foundation_sys::BOOL>;
...
pub type LPWABOPEN = ::core::option::Option<unsafe extern "system" fn(lppadrbook: *mut IAddrBook, lppwabobject: *mut IWABObject, lpwp: *mut WAB_PARAM, reserved2: u32) -> ::windows_core_sys::HRESULT>;
pub type LPWABOPENEX = ::core::option::Option<unsafe extern "system" fn(lppadrbook: *mut IAddrBook, lppwabobject: *mut IWABObject, lpwp: *mut WAB_PARAM, reserved: u32, fnallocatebuffer: LPALLOCATEBUFFER, fnallocatemore: LPALLOCATEMORE, fnfreebuffer: LPFREEBUFFER) -> ::windows_core_sys::HRESULT>;
#[repr(C)]
...
pub type PFNIDLE = ::core::option::Option<unsafe extern "system" fn(param0: *mut ::core::ffi::c_void) -> ::win32_foundation_sys::BOOL>;
...
pub struct SDateTimeArray {
    pub cValues: u32,
    pub lpft: *mut ::win32_foundation_sys::FILETIME,
}
...
pub struct SLPSTRArray {
    pub cValues: u32,
    pub lppszA: *mut ::windows_core_sys::PSTR,
}
...
pub struct SWStringArray {
    pub cValues: u32,
    pub lppszW: *mut ::windows_core_sys::PWSTR,
}
...
pub const S_IMAPI_BOTHADJUSTED: ::windows_core_sys::HRESULT = 11141126i32;
pub const S_IMAPI_COMMAND_HAS_SENSE_DATA: ::windows_core_sys::HRESULT = 11141632i32;
pub const S_IMAPI_RAW_IMAGE_TRACK_INDEX_ALREADY_EXISTS: ::windows_core_sys::HRESULT = 11143688i32;
pub const S_IMAPI_ROTATIONADJUSTED: ::windows_core_sys::HRESULT = 11141125i32;
pub const S_IMAPI_SPEEDADJUSTED: ::windows_core_sys::HRESULT = 11141124i32;
pub const S_IMAPI_WRITE_NOT_IN_PROGRESS: ::windows_core_sys::HRESULT = 11141890i32;
...
pub struct WABEXTDISPLAY {
    ...
    pub fReadOnly: ::win32_foundation_sys::BOOL,
    pub fDataChanged: ::win32_foundation_sys::BOOL,
    pub ulFlags: u32,
    pub lpv: *mut ::core::ffi::c_void,
    pub lpsz: *mut i8,
}
...
pub struct WABIMPORTPARAM {
    ...
    pub ulFlags: u32,
    pub lpszFileName: ::windows_core_sys::PSTR,
}
...
pub struct WAB_PARAM {
    pub cbSize: u32,
    pub hwnd: ::win32_foundation_sys::HWND,
    pub szFileName: ::windows_core_sys::PSTR,
    pub ulFlags: u32,
    pub guidPSExt: ::windows_core_sys::GUID,
}
...
pub union _PV {
    ...
    pub lpszA: ::windows_core_sys::PSTR,
    pub bin: SBinary,
    pub lpszW: ::windows_core_sys::PWSTR,
    pub lpguid: *mut ::windows_core_sys::GUID,
    pub li: i64,
    pub MVi: SShortArray,
    pub MVl: SLongArray,
