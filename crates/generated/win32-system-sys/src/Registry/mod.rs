#[link(name = "windows")]
extern "system" {
    pub fn GetRegistryValueWithFallbackW(hkeyprimary: HKEY, pwszprimarysubkey: ::windows_core_sys::PCWSTR, hkeyfallback: HKEY, pwszfallbacksubkey: ::windows_core_sys::PCWSTR, pwszvalue: ::windows_core_sys::PCWSTR, dwflags: u32, pdwtype: *mut u32, pvdata: *mut ::core::ffi::c_void, cbdatain: u32, pcbdataout: *mut u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegCloseKey(hkey: HKEY) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegConnectRegistryA(lpmachinename: ::windows_core_sys::PCSTR, hkey: HKEY, phkresult: *mut HKEY) -> ::win32_foundation_sys::WIN32_ERROR;
    ...
    pub fn RegConnectRegistryW(lpmachinename: ::windows_core_sys::PCWSTR, hkey: HKEY, phkresult: *mut HKEY) -> ::win32_foundation_sys::WIN32_ERROR;
    ...
    pub fn RegDeleteKeyExA(hkey: HKEY, lpsubkey: ::windows_core_sys::PCSTR, samdesired: u32, reserved: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegDeleteKeyExW(hkey: HKEY, lpsubkey: ::windows_core_sys::PCWSTR, samdesired: u32, reserved: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegDeleteKeyTransactedA(hkey: HKEY, lpsubkey: ::windows_core_sys::PCSTR, samdesired: u32, reserved: u32, htransaction: ::win32_foundation_sys::HANDLE, pextendedparameter: *mut ::core::ffi::c_void) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegDeleteKeyTransactedW(hkey: HKEY, lpsubkey: ::windows_core_sys::PCWSTR, samdesired: u32, reserved: u32, htransaction: ::win32_foundation_sys::HANDLE, pextendedparameter: *mut ::core::ffi::c_void) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegDeleteKeyValueA(hkey: HKEY, lpsubkey: ::windows_core_sys::PCSTR, lpvaluename: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegDeleteKeyValueW(hkey: HKEY, lpsubkey: ::windows_core_sys::PCWSTR, lpvaluename: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegDeleteKeyW(hkey: HKEY, lpsubkey: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegDeleteTreeA(hkey: HKEY, lpsubkey: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegDeleteTreeW(hkey: HKEY, lpsubkey: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegDeleteValueA(hkey: HKEY, lpvaluename: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegDeleteValueW(hkey: HKEY, lpvaluename: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegDisablePredefinedCache() -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegDisablePredefinedCacheEx() -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegDisableReflectionKey(hbase: HKEY) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegEnableReflectionKey(hbase: HKEY) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegEnumKeyA(hkey: HKEY, dwindex: u32, lpname: ::windows_core_sys::PSTR, cchname: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegEnumKeyExA(hkey: HKEY, dwindex: u32, lpname: ::windows_core_sys::PSTR, lpcchname: *mut u32, lpreserved: *mut u32, lpclass: ::windows_core_sys::PSTR, lpcchclass: *mut u32, lpftlastwritetime: *mut ::win32_foundation_sys::FILETIME) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegEnumKeyExW(hkey: HKEY, dwindex: u32, lpname: ::windows_core_sys::PWSTR, lpcchname: *mut u32, lpreserved: *mut u32, lpclass: ::windows_core_sys::PWSTR, lpcchclass: *mut u32, lpftlastwritetime: *mut ::win32_foundation_sys::FILETIME) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegEnumKeyW(hkey: HKEY, dwindex: u32, lpname: ::windows_core_sys::PWSTR, cchname: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    ...
    pub fn RegLoadAppKeyA(lpfile: ::windows_core_sys::PCSTR, phkresult: *mut HKEY, samdesired: u32, dwoptions: u32, reserved: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegLoadAppKeyW(lpfile: ::windows_core_sys::PCWSTR, phkresult: *mut HKEY, samdesired: u32, dwoptions: u32, reserved: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegLoadKeyA(hkey: HKEY, lpsubkey: ::windows_core_sys::PCSTR, lpfile: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegLoadKeyW(hkey: HKEY, lpsubkey: ::windows_core_sys::PCWSTR, lpfile: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegLoadMUIStringA(hkey: HKEY, pszvalue: ::windows_core_sys::PCSTR, pszoutbuf: ::windows_core_sys::PSTR, cboutbuf: u32, pcbdata: *mut u32, flags: u32, pszdirectory: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegLoadMUIStringW(hkey: HKEY, pszvalue: ::windows_core_sys::PCWSTR, pszoutbuf: ::windows_core_sys::PWSTR, cboutbuf: u32, pcbdata: *mut u32, flags: u32, pszdirectory: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegNotifyChangeKeyValue(hkey: HKEY, bwatchsubtree: ::win32_foundation_sys::BOOL, dwnotifyfilter: REG_NOTIFY_FILTER, hevent: ::win32_foundation_sys::HANDLE, fasynchronous: ::win32_foundation_sys::BOOL) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegOpenCurrentUser(samdesired: u32, phkresult: *mut HKEY) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegOpenKeyA(hkey: HKEY, lpsubkey: ::windows_core_sys::PCSTR, phkresult: *mut HKEY) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegOpenKeyExA(hkey: HKEY, lpsubkey: ::windows_core_sys::PCSTR, uloptions: u32, samdesired: REG_SAM_FLAGS, phkresult: *mut HKEY) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegOpenKeyExW(hkey: HKEY, lpsubkey: ::windows_core_sys::PCWSTR, uloptions: u32, samdesired: REG_SAM_FLAGS, phkresult: *mut HKEY) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegOpenKeyTransactedA(hkey: HKEY, lpsubkey: ::windows_core_sys::PCSTR, uloptions: u32, samdesired: REG_SAM_FLAGS, phkresult: *mut HKEY, htransaction: ::win32_foundation_sys::HANDLE, pextendedparemeter: *mut ::core::ffi::c_void) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegOpenKeyTransactedW(hkey: HKEY, lpsubkey: ::windows_core_sys::PCWSTR, uloptions: u32, samdesired: REG_SAM_FLAGS, phkresult: *mut HKEY, htransaction: ::win32_foundation_sys::HANDLE, pextendedparemeter: *mut ::core::ffi::c_void) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegOpenKeyW(hkey: HKEY, lpsubkey: ::windows_core_sys::PCWSTR, phkresult: *mut HKEY) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegOpenUserClassesRoot(htoken: ::win32_foundation_sys::HANDLE, dwoptions: u32, samdesired: u32, phkresult: *mut HKEY) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegOverridePredefKey(hkey: HKEY, hnewhkey: HKEY) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegQueryInfoKeyA(hkey: HKEY, lpclass: ::windows_core_sys::PSTR, lpcchclass: *mut u32, lpreserved: *mut u32, lpcsubkeys: *mut u32, lpcbmaxsubkeylen: *mut u32, lpcbmaxclasslen: *mut u32, lpcvalues: *mut u32, lpcbmaxvaluenamelen: *mut u32, lpcbmaxvaluelen: *mut u32, lpcbsecuritydescriptor: *mut u32, lpftlastwritetime: *mut ::win32_foundation_sys::FILETIME) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegQueryInfoKeyW(hkey: HKEY, lpclass: ::windows_core_sys::PWSTR, lpcchclass: *mut u32, lpreserved: *mut u32, lpcsubkeys: *mut u32, lpcbmaxsubkeylen: *mut u32, lpcbmaxclasslen: *mut u32, lpcvalues: *mut u32, lpcbmaxvaluenamelen: *mut u32, lpcbmaxvaluelen: *mut u32, lpcbsecuritydescriptor: *mut u32, lpftlastwritetime: *mut ::win32_foundation_sys::FILETIME) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegQueryMultipleValuesA(hkey: HKEY, val_list: *mut VALENTA, num_vals: u32, lpvaluebuf: ::windows_core_sys::PSTR, ldwtotsize: *mut u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegQueryMultipleValuesW(hkey: HKEY, val_list: *mut VALENTW, num_vals: u32, lpvaluebuf: ::windows_core_sys::PWSTR, ldwtotsize: *mut u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegQueryReflectionKey(hbase: HKEY, bisreflectiondisabled: *mut ::win32_foundation_sys::BOOL) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegQueryValueA(hkey: HKEY, lpsubkey: ::windows_core_sys::PCSTR, lpdata: ::windows_core_sys::PSTR, lpcbdata: *mut i32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegQueryValueExA(hkey: HKEY, lpvaluename: ::windows_core_sys::PCSTR, lpreserved: *mut u32, lptype: *mut REG_VALUE_TYPE, lpdata: *mut u8, lpcbdata: *mut u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegQueryValueExW(hkey: HKEY, lpvaluename: ::windows_core_sys::PCWSTR, lpreserved: *mut u32, lptype: *mut REG_VALUE_TYPE, lpdata: *mut u8, lpcbdata: *mut u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegQueryValueW(hkey: HKEY, lpsubkey: ::windows_core_sys::PCWSTR, lpdata: ::windows_core_sys::PWSTR, lpcbdata: *mut i32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegRenameKey(hkey: HKEY, lpsubkeyname: ::windows_core_sys::PCWSTR, lpnewkeyname: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegReplaceKeyA(hkey: HKEY, lpsubkey: ::windows_core_sys::PCSTR, lpnewfile: ::windows_core_sys::PCSTR, lpoldfile: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::WIN32_ERROR;
    ...
    pub fn RegSetValueA(hkey: HKEY, lpsubkey: ::windows_core_sys::PCSTR, dwtype: REG_VALUE_TYPE, lpdata: ::windows_core_sys::PCSTR, cbdata: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegSetValueExA(hkey: HKEY, lpvaluename: ::windows_core_sys::PCSTR, reserved: u32, dwtype: REG_VALUE_TYPE, lpdata: *const u8, cbdata: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegSetValueExW(hkey: HKEY, lpvaluename: ::windows_core_sys::PCWSTR, reserved: u32, dwtype: REG_VALUE_TYPE, lpdata: *const u8, cbdata: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegSetValueW(hkey: HKEY, lpsubkey: ::windows_core_sys::PCWSTR, dwtype: REG_VALUE_TYPE, lpdata: ::windows_core_sys::PCWSTR, cbdata: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegUnLoadKeyA(hkey: HKEY, lpsubkey: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn RegUnLoadKeyW(hkey: HKEY, lpsubkey: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::WIN32_ERROR;
}
