...
#[link(name = "windows")]
extern "system" {
    pub fn BackupPerfRegistryToFileW(szfilename: ::windows_sys_core::PCWSTR, szcommentstring: ::windows_sys_core::PCWSTR) -> u32;
    pub fn InstallPerfDllA(szcomputername: ::windows_sys_core::PCSTR, lpinifile: ::windows_sys_core::PCSTR, dwflags: usize) -> u32;
    pub fn InstallPerfDllW(szcomputername: ::windows_sys_core::PCWSTR, lpinifile: ::windows_sys_core::PCWSTR, dwflags: usize) -> u32;
    #[cfg(feature = "Win32_Foundation")]
    pub fn LoadPerfCounterTextStringsA(lpcommandline: ::windows_sys_core::PCSTR, bquietmodearg: super::super::Foundation::BOOL) -> u32;
    #[cfg(feature = "Win32_Foundation")]
    pub fn LoadPerfCounterTextStringsW(lpcommandline: ::windows_sys_core::PCWSTR, bquietmodearg: super::super::Foundation::BOOL) -> u32;
    pub fn PdhAddCounterA(hquery: isize, szfullcounterpath: ::windows_sys_core::PCSTR, dwuserdata: usize, phcounter: *mut isize) -> i32;
    pub fn PdhAddCounterW(hquery: isize, szfullcounterpath: ::windows_sys_core::PCWSTR, dwuserdata: usize, phcounter: *mut isize) -> i32;
    pub fn PdhAddEnglishCounterA(hquery: isize, szfullcounterpath: ::windows_sys_core::PCSTR, dwuserdata: usize, phcounter: *mut isize) -> i32;
    pub fn PdhAddEnglishCounterW(hquery: isize, szfullcounterpath: ::windows_sys_core::PCWSTR, dwuserdata: usize, phcounter: *mut isize) -> i32;
    pub fn PdhBindInputDataSourceA(phdatasource: *mut isize, logfilenamelist: ::windows_sys_core::PCSTR) -> i32;
    pub fn PdhBindInputDataSourceW(phdatasource: *mut isize, logfilenamelist: ::windows_sys_core::PCWSTR) -> i32;
    #[cfg(feature = "Win32_Foundation")]
    ...
    pub fn PdhConnectMachineA(szmachinename: ::windows_sys_core::PCSTR) -> i32;
    pub fn PdhConnectMachineW(szmachinename: ::windows_sys_core::PCWSTR) -> i32;
    pub fn PdhCreateSQLTablesA(szdatasource: ::windows_sys_core::PCSTR) -> i32;
    pub fn PdhCreateSQLTablesW(szdatasource: ::windows_sys_core::PCWSTR) -> i32;
    pub fn PdhEnumLogSetNamesA(szdatasource: ::windows_sys_core::PCSTR, mszdatasetnamelist: ::windows_sys_core::PSTR, pcchbufferlength: *mut u32) -> i32;
    pub fn PdhEnumLogSetNamesW(szdatasource: ::windows_sys_core::PCWSTR, mszdatasetnamelist: ::windows_sys_core::PWSTR, pcchbufferlength: *mut u32) -> i32;
    pub fn PdhEnumMachinesA(szdatasource: ::windows_sys_core::PCSTR, mszmachinelist: ::windows_sys_core::PSTR, pcchbuffersize: *mut u32) -> i32;
    pub fn PdhEnumMachinesHA(hdatasource: isize, mszmachinelist: ::windows_sys_core::PSTR, pcchbuffersize: *mut u32) -> i32;
    pub fn PdhEnumMachinesHW(hdatasource: isize, mszmachinelist: ::windows_sys_core::PWSTR, pcchbuffersize: *mut u32) -> i32;
    pub fn PdhEnumMachinesW(szdatasource: ::windows_sys_core::PCWSTR, mszmachinelist: ::windows_sys_core::PWSTR, pcchbuffersize: *mut u32) -> i32;
    pub fn PdhEnumObjectItemsA(szdatasource: ::windows_sys_core::PCSTR, szmachinename: ::windows_sys_core::PCSTR, szobjectname: ::windows_sys_core::PCSTR, mszcounterlist: ::windows_sys_core::PSTR, pcchcounterlistlength: *mut u32, mszinstancelist: ::windows_sys_core::PSTR, pcchinstancelistlength: *mut u32, dwdetaillevel: PERF_DETAIL, dwflags: u32) -> i32;
    pub fn PdhEnumObjectItemsHA(hdatasource: isize, szmachinename: ::windows_sys_core::PCSTR, szobjectname: ::windows_sys_core::PCSTR, mszcounterlist: ::windows_sys_core::PSTR, pcchcounterlistlength: *mut u32, mszinstancelist: ::windows_sys_core::PSTR, pcchinstancelistlength: *mut u32, dwdetaillevel: PERF_DETAIL, dwflags: u32) -> i32;
    pub fn PdhEnumObjectItemsHW(hdatasource: isize, szmachinename: ::windows_sys_core::PCWSTR, szobjectname: ::windows_sys_core::PCWSTR, mszcounterlist: ::windows_sys_core::PWSTR, pcchcounterlistlength: *mut u32, mszinstancelist: ::windows_sys_core::PWSTR, pcchinstancelistlength: *mut u32, dwdetaillevel: PERF_DETAIL, dwflags: u32) -> i32;
    pub fn PdhEnumObjectItemsW(szdatasource: ::windows_sys_core::PCWSTR, szmachinename: ::windows_sys_core::PCWSTR, szobjectname: ::windows_sys_core::PCWSTR, mszcounterlist: ::windows_sys_core::PWSTR, pcchcounterlistlength: *mut u32, mszinstancelist: ::windows_sys_core::PWSTR, pcchinstancelistlength: *mut u32, dwdetaillevel: PERF_DETAIL, dwflags: u32) -> i32;
    #[cfg(feature = "Win32_Foundation")]
    pub fn PdhEnumObjectsA(szdatasource: ::windows_sys_core::PCSTR, szmachinename: ::windows_sys_core::PCSTR, mszobjectlist: ::windows_sys_core::PSTR, pcchbuffersize: *mut u32, dwdetaillevel: PERF_DETAIL, brefresh: super::super::Foundation::BOOL) -> i32;
    #[cfg(feature = "Win32_Foundation")]
    pub fn PdhEnumObjectsHA(hdatasource: isize, szmachinename: ::windows_sys_core::PCSTR, mszobjectlist: ::windows_sys_core::PSTR, pcchbuffersize: *mut u32, dwdetaillevel: PERF_DETAIL, brefresh: super::super::Foundation::BOOL) -> i32;
    #[cfg(feature = "Win32_Foundation")]
    pub fn PdhEnumObjectsHW(hdatasource: isize, szmachinename: ::windows_sys_core::PCWSTR, mszobjectlist: ::windows_sys_core::PWSTR, pcchbuffersize: *mut u32, dwdetaillevel: PERF_DETAIL, brefresh: super::super::Foundation::BOOL) -> i32;
    #[cfg(feature = "Win32_Foundation")]
    pub fn PdhEnumObjectsW(szdatasource: ::windows_sys_core::PCWSTR, szmachinename: ::windows_sys_core::PCWSTR, mszobjectlist: ::windows_sys_core::PWSTR, pcchbuffersize: *mut u32, dwdetaillevel: PERF_DETAIL, brefresh: super::super::Foundation::BOOL) -> i32;
    pub fn PdhExpandCounterPathA(szwildcardpath: ::windows_sys_core::PCSTR, mszexpandedpathlist: ::windows_sys_core::PSTR, pcchpathlistlength: *mut u32) -> i32;
    pub fn PdhExpandCounterPathW(szwildcardpath: ::windows_sys_core::PCWSTR, mszexpandedpathlist: ::windows_sys_core::PWSTR, pcchpathlistlength: *mut u32) -> i32;
    pub fn PdhExpandWildCardPathA(szdatasource: ::windows_sys_core::PCSTR, szwildcardpath: ::windows_sys_core::PCSTR, mszexpandedpathlist: ::windows_sys_core::PSTR, pcchpathlistlength: *mut u32, dwflags: u32) -> i32;
    pub fn PdhExpandWildCardPathHA(hdatasource: isize, szwildcardpath: ::windows_sys_core::PCSTR, mszexpandedpathlist: ::windows_sys_core::PSTR, pcchpathlistlength: *mut u32, dwflags: u32) -> i32;
    pub fn PdhExpandWildCardPathHW(hdatasource: isize, szwildcardpath: ::windows_sys_core::PCWSTR, mszexpandedpathlist: ::windows_sys_core::PWSTR, pcchpathlistlength: *mut u32, dwflags: u32) -> i32;
    pub fn PdhExpandWildCardPathW(szdatasource: ::windows_sys_core::PCWSTR, szwildcardpath: ::windows_sys_core::PCWSTR, mszexpandedpathlist: ::windows_sys_core::PWSTR, pcchpathlistlength: *mut u32, dwflags: u32) -> i32;
    #[cfg(feature = "Win32_Foundation")]
    ...
    pub fn PdhGetDataSourceTimeRangeA(szdatasource: ::windows_sys_core::PCSTR, pdwnumentries: *mut u32, pinfo: *mut PDH_TIME_INFO, pdwbuffersize: *mut u32) -> i32;
    ...
    pub fn PdhGetDataSourceTimeRangeW(szdatasource: ::windows_sys_core::PCWSTR, pdwnumentries: *mut u32, pinfo: *mut PDH_TIME_INFO, pdwbuffersize: *mut u32) -> i32;
    pub fn PdhGetDefaultPerfCounterA(szdatasource: ::windows_sys_core::PCSTR, szmachinename: ::windows_sys_core::PCSTR, szobjectname: ::windows_sys_core::PCSTR, szdefaultcountername: ::windows_sys_core::PSTR, pcchbuffersize: *mut u32) -> i32;
    pub fn PdhGetDefaultPerfCounterHA(hdatasource: isize, szmachinename: ::windows_sys_core::PCSTR, szobjectname: ::windows_sys_core::PCSTR, szdefaultcountername: ::windows_sys_core::PSTR, pcchbuffersize: *mut u32) -> i32;
    pub fn PdhGetDefaultPerfCounterHW(hdatasource: isize, szmachinename: ::windows_sys_core::PCWSTR, szobjectname: ::windows_sys_core::PCWSTR, szdefaultcountername: ::windows_sys_core::PWSTR, pcchbuffersize: *mut u32) -> i32;
    pub fn PdhGetDefaultPerfCounterW(szdatasource: ::windows_sys_core::PCWSTR, szmachinename: ::windows_sys_core::PCWSTR, szobjectname: ::windows_sys_core::PCWSTR, szdefaultcountername: ::windows_sys_core::PWSTR, pcchbuffersize: *mut u32) -> i32;
    pub fn PdhGetDefaultPerfObjectA(szdatasource: ::windows_sys_core::PCSTR, szmachinename: ::windows_sys_core::PCSTR, szdefaultobjectname: ::windows_sys_core::PSTR, pcchbuffersize: *mut u32) -> i32;
    pub fn PdhGetDefaultPerfObjectHA(hdatasource: isize, szmachinename: ::windows_sys_core::PCSTR, szdefaultobjectname: ::windows_sys_core::PSTR, pcchbuffersize: *mut u32) -> i32;
    pub fn PdhGetDefaultPerfObjectHW(hdatasource: isize, szmachinename: ::windows_sys_core::PCWSTR, szdefaultobjectname: ::windows_sys_core::PWSTR, pcchbuffersize: *mut u32) -> i32;
    pub fn PdhGetDefaultPerfObjectW(szdatasource: ::windows_sys_core::PCWSTR, szmachinename: ::windows_sys_core::PCWSTR, szdefaultobjectname: ::windows_sys_core::PWSTR, pcchbuffersize: *mut u32) -> i32;
    ...
    pub fn PdhGetLogSetGUID(hlog: isize, pguid: *mut ::windows_sys_core::GUID, prunid: *mut i32) -> i32;
    #[cfg(feature = "Win32_Foundation")]
    ...
    pub fn PdhLookupPerfIndexByNameA(szmachinename: ::windows_sys_core::PCSTR, sznamebuffer: ::windows_sys_core::PCSTR, pdwindex: *mut u32) -> i32;
    pub fn PdhLookupPerfIndexByNameW(szmachinename: ::windows_sys_core::PCWSTR, sznamebuffer: ::windows_sys_core::PCWSTR, pdwindex: *mut u32) -> i32;
    pub fn PdhLookupPerfNameByIndexA(szmachinename: ::windows_sys_core::PCSTR, dwnameindex: u32, sznamebuffer: ::windows_sys_core::PSTR, pcchnamebuffersize: *mut u32) -> i32;
    pub fn PdhLookupPerfNameByIndexW(szmachinename: ::windows_sys_core::PCWSTR, dwnameindex: u32, sznamebuffer: ::windows_sys_core::PWSTR, pcchnamebuffersize: *mut u32) -> i32;
    pub fn PdhMakeCounterPathA(pcounterpathelements: *const PDH_COUNTER_PATH_ELEMENTS_A, szfullpathbuffer: ::windows_sys_core::PSTR, pcchbuffersize: *mut u32, dwflags: PDH_PATH_FLAGS) -> i32;
    pub fn PdhMakeCounterPathW(pcounterpathelements: *const PDH_COUNTER_PATH_ELEMENTS_W, szfullpathbuffer: ::windows_sys_core::PWSTR, pcchbuffersize: *mut u32, dwflags: PDH_PATH_FLAGS) -> i32;
    pub fn PdhOpenLogA(szlogfilename: ::windows_sys_core::PCSTR, dwaccessflags: PDH_LOG, lpdwlogtype: *mut PDH_LOG_TYPE, hquery: isize, dwmaxsize: u32, szusercaption: ::windows_sys_core::PCSTR, phlog: *mut isize) -> i32;
    pub fn PdhOpenLogW(szlogfilename: ::windows_sys_core::PCWSTR, dwaccessflags: PDH_LOG, lpdwlogtype: *mut PDH_LOG_TYPE, hquery: isize, dwmaxsize: u32, szusercaption: ::windows_sys_core::PCWSTR, phlog: *mut isize) -> i32;
    pub fn PdhOpenQueryA(szdatasource: ::windows_sys_core::PCSTR, dwuserdata: usize, phquery: *mut isize) -> i32;
    pub fn PdhOpenQueryH(hdatasource: isize, dwuserdata: usize, phquery: *mut isize) -> i32;
    pub fn PdhOpenQueryW(szdatasource: ::windows_sys_core::PCWSTR, dwuserdata: usize, phquery: *mut isize) -> i32;
    pub fn PdhParseCounterPathA(szfullpathbuffer: ::windows_sys_core::PCSTR, pcounterpathelements: *mut PDH_COUNTER_PATH_ELEMENTS_A, pdwbuffersize: *mut u32, dwflags: u32) -> i32;
    pub fn PdhParseCounterPathW(szfullpathbuffer: ::windows_sys_core::PCWSTR, pcounterpathelements: *mut PDH_COUNTER_PATH_ELEMENTS_W, pdwbuffersize: *mut u32, dwflags: u32) -> i32;
    pub fn PdhParseInstanceNameA(szinstancestring: ::windows_sys_core::PCSTR, szinstancename: ::windows_sys_core::PSTR, pcchinstancenamelength: *mut u32, szparentname: ::windows_sys_core::PSTR, pcchparentnamelength: *mut u32, lpindex: *mut u32) -> i32;
    pub fn PdhParseInstanceNameW(szinstancestring: ::windows_sys_core::PCWSTR, szinstancename: ::windows_sys_core::PWSTR, pcchinstancenamelength: *mut u32, szparentname: ::windows_sys_core::PWSTR, pcchparentnamelength: *mut u32, lpindex: *mut u32) -> i32;
    #[cfg(feature = "Win32_Foundation")]
    ...
    #[cfg(feature = "Win32_Foundation")]
    pub fn PdhSelectDataSourceA(hwndowner: super::super::Foundation::HWND, dwflags: PDH_SELECT_DATA_SOURCE_FLAGS, szdatasource: ::windows_sys_core::PSTR, pcchbufferlength: *mut u32) -> i32;
    #[cfg(feature = "Win32_Foundation")]
    pub fn PdhSelectDataSourceW(hwndowner: super::super::Foundation::HWND, dwflags: PDH_SELECT_DATA_SOURCE_FLAGS, szdatasource: ::windows_sys_core::PWSTR, pcchbufferlength: *mut u32) -> i32;
    ...
    pub fn PdhUpdateLogA(hlog: isize, szuserstring: ::windows_sys_core::PCSTR) -> i32;
    pub fn PdhUpdateLogFileCatalog(hlog: isize) -> i32;
    pub fn PdhUpdateLogW(hlog: isize, szuserstring: ::windows_sys_core::PCWSTR) -> i32;
    pub fn PdhValidatePathA(szfullpathbuffer: ::windows_sys_core::PCSTR) -> i32;
    pub fn PdhValidatePathExA(hdatasource: isize, szfullpathbuffer: ::windows_sys_core::PCSTR) -> i32;
    pub fn PdhValidatePathExW(hdatasource: isize, szfullpathbuffer: ::windows_sys_core::PCWSTR) -> i32;
    pub fn PdhValidatePathW(szfullpathbuffer: ::windows_sys_core::PCWSTR) -> i32;
    pub fn PdhVerifySQLDBA(szdatasource: ::windows_sys_core::PCSTR) -> i32;
    pub fn PdhVerifySQLDBW(szdatasource: ::windows_sys_core::PCWSTR) -> i32;
    ...
    pub fn PerfCreateInstance(providerhandle: PerfProviderHandle, countersetguid: *const ::windows_sys_core::GUID, name: ::windows_sys_core::PCWSTR, id: u32) -> *mut PERF_COUNTERSET_INSTANCE;
    #[cfg(feature = "Win32_Foundation")]
    ...
    pub fn PerfEnumerateCounterSet(szmachine: ::windows_sys_core::PCWSTR, pcountersetids: *mut ::windows_sys_core::GUID, ccountersetids: u32, pccountersetidsactual: *mut u32) -> u32;
    pub fn PerfEnumerateCounterSetInstances(szmachine: ::windows_sys_core::PCWSTR, pcountersetid: *const ::windows_sys_core::GUID, pinstances: *mut PERF_INSTANCE_HEADER, cbinstances: u32, pcbinstancesactual: *mut u32) -> u32;
    #[cfg(feature = "Win32_Foundation")]
    ...
    pub fn PerfOpenQueryHandle(szmachine: ::windows_sys_core::PCWSTR, phquery: *mut PerfQueryHandle) -> u32;
    #[cfg(feature = "Win32_Foundation")]
    ...
    pub fn PerfQueryCounterSetRegistrationInfo(szmachine: ::windows_sys_core::PCWSTR, pcountersetid: *const ::windows_sys_core::GUID, requestcode: PerfRegInfoType, requestlangid: u32, pbreginfo: *mut u8, cbreginfo: u32, pcbreginfoactual: *mut u32) -> u32;
    #[cfg(feature = "Win32_Foundation")]
    pub fn PerfQueryInstance(providerhandle: super::super::Foundation::HANDLE, countersetguid: *const ::windows_sys_core::GUID, name: ::windows_sys_core::PCWSTR, id: u32) -> *mut PERF_COUNTERSET_INSTANCE;
    #[cfg(feature = "Win32_Foundation")]
    ...
    pub fn PerfStartProvider(providerguid: *const ::windows_sys_core::GUID, controlcallback: PERFLIBREQUEST, phprovider: *mut PerfProviderHandle) -> u32;
    pub fn PerfStartProviderEx(providerguid: *const ::windows_sys_core::GUID, providercontext: *const PERF_PROVIDER_CONTEXT, provider: *mut PerfProviderHandle) -> u32;
    ...
    pub fn RestorePerfRegistryFromFileW(szfilename: ::windows_sys_core::PCWSTR, szlangid: ::windows_sys_core::PCWSTR) -> u32;
    pub fn SetServiceAsTrustedA(szreserved: ::windows_sys_core::PCSTR, szservicename: ::windows_sys_core::PCSTR) -> u32;
    pub fn SetServiceAsTrustedW(szreserved: ::windows_sys_core::PCWSTR, szservicename: ::windows_sys_core::PCWSTR) -> u32;
    #[cfg(feature = "Win32_Foundation")]
    pub fn UnloadPerfCounterTextStringsA(lpcommandline: ::windows_sys_core::PCSTR, bquietmodearg: super::super::Foundation::BOOL) -> u32;
    #[cfg(feature = "Win32_Foundation")]
    pub fn UnloadPerfCounterTextStringsW(lpcommandline: ::windows_sys_core::PCWSTR, bquietmodearg: super::super::Foundation::BOOL) -> u32;
    pub fn UpdatePerfNameFilesA(sznewctrfilepath: ::windows_sys_core::PCSTR, sznewhlpfilepath: ::windows_sys_core::PCSTR, szlanguageid: ::windows_sys_core::PCSTR, dwflags: usize) -> u32;
    pub fn UpdatePerfNameFilesW(sznewctrfilepath: ::windows_sys_core::PCWSTR, sznewhlpfilepath: ::windows_sys_core::PCWSTR, szlanguageid: ::windows_sys_core::PCWSTR, dwflags: usize) -> u32;
}
pub const AppearPropPage: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3835118057, data2: 37800, data3: 19121, data4: [142, 150, 191, 68, 130, 40, 46, 156] };
...
pub const BootTraceSession: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 58946872, data2: 2443, data3: 4568, data4: [148, 20, 80, 80, 84, 80, 48, 48] };
pub const BootTraceSessionCollection: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 58946873, data2: 2443, data3: 4568, data4: [148, 20, 80, 80, 84, 80, 48, 48] };
...
pub const CounterItem: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3302152416, data2: 53725, data3: 4558, data4: [148, 15, 0, 128, 41, 0, 67, 72] };
pub const CounterItem2: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 1125739618, data2: 49951, data3: 19683, data4: [160, 46, 121, 239, 224, 246, 165, 37] };
pub type CounterPathCallBack = ::core::option::Option<unsafe extern "system" fn(param0: usize) -> i32>;
pub const CounterPropPage: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3482617185, data2: 60904, data3: 4558, data4: [148, 30, 0, 128, 41, 0, 67, 71] };
pub const Counters: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 2997905106, data2: 10924, data3: 4559, data4: [148, 47, 0, 128, 41, 0, 67, 71] };
pub type DICounterItem = *mut ::core::ffi::c_void;
pub const DIID_DICounterItem: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3230420978, data2: 3630, data3: 4559, data4: [148, 44, 0, 128, 41, 0, 67, 71] };
pub const DIID_DILogFileItem: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 2366193660, data2: 63351, data3: 18711, data4: [130, 209, 131, 63, 188, 84, 197, 143] };
pub const DIID_DISystemMonitor: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 332873089, data2: 49966, data3: 4559, data4: [147, 152, 0, 170, 0, 163, 221, 234] };
pub const DIID_DISystemMonitorEvents: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 2224527664, data2: 19123, data3: 4559, data4: [148, 58, 0, 128, 41, 0, 67, 71] };
pub const DIID_DISystemMonitorInternal: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 424587842, data2: 49964, data3: 4559, data4: [147, 152, 0, 170, 0, 163, 221, 234] };
...
pub const DataCollectorSet: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 58946849, data2: 2443, data3: 4568, data4: [148, 20, 80, 80, 84, 80, 48, 48] };
pub const DataCollectorSetCollection: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 58946853, data2: 2443, data3: 4568, data4: [148, 20, 80, 80, 84, 80, 48, 48] };
...
pub const GeneralPropPage: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3286619090, data2: 6659, data3: 4559, data4: [148, 45, 0, 128, 41, 0, 67, 71] };
pub const GraphPropPage: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3286619091, data2: 6659, data3: 4559, data4: [148, 45, 0, 128, 41, 0, 67, 71] };
...
pub const LIBID_SystemMonitor: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 460799554, data2: 9481, data3: 4559, data4: [148, 47, 0, 128, 41, 0, 67, 71] };
pub const LegacyDataCollectorSet: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 58946854, data2: 2443, data3: 4568, data4: [148, 20, 80, 80, 84, 80, 48, 48] };
pub const LegacyDataCollectorSetCollection: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 58946855, data2: 2443, data3: 4568, data4: [148, 20, 80, 80, 84, 80, 48, 48] };
pub const LegacyTraceSession: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 58946856, data2: 2443, data3: 4568, data4: [148, 20, 80, 80, 84, 80, 48, 48] };
pub const LegacyTraceSessionCollection: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 58946857, data2: 2443, data3: 4568, data4: [148, 20, 80, 80, 84, 80, 48, 48] };
pub const LogFileItem: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 384588776, data2: 57235, data3: 16951, data4: [148, 228, 158, 233, 24, 17, 29, 113] };
pub const LogFiles: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 657840637, data2: 63161, data3: 20249, data4: [165, 217, 226, 208, 104, 88, 75, 197] };
...
pub struct PDH_BROWSE_DLG_CONFIG_A {
    ...
    pub szDataSource: ::windows_sys_core::PSTR,
    pub szReturnPathBuffer: ::windows_sys_core::PSTR,
    ...
    pub szDialogBoxCaption: ::windows_sys_core::PSTR,
}
#[cfg(feature = "Win32_Foundation")]
...
pub struct PDH_BROWSE_DLG_CONFIG_HW {
    ...
    pub hWndOwner: super::super::Foundation::HWND,
    pub hDataSource: isize,
    pub szReturnPathBuffer: ::windows_sys_core::PWSTR,
    pub cchReturnPathLength: u32,
    pub pCallBack: CounterPathCallBack,
    pub dwCallBackArg: usize,
    pub CallBackStatus: i32,
    pub dwDefaultDetailLevel: PERF_DETAIL,
    pub szDialogBoxCaption: ::windows_sys_core::PWSTR,
}
#[cfg(feature = "Win32_Foundation")]
...
pub struct PDH_BROWSE_DLG_CONFIG_W {
    pub _bitfield: u32,
    pub hWndOwner: super::super::Foundation::HWND,
    pub szDataSource: ::windows_sys_core::PWSTR,
    pub szReturnPathBuffer: ::windows_sys_core::PWSTR,
    pub cchReturnPathLength: u32,
    pub pCallBack: CounterPathCallBack,
    pub dwCallBackArg: usize,
...
pub struct PDH_COUNTER_INFO_A {
    ...
    pub szFullPath: ::windows_sys_core::PSTR,
    pub Anonymous: PDH_COUNTER_INFO_A_0,
    pub szExplainText: ::windows_sys_core::PSTR,
...
pub struct PDH_COUNTER_INFO_A_0_0 {
    pub szMachineName: ::windows_sys_core::PSTR,
    pub szObjectName: ::windows_sys_core::PSTR,
    pub szInstanceName: ::windows_sys_core::PSTR,
    pub szParentInstance: ::windows_sys_core::PSTR,
    pub dwInstanceIndex: u32,
    pub szCounterName: ::windows_sys_core::PSTR,
}
...
pub struct PDH_COUNTER_INFO_W {
    ...
    pub dwUserData: usize,
    pub dwQueryUserData: usize,
    pub szFullPath: ::windows_sys_core::PWSTR,
    pub Anonymous: PDH_COUNTER_INFO_W_0,
    pub szExplainText: ::windows_sys_core::PWSTR,
    pub DataBuffer: [u32; 1],
}
...
pub struct PDH_COUNTER_INFO_W_0_0 {
    pub szMachineName: ::windows_sys_core::PWSTR,
    pub szObjectName: ::windows_sys_core::PWSTR,
    pub szInstanceName: ::windows_sys_core::PWSTR,
    pub szParentInstance: ::windows_sys_core::PWSTR,
    pub dwInstanceIndex: u32,
    pub szCounterName: ::windows_sys_core::PWSTR,
}
...
pub union PDH_FMT_COUNTERVALUE_0 {
    ...
    pub WideStringValue: ::windows_sys_core::PCWSTR,
}
...
pub struct PDH_FMT_COUNTERVALUE_ITEM_A {
    pub szName: ::windows_sys_core::PSTR,
...
pub struct PDH_LOG_SERVICE_QUERY_INFO_A {
    ...
    pub dwFlags: u32,
    pub dwLogQuota: u32,
    pub szLogFileCaption: ::windows_sys_core::PSTR,
    pub szDefaultDir: ::windows_sys_core::PSTR,
    pub szBaseFileName: ::windows_sys_core::PSTR,
    pub dwFileType: u32,
    pub dwReserved: u32,
...
pub struct PDH_LOG_SERVICE_QUERY_INFO_A_0_0 {
    ...
    pub PdlCommandFilename: ::windows_sys_core::PSTR,
    pub PdlCounterList: ::windows_sys_core::PSTR,
...
pub struct PDH_LOG_SERVICE_QUERY_INFO_A_0_1 {
    ...
    pub TlLogHandle: u32,
    pub TlLogFileName: ::windows_sys_core::PSTR,
}
#[cfg(feature = "Win32_Foundation")]
...
pub struct PDH_LOG_SERVICE_QUERY_INFO_W {
    ...
    pub dwFlags: u32,
    pub dwLogQuota: u32,
    pub szLogFileCaption: ::windows_sys_core::PWSTR,
    pub szDefaultDir: ::windows_sys_core::PWSTR,
    pub szBaseFileName: ::windows_sys_core::PWSTR,
    pub dwFileType: u32,
    pub dwReserved: u32,
...
pub struct PDH_LOG_SERVICE_QUERY_INFO_W_0_0 {
    pub PdlAutoNameInterval: u32,
    pub PdlAutoNameUnits: u32,
    pub PdlCommandFilename: ::windows_sys_core::PWSTR,
    pub PdlCounterList: ::windows_sys_core::PWSTR,
    pub PdlAutoNameFormat: u32,
    pub PdlSampleInterval: u32,
    pub PdlLogStartTime: super::super::Foundation::FILETIME,
    pub PdlLogEndTime: super::super::Foundation::FILETIME,
...
pub struct PDH_LOG_SERVICE_QUERY_INFO_W_0_1 {
    ...
    pub TlBuffersWritten: u32,
    pub TlLogHandle: u32,
    pub TlLogFileName: ::windows_sys_core::PWSTR,
}
#[cfg(feature = "Win32_Foundation")]
...
pub struct PERF_COUNTERSET_INFO {
    pub CounterSetGuid: ::windows_sys_core::GUID,
...
pub struct PERF_COUNTER_DEFINITION {
    pub ByteLength: u32,
    pub CounterNameTitleIndex: u32,
    pub CounterNameTitle: ::windows_sys_core::PWSTR,
    pub CounterHelpTitleIndex: u32,
    pub CounterHelpTitle: ::windows_sys_core::PWSTR,
    pub DefaultScale: i32,
    pub DetailLevel: u32,
    pub CounterType: u32,
    pub CounterSize: u32,
...
pub struct PERF_OBJECT_TYPE {
    ...
    pub HeaderLength: u32,
    pub ObjectNameTitleIndex: u32,
    pub ObjectNameTitle: ::windows_sys_core::PWSTR,
    pub ObjectHelpTitleIndex: u32,
    pub ObjectHelpTitle: ::windows_sys_core::PWSTR,
    pub DetailLevel: u32,
    pub NumCounters: u32,
    pub DefaultCounter: i32,
    pub NumInstances: i32,
...
pub type PLA_CABEXTRACT_CALLBACK = ::core::option::Option<unsafe extern "system" fn(filename: ::windows_sys_core::PCWSTR, context: *mut ::core::ffi::c_void)>;
...
pub type PM_COLLECT_PROC = ::core::option::Option<unsafe extern "system" fn(pvaluename: ::windows_sys_core::PCWSTR, ppdata: *mut *mut ::core::ffi::c_void, pcbtotalbytes: *mut u32, pnumobjecttypes: *mut u32) -> u32>;
pub type PM_OPEN_PROC = ::core::option::Option<unsafe extern "system" fn(pcontext: ::windows_sys_core::PCWSTR) -> u32>;
...
pub const S_PDH: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 81159000, data2: 50337, data3: 16795, data4: [128, 35, 35, 183, 57, 2, 222, 44] };
pub const ServerDataCollectorSet: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 58946865, data2: 2443, data3: 4568, data4: [148, 20, 80, 80, 84, 80, 48, 48] };
pub const ServerDataCollectorSetCollection: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 58946866, data2: 2443, data3: 4568, data4: [148, 20, 80, 80, 84, 80, 48, 48] };
pub const SourcePropPage: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 217262753, data2: 30065, data3: 4560, data4: [147, 196, 0, 170, 0, 163, 221, 234] };
...
pub const SystemDataCollectorSet: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 58946886, data2: 2443, data3: 4568, data4: [148, 20, 80, 80, 84, 80, 48, 48] };
pub const SystemDataCollectorSetCollection: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 58946887, data2: 2443, data3: 4568, data4: [148, 20, 80, 80, 84, 80, 48, 48] };
pub const SystemMonitor: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3302152416, data2: 53725, data3: 4558, data4: [148, 15, 0, 128, 41, 0, 67, 71] };
pub const SystemMonitor2: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 2133874572, data2: 24376, data3: 17938, data4: [172, 254, 110, 208, 76, 123, 122, 248] };
pub const TraceDataProvider: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 58946835, data2: 2443, data3: 4568, data4: [148, 20, 80, 80, 84, 80, 48, 48] };
pub const TraceDataProviderCollection: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 58946833, data2: 2443, data3: 4568, data4: [148, 20, 80, 80, 84, 80, 48, 48] };
pub const TraceSession: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 58946844, data2: 2443, data3: 4568, data4: [148, 20, 80, 80, 84, 80, 48, 48] };
pub const TraceSessionCollection: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 58946864, data2: 2443, data3: 4568, data4: [148, 20, 80, 80, 84, 80, 48, 48] };
