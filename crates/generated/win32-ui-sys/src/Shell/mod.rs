#[cfg(feature = "Common")]
pub mod Common;
#[cfg(feature = "PropertiesSystem")]
pub mod PropertiesSystem;
#[link(name = "windows")]
extern "system" {
    pub fn AssocCreate(clsid: ::windows_core_sys::GUID, riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn AssocCreateForClasses(rgclasses: *const ASSOCIATIONELEMENT, cclasses: u32, riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    #[cfg(all(feature = "win32-system-sys", feature = "win32-system-sys", feature = "win32-ui-sys", feature = "win32-ui-sys"))]
    pub fn AssocGetDetailsOfPropKey(psf: IShellFolder, pidl: *const Common::ITEMIDLIST, pkey: *const PropertiesSystem::PROPERTYKEY, pv: *mut ::win32_system_sys::Com::VARIANT, pffoundpropkey: *mut ::win32_foundation_sys::BOOL) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn AssocGetPerceivedType(pszext: ::windows_core_sys::PCWSTR, ptype: *mut Common::PERCEIVED, pflag: *mut u32, ppsztype: *mut ::windows_core_sys::PWSTR) -> ::windows_core_sys::HRESULT;
    pub fn AssocIsDangerous(pszassoc: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-system-sys")]
    pub fn AssocQueryKeyA(flags: u32, key: ASSOCKEY, pszassoc: ::windows_core_sys::PCSTR, pszextra: ::windows_core_sys::PCSTR, phkeyout: *mut ::win32_system_sys::Registry::HKEY) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn AssocQueryKeyW(flags: u32, key: ASSOCKEY, pszassoc: ::windows_core_sys::PCWSTR, pszextra: ::windows_core_sys::PCWSTR, phkeyout: *mut ::win32_system_sys::Registry::HKEY) -> ::windows_core_sys::HRESULT;
    pub fn AssocQueryStringA(flags: u32, str: ASSOCSTR, pszassoc: ::windows_core_sys::PCSTR, pszextra: ::windows_core_sys::PCSTR, pszout: ::windows_core_sys::PSTR, pcchout: *mut u32) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn AssocQueryStringByKeyA(flags: u32, str: ASSOCSTR, hkassoc: ::win32_system_sys::Registry::HKEY, pszextra: ::windows_core_sys::PCSTR, pszout: ::windows_core_sys::PSTR, pcchout: *mut u32) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn AssocQueryStringByKeyW(flags: u32, str: ASSOCSTR, hkassoc: ::win32_system_sys::Registry::HKEY, pszextra: ::windows_core_sys::PCWSTR, pszout: ::windows_core_sys::PWSTR, pcchout: *mut u32) -> ::windows_core_sys::HRESULT;
    pub fn AssocQueryStringW(flags: u32, str: ASSOCSTR, pszassoc: ::windows_core_sys::PCWSTR, pszextra: ::windows_core_sys::PCWSTR, pszout: ::windows_core_sys::PWSTR, pcchout: *mut u32) -> ::windows_core_sys::HRESULT;
    #[cfg(all(feature = "win32-system-sys", feature = "win32-system-sys", feature = "win32-ui-sys"))]
    pub fn CDefFolderMenu_Create2(pidlfolder: *const Common::ITEMIDLIST, hwnd: ::win32_foundation_sys::HWND, cidl: u32, apidl: *const *const Common::ITEMIDLIST, psf: IShellFolder, pfn: LPFNDFMCALLBACK, nkeys: u32, ahkeys: *const ::win32_system_sys::Registry::HKEY, ppcm: *mut IContextMenu) -> ::windows_core_sys::HRESULT;
    #[cfg(all(feature = "win32-system-sys", feature = "win32-ui-sys"))]
    pub fn CIDLData_CreateFromIDArray(pidlfolder: *const Common::ITEMIDLIST, cidl: u32, apidl: *const *const Common::ITEMIDLIST, ppdtobj: *mut ::win32_system_sys::Com::IDataObject) -> ::windows_core_sys::HRESULT;
    pub fn ChrCmpIA(w1: u16, w2: u16) -> ::win32_foundation_sys::BOOL;
    pub fn ChrCmpIW(w1: u16, w2: u16) -> ::win32_foundation_sys::BOOL;
    pub fn ColorAdjustLuma(clrrgb: u32, n: i32, fscale: ::win32_foundation_sys::BOOL) -> u32;
    ...
    pub fn CommandLineToArgvW(lpcmdline: ::windows_core_sys::PCWSTR, pnumargs: *mut i32) -> *mut ::windows_core_sys::PWSTR;
    #[cfg(feature = "win32-system-sys")]
    pub fn ConnectToConnectionPoint(punk: ::windows_core_sys::IUnknown, riidevent: *const ::windows_core_sys::GUID, fconnect: ::win32_foundation_sys::BOOL, punktarget: ::windows_core_sys::IUnknown, pdwcookie: *mut u32, ppcpout: *mut ::win32_system_sys::Com::IConnectionPoint) -> ::windows_core_sys::HRESULT;
    pub fn CreateProfile(pszusersid: ::windows_core_sys::PCWSTR, pszusername: ::windows_core_sys::PCWSTR, pszprofilepath: ::windows_core_sys::PWSTR, cchprofilepath: u32) -> ::windows_core_sys::HRESULT;
    pub fn DAD_AutoScroll(hwnd: ::win32_foundation_sys::HWND, pad: *mut AUTO_SCROLL_DATA, pptnow: *const ::win32_foundation_sys::POINT) -> ::win32_foundation_sys::BOOL;
    pub fn DAD_DragEnterEx(hwndtarget: ::win32_foundation_sys::HWND, ptstart: ::win32_foundation_sys::POINT) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-system-sys")]
    pub fn DAD_DragEnterEx2(hwndtarget: ::win32_foundation_sys::HWND, ptstart: ::win32_foundation_sys::POINT, pdtobject: ::win32_system_sys::Com::IDataObject) -> ::win32_foundation_sys::BOOL;
    pub fn DAD_DragLeave() -> ::win32_foundation_sys::BOOL;
    pub fn DAD_DragMove(pt: ::win32_foundation_sys::POINT) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-ui-sys")]
    pub fn DAD_SetDragImage(him: super::Controls::HIMAGELIST, pptoffset: *mut ::win32_foundation_sys::POINT) -> ::win32_foundation_sys::BOOL;
    pub fn DAD_ShowDragImage(fshow: ::win32_foundation_sys::BOOL) -> ::win32_foundation_sys::BOOL;
    pub fn DefSubclassProc(hwnd: ::win32_foundation_sys::HWND, umsg: u32, wparam: ::win32_foundation_sys::WPARAM, lparam: ::win32_foundation_sys::LPARAM) -> ::win32_foundation_sys::LRESULT;
    pub fn DeleteProfileA(lpsidstring: ::windows_core_sys::PCSTR, lpprofilepath: ::windows_core_sys::PCSTR, lpcomputername: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn DeleteProfileW(lpsidstring: ::windows_core_sys::PCWSTR, lpprofilepath: ::windows_core_sys::PCWSTR, lpcomputername: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn DoEnvironmentSubstA(pszsrc: ::windows_core_sys::PSTR, cchsrc: u32) -> u32;
    pub fn DoEnvironmentSubstW(pszsrc: ::windows_core_sys::PWSTR, cchsrc: u32) -> u32;
    pub fn DragAcceptFiles(hwnd: ::win32_foundation_sys::HWND, faccept: ::win32_foundation_sys::BOOL);
    pub fn DragFinish(hdrop: HDROP);
    pub fn DragQueryFileA(hdrop: HDROP, ifile: u32, lpszfile: ::windows_core_sys::PSTR, cch: u32) -> u32;
    pub fn DragQueryFileW(hdrop: HDROP, ifile: u32, lpszfile: ::windows_core_sys::PWSTR, cch: u32) -> u32;
    pub fn DragQueryPoint(hdrop: HDROP, ppt: *mut ::win32_foundation_sys::POINT) -> ::win32_foundation_sys::BOOL;
    pub fn DriveType(idrive: i32) -> i32;
    #[cfg(feature = "win32-ui-sys")]
    pub fn DuplicateIcon(hinst: ::win32_foundation_sys::HINSTANCE, hicon: super::WindowsAndMessaging::HICON) -> super::WindowsAndMessaging::HICON;
    #[cfg(feature = "win32-ui-sys")]
    pub fn ExtractAssociatedIconA(hinst: ::win32_foundation_sys::HINSTANCE, psziconpath: ::windows_core_sys::PSTR, piicon: *mut u16) -> super::WindowsAndMessaging::HICON;
    #[cfg(feature = "win32-ui-sys")]
    pub fn ExtractAssociatedIconExA(hinst: ::win32_foundation_sys::HINSTANCE, psziconpath: ::windows_core_sys::PSTR, piiconindex: *mut u16, piiconid: *mut u16) -> super::WindowsAndMessaging::HICON;
    #[cfg(feature = "win32-ui-sys")]
    pub fn ExtractAssociatedIconExW(hinst: ::win32_foundation_sys::HINSTANCE, psziconpath: ::windows_core_sys::PWSTR, piiconindex: *mut u16, piiconid: *mut u16) -> super::WindowsAndMessaging::HICON;
    #[cfg(feature = "win32-ui-sys")]
    pub fn ExtractAssociatedIconW(hinst: ::win32_foundation_sys::HINSTANCE, psziconpath: ::windows_core_sys::PWSTR, piicon: *mut u16) -> super::WindowsAndMessaging::HICON;
    #[cfg(feature = "win32-ui-sys")]
    pub fn ExtractIconA(hinst: ::win32_foundation_sys::HINSTANCE, pszexefilename: ::windows_core_sys::PCSTR, niconindex: u32) -> super::WindowsAndMessaging::HICON;
    #[cfg(feature = "win32-ui-sys")]
    pub fn ExtractIconExA(lpszfile: ::windows_core_sys::PCSTR, niconindex: i32, phiconlarge: *mut super::WindowsAndMessaging::HICON, phiconsmall: *mut super::WindowsAndMessaging::HICON, nicons: u32) -> u32;
    #[cfg(feature = "win32-ui-sys")]
    pub fn ExtractIconExW(lpszfile: ::windows_core_sys::PCWSTR, niconindex: i32, phiconlarge: *mut super::WindowsAndMessaging::HICON, phiconsmall: *mut super::WindowsAndMessaging::HICON, nicons: u32) -> u32;
    #[cfg(feature = "win32-ui-sys")]
    pub fn ExtractIconW(hinst: ::win32_foundation_sys::HINSTANCE, pszexefilename: ::windows_core_sys::PCWSTR, niconindex: u32) -> super::WindowsAndMessaging::HICON;
    pub fn FindExecutableA(lpfile: ::windows_core_sys::PCSTR, lpdirectory: ::windows_core_sys::PCSTR, lpresult: ::windows_core_sys::PSTR) -> ::win32_foundation_sys::HINSTANCE;
    pub fn FindExecutableW(lpfile: ::windows_core_sys::PCWSTR, lpdirectory: ::windows_core_sys::PCWSTR, lpresult: ::windows_core_sys::PWSTR) -> ::win32_foundation_sys::HINSTANCE;
    pub fn GetAcceptLanguagesA(pszlanguages: ::windows_core_sys::PSTR, pcchlanguages: *mut u32) -> ::windows_core_sys::HRESULT;
    pub fn GetAcceptLanguagesW(pszlanguages: ::windows_core_sys::PWSTR, pcchlanguages: *mut u32) -> ::windows_core_sys::HRESULT;
    pub fn GetAllUsersProfileDirectoryA(lpprofiledir: ::windows_core_sys::PSTR, lpcchsize: *mut u32) -> ::win32_foundation_sys::BOOL;
    pub fn GetAllUsersProfileDirectoryW(lpprofiledir: ::windows_core_sys::PWSTR, lpcchsize: *mut u32) -> ::win32_foundation_sys::BOOL;
    pub fn GetCurrentProcessExplicitAppUserModelID(appid: *mut ::windows_core_sys::PWSTR) -> ::windows_core_sys::HRESULT;
    pub fn GetDefaultUserProfileDirectoryA(lpprofiledir: ::windows_core_sys::PSTR, lpcchsize: *mut u32) -> ::win32_foundation_sys::BOOL;
    pub fn GetDefaultUserProfileDirectoryW(lpprofiledir: ::windows_core_sys::PWSTR, lpcchsize: *mut u32) -> ::win32_foundation_sys::BOOL;
    pub fn GetDpiForShellUIComponent(param0: SHELL_UI_COMPONENT) -> u32;
    pub fn GetFileNameFromBrowse(hwnd: ::win32_foundation_sys::HWND, pszfilepath: ::windows_core_sys::PWSTR, cchfilepath: u32, pszworkingdir: ::windows_core_sys::PCWSTR, pszdefext: ::windows_core_sys::PCWSTR, pszfilters: ::windows_core_sys::PCWSTR, psztitle: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-ui-sys")]
    ...
    pub fn GetProfileType(dwflags: *mut u32) -> ::win32_foundation_sys::BOOL;
    pub fn GetProfilesDirectoryA(lpprofiledir: ::windows_core_sys::PSTR, lpcchsize: *mut u32) -> ::win32_foundation_sys::BOOL;
    pub fn GetProfilesDirectoryW(lpprofiledir: ::windows_core_sys::PWSTR, lpcchsize: *mut u32) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-ui-sys")]
    ...
    pub fn GetScaleFactorForMonitor(hmon: ::win32_graphics_sys::Gdi::HMONITOR, pscale: *mut Common::DEVICE_SCALE_FACTOR) -> ::windows_core_sys::HRESULT;
    pub fn GetUserProfileDirectoryA(htoken: ::win32_foundation_sys::HANDLE, lpprofiledir: ::windows_core_sys::PSTR, lpcchsize: *mut u32) -> ::win32_foundation_sys::BOOL;
    pub fn GetUserProfileDirectoryW(htoken: ::win32_foundation_sys::HANDLE, lpprofiledir: ::windows_core_sys::PWSTR, lpcchsize: *mut u32) -> ::win32_foundation_sys::BOOL;
    pub fn GetWindowContextHelpId(param0: ::win32_foundation_sys::HWND) -> u32;
    pub fn GetWindowSubclass(hwnd: ::win32_foundation_sys::HWND, pfnsubclass: SUBCLASSPROC, uidsubclass: usize, pdwrefdata: *mut usize) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-graphics-sys")]
    pub fn HMONITOR_UserFree(param0: *const u32, param1: *const ::win32_graphics_sys::Gdi::HMONITOR);
    #[cfg(feature = "win32-graphics-sys")]
    pub fn HMONITOR_UserFree64(param0: *const u32, param1: *const ::win32_graphics_sys::Gdi::HMONITOR);
    #[cfg(feature = "win32-graphics-sys")]
    pub fn HMONITOR_UserMarshal(param0: *const u32, param1: *mut u8, param2: *const ::win32_graphics_sys::Gdi::HMONITOR) -> *mut u8;
    #[cfg(feature = "win32-graphics-sys")]
    pub fn HMONITOR_UserMarshal64(param0: *const u32, param1: *mut u8, param2: *const ::win32_graphics_sys::Gdi::HMONITOR) -> *mut u8;
    #[cfg(feature = "win32-graphics-sys")]
    pub fn HMONITOR_UserSize(param0: *const u32, param1: u32, param2: *const ::win32_graphics_sys::Gdi::HMONITOR) -> u32;
    #[cfg(feature = "win32-graphics-sys")]
    pub fn HMONITOR_UserSize64(param0: *const u32, param1: u32, param2: *const ::win32_graphics_sys::Gdi::HMONITOR) -> u32;
    #[cfg(feature = "win32-graphics-sys")]
    pub fn HMONITOR_UserUnmarshal(param0: *const u32, param1: *const u8, param2: *mut ::win32_graphics_sys::Gdi::HMONITOR) -> *mut u8;
    #[cfg(feature = "win32-graphics-sys")]
    pub fn HMONITOR_UserUnmarshal64(param0: *const u32, param1: *const u8, param2: *mut ::win32_graphics_sys::Gdi::HMONITOR) -> *mut u8;
    pub fn HashData(pbdata: *const u8, cbdata: u32, pbhash: *mut u8, cbhash: u32) -> ::windows_core_sys::HRESULT;
    pub fn HlinkClone(pihl: IHlink, riid: *const ::windows_core_sys::GUID, pihlsiteforclone: IHlinkSite, dwsitedata: u32, ppvobj: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    pub fn HlinkCreateBrowseContext(piunkouter: ::windows_core_sys::IUnknown, riid: *const ::windows_core_sys::GUID, ppvobj: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    pub fn HlinkCreateExtensionServices(pwzadditionalheaders: ::windows_core_sys::PCWSTR, phwnd: ::win32_foundation_sys::HWND, pszusername: ::windows_core_sys::PCWSTR, pszpassword: ::windows_core_sys::PCWSTR, piunkouter: ::windows_core_sys::IUnknown, riid: *const ::windows_core_sys::GUID, ppvobj: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn HlinkCreateFromData(pidataobj: ::win32_system_sys::Com::IDataObject, pihlsite: IHlinkSite, dwsitedata: u32, piunkouter: ::windows_core_sys::IUnknown, riid: *const ::windows_core_sys::GUID, ppvobj: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn HlinkCreateFromMoniker(pimktrgt: ::win32_system_sys::Com::IMoniker, pwzlocation: ::windows_core_sys::PCWSTR, pwzfriendlyname: ::windows_core_sys::PCWSTR, pihlsite: IHlinkSite, dwsitedata: u32, piunkouter: ::windows_core_sys::IUnknown, riid: *const ::windows_core_sys::GUID, ppvobj: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    pub fn HlinkCreateFromString(pwztarget: ::windows_core_sys::PCWSTR, pwzlocation: ::windows_core_sys::PCWSTR, pwzfriendlyname: ::windows_core_sys::PCWSTR, pihlsite: IHlinkSite, dwsitedata: u32, piunkouter: ::windows_core_sys::IUnknown, riid: *const ::windows_core_sys::GUID, ppvobj: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    pub fn HlinkCreateShortcut(grfhlshortcutf: u32, pihl: IHlink, pwzdir: ::windows_core_sys::PCWSTR, pwzfilename: ::windows_core_sys::PCWSTR, ppwzshortcutfile: *mut ::windows_core_sys::PWSTR, dwreserved: u32) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn HlinkCreateShortcutFromMoniker(grfhlshortcutf: u32, pimktarget: ::win32_system_sys::Com::IMoniker, pwzlocation: ::windows_core_sys::PCWSTR, pwzdir: ::windows_core_sys::PCWSTR, pwzfilename: ::windows_core_sys::PCWSTR, ppwzshortcutfile: *mut ::windows_core_sys::PWSTR, dwreserved: u32) -> ::windows_core_sys::HRESULT;
    pub fn HlinkCreateShortcutFromString(grfhlshortcutf: u32, pwztarget: ::windows_core_sys::PCWSTR, pwzlocation: ::windows_core_sys::PCWSTR, pwzdir: ::windows_core_sys::PCWSTR, pwzfilename: ::windows_core_sys::PCWSTR, ppwzshortcutfile: *mut ::windows_core_sys::PWSTR, dwreserved: u32) -> ::windows_core_sys::HRESULT;
    pub fn HlinkGetSpecialReference(ureference: u32, ppwzreference: *mut ::windows_core_sys::PWSTR) -> ::windows_core_sys::HRESULT;
    pub fn HlinkGetValueFromParams(pwzparams: ::windows_core_sys::PCWSTR, pwzname: ::windows_core_sys::PCWSTR, ppwzvalue: *mut ::windows_core_sys::PWSTR) -> ::windows_core_sys::HRESULT;
    pub fn HlinkIsShortcut(pwzfilename: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn HlinkNavigate(pihl: IHlink, pihlframe: IHlinkFrame, grfhlnf: u32, pbc: ::win32_system_sys::Com::IBindCtx, pibsc: ::win32_system_sys::Com::IBindStatusCallback, pihlbc: IHlinkBrowseContext) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn HlinkNavigateToStringReference(pwztarget: ::windows_core_sys::PCWSTR, pwzlocation: ::windows_core_sys::PCWSTR, pihlsite: IHlinkSite, dwsitedata: u32, pihlframe: IHlinkFrame, grfhlnf: u32, pibc: ::win32_system_sys::Com::IBindCtx, pibsc: ::win32_system_sys::Com::IBindStatusCallback, pihlbc: IHlinkBrowseContext) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn HlinkOnNavigate(pihlframe: IHlinkFrame, pihlbc: IHlinkBrowseContext, grfhlnf: u32, pimktarget: ::win32_system_sys::Com::IMoniker, pwzlocation: ::windows_core_sys::PCWSTR, pwzfriendlyname: ::windows_core_sys::PCWSTR, puhlid: *mut u32) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn HlinkOnRenameDocument(dwreserved: u32, pihlbc: IHlinkBrowseContext, pimkold: ::win32_system_sys::Com::IMoniker, pimknew: ::win32_system_sys::Com::IMoniker) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn HlinkParseDisplayName(pibc: ::win32_system_sys::Com::IBindCtx, pwzdisplayname: ::windows_core_sys::PCWSTR, fnoforceabs: ::win32_foundation_sys::BOOL, pccheaten: *mut u32, ppimk: *mut ::win32_system_sys::Com::IMoniker) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn HlinkPreprocessMoniker(pibc: ::win32_system_sys::Com::IBindCtx, pimkin: ::win32_system_sys::Com::IMoniker, ppimkout: *mut ::win32_system_sys::Com::IMoniker) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn HlinkQueryCreateFromData(pidataobj: ::win32_system_sys::Com::IDataObject) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn HlinkResolveMonikerForData(pimkreference: ::win32_system_sys::Com::IMoniker, reserved: u32, pibc: ::win32_system_sys::Com::IBindCtx, cfmtetc: u32, rgfmtetc: *mut ::win32_system_sys::Com::FORMATETC, pibsc: ::win32_system_sys::Com::IBindStatusCallback, pimkbase: ::win32_system_sys::Com::IMoniker) -> ::windows_core_sys::HRESULT;
    pub fn HlinkResolveShortcut(pwzshortcutfilename: ::windows_core_sys::PCWSTR, pihlsite: IHlinkSite, dwsitedata: u32, piunkouter: ::windows_core_sys::IUnknown, riid: *const ::windows_core_sys::GUID, ppvobj: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn HlinkResolveShortcutToMoniker(pwzshortcutfilename: ::windows_core_sys::PCWSTR, ppimktarget: *mut ::win32_system_sys::Com::IMoniker, ppwzlocation: *mut ::windows_core_sys::PWSTR) -> ::windows_core_sys::HRESULT;
    pub fn HlinkResolveShortcutToString(pwzshortcutfilename: ::windows_core_sys::PCWSTR, ppwztarget: *mut ::windows_core_sys::PWSTR, ppwzlocation: *mut ::windows_core_sys::PWSTR) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn HlinkResolveStringForData(pwzreference: ::windows_core_sys::PCWSTR, reserved: u32, pibc: ::win32_system_sys::Com::IBindCtx, cfmtetc: u32, rgfmtetc: *mut ::win32_system_sys::Com::FORMATETC, pibsc: ::win32_system_sys::Com::IBindStatusCallback, pimkbase: ::win32_system_sys::Com::IMoniker) -> ::windows_core_sys::HRESULT;
    pub fn HlinkSetSpecialReference(ureference: u32, pwzreference: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::HRESULT;
    pub fn HlinkTranslateURL(pwzurl: ::windows_core_sys::PCWSTR, grfflags: u32, ppwztranslatedurl: *mut ::windows_core_sys::PWSTR) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn HlinkUpdateStackItem(pihlframe: IHlinkFrame, pihlbc: IHlinkBrowseContext, uhlid: u32, pimktrgt: ::win32_system_sys::Com::IMoniker, pwzlocation: ::windows_core_sys::PCWSTR, pwzfriendlyname: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn ILAppendID(pidl: *const Common::ITEMIDLIST, pmkid: *const Common::SHITEMID, fappend: ::win32_foundation_sys::BOOL) -> *mut Common::ITEMIDLIST;
    #[cfg(feature = "win32-ui-sys")]
    ...
    #[cfg(feature = "win32-ui-sys")]
    pub fn ILCreateFromPathA(pszpath: ::windows_core_sys::PCSTR) -> *mut Common::ITEMIDLIST;
    #[cfg(feature = "win32-ui-sys")]
    pub fn ILCreateFromPathW(pszpath: ::windows_core_sys::PCWSTR) -> *mut Common::ITEMIDLIST;
    #[cfg(feature = "win32-ui-sys")]
    ...
    #[cfg(feature = "win32-ui-sys")]
    pub fn ILIsEqual(pidl1: *const Common::ITEMIDLIST, pidl2: *const Common::ITEMIDLIST) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-ui-sys")]
    pub fn ILIsParent(pidl1: *const Common::ITEMIDLIST, pidl2: *const Common::ITEMIDLIST, fimmediate: ::win32_foundation_sys::BOOL) -> ::win32_foundation_sys::BOOL;
    #[cfg(all(feature = "win32-system-sys", feature = "win32-ui-sys"))]
    pub fn ILLoadFromStreamEx(pstm: ::win32_system_sys::Com::IStream, pidl: *mut *mut Common::ITEMIDLIST) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn ILRemoveLastID(pidl: *mut Common::ITEMIDLIST) -> ::win32_foundation_sys::BOOL;
    #[cfg(all(feature = "win32-system-sys", feature = "win32-ui-sys"))]
    pub fn ILSaveToStream(pstm: ::win32_system_sys::Com::IStream, pidl: *const Common::ITEMIDLIST) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn IStream_Copy(pstmfrom: ::win32_system_sys::Com::IStream, pstmto: ::win32_system_sys::Com::IStream, cb: u32) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn IStream_Read(pstm: ::win32_system_sys::Com::IStream, pv: *mut ::core::ffi::c_void, cb: u32) -> ::windows_core_sys::HRESULT;
    #[cfg(all(feature = "win32-system-sys", feature = "win32-ui-sys"))]
    pub fn IStream_ReadPidl(pstm: ::win32_system_sys::Com::IStream, ppidlout: *mut *mut Common::ITEMIDLIST) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn IStream_ReadStr(pstm: ::win32_system_sys::Com::IStream, ppsz: *mut ::windows_core_sys::PWSTR) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn IStream_Reset(pstm: ::win32_system_sys::Com::IStream) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn IStream_Size(pstm: ::win32_system_sys::Com::IStream, pui: *mut u64) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn IStream_Write(pstm: ::win32_system_sys::Com::IStream, pv: *const ::core::ffi::c_void, cb: u32) -> ::windows_core_sys::HRESULT;
    #[cfg(all(feature = "win32-system-sys", feature = "win32-ui-sys"))]
    pub fn IStream_WritePidl(pstm: ::win32_system_sys::Com::IStream, pidlwrite: *const Common::ITEMIDLIST) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn IStream_WriteStr(pstm: ::win32_system_sys::Com::IStream, psz: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::HRESULT;
    pub fn IUnknown_AtomicRelease(ppunk: *mut *mut ::core::ffi::c_void);
    pub fn IUnknown_GetSite(punk: ::windows_core_sys::IUnknown, riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    pub fn IUnknown_GetWindow(punk: ::windows_core_sys::IUnknown, phwnd: *mut ::win32_foundation_sys::HWND) -> ::windows_core_sys::HRESULT;
    pub fn IUnknown_QueryService(punk: ::windows_core_sys::IUnknown, guidservice: *const ::windows_core_sys::GUID, riid: *const ::windows_core_sys::GUID, ppvout: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    pub fn IUnknown_Set(ppunk: *mut ::windows_core_sys::IUnknown, punk: ::windows_core_sys::IUnknown);
    pub fn IUnknown_SetSite(punk: ::windows_core_sys::IUnknown, punksite: ::windows_core_sys::IUnknown) -> ::windows_core_sys::HRESULT;
    pub fn ImportPrivacySettings(pszfilename: ::windows_core_sys::PCWSTR, pfparseprivacypreferences: *mut ::win32_foundation_sys::BOOL, pfparsepersiterules: *mut ::win32_foundation_sys::BOOL) -> ::win32_foundation_sys::BOOL;
    pub fn InitNetworkAddressControl() -> ::win32_foundation_sys::BOOL;
    pub fn IntlStrEqWorkerA(fcasesens: ::win32_foundation_sys::BOOL, lpstring1: ::windows_core_sys::PCSTR, lpstring2: ::windows_core_sys::PCSTR, nchar: i32) -> ::win32_foundation_sys::BOOL;
    pub fn IntlStrEqWorkerW(fcasesens: ::win32_foundation_sys::BOOL, lpstring1: ::windows_core_sys::PCWSTR, lpstring2: ::windows_core_sys::PCWSTR, nchar: i32) -> ::win32_foundation_sys::BOOL;
    pub fn IsCharSpaceA(wch: ::win32_foundation_sys::CHAR) -> ::win32_foundation_sys::BOOL;
    pub fn IsCharSpaceW(wch: u16) -> ::win32_foundation_sys::BOOL;
    pub fn IsInternetESCEnabled() -> ::win32_foundation_sys::BOOL;
    pub fn IsLFNDriveA(pszpath: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn IsLFNDriveW(pszpath: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn IsNetDrive(idrive: i32) -> i32;
    pub fn IsOS(dwos: OS) -> ::win32_foundation_sys::BOOL;
    pub fn IsUserAnAdmin() -> ::win32_foundation_sys::BOOL;
    pub fn LoadUserProfileA(htoken: ::win32_foundation_sys::HANDLE, lpprofileinfo: *mut PROFILEINFOA) -> ::win32_foundation_sys::BOOL;
    pub fn LoadUserProfileW(htoken: ::win32_foundation_sys::HANDLE, lpprofileinfo: *mut PROFILEINFOW) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-system-sys")]
    pub fn OleSaveToStreamEx(piunk: ::windows_core_sys::IUnknown, pistm: ::win32_system_sys::Com::IStream, fcleardirty: ::win32_foundation_sys::BOOL) -> ::windows_core_sys::HRESULT;
    #[cfg(all(feature = "win32-system-sys", feature = "win32-system-sys"))]
    pub fn OpenRegStream(hkey: ::win32_system_sys::Registry::HKEY, pszsubkey: ::windows_core_sys::PCWSTR, pszvalue: ::windows_core_sys::PCWSTR, grfmode: u32) -> ::win32_system_sys::Com::IStream;
    pub fn ParseURLA(pcszurl: ::windows_core_sys::PCSTR, ppu: *mut PARSEDURLA) -> ::windows_core_sys::HRESULT;
    pub fn ParseURLW(pcszurl: ::windows_core_sys::PCWSTR, ppu: *mut PARSEDURLW) -> ::windows_core_sys::HRESULT;
    pub fn PathAddBackslashA(pszpath: ::windows_core_sys::PSTR) -> ::windows_core_sys::PSTR;
    pub fn PathAddBackslashW(pszpath: ::windows_core_sys::PWSTR) -> ::windows_core_sys::PWSTR;
    pub fn PathAddExtensionA(pszpath: ::windows_core_sys::PSTR, pszext: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathAddExtensionW(pszpath: ::windows_core_sys::PWSTR, pszext: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathAllocCanonicalize(pszpathin: ::windows_core_sys::PCWSTR, dwflags: u32, ppszpathout: *mut ::windows_core_sys::PWSTR) -> ::windows_core_sys::HRESULT;
    pub fn PathAllocCombine(pszpathin: ::windows_core_sys::PCWSTR, pszmore: ::windows_core_sys::PCWSTR, dwflags: u32, ppszpathout: *mut ::windows_core_sys::PWSTR) -> ::windows_core_sys::HRESULT;
    pub fn PathAppendA(pszpath: ::windows_core_sys::PSTR, pszmore: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathAppendW(pszpath: ::windows_core_sys::PWSTR, pszmore: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathBuildRootA(pszroot: ::windows_core_sys::PSTR, idrive: i32) -> ::windows_core_sys::PSTR;
    pub fn PathBuildRootW(pszroot: ::windows_core_sys::PWSTR, idrive: i32) -> ::windows_core_sys::PWSTR;
    pub fn PathCanonicalizeA(pszbuf: ::windows_core_sys::PSTR, pszpath: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathCanonicalizeW(pszbuf: ::windows_core_sys::PWSTR, pszpath: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathCchAddBackslash(pszpath: ::windows_core_sys::PWSTR, cchpath: usize) -> ::windows_core_sys::HRESULT;
    pub fn PathCchAddBackslashEx(pszpath: ::windows_core_sys::PWSTR, cchpath: usize, ppszend: *mut ::windows_core_sys::PWSTR, pcchremaining: *mut usize) -> ::windows_core_sys::HRESULT;
    pub fn PathCchAddExtension(pszpath: ::windows_core_sys::PWSTR, cchpath: usize, pszext: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::HRESULT;
    pub fn PathCchAppend(pszpath: ::windows_core_sys::PWSTR, cchpath: usize, pszmore: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::HRESULT;
    pub fn PathCchAppendEx(pszpath: ::windows_core_sys::PWSTR, cchpath: usize, pszmore: ::windows_core_sys::PCWSTR, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn PathCchCanonicalize(pszpathout: ::windows_core_sys::PWSTR, cchpathout: usize, pszpathin: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::HRESULT;
    pub fn PathCchCanonicalizeEx(pszpathout: ::windows_core_sys::PWSTR, cchpathout: usize, pszpathin: ::windows_core_sys::PCWSTR, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn PathCchCombine(pszpathout: ::windows_core_sys::PWSTR, cchpathout: usize, pszpathin: ::windows_core_sys::PCWSTR, pszmore: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::HRESULT;
    pub fn PathCchCombineEx(pszpathout: ::windows_core_sys::PWSTR, cchpathout: usize, pszpathin: ::windows_core_sys::PCWSTR, pszmore: ::windows_core_sys::PCWSTR, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn PathCchFindExtension(pszpath: ::windows_core_sys::PCWSTR, cchpath: usize, ppszext: *mut ::windows_core_sys::PWSTR) -> ::windows_core_sys::HRESULT;
    pub fn PathCchIsRoot(pszpath: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathCchRemoveBackslash(pszpath: ::windows_core_sys::PWSTR, cchpath: usize) -> ::windows_core_sys::HRESULT;
    pub fn PathCchRemoveBackslashEx(pszpath: ::windows_core_sys::PWSTR, cchpath: usize, ppszend: *mut ::windows_core_sys::PWSTR, pcchremaining: *mut usize) -> ::windows_core_sys::HRESULT;
    pub fn PathCchRemoveExtension(pszpath: ::windows_core_sys::PWSTR, cchpath: usize) -> ::windows_core_sys::HRESULT;
    pub fn PathCchRemoveFileSpec(pszpath: ::windows_core_sys::PWSTR, cchpath: usize) -> ::windows_core_sys::HRESULT;
    pub fn PathCchRenameExtension(pszpath: ::windows_core_sys::PWSTR, cchpath: usize, pszext: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::HRESULT;
    pub fn PathCchSkipRoot(pszpath: ::windows_core_sys::PCWSTR, ppszrootend: *mut ::windows_core_sys::PWSTR) -> ::windows_core_sys::HRESULT;
    pub fn PathCchStripPrefix(pszpath: ::windows_core_sys::PWSTR, cchpath: usize) -> ::windows_core_sys::HRESULT;
    pub fn PathCchStripToRoot(pszpath: ::windows_core_sys::PWSTR, cchpath: usize) -> ::windows_core_sys::HRESULT;
    pub fn PathCleanupSpec(pszdir: ::windows_core_sys::PCWSTR, pszspec: ::windows_core_sys::PWSTR) -> PCS_RET;
    pub fn PathCombineA(pszdest: ::windows_core_sys::PSTR, pszdir: ::windows_core_sys::PCSTR, pszfile: ::windows_core_sys::PCSTR) -> ::windows_core_sys::PSTR;
    pub fn PathCombineW(pszdest: ::windows_core_sys::PWSTR, pszdir: ::windows_core_sys::PCWSTR, pszfile: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::PWSTR;
    pub fn PathCommonPrefixA(pszfile1: ::windows_core_sys::PCSTR, pszfile2: ::windows_core_sys::PCSTR, achpath: ::windows_core_sys::PSTR) -> i32;
    pub fn PathCommonPrefixW(pszfile1: ::windows_core_sys::PCWSTR, pszfile2: ::windows_core_sys::PCWSTR, achpath: ::windows_core_sys::PWSTR) -> i32;
    #[cfg(feature = "win32-graphics-sys")]
    pub fn PathCompactPathA(hdc: ::win32_graphics_sys::Gdi::HDC, pszpath: ::windows_core_sys::PSTR, dx: u32) -> ::win32_foundation_sys::BOOL;
    pub fn PathCompactPathExA(pszout: ::windows_core_sys::PSTR, pszsrc: ::windows_core_sys::PCSTR, cchmax: u32, dwflags: u32) -> ::win32_foundation_sys::BOOL;
    pub fn PathCompactPathExW(pszout: ::windows_core_sys::PWSTR, pszsrc: ::windows_core_sys::PCWSTR, cchmax: u32, dwflags: u32) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-graphics-sys")]
    pub fn PathCompactPathW(hdc: ::win32_graphics_sys::Gdi::HDC, pszpath: ::windows_core_sys::PWSTR, dx: u32) -> ::win32_foundation_sys::BOOL;
    pub fn PathCreateFromUrlA(pszurl: ::windows_core_sys::PCSTR, pszpath: ::windows_core_sys::PSTR, pcchpath: *mut u32, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn PathCreateFromUrlAlloc(pszin: ::windows_core_sys::PCWSTR, ppszout: *mut ::windows_core_sys::PWSTR, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn PathCreateFromUrlW(pszurl: ::windows_core_sys::PCWSTR, pszpath: ::windows_core_sys::PWSTR, pcchpath: *mut u32, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn PathFileExistsA(pszpath: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathFileExistsW(pszpath: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathFindExtensionA(pszpath: ::windows_core_sys::PCSTR) -> ::windows_core_sys::PSTR;
    pub fn PathFindExtensionW(pszpath: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::PWSTR;
    pub fn PathFindFileNameA(pszpath: ::windows_core_sys::PCSTR) -> ::windows_core_sys::PSTR;
    pub fn PathFindFileNameW(pszpath: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::PWSTR;
    pub fn PathFindNextComponentA(pszpath: ::windows_core_sys::PCSTR) -> ::windows_core_sys::PSTR;
    pub fn PathFindNextComponentW(pszpath: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::PWSTR;
    pub fn PathFindOnPathA(pszpath: ::windows_core_sys::PSTR, ppszotherdirs: *const *const i8) -> ::win32_foundation_sys::BOOL;
    pub fn PathFindOnPathW(pszpath: ::windows_core_sys::PWSTR, ppszotherdirs: *const *const u16) -> ::win32_foundation_sys::BOOL;
    pub fn PathFindSuffixArrayA(pszpath: ::windows_core_sys::PCSTR, apszsuffix: *const ::windows_core_sys::PSTR, iarraysize: i32) -> ::windows_core_sys::PSTR;
    pub fn PathFindSuffixArrayW(pszpath: ::windows_core_sys::PCWSTR, apszsuffix: *const ::windows_core_sys::PWSTR, iarraysize: i32) -> ::windows_core_sys::PWSTR;
    pub fn PathGetArgsA(pszpath: ::windows_core_sys::PCSTR) -> ::windows_core_sys::PSTR;
    pub fn PathGetArgsW(pszpath: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::PWSTR;
    pub fn PathGetCharTypeA(ch: u8) -> u32;
    pub fn PathGetCharTypeW(ch: u16) -> u32;
    pub fn PathGetDriveNumberA(pszpath: ::windows_core_sys::PCSTR) -> i32;
    pub fn PathGetDriveNumberW(pszpath: ::windows_core_sys::PCWSTR) -> i32;
    pub fn PathGetShortPath(pszlongpath: ::windows_core_sys::PWSTR);
    pub fn PathIsContentTypeA(pszpath: ::windows_core_sys::PCSTR, pszcontenttype: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsContentTypeW(pszpath: ::windows_core_sys::PCWSTR, pszcontenttype: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsDirectoryA(pszpath: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsDirectoryEmptyA(pszpath: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsDirectoryEmptyW(pszpath: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsDirectoryW(pszpath: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsExe(pszpath: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsFileSpecA(pszpath: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsFileSpecW(pszpath: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsLFNFileSpecA(pszname: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsLFNFileSpecW(pszname: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsNetworkPathA(pszpath: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsNetworkPathW(pszpath: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsPrefixA(pszprefix: ::windows_core_sys::PCSTR, pszpath: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsPrefixW(pszprefix: ::windows_core_sys::PCWSTR, pszpath: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsRelativeA(pszpath: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsRelativeW(pszpath: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsRootA(pszpath: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsRootW(pszpath: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsSameRootA(pszpath1: ::windows_core_sys::PCSTR, pszpath2: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsSameRootW(pszpath1: ::windows_core_sys::PCWSTR, pszpath2: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsSlowA(pszfile: ::windows_core_sys::PCSTR, dwattr: u32) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsSlowW(pszfile: ::windows_core_sys::PCWSTR, dwattr: u32) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsSystemFolderA(pszpath: ::windows_core_sys::PCSTR, dwattrb: u32) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsSystemFolderW(pszpath: ::windows_core_sys::PCWSTR, dwattrb: u32) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsUNCA(pszpath: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsUNCEx(pszpath: ::windows_core_sys::PCWSTR, ppszserver: *mut ::windows_core_sys::PWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsUNCServerA(pszpath: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsUNCServerShareA(pszpath: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsUNCServerShareW(pszpath: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsUNCServerW(pszpath: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsUNCW(pszpath: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsURLA(pszpath: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathIsURLW(pszpath: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathMakePrettyA(pszpath: ::windows_core_sys::PSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathMakePrettyW(pszpath: ::windows_core_sys::PWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathMakeSystemFolderA(pszpath: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathMakeSystemFolderW(pszpath: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathMakeUniqueName(pszuniquename: ::windows_core_sys::PWSTR, cchmax: u32, psztemplate: ::windows_core_sys::PCWSTR, pszlongplate: ::windows_core_sys::PCWSTR, pszdir: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathMatchSpecA(pszfile: ::windows_core_sys::PCSTR, pszspec: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathMatchSpecExA(pszfile: ::windows_core_sys::PCSTR, pszspec: ::windows_core_sys::PCSTR, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn PathMatchSpecExW(pszfile: ::windows_core_sys::PCWSTR, pszspec: ::windows_core_sys::PCWSTR, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn PathMatchSpecW(pszfile: ::windows_core_sys::PCWSTR, pszspec: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathParseIconLocationA(psziconfile: ::windows_core_sys::PSTR) -> i32;
    pub fn PathParseIconLocationW(psziconfile: ::windows_core_sys::PWSTR) -> i32;
    pub fn PathQualify(psz: ::windows_core_sys::PWSTR);
    pub fn PathQuoteSpacesA(lpsz: ::windows_core_sys::PSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathQuoteSpacesW(lpsz: ::windows_core_sys::PWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathRelativePathToA(pszpath: ::windows_core_sys::PSTR, pszfrom: ::windows_core_sys::PCSTR, dwattrfrom: u32, pszto: ::windows_core_sys::PCSTR, dwattrto: u32) -> ::win32_foundation_sys::BOOL;
    pub fn PathRelativePathToW(pszpath: ::windows_core_sys::PWSTR, pszfrom: ::windows_core_sys::PCWSTR, dwattrfrom: u32, pszto: ::windows_core_sys::PCWSTR, dwattrto: u32) -> ::win32_foundation_sys::BOOL;
    pub fn PathRemoveArgsA(pszpath: ::windows_core_sys::PSTR);
    pub fn PathRemoveArgsW(pszpath: ::windows_core_sys::PWSTR);
    pub fn PathRemoveBackslashA(pszpath: ::windows_core_sys::PSTR) -> ::windows_core_sys::PSTR;
    pub fn PathRemoveBackslashW(pszpath: ::windows_core_sys::PWSTR) -> ::windows_core_sys::PWSTR;
    pub fn PathRemoveBlanksA(pszpath: ::windows_core_sys::PSTR);
    pub fn PathRemoveBlanksW(pszpath: ::windows_core_sys::PWSTR);
    pub fn PathRemoveExtensionA(pszpath: ::windows_core_sys::PSTR);
    pub fn PathRemoveExtensionW(pszpath: ::windows_core_sys::PWSTR);
    pub fn PathRemoveFileSpecA(pszpath: ::windows_core_sys::PSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathRemoveFileSpecW(pszpath: ::windows_core_sys::PWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathRenameExtensionA(pszpath: ::windows_core_sys::PSTR, pszext: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathRenameExtensionW(pszpath: ::windows_core_sys::PWSTR, pszext: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathResolve(pszpath: ::windows_core_sys::PWSTR, dirs: *const *const u16, fflags: PRF_FLAGS) -> i32;
    pub fn PathSearchAndQualifyA(pszpath: ::windows_core_sys::PCSTR, pszbuf: ::windows_core_sys::PSTR, cchbuf: u32) -> ::win32_foundation_sys::BOOL;
    pub fn PathSearchAndQualifyW(pszpath: ::windows_core_sys::PCWSTR, pszbuf: ::windows_core_sys::PWSTR, cchbuf: u32) -> ::win32_foundation_sys::BOOL;
    pub fn PathSetDlgItemPathA(hdlg: ::win32_foundation_sys::HWND, id: i32, pszpath: ::windows_core_sys::PCSTR);
    pub fn PathSetDlgItemPathW(hdlg: ::win32_foundation_sys::HWND, id: i32, pszpath: ::windows_core_sys::PCWSTR);
    pub fn PathSkipRootA(pszpath: ::windows_core_sys::PCSTR) -> ::windows_core_sys::PSTR;
    pub fn PathSkipRootW(pszpath: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::PWSTR;
    pub fn PathStripPathA(pszpath: ::windows_core_sys::PSTR);
    pub fn PathStripPathW(pszpath: ::windows_core_sys::PWSTR);
    pub fn PathStripToRootA(pszpath: ::windows_core_sys::PSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathStripToRootW(pszpath: ::windows_core_sys::PWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathUnExpandEnvStringsA(pszpath: ::windows_core_sys::PCSTR, pszbuf: ::windows_core_sys::PSTR, cchbuf: u32) -> ::win32_foundation_sys::BOOL;
    pub fn PathUnExpandEnvStringsW(pszpath: ::windows_core_sys::PCWSTR, pszbuf: ::windows_core_sys::PWSTR, cchbuf: u32) -> ::win32_foundation_sys::BOOL;
    pub fn PathUndecorateA(pszpath: ::windows_core_sys::PSTR);
    pub fn PathUndecorateW(pszpath: ::windows_core_sys::PWSTR);
    pub fn PathUnmakeSystemFolderA(pszpath: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathUnmakeSystemFolderW(pszpath: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathUnquoteSpacesA(lpsz: ::windows_core_sys::PSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathUnquoteSpacesW(lpsz: ::windows_core_sys::PWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PathYetAnotherMakeUniqueName(pszuniquename: ::windows_core_sys::PWSTR, pszpath: ::windows_core_sys::PCWSTR, pszshort: ::windows_core_sys::PCWSTR, pszfilespec: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn PickIconDlg(hwnd: ::win32_foundation_sys::HWND, psziconpath: ::windows_core_sys::PWSTR, cchiconpath: u32, piiconindex: *mut i32) -> i32;
    pub fn QISearch(that: *mut ::core::ffi::c_void, pqit: *const QITAB, riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    pub fn ReadCabinetState(pcs: *mut CABINETSTATE, clength: i32) -> ::win32_foundation_sys::BOOL;
    pub fn RealDriveType(idrive: i32, foktohitnet: ::win32_foundation_sys::BOOL) -> i32;
    ...
    pub fn RegisterScaleChangeEvent(hevent: ::win32_foundation_sys::HANDLE, pdwcookie: *mut usize) -> ::windows_core_sys::HRESULT;
    pub fn RegisterScaleChangeNotifications(displaydevice: DISPLAY_DEVICE_TYPE, hwndnotify: ::win32_foundation_sys::HWND, umsgnotify: u32, pdwcookie: *mut u32) -> ::windows_core_sys::HRESULT;
    pub fn RemoveWindowSubclass(hwnd: ::win32_foundation_sys::HWND, pfnsubclass: SUBCLASSPROC, uidsubclass: usize) -> ::win32_foundation_sys::BOOL;
    pub fn RestartDialog(hwnd: ::win32_foundation_sys::HWND, pszprompt: ::windows_core_sys::PCWSTR, dwreturn: u32) -> i32;
    pub fn RestartDialogEx(hwnd: ::win32_foundation_sys::HWND, pszprompt: ::windows_core_sys::PCWSTR, dwreturn: u32, dwreasoncode: u32) -> i32;
    pub fn RevokeScaleChangeNotifications(displaydevice: DISPLAY_DEVICE_TYPE, dwcookie: u32) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHAddFromPropSheetExtArray(hpsxa: HPSXA, lpfnaddpage: super::Controls::LPFNSVADDPROPSHEETPAGE, lparam: ::win32_foundation_sys::LPARAM) -> u32;
    pub fn SHAddToRecentDocs(uflags: u32, pv: *const ::core::ffi::c_void);
    pub fn SHAlloc(cb: usize) -> *mut ::core::ffi::c_void;
    pub fn SHAllocShared(pvdata: *const ::core::ffi::c_void, dwsize: u32, dwprocessid: u32) -> ::win32_foundation_sys::HANDLE;
    pub fn SHAnsiToAnsi(pszsrc: ::windows_core_sys::PCSTR, pszdst: ::windows_core_sys::PSTR, cchbuf: i32) -> i32;
    pub fn SHAnsiToUnicode(pszsrc: ::windows_core_sys::PCSTR, pwszdst: ::windows_core_sys::PWSTR, cwchbuf: i32) -> i32;
    pub fn SHAppBarMessage(dwmessage: u32, pdata: *mut APPBARDATA) -> usize;
    pub fn SHAssocEnumHandlers(pszextra: ::windows_core_sys::PCWSTR, affilter: ASSOC_FILTER, ppenumhandler: *mut IEnumAssocHandlers) -> ::windows_core_sys::HRESULT;
    pub fn SHAssocEnumHandlersForProtocolByApplication(protocol: ::windows_core_sys::PCWSTR, riid: *const ::windows_core_sys::GUID, enumhandlers: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    pub fn SHAutoComplete(hwndedit: ::win32_foundation_sys::HWND, dwflags: u32) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHBindToFolderIDListParent(psfroot: IShellFolder, pidl: *const Common::ITEMIDLIST, riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void, ppidllast: *mut *mut Common::ITEMIDLIST) -> ::windows_core_sys::HRESULT;
    #[cfg(all(feature = "win32-system-sys", feature = "win32-ui-sys"))]
    pub fn SHBindToFolderIDListParentEx(psfroot: IShellFolder, pidl: *const Common::ITEMIDLIST, ppbc: ::win32_system_sys::Com::IBindCtx, riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void, ppidllast: *mut *mut Common::ITEMIDLIST) -> ::windows_core_sys::HRESULT;
    #[cfg(all(feature = "win32-system-sys", feature = "win32-ui-sys"))]
    pub fn SHBindToObject(psf: IShellFolder, pidl: *const Common::ITEMIDLIST, pbc: ::win32_system_sys::Com::IBindCtx, riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHBindToParent(pidl: *const Common::ITEMIDLIST, riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void, ppidllast: *mut *mut Common::ITEMIDLIST) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    ...
    pub fn SHCLSIDFromString(psz: ::windows_core_sys::PCWSTR, pclsid: *mut ::windows_core_sys::GUID) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHChangeNotification_Lock(hchange: ::win32_foundation_sys::HANDLE, dwprocid: u32, pppidl: *mut *mut *mut Common::ITEMIDLIST, plevent: *mut i32) -> ShFindChangeNotificationHandle;
    pub fn SHChangeNotification_Unlock(hlock: ::win32_foundation_sys::HANDLE) -> ::win32_foundation_sys::BOOL;
    pub fn SHChangeNotify(weventid: SHCNE_ID, uflags: SHCNF_FLAGS, dwitem1: *const ::core::ffi::c_void, dwitem2: *const ::core::ffi::c_void);
    pub fn SHChangeNotifyDeregister(ulid: u32) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHChangeNotifyRegister(hwnd: ::win32_foundation_sys::HWND, fsources: SHCNRF_SOURCE, fevents: i32, wmsg: u32, centries: i32, pshcne: *const SHChangeNotifyEntry) -> u32;
    pub fn SHChangeNotifyRegisterThread(status: SCNRT_STATUS);
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHCloneSpecialIDList(hwnd: ::win32_foundation_sys::HWND, csidl: i32, fcreate: ::win32_foundation_sys::BOOL) -> *mut Common::ITEMIDLIST;
    pub fn SHCoCreateInstance(pszclsid: ::windows_core_sys::PCWSTR, pclsid: *const ::windows_core_sys::GUID, punkouter: ::windows_core_sys::IUnknown, riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHCopyKeyA(hkeysrc: ::win32_system_sys::Registry::HKEY, pszsrcsubkey: ::windows_core_sys::PCSTR, hkeydest: ::win32_system_sys::Registry::HKEY, freserved: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHCopyKeyW(hkeysrc: ::win32_system_sys::Registry::HKEY, pszsrcsubkey: ::windows_core_sys::PCWSTR, hkeydest: ::win32_system_sys::Registry::HKEY, freserved: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHCreateAssociationRegistration(riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    #[cfg(all(feature = "win32-system-sys", feature = "win32-ui-sys"))]
    pub fn SHCreateDataObject(pidlfolder: *const Common::ITEMIDLIST, cidl: u32, apidl: *const *const Common::ITEMIDLIST, pdtinner: ::win32_system_sys::Com::IDataObject, riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    #[cfg(all(feature = "win32-system-sys", feature = "win32-ui-sys"))]
    pub fn SHCreateDefaultContextMenu(pdcm: *const DEFCONTEXTMENU, riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    pub fn SHCreateDefaultExtractIcon(riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    pub fn SHCreateDefaultPropertiesOp(psi: IShellItem, ppfileop: *mut IFileOperation) -> ::windows_core_sys::HRESULT;
    pub fn SHCreateDirectory(hwnd: ::win32_foundation_sys::HWND, pszpath: ::windows_core_sys::PCWSTR) -> i32;
    #[cfg(feature = "win32-security-sys")]
    pub fn SHCreateDirectoryExA(hwnd: ::win32_foundation_sys::HWND, pszpath: ::windows_core_sys::PCSTR, psa: *const ::win32_security_sys::SECURITY_ATTRIBUTES) -> i32;
    #[cfg(feature = "win32-security-sys")]
    pub fn SHCreateDirectoryExW(hwnd: ::win32_foundation_sys::HWND, pszpath: ::windows_core_sys::PCWSTR, psa: *const ::win32_security_sys::SECURITY_ATTRIBUTES) -> i32;
    pub fn SHCreateFileExtractIconW(pszfile: ::windows_core_sys::PCWSTR, dwfileattributes: u32, riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHCreateItemFromIDList(pidl: *const Common::ITEMIDLIST, riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHCreateItemFromParsingName(pszpath: ::windows_core_sys::PCWSTR, pbc: ::win32_system_sys::Com::IBindCtx, riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHCreateItemFromRelativeName(psiparent: IShellItem, pszname: ::windows_core_sys::PCWSTR, pbc: ::win32_system_sys::Com::IBindCtx, riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    pub fn SHCreateItemInKnownFolder(kfid: *const ::windows_core_sys::GUID, dwkfflags: u32, pszitem: ::windows_core_sys::PCWSTR, riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHCreateItemWithParent(pidlparent: *const Common::ITEMIDLIST, psfparent: IShellFolder, pidl: *const Common::ITEMIDLIST, riid: *const ::windows_core_sys::GUID, ppvitem: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHCreateMemStream(pinit: *const u8, cbinit: u32) -> ::win32_system_sys::Com::IStream;
    #[cfg(all(feature = "win32-security-sys", feature = "win32-system-sys"))]
    pub fn SHCreateProcessAsUserW(pscpi: *mut SHCREATEPROCESSINFOW) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHCreatePropSheetExtArray(hkey: ::win32_system_sys::Registry::HKEY, pszsubkey: ::windows_core_sys::PCWSTR, max_iface: u32) -> HPSXA;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHCreateQueryCancelAutoPlayMoniker(ppmoniker: *mut ::win32_system_sys::Com::IMoniker) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHCreateShellFolderView(pcsfv: *const SFV_CREATE, ppsv: *mut IShellView) -> ::windows_core_sys::HRESULT;
    #[cfg(all(feature = "win32-system-sys", feature = "win32-ui-sys"))]
    pub fn SHCreateShellFolderViewEx(pcsfv: *const CSFV, ppsv: *mut IShellView) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHCreateShellItem(pidlparent: *const Common::ITEMIDLIST, psfparent: IShellFolder, pidl: *const Common::ITEMIDLIST, ppsi: *mut IShellItem) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHCreateShellItemArray(pidlparent: *const Common::ITEMIDLIST, psf: IShellFolder, cidl: u32, ppidl: *const *const Common::ITEMIDLIST, ppsiitemarray: *mut IShellItemArray) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHCreateShellItemArrayFromDataObject(pdo: ::win32_system_sys::Com::IDataObject, riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHCreateShellItemArrayFromIDLists(cidl: u32, rgpidl: *const *const Common::ITEMIDLIST, ppsiitemarray: *mut IShellItemArray) -> ::windows_core_sys::HRESULT;
    pub fn SHCreateShellItemArrayFromShellItem(psi: IShellItem, riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-graphics-sys")]
    pub fn SHCreateShellPalette(hdc: ::win32_graphics_sys::Gdi::HDC) -> ::win32_graphics_sys::Gdi::HPALETTE;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHCreateStdEnumFmtEtc(cfmt: u32, afmt: *const ::win32_system_sys::Com::FORMATETC, ppenumformatetc: *mut ::win32_system_sys::Com::IEnumFORMATETC) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHCreateStreamOnFileA(pszfile: ::windows_core_sys::PCSTR, grfmode: u32, ppstm: *mut ::win32_system_sys::Com::IStream) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHCreateStreamOnFileEx(pszfile: ::windows_core_sys::PCWSTR, grfmode: u32, dwattributes: u32, fcreate: ::win32_foundation_sys::BOOL, pstmtemplate: ::win32_system_sys::Com::IStream, ppstm: *mut ::win32_system_sys::Com::IStream) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHCreateStreamOnFileW(pszfile: ::windows_core_sys::PCWSTR, grfmode: u32, ppstm: *mut ::win32_system_sys::Com::IStream) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHCreateThread(pfnthreadproc: ::win32_system_sys::Threading::LPTHREAD_START_ROUTINE, pdata: *const ::core::ffi::c_void, flags: u32, pfncallback: ::win32_system_sys::Threading::LPTHREAD_START_ROUTINE) -> ::win32_foundation_sys::BOOL;
    pub fn SHCreateThreadRef(pcref: *mut i32, ppunk: *mut ::windows_core_sys::IUnknown) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHCreateThreadWithHandle(pfnthreadproc: ::win32_system_sys::Threading::LPTHREAD_START_ROUTINE, pdata: *const ::core::ffi::c_void, flags: u32, pfncallback: ::win32_system_sys::Threading::LPTHREAD_START_ROUTINE, phandle: *mut ::win32_foundation_sys::HANDLE) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHDefExtractIconA(psziconfile: ::windows_core_sys::PCSTR, iindex: i32, uflags: u32, phiconlarge: *mut super::WindowsAndMessaging::HICON, phiconsmall: *mut super::WindowsAndMessaging::HICON, niconsize: u32) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHDefExtractIconW(psziconfile: ::windows_core_sys::PCWSTR, iindex: i32, uflags: u32, phiconlarge: *mut super::WindowsAndMessaging::HICON, phiconsmall: *mut super::WindowsAndMessaging::HICON, niconsize: u32) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHDeleteEmptyKeyA(hkey: ::win32_system_sys::Registry::HKEY, pszsubkey: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::WIN32_ERROR;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHDeleteEmptyKeyW(hkey: ::win32_system_sys::Registry::HKEY, pszsubkey: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::WIN32_ERROR;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHDeleteKeyA(hkey: ::win32_system_sys::Registry::HKEY, pszsubkey: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::WIN32_ERROR;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHDeleteKeyW(hkey: ::win32_system_sys::Registry::HKEY, pszsubkey: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::WIN32_ERROR;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHDeleteValueA(hkey: ::win32_system_sys::Registry::HKEY, pszsubkey: ::windows_core_sys::PCSTR, pszvalue: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::WIN32_ERROR;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHDeleteValueW(hkey: ::win32_system_sys::Registry::HKEY, pszsubkey: ::windows_core_sys::PCWSTR, pszvalue: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHDestroyPropSheetExtArray(hpsxa: HPSXA);
    #[cfg(all(feature = "win32-system-sys", feature = "win32-system-sys"))]
    pub fn SHDoDragDrop(hwnd: ::win32_foundation_sys::HWND, pdata: ::win32_system_sys::Com::IDataObject, pdsrc: ::win32_system_sys::Ole::IDropSource, dweffect: u32, pdweffect: *mut u32) -> ::windows_core_sys::HRESULT;
    pub fn SHEmptyRecycleBinA(hwnd: ::win32_foundation_sys::HWND, pszrootpath: ::windows_core_sys::PCSTR, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn SHEmptyRecycleBinW(hwnd: ::win32_foundation_sys::HWND, pszrootpath: ::windows_core_sys::PCWSTR, dwflags: u32) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHEnumKeyExA(hkey: ::win32_system_sys::Registry::HKEY, dwindex: u32, pszname: ::windows_core_sys::PSTR, pcchname: *mut u32) -> ::win32_foundation_sys::WIN32_ERROR;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHEnumKeyExW(hkey: ::win32_system_sys::Registry::HKEY, dwindex: u32, pszname: ::windows_core_sys::PWSTR, pcchname: *mut u32) -> ::win32_foundation_sys::WIN32_ERROR;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHEnumValueA(hkey: ::win32_system_sys::Registry::HKEY, dwindex: u32, pszvaluename: ::windows_core_sys::PSTR, pcchvaluename: *mut u32, pdwtype: *mut u32, pvdata: *mut ::core::ffi::c_void, pcbdata: *mut u32) -> ::win32_foundation_sys::WIN32_ERROR;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHEnumValueW(hkey: ::win32_system_sys::Registry::HKEY, dwindex: u32, pszvaluename: ::windows_core_sys::PWSTR, pcchvaluename: *mut u32, pdwtype: *mut u32, pvdata: *mut ::core::ffi::c_void, pcbdata: *mut u32) -> ::win32_foundation_sys::WIN32_ERROR;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHEnumerateUnreadMailAccountsW(hkeyuser: ::win32_system_sys::Registry::HKEY, dwindex: u32, pszmailaddress: ::windows_core_sys::PWSTR, cchmailaddress: i32) -> ::windows_core_sys::HRESULT;
    pub fn SHEvaluateSystemCommandTemplate(pszcmdtemplate: ::windows_core_sys::PCWSTR, ppszapplication: *mut ::windows_core_sys::PWSTR, ppszcommandline: *mut ::windows_core_sys::PWSTR, ppszparameters: *mut ::windows_core_sys::PWSTR) -> ::windows_core_sys::HRESULT;
    pub fn SHFileOperationA(lpfileop: *mut SHFILEOPSTRUCTA) -> i32;
    pub fn SHFileOperationW(lpfileop: *mut SHFILEOPSTRUCTW) -> i32;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHFindFiles(pidlfolder: *const Common::ITEMIDLIST, pidlsavefile: *const Common::ITEMIDLIST) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHFind_InitMenuPopup(hmenu: super::WindowsAndMessaging::HMENU, hwndowner: ::win32_foundation_sys::HWND, idcmdfirst: u32, idcmdlast: u32) -> IContextMenu;
    pub fn SHFlushSFCache();
    pub fn SHFormatDateTimeA(pft: *const ::win32_foundation_sys::FILETIME, pdwflags: *mut u32, pszbuf: ::windows_core_sys::PSTR, cchbuf: u32) -> i32;
    pub fn SHFormatDateTimeW(pft: *const ::win32_foundation_sys::FILETIME, pdwflags: *mut u32, pszbuf: ::windows_core_sys::PWSTR, cchbuf: u32) -> i32;
    pub fn SHFormatDrive(hwnd: ::win32_foundation_sys::HWND, drive: u32, fmtid: SHFMT_ID, options: SHFMT_OPT) -> u32;
    pub fn SHFree(pv: *const ::core::ffi::c_void);
    pub fn SHFreeNameMappings(hnamemappings: ::win32_foundation_sys::HANDLE);
    pub fn SHFreeShared(hdata: ::win32_foundation_sys::HANDLE, dwprocessid: u32) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHGetAttributesFromDataObject(pdo: ::win32_system_sys::Com::IDataObject, dwattributemask: u32, pdwattributes: *mut u32, pcitems: *mut u32) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHGetDataFromIDListA(psf: IShellFolder, pidl: *const Common::ITEMIDLIST, nformat: SHGDFIL_FORMAT, pv: *mut ::core::ffi::c_void, cb: i32) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHGetDataFromIDListW(psf: IShellFolder, pidl: *const Common::ITEMIDLIST, nformat: SHGDFIL_FORMAT, pv: *mut ::core::ffi::c_void, cb: i32) -> ::windows_core_sys::HRESULT;
    pub fn SHGetDesktopFolder(ppshf: *mut IShellFolder) -> ::windows_core_sys::HRESULT;
    pub fn SHGetDiskFreeSpaceExA(pszdirectoryname: ::windows_core_sys::PCSTR, pulfreebytesavailabletocaller: *mut u64, pultotalnumberofbytes: *mut u64, pultotalnumberoffreebytes: *mut u64) -> ::win32_foundation_sys::BOOL;
    pub fn SHGetDiskFreeSpaceExW(pszdirectoryname: ::windows_core_sys::PCWSTR, pulfreebytesavailabletocaller: *mut u64, pultotalnumberofbytes: *mut u64, pultotalnumberoffreebytes: *mut u64) -> ::win32_foundation_sys::BOOL;
    pub fn SHGetDriveMedia(pszdrive: ::windows_core_sys::PCWSTR, pdwmediacontent: *mut u32) -> ::windows_core_sys::HRESULT;
    #[cfg(all(feature = "win32-storage-sys", feature = "win32-ui-sys"))]
    pub fn SHGetFileInfoA(pszpath: ::windows_core_sys::PCSTR, dwfileattributes: ::win32_storage_sys::FileSystem::FILE_FLAGS_AND_ATTRIBUTES, psfi: *mut SHFILEINFOA, cbfileinfo: u32, uflags: SHGFI_FLAGS) -> usize;
    #[cfg(all(feature = "win32-storage-sys", feature = "win32-ui-sys"))]
    pub fn SHGetFileInfoW(pszpath: ::windows_core_sys::PCWSTR, dwfileattributes: ::win32_storage_sys::FileSystem::FILE_FLAGS_AND_ATTRIBUTES, psfi: *mut SHFILEINFOW, cbfileinfo: u32, uflags: SHGFI_FLAGS) -> usize;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHGetFolderLocation(hwnd: ::win32_foundation_sys::HWND, csidl: i32, htoken: ::win32_foundation_sys::HANDLE, dwflags: u32, ppidl: *mut *mut Common::ITEMIDLIST) -> ::windows_core_sys::HRESULT;
    pub fn SHGetFolderPathA(hwnd: ::win32_foundation_sys::HWND, csidl: i32, htoken: ::win32_foundation_sys::HANDLE, dwflags: u32, pszpath: ::windows_core_sys::PSTR) -> ::windows_core_sys::HRESULT;
    pub fn SHGetFolderPathAndSubDirA(hwnd: ::win32_foundation_sys::HWND, csidl: i32, htoken: ::win32_foundation_sys::HANDLE, dwflags: u32, pszsubdir: ::windows_core_sys::PCSTR, pszpath: ::windows_core_sys::PSTR) -> ::windows_core_sys::HRESULT;
    pub fn SHGetFolderPathAndSubDirW(hwnd: ::win32_foundation_sys::HWND, csidl: i32, htoken: ::win32_foundation_sys::HANDLE, dwflags: u32, pszsubdir: ::windows_core_sys::PCWSTR, pszpath: ::windows_core_sys::PWSTR) -> ::windows_core_sys::HRESULT;
    pub fn SHGetFolderPathW(hwnd: ::win32_foundation_sys::HWND, csidl: i32, htoken: ::win32_foundation_sys::HANDLE, dwflags: u32, pszpath: ::windows_core_sys::PWSTR) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHGetIDListFromObject(punk: ::windows_core_sys::IUnknown, ppidl: *mut *mut Common::ITEMIDLIST) -> ::windows_core_sys::HRESULT;
    pub fn SHGetIconOverlayIndexA(psziconpath: ::windows_core_sys::PCSTR, iiconindex: i32) -> i32;
    pub fn SHGetIconOverlayIndexW(psziconpath: ::windows_core_sys::PCWSTR, iiconindex: i32) -> i32;
    pub fn SHGetImageList(iimagelist: i32, riid: *const ::windows_core_sys::GUID, ppvobj: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    pub fn SHGetInstanceExplorer(ppunk: *mut ::windows_core_sys::IUnknown) -> ::windows_core_sys::HRESULT;
    pub fn SHGetInverseCMAP(pbmap: *mut u8, cbmap: u32) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHGetItemFromDataObject(pdtobj: ::win32_system_sys::Com::IDataObject, dwflags: DATAOBJ_GET_ITEM_FLAGS, riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    pub fn SHGetItemFromObject(punk: ::windows_core_sys::IUnknown, riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHGetKnownFolderIDList(rfid: *const ::windows_core_sys::GUID, dwflags: u32, htoken: ::win32_foundation_sys::HANDLE, ppidl: *mut *mut Common::ITEMIDLIST) -> ::windows_core_sys::HRESULT;
    pub fn SHGetKnownFolderItem(rfid: *const ::windows_core_sys::GUID, flags: KNOWN_FOLDER_FLAG, htoken: ::win32_foundation_sys::HANDLE, riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    pub fn SHGetKnownFolderPath(rfid: *const ::windows_core_sys::GUID, dwflags: u32, htoken: ::win32_foundation_sys::HANDLE, ppszpath: *mut ::windows_core_sys::PWSTR) -> ::windows_core_sys::HRESULT;
    pub fn SHGetLocalizedName(pszpath: ::windows_core_sys::PCWSTR, pszresmodule: ::windows_core_sys::PWSTR, cch: u32, pidsres: *mut i32) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHGetMalloc(ppmalloc: *mut ::win32_system_sys::Com::IMalloc) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHGetNameFromIDList(pidl: *const Common::ITEMIDLIST, sigdnname: SIGDN, ppszname: *mut ::windows_core_sys::PWSTR) -> ::windows_core_sys::HRESULT;
    pub fn SHGetNewLinkInfoA(pszlinkto: ::windows_core_sys::PCSTR, pszdir: ::windows_core_sys::PCSTR, pszname: ::windows_core_sys::PSTR, pfmustcopy: *mut ::win32_foundation_sys::BOOL, uflags: u32) -> ::win32_foundation_sys::BOOL;
    pub fn SHGetNewLinkInfoW(pszlinkto: ::windows_core_sys::PCWSTR, pszdir: ::windows_core_sys::PCWSTR, pszname: ::windows_core_sys::PWSTR, pfmustcopy: *mut ::win32_foundation_sys::BOOL, uflags: u32) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHGetPathFromIDListA(pidl: *const Common::ITEMIDLIST, pszpath: ::windows_core_sys::PSTR) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHGetPathFromIDListEx(pidl: *const Common::ITEMIDLIST, pszpath: ::windows_core_sys::PWSTR, cchpath: u32, uopts: i32) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHGetPathFromIDListW(pidl: *const Common::ITEMIDLIST, pszpath: ::windows_core_sys::PWSTR) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHGetRealIDL(psf: IShellFolder, pidlsimple: *const Common::ITEMIDLIST, ppidlreal: *mut *mut Common::ITEMIDLIST) -> ::windows_core_sys::HRESULT;
    pub fn SHGetSetFolderCustomSettings(pfcs: *mut SHFOLDERCUSTOMSETTINGS, pszpath: ::windows_core_sys::PCWSTR, dwreadwrite: u32) -> ::windows_core_sys::HRESULT;
    pub fn SHGetSetSettings(lpss: *mut SHELLSTATEA, dwmask: SSF_MASK, bset: ::win32_foundation_sys::BOOL);
    pub fn SHGetSettings(psfs: *mut SHELLFLAGSTATE, dwmask: u32);
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHGetSpecialFolderLocation(hwnd: ::win32_foundation_sys::HWND, csidl: i32, ppidl: *mut *mut Common::ITEMIDLIST) -> ::windows_core_sys::HRESULT;
    pub fn SHGetSpecialFolderPathA(hwnd: ::win32_foundation_sys::HWND, pszpath: ::windows_core_sys::PSTR, csidl: i32, fcreate: ::win32_foundation_sys::BOOL) -> ::win32_foundation_sys::BOOL;
    pub fn SHGetSpecialFolderPathW(hwnd: ::win32_foundation_sys::HWND, pszpath: ::windows_core_sys::PWSTR, csidl: i32, fcreate: ::win32_foundation_sys::BOOL) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHGetStockIconInfo(siid: SHSTOCKICONID, uflags: u32, psii: *mut SHSTOCKICONINFO) -> ::windows_core_sys::HRESULT;
    #[cfg(all(feature = "win32-system-sys", feature = "win32-ui-sys"))]
    pub fn SHGetTemporaryPropertyForItem(psi: IShellItem, propkey: *const PropertiesSystem::PROPERTYKEY, ppropvar: *mut ::win32_system_sys::Com::StructuredStorage::PROPVARIANT) -> ::windows_core_sys::HRESULT;
    pub fn SHGetThreadRef(ppunk: *mut ::windows_core_sys::IUnknown) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHGetUnreadMailCountW(hkeyuser: ::win32_system_sys::Registry::HKEY, pszmailaddress: ::windows_core_sys::PCWSTR, pdwcount: *mut u32, pfiletime: *mut ::win32_foundation_sys::FILETIME, pszshellexecutecommand: ::windows_core_sys::PWSTR, cchshellexecutecommand: i32) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHGetValueA(hkey: ::win32_system_sys::Registry::HKEY, pszsubkey: ::windows_core_sys::PCSTR, pszvalue: ::windows_core_sys::PCSTR, pdwtype: *mut u32, pvdata: *mut ::core::ffi::c_void, pcbdata: *mut u32) -> ::win32_foundation_sys::WIN32_ERROR;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHGetValueW(hkey: ::win32_system_sys::Registry::HKEY, pszsubkey: ::windows_core_sys::PCWSTR, pszvalue: ::windows_core_sys::PCWSTR, pdwtype: *mut u32, pvdata: *mut ::core::ffi::c_void, pcbdata: *mut u32) -> ::win32_foundation_sys::WIN32_ERROR;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHGetViewStatePropertyBag(pidl: *const Common::ITEMIDLIST, pszbagname: ::windows_core_sys::PCWSTR, dwflags: u32, riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    ...
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHILCreateFromPath(pszpath: ::windows_core_sys::PCWSTR, ppidl: *mut *mut Common::ITEMIDLIST, rgfinout: *mut u32) -> ::windows_core_sys::HRESULT;
    pub fn SHInvokePrinterCommandA(hwnd: ::win32_foundation_sys::HWND, uaction: u32, lpbuf1: ::windows_core_sys::PCSTR, lpbuf2: ::windows_core_sys::PCSTR, fmodal: ::win32_foundation_sys::BOOL) -> ::win32_foundation_sys::BOOL;
    pub fn SHInvokePrinterCommandW(hwnd: ::win32_foundation_sys::HWND, uaction: u32, lpbuf1: ::windows_core_sys::PCWSTR, lpbuf2: ::windows_core_sys::PCWSTR, fmodal: ::win32_foundation_sys::BOOL) -> ::win32_foundation_sys::BOOL;
    pub fn SHIsFileAvailableOffline(pwszpath: ::windows_core_sys::PCWSTR, pdwstatus: *mut u32) -> ::windows_core_sys::HRESULT;
    pub fn SHIsLowMemoryMachine(dwtype: u32) -> ::win32_foundation_sys::BOOL;
    pub fn SHLimitInputEdit(hwndedit: ::win32_foundation_sys::HWND, psf: IShellFolder) -> ::windows_core_sys::HRESULT;
    pub fn SHLoadInProc(rclsid: *const ::windows_core_sys::GUID) -> ::windows_core_sys::HRESULT;
    pub fn SHLoadIndirectString(pszsource: ::windows_core_sys::PCWSTR, pszoutbuf: ::windows_core_sys::PWSTR, cchoutbuf: u32, ppvreserved: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    pub fn SHLoadNonloadedIconOverlayIdentifiers() -> ::windows_core_sys::HRESULT;
    pub fn SHLockShared(hdata: ::win32_foundation_sys::HANDLE, dwprocessid: u32) -> *mut ::core::ffi::c_void;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHMapPIDLToSystemImageListIndex(pshf: IShellFolder, pidl: *const Common::ITEMIDLIST, piindexsel: *mut i32) -> i32;
    pub fn SHMessageBoxCheckA(hwnd: ::win32_foundation_sys::HWND, psztext: ::windows_core_sys::PCSTR, pszcaption: ::windows_core_sys::PCSTR, utype: u32, idefault: i32, pszregval: ::windows_core_sys::PCSTR) -> i32;
    pub fn SHMessageBoxCheckW(hwnd: ::win32_foundation_sys::HWND, psztext: ::windows_core_sys::PCWSTR, pszcaption: ::windows_core_sys::PCWSTR, utype: u32, idefault: i32, pszregval: ::windows_core_sys::PCWSTR) -> i32;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHMultiFileProperties(pdtobj: ::win32_system_sys::Com::IDataObject, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn SHObjectProperties(hwnd: ::win32_foundation_sys::HWND, shopobjecttype: SHOP_TYPE, pszobjectname: ::windows_core_sys::PCWSTR, pszpropertypage: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHOpenFolderAndSelectItems(pidlfolder: *const Common::ITEMIDLIST, cidl: u32, apidl: *const *const Common::ITEMIDLIST, dwflags: u32) -> ::windows_core_sys::HRESULT;
    #[cfg(all(feature = "win32-system-sys", feature = "win32-system-sys", feature = "win32-system-sys"))]
    pub fn SHOpenPropSheetW(pszcaption: ::windows_core_sys::PCWSTR, ahkeys: *const ::win32_system_sys::Registry::HKEY, ckeys: u32, pclsiddefault: *const ::windows_core_sys::GUID, pdtobj: ::win32_system_sys::Com::IDataObject, psb: IShellBrowser, pstartpage: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    #[cfg(all(feature = "win32-system-sys", feature = "win32-system-sys"))]
    pub fn SHOpenRegStream2A(hkey: ::win32_system_sys::Registry::HKEY, pszsubkey: ::windows_core_sys::PCSTR, pszvalue: ::windows_core_sys::PCSTR, grfmode: u32) -> ::win32_system_sys::Com::IStream;
    #[cfg(all(feature = "win32-system-sys", feature = "win32-system-sys"))]
    pub fn SHOpenRegStream2W(hkey: ::win32_system_sys::Registry::HKEY, pszsubkey: ::windows_core_sys::PCWSTR, pszvalue: ::windows_core_sys::PCWSTR, grfmode: u32) -> ::win32_system_sys::Com::IStream;
    #[cfg(all(feature = "win32-system-sys", feature = "win32-system-sys"))]
    pub fn SHOpenRegStreamA(hkey: ::win32_system_sys::Registry::HKEY, pszsubkey: ::windows_core_sys::PCSTR, pszvalue: ::windows_core_sys::PCSTR, grfmode: u32) -> ::win32_system_sys::Com::IStream;
    #[cfg(all(feature = "win32-system-sys", feature = "win32-system-sys"))]
    pub fn SHOpenRegStreamW(hkey: ::win32_system_sys::Registry::HKEY, pszsubkey: ::windows_core_sys::PCWSTR, pszvalue: ::windows_core_sys::PCWSTR, grfmode: u32) -> ::win32_system_sys::Com::IStream;
    pub fn SHOpenWithDialog(hwndparent: ::win32_foundation_sys::HWND, poainfo: *const OPENASINFO) -> ::windows_core_sys::HRESULT;
    #[cfg(all(feature = "win32-system-sys", feature = "win32-ui-sys"))]
    pub fn SHParseDisplayName(pszname: ::windows_core_sys::PCWSTR, pbc: ::win32_system_sys::Com::IBindCtx, ppidl: *mut *mut Common::ITEMIDLIST, sfgaoin: u32, psfgaoout: *mut u32) -> ::windows_core_sys::HRESULT;
    pub fn SHPathPrepareForWriteA(hwnd: ::win32_foundation_sys::HWND, punkenablemodless: ::windows_core_sys::IUnknown, pszpath: ::windows_core_sys::PCSTR, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn SHPathPrepareForWriteW(hwnd: ::win32_foundation_sys::HWND, punkenablemodless: ::windows_core_sys::IUnknown, pszpath: ::windows_core_sys::PCWSTR, dwflags: u32) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHQueryInfoKeyA(hkey: ::win32_system_sys::Registry::HKEY, pcsubkeys: *mut u32, pcchmaxsubkeylen: *mut u32, pcvalues: *mut u32, pcchmaxvaluenamelen: *mut u32) -> ::win32_foundation_sys::WIN32_ERROR;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHQueryInfoKeyW(hkey: ::win32_system_sys::Registry::HKEY, pcsubkeys: *mut u32, pcchmaxsubkeylen: *mut u32, pcvalues: *mut u32, pcchmaxvaluenamelen: *mut u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHQueryRecycleBinA(pszrootpath: ::windows_core_sys::PCSTR, pshqueryrbinfo: *mut SHQUERYRBINFO) -> ::windows_core_sys::HRESULT;
    pub fn SHQueryRecycleBinW(pszrootpath: ::windows_core_sys::PCWSTR, pshqueryrbinfo: *mut SHQUERYRBINFO) -> ::windows_core_sys::HRESULT;
    pub fn SHQueryUserNotificationState(pquns: *mut QUERY_USER_NOTIFICATION_STATE) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHQueryValueExA(hkey: ::win32_system_sys::Registry::HKEY, pszvalue: ::windows_core_sys::PCSTR, pdwreserved: *mut u32, pdwtype: *mut u32, pvdata: *mut ::core::ffi::c_void, pcbdata: *mut u32) -> ::win32_foundation_sys::WIN32_ERROR;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHQueryValueExW(hkey: ::win32_system_sys::Registry::HKEY, pszvalue: ::windows_core_sys::PCWSTR, pdwreserved: *mut u32, pdwtype: *mut u32, pvdata: *mut ::core::ffi::c_void, pcbdata: *mut u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegCloseUSKey(huskey: isize) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegCreateUSKeyA(pszpath: ::windows_core_sys::PCSTR, samdesired: u32, hrelativeuskey: isize, phnewuskey: *mut isize, dwflags: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegCreateUSKeyW(pwzpath: ::windows_core_sys::PCWSTR, samdesired: u32, hrelativeuskey: isize, phnewuskey: *mut isize, dwflags: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegDeleteEmptyUSKeyA(huskey: isize, pszsubkey: ::windows_core_sys::PCSTR, delregflags: SHREGDEL_FLAGS) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegDeleteEmptyUSKeyW(huskey: isize, pwzsubkey: ::windows_core_sys::PCWSTR, delregflags: SHREGDEL_FLAGS) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegDeleteUSValueA(huskey: isize, pszvalue: ::windows_core_sys::PCSTR, delregflags: SHREGDEL_FLAGS) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegDeleteUSValueW(huskey: isize, pwzvalue: ::windows_core_sys::PCWSTR, delregflags: SHREGDEL_FLAGS) -> ::win32_foundation_sys::WIN32_ERROR;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHRegDuplicateHKey(hkey: ::win32_system_sys::Registry::HKEY) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegEnumUSKeyA(huskey: isize, dwindex: u32, pszname: ::windows_core_sys::PSTR, pcchname: *mut u32, enumregflags: SHREGENUM_FLAGS) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegEnumUSKeyW(huskey: isize, dwindex: u32, pwzname: ::windows_core_sys::PWSTR, pcchname: *mut u32, enumregflags: SHREGENUM_FLAGS) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegEnumUSValueA(huskey: isize, dwindex: u32, pszvaluename: ::windows_core_sys::PSTR, pcchvaluename: *mut u32, pdwtype: *mut u32, pvdata: *mut ::core::ffi::c_void, pcbdata: *mut u32, enumregflags: SHREGENUM_FLAGS) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegEnumUSValueW(huskey: isize, dwindex: u32, pszvaluename: ::windows_core_sys::PWSTR, pcchvaluename: *mut u32, pdwtype: *mut u32, pvdata: *mut ::core::ffi::c_void, pcbdata: *mut u32, enumregflags: SHREGENUM_FLAGS) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegGetBoolUSValueA(pszsubkey: ::windows_core_sys::PCSTR, pszvalue: ::windows_core_sys::PCSTR, fignorehkcu: ::win32_foundation_sys::BOOL, fdefault: ::win32_foundation_sys::BOOL) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegGetBoolUSValueW(pszsubkey: ::windows_core_sys::PCWSTR, pszvalue: ::windows_core_sys::PCWSTR, fignorehkcu: ::win32_foundation_sys::BOOL, fdefault: ::win32_foundation_sys::BOOL) -> ::win32_foundation_sys::WIN32_ERROR;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHRegGetIntW(hk: ::win32_system_sys::Registry::HKEY, pwzkey: ::windows_core_sys::PCWSTR, idefault: i32) -> ::win32_foundation_sys::WIN32_ERROR;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHRegGetPathA(hkey: ::win32_system_sys::Registry::HKEY, pcszsubkey: ::windows_core_sys::PCSTR, pcszvalue: ::windows_core_sys::PCSTR, pszpath: ::windows_core_sys::PSTR, dwflags: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHRegGetPathW(hkey: ::win32_system_sys::Registry::HKEY, pcszsubkey: ::windows_core_sys::PCWSTR, pcszvalue: ::windows_core_sys::PCWSTR, pszpath: ::windows_core_sys::PWSTR, dwflags: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegGetUSValueA(pszsubkey: ::windows_core_sys::PCSTR, pszvalue: ::windows_core_sys::PCSTR, pdwtype: *mut u32, pvdata: *mut ::core::ffi::c_void, pcbdata: *mut u32, fignorehkcu: ::win32_foundation_sys::BOOL, pvdefaultdata: *const ::core::ffi::c_void, dwdefaultdatasize: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegGetUSValueW(pszsubkey: ::windows_core_sys::PCWSTR, pszvalue: ::windows_core_sys::PCWSTR, pdwtype: *mut u32, pvdata: *mut ::core::ffi::c_void, pcbdata: *mut u32, fignorehkcu: ::win32_foundation_sys::BOOL, pvdefaultdata: *const ::core::ffi::c_void, dwdefaultdatasize: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHRegGetValueA(hkey: ::win32_system_sys::Registry::HKEY, pszsubkey: ::windows_core_sys::PCSTR, pszvalue: ::windows_core_sys::PCSTR, srrfflags: i32, pdwtype: *mut u32, pvdata: *mut ::core::ffi::c_void, pcbdata: *mut u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegGetValueFromHKCUHKLM(pwszkey: ::windows_core_sys::PCWSTR, pwszvalue: ::windows_core_sys::PCWSTR, srrfflags: i32, pdwtype: *mut u32, pvdata: *mut ::core::ffi::c_void, pcbdata: *mut u32) -> ::win32_foundation_sys::WIN32_ERROR;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHRegGetValueW(hkey: ::win32_system_sys::Registry::HKEY, pszsubkey: ::windows_core_sys::PCWSTR, pszvalue: ::windows_core_sys::PCWSTR, srrfflags: i32, pdwtype: *mut u32, pvdata: *mut ::core::ffi::c_void, pcbdata: *mut u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegOpenUSKeyA(pszpath: ::windows_core_sys::PCSTR, samdesired: u32, hrelativeuskey: isize, phnewuskey: *mut isize, fignorehkcu: ::win32_foundation_sys::BOOL) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegOpenUSKeyW(pwzpath: ::windows_core_sys::PCWSTR, samdesired: u32, hrelativeuskey: isize, phnewuskey: *mut isize, fignorehkcu: ::win32_foundation_sys::BOOL) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegQueryInfoUSKeyA(huskey: isize, pcsubkeys: *mut u32, pcchmaxsubkeylen: *mut u32, pcvalues: *mut u32, pcchmaxvaluenamelen: *mut u32, enumregflags: SHREGENUM_FLAGS) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegQueryInfoUSKeyW(huskey: isize, pcsubkeys: *mut u32, pcchmaxsubkeylen: *mut u32, pcvalues: *mut u32, pcchmaxvaluenamelen: *mut u32, enumregflags: SHREGENUM_FLAGS) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegQueryUSValueA(huskey: isize, pszvalue: ::windows_core_sys::PCSTR, pdwtype: *mut u32, pvdata: *mut ::core::ffi::c_void, pcbdata: *mut u32, fignorehkcu: ::win32_foundation_sys::BOOL, pvdefaultdata: *const ::core::ffi::c_void, dwdefaultdatasize: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegQueryUSValueW(huskey: isize, pszvalue: ::windows_core_sys::PCWSTR, pdwtype: *mut u32, pvdata: *mut ::core::ffi::c_void, pcbdata: *mut u32, fignorehkcu: ::win32_foundation_sys::BOOL, pvdefaultdata: *const ::core::ffi::c_void, dwdefaultdatasize: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHRegSetPathA(hkey: ::win32_system_sys::Registry::HKEY, pcszsubkey: ::windows_core_sys::PCSTR, pcszvalue: ::windows_core_sys::PCSTR, pcszpath: ::windows_core_sys::PCSTR, dwflags: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHRegSetPathW(hkey: ::win32_system_sys::Registry::HKEY, pcszsubkey: ::windows_core_sys::PCWSTR, pcszvalue: ::windows_core_sys::PCWSTR, pcszpath: ::windows_core_sys::PCWSTR, dwflags: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegSetUSValueA(pszsubkey: ::windows_core_sys::PCSTR, pszvalue: ::windows_core_sys::PCSTR, dwtype: u32, pvdata: *const ::core::ffi::c_void, cbdata: u32, dwflags: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegSetUSValueW(pwzsubkey: ::windows_core_sys::PCWSTR, pwzvalue: ::windows_core_sys::PCWSTR, dwtype: u32, pvdata: *const ::core::ffi::c_void, cbdata: u32, dwflags: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegWriteUSValueA(huskey: isize, pszvalue: ::windows_core_sys::PCSTR, dwtype: u32, pvdata: *const ::core::ffi::c_void, cbdata: u32, dwflags: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHRegWriteUSValueW(huskey: isize, pwzvalue: ::windows_core_sys::PCWSTR, dwtype: u32, pvdata: *const ::core::ffi::c_void, cbdata: u32, dwflags: u32) -> ::win32_foundation_sys::WIN32_ERROR;
    pub fn SHReleaseThreadRef() -> ::windows_core_sys::HRESULT;
    pub fn SHRemoveLocalizedName(pszpath: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHReplaceFromPropSheetExtArray(hpsxa: HPSXA, upageid: u32, lpfnreplacewith: super::Controls::LPFNSVADDPROPSHEETPAGE, lparam: ::win32_foundation_sys::LPARAM) -> u32;
    pub fn SHResolveLibrary(psilibrary: IShellItem) -> ::windows_core_sys::HRESULT;
    pub fn SHRestricted(rest: RESTRICTIONS) -> u32;
    pub fn SHSendMessageBroadcastA(umsg: u32, wparam: ::win32_foundation_sys::WPARAM, lparam: ::win32_foundation_sys::LPARAM) -> ::win32_foundation_sys::LRESULT;
    pub fn SHSendMessageBroadcastW(umsg: u32, wparam: ::win32_foundation_sys::WPARAM, lparam: ::win32_foundation_sys::LPARAM) -> ::win32_foundation_sys::LRESULT;
    pub fn SHSetDefaultProperties(hwnd: ::win32_foundation_sys::HWND, psi: IShellItem, dwfileopflags: u32, pfops: IFileOperationProgressSink) -> ::windows_core_sys::HRESULT;
    pub fn SHSetFolderPathA(csidl: i32, htoken: ::win32_foundation_sys::HANDLE, dwflags: u32, pszpath: ::windows_core_sys::PCSTR) -> ::windows_core_sys::HRESULT;
    pub fn SHSetFolderPathW(csidl: i32, htoken: ::win32_foundation_sys::HANDLE, dwflags: u32, pszpath: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::HRESULT;
    pub fn SHSetInstanceExplorer(punk: ::windows_core_sys::IUnknown);
    pub fn SHSetKnownFolderPath(rfid: *const ::windows_core_sys::GUID, dwflags: u32, htoken: ::win32_foundation_sys::HANDLE, pszpath: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::HRESULT;
    pub fn SHSetLocalizedName(pszpath: ::windows_core_sys::PCWSTR, pszresmodule: ::windows_core_sys::PCWSTR, idsres: i32) -> ::windows_core_sys::HRESULT;
    #[cfg(all(feature = "win32-system-sys", feature = "win32-ui-sys"))]
    pub fn SHSetTemporaryPropertyForItem(psi: IShellItem, propkey: *const PropertiesSystem::PROPERTYKEY, propvar: *const ::win32_system_sys::Com::StructuredStorage::PROPVARIANT) -> ::windows_core_sys::HRESULT;
    pub fn SHSetThreadRef(punk: ::windows_core_sys::IUnknown) -> ::windows_core_sys::HRESULT;
    pub fn SHSetUnreadMailCountW(pszmailaddress: ::windows_core_sys::PCWSTR, dwcount: u32, pszshellexecutecommand: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHSetValueA(hkey: ::win32_system_sys::Registry::HKEY, pszsubkey: ::windows_core_sys::PCSTR, pszvalue: ::windows_core_sys::PCSTR, dwtype: u32, pvdata: *const ::core::ffi::c_void, cbdata: u32) -> i32;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHSetValueW(hkey: ::win32_system_sys::Registry::HKEY, pszsubkey: ::windows_core_sys::PCWSTR, pszvalue: ::windows_core_sys::PCWSTR, dwtype: u32, pvdata: *const ::core::ffi::c_void, cbdata: u32) -> i32;
    pub fn SHShellFolderView_Message(hwndmain: ::win32_foundation_sys::HWND, umsg: u32, lparam: ::win32_foundation_sys::LPARAM) -> ::win32_foundation_sys::LRESULT;
    pub fn SHShowManageLibraryUI(psilibrary: IShellItem, hwndowner: ::win32_foundation_sys::HWND, psztitle: ::windows_core_sys::PCWSTR, pszinstruction: ::windows_core_sys::PCWSTR, lmdoptions: LIBRARYMANAGEDIALOGOPTIONS) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SHSimpleIDListFromPath(pszpath: ::windows_core_sys::PCWSTR) -> *mut Common::ITEMIDLIST;
    #[cfg(feature = "win32-system-sys")]
    pub fn SHSkipJunction(pbc: ::win32_system_sys::Com::IBindCtx, pclsid: *const ::windows_core_sys::GUID) -> ::win32_foundation_sys::BOOL;
    pub fn SHStartNetConnectionDialogW(hwnd: ::win32_foundation_sys::HWND, pszremotename: ::windows_core_sys::PCWSTR, dwtype: u32) -> ::windows_core_sys::HRESULT;
    pub fn SHStrDupA(psz: ::windows_core_sys::PCSTR, ppwsz: *mut ::windows_core_sys::PWSTR) -> ::windows_core_sys::HRESULT;
    pub fn SHStrDupW(psz: ::windows_core_sys::PCWSTR, ppwsz: *mut ::windows_core_sys::PWSTR) -> ::windows_core_sys::HRESULT;
    pub fn SHStripMneumonicA(pszmenu: ::windows_core_sys::PSTR) -> ::win32_foundation_sys::CHAR;
    pub fn SHStripMneumonicW(pszmenu: ::windows_core_sys::PWSTR) -> u16;
    pub fn SHTestTokenMembership(htoken: ::win32_foundation_sys::HANDLE, ulrid: u32) -> ::win32_foundation_sys::BOOL;
    pub fn SHUnicodeToAnsi(pwszsrc: ::windows_core_sys::PCWSTR, pszdst: ::windows_core_sys::PSTR, cchbuf: i32) -> i32;
    pub fn SHUnicodeToUnicode(pwzsrc: ::windows_core_sys::PCWSTR, pwzdst: ::windows_core_sys::PWSTR, cwchbuf: i32) -> i32;
    pub fn SHUnlockShared(pvdata: *const ::core::ffi::c_void) -> ::win32_foundation_sys::BOOL;
    pub fn SHUpdateImageA(pszhashitem: ::windows_core_sys::PCSTR, iindex: i32, uflags: u32, iimageindex: i32);
    pub fn SHUpdateImageW(pszhashitem: ::windows_core_sys::PCWSTR, iindex: i32, uflags: u32, iimageindex: i32);
    pub fn SHValidateUNC(hwndowner: ::win32_foundation_sys::HWND, pszfile: ::windows_core_sys::PWSTR, fconnect: VALIDATEUNC_OPTION) -> ::win32_foundation_sys::BOOL;
    pub fn SetCurrentProcessExplicitAppUserModelID(appid: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SetMenuContextHelpId(param0: super::WindowsAndMessaging::HMENU, param1: u32) -> ::win32_foundation_sys::BOOL;
    pub fn SetWindowContextHelpId(param0: ::win32_foundation_sys::HWND, param1: u32) -> ::win32_foundation_sys::BOOL;
    pub fn SetWindowSubclass(hwnd: ::win32_foundation_sys::HWND, pfnsubclass: SUBCLASSPROC, uidsubclass: usize, dwrefdata: usize) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-ui-sys")]
    pub fn ShellAboutA(hwnd: ::win32_foundation_sys::HWND, szapp: ::windows_core_sys::PCSTR, szotherstuff: ::windows_core_sys::PCSTR, hicon: super::WindowsAndMessaging::HICON) -> i32;
    #[cfg(feature = "win32-ui-sys")]
    pub fn ShellAboutW(hwnd: ::win32_foundation_sys::HWND, szapp: ::windows_core_sys::PCWSTR, szotherstuff: ::windows_core_sys::PCWSTR, hicon: super::WindowsAndMessaging::HICON) -> i32;
    pub fn ShellExecuteA(hwnd: ::win32_foundation_sys::HWND, lpoperation: ::windows_core_sys::PCSTR, lpfile: ::windows_core_sys::PCSTR, lpparameters: ::windows_core_sys::PCSTR, lpdirectory: ::windows_core_sys::PCSTR, nshowcmd: i32) -> ::win32_foundation_sys::HINSTANCE;
    #[cfg(feature = "win32-system-sys")]
    pub fn ShellExecuteExA(pexecinfo: *mut SHELLEXECUTEINFOA) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-system-sys")]
    pub fn ShellExecuteExW(pexecinfo: *mut SHELLEXECUTEINFOW) -> ::win32_foundation_sys::BOOL;
    pub fn ShellExecuteW(hwnd: ::win32_foundation_sys::HWND, lpoperation: ::windows_core_sys::PCWSTR, lpfile: ::windows_core_sys::PCWSTR, lpparameters: ::windows_core_sys::PCWSTR, lpdirectory: ::windows_core_sys::PCWSTR, nshowcmd: i32) -> ::win32_foundation_sys::HINSTANCE;
    pub fn ShellMessageBoxA(happinst: ::win32_foundation_sys::HINSTANCE, hwnd: ::win32_foundation_sys::HWND, lpctext: ::windows_core_sys::PCSTR, lpctitle: ::windows_core_sys::PCSTR, fustyle: u32) -> i32;
    pub fn ShellMessageBoxW(happinst: ::win32_foundation_sys::HINSTANCE, hwnd: ::win32_foundation_sys::HWND, lpctext: ::windows_core_sys::PCWSTR, lpctitle: ::windows_core_sys::PCWSTR, fustyle: u32) -> i32;
    pub fn Shell_GetCachedImageIndex(pwsziconpath: ::windows_core_sys::PCWSTR, iiconindex: i32, uiconflags: u32) -> i32;
    pub fn Shell_GetCachedImageIndexA(psziconpath: ::windows_core_sys::PCSTR, iiconindex: i32, uiconflags: u32) -> i32;
    pub fn Shell_GetCachedImageIndexW(psziconpath: ::windows_core_sys::PCWSTR, iiconindex: i32, uiconflags: u32) -> i32;
    #[cfg(feature = "win32-ui-sys")]
    pub fn Shell_GetImageLists(phiml: *mut super::Controls::HIMAGELIST, phimlsmall: *mut super::Controls::HIMAGELIST) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-ui-sys")]
    ...
    #[cfg(feature = "win32-ui-sys")]
    pub fn Shell_NotifyIconA(dwmessage: NOTIFY_ICON_MESSAGE, lpdata: *const NOTIFYICONDATAA) -> ::win32_foundation_sys::BOOL;
    pub fn Shell_NotifyIconGetRect(identifier: *const NOTIFYICONIDENTIFIER, iconlocation: *mut ::win32_foundation_sys::RECT) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn Shell_NotifyIconW(dwmessage: NOTIFY_ICON_MESSAGE, lpdata: *const NOTIFYICONDATAW) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-ui-sys")]
    pub fn SignalFileOpen(pidl: *const Common::ITEMIDLIST) -> ::win32_foundation_sys::BOOL;
    #[cfg(feature = "win32-system-sys")]
    pub fn SoftwareUpdateMessageBox(hwnd: ::win32_foundation_sys::HWND, pszdistunit: ::windows_core_sys::PCWSTR, dwflags: u32, psdi: *mut ::win32_system_sys::Com::Urlmon::SOFTDISTINFO) -> u32;
    #[cfg(feature = "win32-system-sys")]
    pub fn StgMakeUniqueName(pstgparent: ::win32_system_sys::Com::StructuredStorage::IStorage, pszfilespec: ::windows_core_sys::PCWSTR, grfmode: u32, riid: *const ::windows_core_sys::GUID, ppv: *mut *mut ::core::ffi::c_void) -> ::windows_core_sys::HRESULT;
    pub fn StrCSpnA(pszstr: ::windows_core_sys::PCSTR, pszset: ::windows_core_sys::PCSTR) -> i32;
    pub fn StrCSpnIA(pszstr: ::windows_core_sys::PCSTR, pszset: ::windows_core_sys::PCSTR) -> i32;
    pub fn StrCSpnIW(pszstr: ::windows_core_sys::PCWSTR, pszset: ::windows_core_sys::PCWSTR) -> i32;
    pub fn StrCSpnW(pszstr: ::windows_core_sys::PCWSTR, pszset: ::windows_core_sys::PCWSTR) -> i32;
    pub fn StrCatBuffA(pszdest: ::windows_core_sys::PSTR, pszsrc: ::windows_core_sys::PCSTR, cchdestbuffsize: i32) -> ::windows_core_sys::PSTR;
    pub fn StrCatBuffW(pszdest: ::windows_core_sys::PWSTR, pszsrc: ::windows_core_sys::PCWSTR, cchdestbuffsize: i32) -> ::windows_core_sys::PWSTR;
    pub fn StrCatChainW(pszdst: ::windows_core_sys::PWSTR, cchdst: u32, ichat: u32, pszsrc: ::windows_core_sys::PCWSTR) -> u32;
    pub fn StrCatW(psz1: ::windows_core_sys::PWSTR, psz2: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::PWSTR;
    pub fn StrChrA(pszstart: ::windows_core_sys::PCSTR, wmatch: u16) -> ::windows_core_sys::PSTR;
    pub fn StrChrIA(pszstart: ::windows_core_sys::PCSTR, wmatch: u16) -> ::windows_core_sys::PSTR;
    pub fn StrChrIW(pszstart: ::windows_core_sys::PCWSTR, wmatch: u16) -> ::windows_core_sys::PWSTR;
    pub fn StrChrNIW(pszstart: ::windows_core_sys::PCWSTR, wmatch: u16, cchmax: u32) -> ::windows_core_sys::PWSTR;
    pub fn StrChrNW(pszstart: ::windows_core_sys::PCWSTR, wmatch: u16, cchmax: u32) -> ::windows_core_sys::PWSTR;
    pub fn StrChrW(pszstart: ::windows_core_sys::PCWSTR, wmatch: u16) -> ::windows_core_sys::PWSTR;
    pub fn StrCmpCA(pszstr1: ::windows_core_sys::PCSTR, pszstr2: ::windows_core_sys::PCSTR) -> i32;
    pub fn StrCmpCW(pszstr1: ::windows_core_sys::PCWSTR, pszstr2: ::windows_core_sys::PCWSTR) -> i32;
    pub fn StrCmpICA(pszstr1: ::windows_core_sys::PCSTR, pszstr2: ::windows_core_sys::PCSTR) -> i32;
    pub fn StrCmpICW(pszstr1: ::windows_core_sys::PCWSTR, pszstr2: ::windows_core_sys::PCWSTR) -> i32;
    pub fn StrCmpIW(psz1: ::windows_core_sys::PCWSTR, psz2: ::windows_core_sys::PCWSTR) -> i32;
    pub fn StrCmpLogicalW(psz1: ::windows_core_sys::PCWSTR, psz2: ::windows_core_sys::PCWSTR) -> i32;
    pub fn StrCmpNA(psz1: ::windows_core_sys::PCSTR, psz2: ::windows_core_sys::PCSTR, nchar: i32) -> i32;
    pub fn StrCmpNCA(pszstr1: ::windows_core_sys::PCSTR, pszstr2: ::windows_core_sys::PCSTR, nchar: i32) -> i32;
    pub fn StrCmpNCW(pszstr1: ::windows_core_sys::PCWSTR, pszstr2: ::windows_core_sys::PCWSTR, nchar: i32) -> i32;
    pub fn StrCmpNIA(psz1: ::windows_core_sys::PCSTR, psz2: ::windows_core_sys::PCSTR, nchar: i32) -> i32;
    pub fn StrCmpNICA(pszstr1: ::windows_core_sys::PCSTR, pszstr2: ::windows_core_sys::PCSTR, nchar: i32) -> i32;
    pub fn StrCmpNICW(pszstr1: ::windows_core_sys::PCWSTR, pszstr2: ::windows_core_sys::PCWSTR, nchar: i32) -> i32;
    pub fn StrCmpNIW(psz1: ::windows_core_sys::PCWSTR, psz2: ::windows_core_sys::PCWSTR, nchar: i32) -> i32;
    pub fn StrCmpNW(psz1: ::windows_core_sys::PCWSTR, psz2: ::windows_core_sys::PCWSTR, nchar: i32) -> i32;
    pub fn StrCmpW(psz1: ::windows_core_sys::PCWSTR, psz2: ::windows_core_sys::PCWSTR) -> i32;
    pub fn StrCpyNW(pszdst: ::windows_core_sys::PWSTR, pszsrc: ::windows_core_sys::PCWSTR, cchmax: i32) -> ::windows_core_sys::PWSTR;
    pub fn StrCpyW(psz1: ::windows_core_sys::PWSTR, psz2: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::PWSTR;
    pub fn StrDupA(pszsrch: ::windows_core_sys::PCSTR) -> ::windows_core_sys::PSTR;
    pub fn StrDupW(pszsrch: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::PWSTR;
    pub fn StrFormatByteSize64A(qdw: i64, pszbuf: ::windows_core_sys::PSTR, cchbuf: u32) -> ::windows_core_sys::PSTR;
    pub fn StrFormatByteSizeA(dw: u32, pszbuf: ::windows_core_sys::PSTR, cchbuf: u32) -> ::windows_core_sys::PSTR;
    pub fn StrFormatByteSizeEx(ull: u64, flags: SFBS_FLAGS, pszbuf: ::windows_core_sys::PWSTR, cchbuf: u32) -> ::windows_core_sys::HRESULT;
    pub fn StrFormatByteSizeW(qdw: i64, pszbuf: ::windows_core_sys::PWSTR, cchbuf: u32) -> ::windows_core_sys::PWSTR;
    pub fn StrFormatKBSizeA(qdw: i64, pszbuf: ::windows_core_sys::PSTR, cchbuf: u32) -> ::windows_core_sys::PSTR;
    pub fn StrFormatKBSizeW(qdw: i64, pszbuf: ::windows_core_sys::PWSTR, cchbuf: u32) -> ::windows_core_sys::PWSTR;
    pub fn StrFromTimeIntervalA(pszout: ::windows_core_sys::PSTR, cchmax: u32, dwtimems: u32, digits: i32) -> i32;
    pub fn StrFromTimeIntervalW(pszout: ::windows_core_sys::PWSTR, cchmax: u32, dwtimems: u32, digits: i32) -> i32;
    pub fn StrIsIntlEqualA(fcasesens: ::win32_foundation_sys::BOOL, pszstring1: ::windows_core_sys::PCSTR, pszstring2: ::windows_core_sys::PCSTR, nchar: i32) -> ::win32_foundation_sys::BOOL;
    pub fn StrIsIntlEqualW(fcasesens: ::win32_foundation_sys::BOOL, pszstring1: ::windows_core_sys::PCWSTR, pszstring2: ::windows_core_sys::PCWSTR, nchar: i32) -> ::win32_foundation_sys::BOOL;
    pub fn StrNCatA(psz1: ::windows_core_sys::PSTR, psz2: ::windows_core_sys::PCSTR, cchmax: i32) -> ::windows_core_sys::PSTR;
    pub fn StrNCatW(psz1: ::windows_core_sys::PWSTR, psz2: ::windows_core_sys::PCWSTR, cchmax: i32) -> ::windows_core_sys::PWSTR;
    pub fn StrPBrkA(psz: ::windows_core_sys::PCSTR, pszset: ::windows_core_sys::PCSTR) -> ::windows_core_sys::PSTR;
    pub fn StrPBrkW(psz: ::windows_core_sys::PCWSTR, pszset: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::PWSTR;
    pub fn StrRChrA(pszstart: ::windows_core_sys::PCSTR, pszend: ::windows_core_sys::PCSTR, wmatch: u16) -> ::windows_core_sys::PSTR;
    pub fn StrRChrIA(pszstart: ::windows_core_sys::PCSTR, pszend: ::windows_core_sys::PCSTR, wmatch: u16) -> ::windows_core_sys::PSTR;
    pub fn StrRChrIW(pszstart: ::windows_core_sys::PCWSTR, pszend: ::windows_core_sys::PCWSTR, wmatch: u16) -> ::windows_core_sys::PWSTR;
    pub fn StrRChrW(pszstart: ::windows_core_sys::PCWSTR, pszend: ::windows_core_sys::PCWSTR, wmatch: u16) -> ::windows_core_sys::PWSTR;
    pub fn StrRStrIA(pszsource: ::windows_core_sys::PCSTR, pszlast: ::windows_core_sys::PCSTR, pszsrch: ::windows_core_sys::PCSTR) -> ::windows_core_sys::PSTR;
    pub fn StrRStrIW(pszsource: ::windows_core_sys::PCWSTR, pszlast: ::windows_core_sys::PCWSTR, pszsrch: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::PWSTR;
    #[cfg(feature = "win32-ui-sys")]
    pub fn StrRetToBSTR(pstr: *mut Common::STRRET, pidl: *const Common::ITEMIDLIST, pbstr: *mut ::win32_foundation_sys::BSTR) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn StrRetToBufA(pstr: *mut Common::STRRET, pidl: *const Common::ITEMIDLIST, pszbuf: ::windows_core_sys::PSTR, cchbuf: u32) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn StrRetToBufW(pstr: *mut Common::STRRET, pidl: *const Common::ITEMIDLIST, pszbuf: ::windows_core_sys::PWSTR, cchbuf: u32) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn StrRetToStrA(pstr: *mut Common::STRRET, pidl: *const Common::ITEMIDLIST, ppsz: *mut ::windows_core_sys::PSTR) -> ::windows_core_sys::HRESULT;
    #[cfg(feature = "win32-ui-sys")]
    pub fn StrRetToStrW(pstr: *mut Common::STRRET, pidl: *const Common::ITEMIDLIST, ppsz: *mut ::windows_core_sys::PWSTR) -> ::windows_core_sys::HRESULT;
    pub fn StrSpnA(psz: ::windows_core_sys::PCSTR, pszset: ::windows_core_sys::PCSTR) -> i32;
    pub fn StrSpnW(psz: ::windows_core_sys::PCWSTR, pszset: ::windows_core_sys::PCWSTR) -> i32;
    pub fn StrStrA(pszfirst: ::windows_core_sys::PCSTR, pszsrch: ::windows_core_sys::PCSTR) -> ::windows_core_sys::PSTR;
    pub fn StrStrIA(pszfirst: ::windows_core_sys::PCSTR, pszsrch: ::windows_core_sys::PCSTR) -> ::windows_core_sys::PSTR;
    pub fn StrStrIW(pszfirst: ::windows_core_sys::PCWSTR, pszsrch: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::PWSTR;
    pub fn StrStrNIW(pszfirst: ::windows_core_sys::PCWSTR, pszsrch: ::windows_core_sys::PCWSTR, cchmax: u32) -> ::windows_core_sys::PWSTR;
    pub fn StrStrNW(pszfirst: ::windows_core_sys::PCWSTR, pszsrch: ::windows_core_sys::PCWSTR, cchmax: u32) -> ::windows_core_sys::PWSTR;
    pub fn StrStrW(pszfirst: ::windows_core_sys::PCWSTR, pszsrch: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::PWSTR;
    pub fn StrToInt64ExA(pszstring: ::windows_core_sys::PCSTR, dwflags: i32, pllret: *mut i64) -> ::win32_foundation_sys::BOOL;
    pub fn StrToInt64ExW(pszstring: ::windows_core_sys::PCWSTR, dwflags: i32, pllret: *mut i64) -> ::win32_foundation_sys::BOOL;
    pub fn StrToIntA(pszsrc: ::windows_core_sys::PCSTR) -> i32;
    pub fn StrToIntExA(pszstring: ::windows_core_sys::PCSTR, dwflags: i32, piret: *mut i32) -> ::win32_foundation_sys::BOOL;
    pub fn StrToIntExW(pszstring: ::windows_core_sys::PCWSTR, dwflags: i32, piret: *mut i32) -> ::win32_foundation_sys::BOOL;
    pub fn StrToIntW(pszsrc: ::windows_core_sys::PCWSTR) -> i32;
    pub fn StrTrimA(psz: ::windows_core_sys::PSTR, psztrimchars: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn StrTrimW(psz: ::windows_core_sys::PWSTR, psztrimchars: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn UnloadUserProfile(htoken: ::win32_foundation_sys::HANDLE, hprofile: ::win32_foundation_sys::HANDLE) -> ::win32_foundation_sys::BOOL;
    ...
    pub fn UnregisterScaleChangeEvent(dwcookie: usize) -> ::windows_core_sys::HRESULT;
    pub fn UrlApplySchemeA(pszin: ::windows_core_sys::PCSTR, pszout: ::windows_core_sys::PSTR, pcchout: *mut u32, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn UrlApplySchemeW(pszin: ::windows_core_sys::PCWSTR, pszout: ::windows_core_sys::PWSTR, pcchout: *mut u32, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn UrlCanonicalizeA(pszurl: ::windows_core_sys::PCSTR, pszcanonicalized: ::windows_core_sys::PSTR, pcchcanonicalized: *mut u32, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn UrlCanonicalizeW(pszurl: ::windows_core_sys::PCWSTR, pszcanonicalized: ::windows_core_sys::PWSTR, pcchcanonicalized: *mut u32, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn UrlCombineA(pszbase: ::windows_core_sys::PCSTR, pszrelative: ::windows_core_sys::PCSTR, pszcombined: ::windows_core_sys::PSTR, pcchcombined: *mut u32, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn UrlCombineW(pszbase: ::windows_core_sys::PCWSTR, pszrelative: ::windows_core_sys::PCWSTR, pszcombined: ::windows_core_sys::PWSTR, pcchcombined: *mut u32, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn UrlCompareA(psz1: ::windows_core_sys::PCSTR, psz2: ::windows_core_sys::PCSTR, fignoreslash: ::win32_foundation_sys::BOOL) -> i32;
    pub fn UrlCompareW(psz1: ::windows_core_sys::PCWSTR, psz2: ::windows_core_sys::PCWSTR, fignoreslash: ::win32_foundation_sys::BOOL) -> i32;
    pub fn UrlCreateFromPathA(pszpath: ::windows_core_sys::PCSTR, pszurl: ::windows_core_sys::PSTR, pcchurl: *mut u32, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn UrlCreateFromPathW(pszpath: ::windows_core_sys::PCWSTR, pszurl: ::windows_core_sys::PWSTR, pcchurl: *mut u32, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn UrlEscapeA(pszurl: ::windows_core_sys::PCSTR, pszescaped: ::windows_core_sys::PSTR, pcchescaped: *mut u32, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn UrlEscapeW(pszurl: ::windows_core_sys::PCWSTR, pszescaped: ::windows_core_sys::PWSTR, pcchescaped: *mut u32, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn UrlFixupW(pcszurl: ::windows_core_sys::PCWSTR, psztranslatedurl: ::windows_core_sys::PWSTR, cchmax: u32) -> ::windows_core_sys::HRESULT;
    pub fn UrlGetLocationA(pszurl: ::windows_core_sys::PCSTR) -> ::windows_core_sys::PSTR;
    pub fn UrlGetLocationW(pszurl: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::PWSTR;
    pub fn UrlGetPartA(pszin: ::windows_core_sys::PCSTR, pszout: ::windows_core_sys::PSTR, pcchout: *mut u32, dwpart: u32, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn UrlGetPartW(pszin: ::windows_core_sys::PCWSTR, pszout: ::windows_core_sys::PWSTR, pcchout: *mut u32, dwpart: u32, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn UrlHashA(pszurl: ::windows_core_sys::PCSTR, pbhash: *mut u8, cbhash: u32) -> ::windows_core_sys::HRESULT;
    pub fn UrlHashW(pszurl: ::windows_core_sys::PCWSTR, pbhash: *mut u8, cbhash: u32) -> ::windows_core_sys::HRESULT;
    pub fn UrlIsA(pszurl: ::windows_core_sys::PCSTR, urlis: URLIS) -> ::win32_foundation_sys::BOOL;
    pub fn UrlIsNoHistoryA(pszurl: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn UrlIsNoHistoryW(pszurl: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn UrlIsOpaqueA(pszurl: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn UrlIsOpaqueW(pszurl: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn UrlIsW(pszurl: ::windows_core_sys::PCWSTR, urlis: URLIS) -> ::win32_foundation_sys::BOOL;
    pub fn UrlUnescapeA(pszurl: ::windows_core_sys::PSTR, pszunescaped: ::windows_core_sys::PSTR, pcchunescaped: *mut u32, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn UrlUnescapeW(pszurl: ::windows_core_sys::PWSTR, pszunescaped: ::windows_core_sys::PWSTR, pcchunescaped: *mut u32, dwflags: u32) -> ::windows_core_sys::HRESULT;
    pub fn WhichPlatform() -> u32;
    pub fn Win32DeleteFile(pszpath: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn WinHelpA(hwndmain: ::win32_foundation_sys::HWND, lpszhelp: ::windows_core_sys::PCSTR, ucommand: u32, dwdata: usize) -> ::win32_foundation_sys::BOOL;
    pub fn WinHelpW(hwndmain: ::win32_foundation_sys::HWND, lpszhelp: ::windows_core_sys::PCWSTR, ucommand: u32, dwdata: usize) -> ::win32_foundation_sys::BOOL;
    pub fn WriteCabinetState(pcs: *const CABINETSTATE) -> ::win32_foundation_sys::BOOL;
    pub fn wnsprintfA(pszdest: ::windows_core_sys::PSTR, cchdest: i32, pszfmt: ::windows_core_sys::PCSTR) -> i32;
    pub fn wnsprintfW(pszdest: ::windows_core_sys::PWSTR, cchdest: i32, pszfmt: ::windows_core_sys::PCWSTR) -> i32;
    pub fn wvnsprintfA(pszdest: ::windows_core_sys::PSTR, cchdest: i32, pszfmt: ::windows_core_sys::PCSTR, arglist: *const i8) -> i32;
    pub fn wvnsprintfW(pszdest: ::windows_core_sys::PWSTR, cchdest: i32, pszfmt: ::windows_core_sys::PCWSTR, arglist: *const i8) -> i32;
}
#[repr(C)]
...
pub struct APPCATEGORYINFO {
    ...
    pub AppCategoryId: ::windows_core_sys::GUID,
}
...
pub struct APPINFODATA {
    pub cbSize: u32,
    pub dwMask: u32,
    pub pszDisplayName: ::windows_core_sys::PWSTR,
    pub pszVersion: ::windows_core_sys::PWSTR,
    pub pszPublisher: ::windows_core_sys::PWSTR,
    pub pszProductID: ::windows_core_sys::PWSTR,
    pub pszRegisteredOwner: ::windows_core_sys::PWSTR,
    pub pszRegisteredCompany: ::windows_core_sys::PWSTR,
    pub pszLanguage: ::windows_core_sys::PWSTR,
    pub pszSupportUrl: ::windows_core_sys::PWSTR,
    pub pszSupportTelephone: ::windows_core_sys::PWSTR,
    pub pszHelpLink: ::windows_core_sys::PWSTR,
    pub pszInstallLocation: ::windows_core_sys::PWSTR,
    pub pszInstallSource: ::windows_core_sys::PWSTR,
    pub pszInstallDate: ::windows_core_sys::PWSTR,
    pub pszContact: ::windows_core_sys::PWSTR,
    pub pszComments: ::windows_core_sys::PWSTR,
    pub pszImage: ::windows_core_sys::PWSTR,
    pub pszReadmeUrl: ::windows_core_sys::PWSTR,
    pub pszUpdateInfoUrl: ::windows_core_sys::PWSTR,
}
...
pub type APPLET_PROC = ::core::option::Option<unsafe extern "system" fn(hwndcpl: ::win32_foundation_sys::HWND, msg: u32, lparam1: ::win32_foundation_sys::LPARAM, lparam2: ::win32_foundation_sys::LPARAM) -> i32>;
...
pub struct ASSOCIATIONELEMENT {
    pub ac: ASSOCCLASS,
    pub hkClass: ::win32_system_sys::Registry::HKEY,
...
pub struct AUTO_SCROLL_DATA {
    ...
    pub bFull: ::win32_foundation_sys::BOOL,
    pub pts: [::win32_foundation_sys::POINT; 3],
    pub dwTimes: [u32; 3],
}
...
pub const AccessibilityDockingService: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 701373766, data2: 46209, data3: 19104, data4: [160, 138, 211, 235, 200, 172, 164, 2] };
pub const AlphabeticalCategorizer: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1009145030, data2: 29554, data3: 20331, data4: [179, 16, 85, 214, 18, 143, 73, 210] };
pub const AppShellVerbHandler: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1322493721, data2: 52904, data3: 19417, data4: [145, 13, 226, 82, 249, 151, 175, 194] };
pub const AppStartupLink: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 658421223, data2: 34992, data3: 18499, data4: [191, 239, 226, 200, 29, 67, 170, 229] };
pub const AppVisibility: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2120213465, data2: 39007, data3: 18696, data4: [145, 249, 238, 25, 249, 253, 21, 20] };
pub const ApplicationActivationManager: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1169822333, data2: 4264, data3: 18154, data4: [138, 183, 86, 234, 144, 120, 148, 60] };
pub const ApplicationAssociationRegistration: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1494354375, data2: 30331, data3: 17074, data4: [159, 186, 68, 238, 70, 21, 242, 199] };
pub const ApplicationAssociationRegistrationUI: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 426250349, data2: 62389, data3: 17615, data4: [137, 14, 17, 111, 203, 158, 206, 241] };
pub const ApplicationDesignModeSettings: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2508877749, data2: 56498, data3: 20399, data4: [170, 253, 127, 176, 84, 173, 26, 59] };
pub const ApplicationDestinations: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2260811779, data2: 19819, data3: 20211, data4: [167, 180, 5, 6, 102, 59, 46, 104] };
pub const ApplicationDocumentLists: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2260648482, data2: 12530, data3: 18400, data4: [159, 37, 96, 209, 28, 215, 92, 40] };
pub const AttachmentServices: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1093000598, data2: 57402, data3: 16643, data4: [143, 112, 224, 89, 125, 128, 59, 156] };
#[repr(C)]
#[cfg(feature = "win32-ui-sys")]
...
pub struct BANNER_NOTIFICATION {
    ...
    pub providerIdentity: ::windows_core_sys::PCWSTR,
    pub contentId: ::windows_core_sys::PCWSTR,
}
...
pub struct BASEBROWSERDATALH {
    pub _hwnd: ::win32_foundation_sys::HWND,
    pub _ptl: ITravelLog,
    ...
    pub _pctView: ::win32_system_sys::Ole::IOleCommandTarget,
    pub _pidlCur: *mut Common::ITEMIDLIST,
    pub _psv: IShellView,
    pub _psf: IShellFolder,
    pub _hwndView: ::win32_foundation_sys::HWND,
    pub _pszTitleCur: ::windows_core_sys::PWSTR,
    pub _pidlPending: *mut Common::ITEMIDLIST,
    pub _psvPending: IShellView,
    pub _psfPending: IShellFolder,
    pub _hwndViewPending: ::win32_foundation_sys::HWND,
    pub _pszTitlePending: ::windows_core_sys::PWSTR,
    pub _fIsViewMSHTML: ::win32_foundation_sys::BOOL,
    pub _fPrivacyImpacted: ::win32_foundation_sys::BOOL,
    pub _clsidView: ::windows_core_sys::GUID,
    pub _clsidViewPending: ::windows_core_sys::GUID,
    pub _hwndFrame: ::win32_foundation_sys::HWND,
...
pub type BFFCALLBACK = ::core::option::Option<unsafe extern "system" fn(hwnd: ::win32_foundation_sys::HWND, umsg: u32, lparam: ::win32_foundation_sys::LPARAM, lpdata: ::win32_foundation_sys::LPARAM) -> i32>;
...
pub const BHID_AssociationArray: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3198807831, data2: 33521, data3: 20320, data4: [146, 132, 79, 141, 183, 92, 59, 233] };
pub const BHID_DataObject: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3099639199, data2: 60708, data3: 17756, data4: [131, 230, 213, 57, 12, 79, 232, 196] };
pub const BHID_EnumAssocHandlers: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3098217372, data2: 49900, data3: 20346, data4: [145, 141, 49, 73, 0, 230, 40, 10] };
pub const BHID_EnumItems: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2499151129, data2: 10320, data3: 18724, data4: [170, 90, 209, 94, 132, 134, 128, 57] };
pub const BHID_FilePlaceholder: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2256002283, data2: 43744, data3: 16389, data4: [141, 61, 84, 127, 168, 82, 248, 37] };
pub const BHID_Filter: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 953190264, data2: 62807, data3: 18064, data4: [158, 191, 186, 84, 112, 106, 216, 247] };
pub const BHID_LinkTargetItem: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 964813352, data2: 62809, data3: 4563, data4: [142, 58, 0, 192, 79, 104, 55, 213] };
pub const BHID_PropertyStore: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 59040164, data2: 5411, data3: 17308, data4: [164, 200, 171, 145, 16, 82, 245, 134] };
pub const BHID_RandomAccessStream: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4050635067, data2: 30638, data3: 19710, data4: [189, 167, 168, 102, 238, 166, 135, 141] };
pub const BHID_SFObject: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 964813348, data2: 62809, data3: 4563, data4: [142, 58, 0, 192, 79, 104, 55, 213] };
pub const BHID_SFUIObject: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 964813349, data2: 62809, data3: 4563, data4: [142, 58, 0, 192, 79, 104, 55, 213] };
pub const BHID_SFViewObject: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 964813350, data2: 62809, data3: 4563, data4: [142, 58, 0, 192, 79, 104, 55, 213] };
pub const BHID_Storage: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 964813351, data2: 62809, data3: 4563, data4: [142, 58, 0, 192, 79, 104, 55, 213] };
pub const BHID_StorageEnum: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1176610019, data2: 61654, data3: 18291, data4: [138, 156, 70, 231, 123, 23, 72, 64] };
pub const BHID_StorageItem: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1078862089, data2: 30674, data3: 18073, data4: [165, 160, 79, 223, 16, 219, 152, 55] };
pub const BHID_Stream: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 485209003, data2: 31760, data3: 18842, data4: [164, 23, 146, 202, 22, 196, 203, 131] };
pub const BHID_ThumbnailHandler: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2066638090, data2: 36384, data3: 20298, data4: [176, 158, 101, 151, 175, 199, 47, 176] };
pub const BHID_Transfer: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3588441761, data2: 63315, data3: 18738, data4: [180, 3, 69, 116, 128, 14, 36, 152] };
...
pub struct BROWSEINFOA {
    ...
    pub pszDisplayName: ::windows_core_sys::PSTR,
    pub lpszTitle: ::windows_core_sys::PCSTR,
    pub ulFlags: u32,
...
pub struct BROWSEINFOW {
    ...
    pub pidlRoot: *mut Common::ITEMIDLIST,
    pub pszDisplayName: ::windows_core_sys::PWSTR,
    pub lpszTitle: ::windows_core_sys::PCWSTR,
    pub ulFlags: u32,
    pub lpfn: BFFCALLBACK,
    pub lParam: ::win32_foundation_sys::LPARAM,
    pub iImage: i32,
...
pub const CAMERAROLL_E_NO_DOWNSAMPLING_REQUIRED: ::windows_core_sys::HRESULT = -2144927456i32;
...
pub const CATID_BrowsableShellExt: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 136336, data2: 0, data3: 0, data4: [192, 0, 0, 0, 0, 0, 0, 70] };
pub const CATID_BrowseInPlace: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 136337, data2: 0, data3: 0, data4: [192, 0, 0, 0, 0, 0, 0, 70] };
pub const CATID_CommBand: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 136340, data2: 0, data3: 0, data4: [192, 0, 0, 0, 0, 0, 0, 70] };
pub const CATID_DeskBand: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 136338, data2: 0, data3: 0, data4: [192, 0, 0, 0, 0, 0, 0, 70] };
pub const CATID_FilePlaceholderMergeHandler: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1050450513, data2: 54442, data3: 18544, data4: [180, 124, 116, 36, 180, 145, 241, 204] };
pub const CATID_InfoBand: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 136339, data2: 0, data3: 0, data4: [192, 0, 0, 0, 0, 0, 0, 70] };
pub const CATID_LocationFactory: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2522631505, data2: 35702, data3: 20055, data4: [128, 183, 86, 77, 46, 164, 181, 94] };
pub const CATID_LocationProvider: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 456959092, data2: 9748, data3: 16715, data4: [184, 19, 26, 206, 202, 62, 61, 216] };
pub const CATID_SearchableApplication: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 913058090, data2: 55731, data3: 19903, data4: [187, 112, 230, 46, 195, 208, 187, 191] };
...
pub const CDBurn: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4226517509, data2: 48878, data3: 17474, data4: [128, 78, 64, 157, 108, 69, 21, 233] };
...
pub const CGID_DefView: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1257275152, data2: 53809, data3: 4560, data4: [185, 66, 0, 160, 201, 3, 18, 225] };
pub const CGID_Explorer: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 136400, data2: 0, data3: 0, data4: [192, 0, 0, 0, 0, 0, 0, 70] };
pub const CGID_ExplorerBarDoc: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 136403, data2: 0, data3: 0, data4: [192, 0, 0, 0, 0, 0, 0, 70] };
pub const CGID_MENUDESKBAR: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1553926674, data2: 38302, data3: 4560, data4: [163, 164, 0, 160, 201, 8, 38, 54] };
pub const CGID_ShellDocView: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 136401, data2: 0, data3: 0, data4: [192, 0, 0, 0, 0, 0, 0, 70] };
pub const CGID_ShellServiceObject: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 136402, data2: 0, data3: 0, data4: [192, 0, 0, 0, 0, 0, 0, 70] };
pub const CGID_ShortCut: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2477164368, data2: 38170, data3: 4561, data4: [148, 111, 0, 0, 0, 0, 0, 0] };
#[repr(C, packed(1))]
pub struct CIDA {
    pub cidl: u32,
    pub aoffset: [u32; 1],
...
pub const CLSID_ACLCustomMRU: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1765137299, data2: 8680, data3: 19660, data4: [190, 185, 159, 227, 199, 122, 41, 122] };
pub const CLSID_ACLHistory: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 12265316, data2: 27255, data3: 4560, data4: [165, 53, 0, 192, 79, 215, 208, 98] };
pub const CLSID_ACLMRU: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1733731905, data2: 56945, data3: 4560, data4: [131, 27, 0, 170, 0, 91, 67, 131] };
pub const CLSID_ACLMulti: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 12265317, data2: 27255, data3: 4560, data4: [165, 53, 0, 192, 79, 215, 208, 98] };
pub const CLSID_ACListISF: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 62928625, data2: 41350, data3: 4560, data4: [130, 74, 0, 170, 0, 91, 67, 131] };
pub const CLSID_ActiveDesktop: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1963230976, data2: 61215, data3: 4560, data4: [152, 136, 0, 96, 151, 222, 172, 249] };
pub const CLSID_AutoComplete: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 12265315, data2: 27255, data3: 4560, data4: [165, 53, 0, 192, 79, 215, 208, 98] };
pub const CLSID_CAnchorBrowsePropertyPage: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 810611643, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const CLSID_CDocBrowsePropertyPage: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 810611636, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const CLSID_CFSIconOverlayManager: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1672814465, data2: 51304, data3: 4560, data4: [153, 156, 0, 192, 79, 214, 85, 225] };
pub const CLSID_CImageBrowsePropertyPage: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 810611635, data2: 39093, data3: 4559, data4: [187, 130, 0, 170, 0, 189, 206, 11] };
pub const CLSID_CURLSearchHook: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3485445632, data2: 6054, data3: 4560, data4: [153, 203, 0, 192, 79, 214, 68, 151] };
pub const CLSID_CUrlHistory: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1010256448, data2: 47844, data3: 4559, data4: [191, 125, 0, 170, 0, 105, 70, 238] };
pub const CLSID_ControlPanel: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 569122848, data2: 15082, data3: 4201, data4: [162, 221, 8, 0, 43, 48, 48, 157] };
pub const CLSID_DarwinAppPublisher: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3486304160, data2: 41602, data3: 4561, data4: [144, 130, 0, 96, 8, 5, 147, 130] };
pub const CLSID_DocHostUIHandler: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1884809554, data2: 48411, data3: 4561, data4: [137, 25, 0, 192, 79, 194, 200, 54] };
pub const CLSID_DragDropHelper: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1180116874, data2: 16667, data3: 4562, data4: [131, 154, 0, 192, 79, 217, 24, 208] };
pub const CLSID_FileTypes: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2962351424, data2: 33763, data3: 4559, data4: [167, 19, 0, 32, 175, 215, 151, 98] };
pub const CLSID_FolderItemsMultiLevel: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1405569062, data2: 43929, data3: 19763, data4: [172, 164, 49, 23, 245, 29, 55, 136] };
pub const CLSID_FolderShortcut: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 184209105, data2: 59432, data3: 4561, data4: [145, 135, 181, 50, 241, 233, 87, 93] };
pub const CLSID_HWShellExecute: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4290274655, data2: 33209, data3: 20430, data4: [184, 156, 154, 107, 167, 109, 19, 231] };
pub const CLSID_ISFBand: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3626754736, data2: 22372, data3: 4560, data4: [169, 110, 0, 192, 79, 215, 5, 162] };
pub const CLSID_Internet: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2266780544, data2: 17056, data3: 4201, data4: [162, 234, 8, 0, 43, 48, 48, 157] };
pub const CLSID_InternetButtons: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 511273344, data2: 40133, data3: 4561, data4: [168, 63, 0, 192, 79, 201, 157, 97] };
pub const CLSID_InternetShortcut: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4226956096, data2: 58352, data3: 4123, data4: [132, 136, 0, 170, 0, 62, 86, 248] };
pub const CLSID_LinkColumnProvider: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 619794178, data2: 31516, data3: 4561, data4: [131, 143, 0, 0, 248, 4, 97, 207] };
pub const CLSID_MSOButtons: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 395261112, data2: 41602, data3: 4562, data4: [134, 197, 0, 192, 79, 142, 234, 153] };
pub const CLSID_MenuBand: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1531817510, data2: 47111, data3: 4560, data4: [152, 21, 0, 192, 79, 217, 25, 114] };
pub const CLSID_MenuBandSite: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3778999524, data2: 54002, data3: 4560, data4: [152, 22, 0, 192, 79, 217, 25, 114] };
pub const CLSID_MenuToolbarBase: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1085892112, data2: 46370, data3: 4561, data4: [179, 180, 0, 170, 0, 110, 253, 231] };
pub const CLSID_MyComputer: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 550522848, data2: 15082, data3: 4201, data4: [162, 216, 8, 0, 43, 48, 48, 157] };
pub const CLSID_MyDocuments: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1158516666, data2: 44325, data3: 4560, data4: [152, 168, 8, 0, 54, 27, 17, 3] };
pub const CLSID_NetworkDomain: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1189111424, data2: 19440, data3: 4561, data4: [131, 238, 0, 160, 201, 13, 200, 73] };
pub const CLSID_NetworkServer: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3226741392, data2: 19440, data3: 4561, data4: [131, 238, 0, 160, 201, 13, 200, 73] };
pub const CLSID_NetworkShare: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1420252352, data2: 19440, data3: 4561, data4: [131, 238, 0, 160, 201, 13, 200, 73] };
pub const CLSID_NewMenu: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3647578880, data2: 59391, data3: 4560, data4: [169, 59, 0, 160, 201, 15, 39, 25] };
pub const CLSID_Printers: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 573022848, data2: 15082, data3: 4201, data4: [162, 222, 8, 0, 43, 48, 48, 157] };
pub const CLSID_ProgressDialog: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4164434002, data2: 64723, data3: 4561, data4: [166, 185, 0, 96, 151, 223, 91, 212] };
pub const CLSID_QueryAssociations: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2691708157, data2: 27818, data3: 18772, data4: [172, 63, 151, 162, 114, 22, 249, 138] };
pub const CLSID_QuickLinks: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 240959265, data2: 53599, data3: 4560, data4: [131, 1, 0, 170, 0, 91, 67, 131] };
pub const CLSID_RecycleBin: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1684009024, data2: 20609, data3: 4123, data4: [159, 8, 0, 170, 0, 47, 149, 78] };
pub const CLSID_ShellFldSetExt: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1834161088, data2: 35938, data3: 4561, data4: [178, 205, 0, 96, 151, 223, 140, 17] };
pub const CLSID_ShellThumbnailDiskCache: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 515755904, data2: 41472, data3: 4560, data4: [163, 164, 0, 192, 79, 215, 6, 236] };
pub const CLSID_ToolbarExtButtons: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 753186264, data2: 41615, data3: 4562, data4: [134, 197, 0, 192, 79, 142, 234, 153] };
...
pub struct CMINVOKECOMMANDINFO {
    ...
    pub fMask: u32,
    pub hwnd: ::win32_foundation_sys::HWND,
    pub lpVerb: ::windows_core_sys::PCSTR,
    pub lpParameters: ::windows_core_sys::PCSTR,
    pub lpDirectory: ::windows_core_sys::PCSTR,
    pub nShow: i32,
    pub dwHotKey: u32,
    pub hIcon: ::win32_foundation_sys::HANDLE,
}
...
pub struct CMINVOKECOMMANDINFOEX {
    ...
    pub dwHotKey: u32,
    pub hIcon: ::win32_foundation_sys::HANDLE,
    pub lpTitle: ::windows_core_sys::PCSTR,
    pub lpVerbW: ::windows_core_sys::PCWSTR,
    pub lpParametersW: ::windows_core_sys::PCWSTR,
    pub lpDirectoryW: ::windows_core_sys::PCWSTR,
    pub lpTitleW: ::windows_core_sys::PCWSTR,
    pub ptInvoke: ::win32_foundation_sys::POINT,
}
...
pub struct CMINVOKECOMMANDINFOEX_REMOTE {
    ...
    pub fMask: u32,
    pub hwnd: ::win32_foundation_sys::HWND,
    pub lpVerbString: ::windows_core_sys::PCSTR,
    pub lpParameters: ::windows_core_sys::PCSTR,
    pub lpDirectory: ::windows_core_sys::PCSTR,
    pub nShow: i32,
    pub dwHotKey: u32,
    pub lpTitle: ::windows_core_sys::PCSTR,
    pub lpVerbWString: ::windows_core_sys::PCWSTR,
    pub lpParametersW: ::windows_core_sys::PCWSTR,
    pub lpDirectoryW: ::windows_core_sys::PCWSTR,
    pub lpTitleW: ::windows_core_sys::PCWSTR,
    pub ptInvoke: ::win32_foundation_sys::POINT,
...
pub struct CONFIRM_CONFLICT_ITEM {
    ...
    pub pszOriginalName: ::windows_core_sys::PWSTR,
    pub pszAlternateName: ::windows_core_sys::PWSTR,
    pub pszLocationShort: ::windows_core_sys::PWSTR,
    pub pszLocationFull: ::windows_core_sys::PWSTR,
...
pub struct CONFIRM_CONFLICT_RESULT_INFO {
    pub pszNewName: ::windows_core_sys::PWSTR,
    pub iItemIndex: u32,
}
...
pub const COPYENGINE_E_ACCESSDENIED_READONLY: ::windows_core_sys::HRESULT = -2144927681i32;
pub const COPYENGINE_E_ACCESS_DENIED_DEST: ::windows_core_sys::HRESULT = -2144927710i32;
pub const COPYENGINE_E_ACCESS_DENIED_SRC: ::windows_core_sys::HRESULT = -2144927711i32;
pub const COPYENGINE_E_ALREADY_EXISTS_FOLDER: ::windows_core_sys::HRESULT = -2144927700i32;
pub const COPYENGINE_E_ALREADY_EXISTS_NORMAL: ::windows_core_sys::HRESULT = -2144927703i32;
pub const COPYENGINE_E_ALREADY_EXISTS_READONLY: ::windows_core_sys::HRESULT = -2144927702i32;
pub const COPYENGINE_E_ALREADY_EXISTS_SYSTEM: ::windows_core_sys::HRESULT = -2144927701i32;
pub const COPYENGINE_E_BLOCKED_BY_DLP_POLICY: ::windows_core_sys::HRESULT = -2144927666i32;
pub const COPYENGINE_E_BLOCKED_BY_EDP_FOR_REMOVABLE_DRIVE: ::windows_core_sys::HRESULT = -2144927670i32;
pub const COPYENGINE_E_BLOCKED_BY_EDP_POLICY: ::windows_core_sys::HRESULT = -2144927672i32;
pub const COPYENGINE_E_CANCELLED: ::windows_core_sys::HRESULT = -2144927743i32;
pub const COPYENGINE_E_CANNOT_MOVE_FROM_RECYCLE_BIN: ::windows_core_sys::HRESULT = -2144927677i32;
pub const COPYENGINE_E_CANNOT_MOVE_SHARED_FOLDER: ::windows_core_sys::HRESULT = -2144927676i32;
pub const COPYENGINE_E_CANT_REACH_SOURCE: ::windows_core_sys::HRESULT = -2144927691i32;
pub const COPYENGINE_E_DEST_IS_RO_CD: ::windows_core_sys::HRESULT = -2144927729i32;
pub const COPYENGINE_E_DEST_IS_RO_DVD: ::windows_core_sys::HRESULT = -2144927726i32;
pub const COPYENGINE_E_DEST_IS_RW_CD: ::windows_core_sys::HRESULT = -2144927728i32;
pub const COPYENGINE_E_DEST_IS_RW_DVD: ::windows_core_sys::HRESULT = -2144927725i32;
pub const COPYENGINE_E_DEST_IS_R_CD: ::windows_core_sys::HRESULT = -2144927727i32;
pub const COPYENGINE_E_DEST_IS_R_DVD: ::windows_core_sys::HRESULT = -2144927724i32;
pub const COPYENGINE_E_DEST_SAME_TREE: ::windows_core_sys::HRESULT = -2144927734i32;
pub const COPYENGINE_E_DEST_SUBTREE: ::windows_core_sys::HRESULT = -2144927735i32;
pub const COPYENGINE_E_DIFF_DIR: ::windows_core_sys::HRESULT = -2144927740i32;
pub const COPYENGINE_E_DIR_NOT_EMPTY: ::windows_core_sys::HRESULT = -2144927683i32;
pub const COPYENGINE_E_DISK_FULL: ::windows_core_sys::HRESULT = -2144927694i32;
pub const COPYENGINE_E_DISK_FULL_CLEAN: ::windows_core_sys::HRESULT = -2144927693i32;
pub const COPYENGINE_E_EA_LOSS: ::windows_core_sys::HRESULT = -2144927698i32;
pub const COPYENGINE_E_EA_NOT_SUPPORTED: ::windows_core_sys::HRESULT = -2144927692i32;
pub const COPYENGINE_E_ENCRYPTION_LOSS: ::windows_core_sys::HRESULT = -2144927695i32;
pub const COPYENGINE_E_FAT_MAX_IN_ROOT: ::windows_core_sys::HRESULT = -2144927682i32;
pub const COPYENGINE_E_FILE_IS_FLD_DEST: ::windows_core_sys::HRESULT = -2144927732i32;
pub const COPYENGINE_E_FILE_TOO_LARGE: ::windows_core_sys::HRESULT = -2144927731i32;
pub const COPYENGINE_E_FLD_IS_FILE_DEST: ::windows_core_sys::HRESULT = -2144927733i32;
pub const COPYENGINE_E_INTERNET_ITEM_STORAGE_PROVIDER_ERROR: ::windows_core_sys::HRESULT = -2144927675i32;
pub const COPYENGINE_E_INTERNET_ITEM_STORAGE_PROVIDER_PAUSED: ::windows_core_sys::HRESULT = -2144927674i32;
pub const COPYENGINE_E_INTERNET_ITEM_UNAVAILABLE: ::windows_core_sys::HRESULT = -2144927678i32;
pub const COPYENGINE_E_INVALID_FILES_DEST: ::windows_core_sys::HRESULT = -2144927716i32;
pub const COPYENGINE_E_INVALID_FILES_SRC: ::windows_core_sys::HRESULT = -2144927717i32;
pub const COPYENGINE_E_MANY_SRC_1_DEST: ::windows_core_sys::HRESULT = -2144927739i32;
pub const COPYENGINE_E_NET_DISCONNECT_DEST: ::windows_core_sys::HRESULT = -2144927706i32;
pub const COPYENGINE_E_NET_DISCONNECT_SRC: ::windows_core_sys::HRESULT = -2144927707i32;
pub const COPYENGINE_E_NEWFILE_NAME_TOO_LONG: ::windows_core_sys::HRESULT = -2144927685i32;
pub const COPYENGINE_E_NEWFOLDER_NAME_TOO_LONG: ::windows_core_sys::HRESULT = -2144927684i32;
pub const COPYENGINE_E_PATH_NOT_FOUND_DEST: ::windows_core_sys::HRESULT = -2144927708i32;
pub const COPYENGINE_E_PATH_NOT_FOUND_SRC: ::windows_core_sys::HRESULT = -2144927709i32;
pub const COPYENGINE_E_PATH_TOO_DEEP_DEST: ::windows_core_sys::HRESULT = -2144927714i32;
pub const COPYENGINE_E_PATH_TOO_DEEP_SRC: ::windows_core_sys::HRESULT = -2144927715i32;
pub const COPYENGINE_E_PROPERTIES_LOSS: ::windows_core_sys::HRESULT = -2144927696i32;
pub const COPYENGINE_E_PROPERTY_LOSS: ::windows_core_sys::HRESULT = -2144927697i32;
pub const COPYENGINE_E_RECYCLE_BIN_NOT_FOUND: ::windows_core_sys::HRESULT = -2144927686i32;
pub const COPYENGINE_E_RECYCLE_FORCE_NUKE: ::windows_core_sys::HRESULT = -2144927690i32;
pub const COPYENGINE_E_RECYCLE_PATH_TOO_LONG: ::windows_core_sys::HRESULT = -2144927688i32;
pub const COPYENGINE_E_RECYCLE_SIZE_TOO_BIG: ::windows_core_sys::HRESULT = -2144927689i32;
pub const COPYENGINE_E_RECYCLE_UNKNOWN_ERROR: ::windows_core_sys::HRESULT = -2144927691i32;
pub const COPYENGINE_E_REDIRECTED_TO_WEBPAGE: ::windows_core_sys::HRESULT = -2144927680i32;
pub const COPYENGINE_E_REMOVABLE_FULL: ::windows_core_sys::HRESULT = -2144927730i32;
pub const COPYENGINE_E_REQUIRES_EDP_CONSENT: ::windows_core_sys::HRESULT = -2144927673i32;
pub const COPYENGINE_E_REQUIRES_EDP_CONSENT_FOR_REMOVABLE_DRIVE: ::windows_core_sys::HRESULT = -2144927671i32;
pub const COPYENGINE_E_REQUIRES_ELEVATION: ::windows_core_sys::HRESULT = -2144927742i32;
pub const COPYENGINE_E_RMS_BLOCKED_BY_EDP_FOR_REMOVABLE_DRIVE: ::windows_core_sys::HRESULT = -2144927668i32;
pub const COPYENGINE_E_RMS_REQUIRES_EDP_CONSENT_FOR_REMOVABLE_DRIVE: ::windows_core_sys::HRESULT = -2144927669i32;
pub const COPYENGINE_E_ROOT_DIR_DEST: ::windows_core_sys::HRESULT = -2144927712i32;
pub const COPYENGINE_E_ROOT_DIR_SRC: ::windows_core_sys::HRESULT = -2144927713i32;
pub const COPYENGINE_E_SAME_FILE: ::windows_core_sys::HRESULT = -2144927741i32;
pub const COPYENGINE_E_SERVER_BAD_FILE_TYPE: ::windows_core_sys::HRESULT = -2144927679i32;
pub const COPYENGINE_E_SHARING_VIOLATION_DEST: ::windows_core_sys::HRESULT = -2144927704i32;
pub const COPYENGINE_E_SHARING_VIOLATION_SRC: ::windows_core_sys::HRESULT = -2144927705i32;
pub const COPYENGINE_E_SILENT_FAIL_BY_DLP_POLICY: ::windows_core_sys::HRESULT = -2144927665i32;
pub const COPYENGINE_E_SRC_IS_RO_CD: ::windows_core_sys::HRESULT = -2144927723i32;
pub const COPYENGINE_E_SRC_IS_RO_DVD: ::windows_core_sys::HRESULT = -2144927720i32;
pub const COPYENGINE_E_SRC_IS_RW_CD: ::windows_core_sys::HRESULT = -2144927722i32;
pub const COPYENGINE_E_SRC_IS_RW_DVD: ::windows_core_sys::HRESULT = -2144927719i32;
pub const COPYENGINE_E_SRC_IS_R_CD: ::windows_core_sys::HRESULT = -2144927721i32;
pub const COPYENGINE_E_SRC_IS_R_DVD: ::windows_core_sys::HRESULT = -2144927718i32;
pub const COPYENGINE_E_STREAM_LOSS: ::windows_core_sys::HRESULT = -2144927699i32;
pub const COPYENGINE_E_USER_CANCELLED: ::windows_core_sys::HRESULT = -2144927744i32;
pub const COPYENGINE_E_WARNED_BY_DLP_POLICY: ::windows_core_sys::HRESULT = -2144927667i32;
pub const COPYENGINE_S_ALREADY_DONE: ::windows_core_sys::HRESULT = 2555914i32;
pub const COPYENGINE_S_CLOSE_PROGRAM: ::windows_core_sys::HRESULT = 2555917i32;
pub const COPYENGINE_S_COLLISIONRESOLVED: ::windows_core_sys::HRESULT = 2555918i32;
pub const COPYENGINE_S_DONT_PROCESS_CHILDREN: ::windows_core_sys::HRESULT = 2555912i32;
pub const COPYENGINE_S_KEEP_BOTH: ::windows_core_sys::HRESULT = 2555916i32;
pub const COPYENGINE_S_MERGE: ::windows_core_sys::HRESULT = 2555910i32;
pub const COPYENGINE_S_NOT_HANDLED: ::windows_core_sys::HRESULT = 2555907i32;
pub const COPYENGINE_S_PENDING: ::windows_core_sys::HRESULT = 2555915i32;
pub const COPYENGINE_S_PROGRESS_PAUSE: ::windows_core_sys::HRESULT = 2555919i32;
pub const COPYENGINE_S_USER_IGNORED: ::windows_core_sys::HRESULT = 2555909i32;
pub const COPYENGINE_S_USER_RETRY: ::windows_core_sys::HRESULT = 2555908i32;
pub const COPYENGINE_S_YES: ::windows_core_sys::HRESULT = 2555905i32;
pub const CPFG_CREDENTIAL_PROVIDER_LABEL: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 678150131, data2: 47828, data3: 17295, data4: [176, 7, 121, 183, 38, 124, 61, 72] };
pub const CPFG_CREDENTIAL_PROVIDER_LOGO: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 763590517, data2: 63181, data3: 17998, data4: [167, 69, 72, 47, 208, 180, 116, 147] };
pub const CPFG_LOGON_PASSWORD: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1617054970, data2: 42103, data3: 18353, data4: [138, 142, 58, 74, 25, 152, 24, 39] };
pub const CPFG_LOGON_USERNAME: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3658857448, data2: 38221, data3: 20435, data4: [176, 244, 31, 181, 185, 11, 23, 75] };
pub const CPFG_SMARTCARD_PIN: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1340417595, data2: 37249, data3: 18113, data4: [176, 164, 157, 237, 212, 219, 125, 234] };
pub const CPFG_SMARTCARD_USERNAME: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1042206569, data2: 22156, data3: 19862, data4: [157, 89, 70, 68, 65, 116, 226, 214] };
pub const CPFG_STANDALONE_SUBMIT_BUTTON: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 192613080, data2: 52278, data3: 19801, data4: [128, 43, 130, 247, 20, 250, 112, 34] };
pub const CPFG_STYLE_LINK_AS_BUTTON: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 143631624, data2: 38054, data3: 17456, data4: [164, 203, 111, 198, 227, 192, 185, 226] };
#[repr(C, packed(1))]
pub struct CPLINFO {
    pub idIcon: i32,
    pub idName: i32,
...
pub struct CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATION {
    ...
    pub clsidCredentialProvider: ::windows_core_sys::GUID,
...
pub struct CREDENTIAL_PROVIDER_FIELD_DESCRIPTOR {
    ...
    pub pszLabel: ::windows_core_sys::PWSTR,
    pub guidFieldType: ::windows_core_sys::GUID,
}
...
pub const CScriptErrorList: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4023390976, data2: 5647, data3: 4562, data4: [187, 46, 0, 128, 95, 247, 239, 202] };
...
pub const ConflictFolder: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 681146540, data2: 41217, data3: 17217, data4: [168, 23, 33, 235, 167, 253, 4, 109] };
#[repr(C, packed(1))]
...
pub struct DEFCONTEXTMENU {
    ...
    pub punkAssociationInfo: ::windows_core_sys::IUnknown,
    pub cKeys: u32,
    pub aKeys: *const ::win32_system_sys::Registry::HKEY,
}
#[cfg(all(feature = "win32-system-sys", feature = "win32-ui-sys"))]
...
pub struct DESKBANDINFO {
    pub dwMask: u32,
    pub ptMinSize: ::win32_foundation_sys::POINTL,
    pub ptMaxSize: ::win32_foundation_sys::POINTL,
    pub ptIntegral: ::win32_foundation_sys::POINTL,
    pub ptActual: ::win32_foundation_sys::POINTL,
...
pub struct DFMICS {
    ...
    pub punkSite: ::windows_core_sys::IUnknown,
}
...
pub type DLLGETVERSIONPROC = ::core::option::Option<unsafe extern "system" fn(param0: *mut DLLVERSIONINFO) -> ::windows_core_sys::HRESULT>;
#[repr(C)]
...
pub struct DRAGINFOA {
    ...
    pub fNC: ::win32_foundation_sys::BOOL,
    pub lpFileList: ::windows_core_sys::PSTR,
    pub grfKeyState: u32,
}
#[cfg(any(target_arch = "aarch64", target_arch = "x86_64"))]
...
pub struct DRAGINFOW {
    ...
    pub pt: ::win32_foundation_sys::POINT,
    pub fNC: ::win32_foundation_sys::BOOL,
    pub lpFileList: ::windows_core_sys::PWSTR,
    pub grfKeyState: u32,
}
#[cfg(any(target_arch = "aarch64", target_arch = "x86_64"))]
...
pub struct DROPFILES {
    ...
    pub pt: ::win32_foundation_sys::POINT,
    pub fNC: ::win32_foundation_sys::BOOL,
    pub fWide: ::win32_foundation_sys::BOOL,
}
...
pub const DefFolderMenu: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3325264574, data2: 31027, data3: 18640, data4: [154, 200, 133, 251, 70, 190, 47, 221] };
pub const DesktopGadget: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2454506523, data2: 25954, data3: 19589, data4: [134, 87, 209, 119, 146, 82, 34, 182] };
pub const DesktopWallpaper: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3268358416, data2: 17934, data3: 20417, data4: [185, 208, 138, 28, 12, 156, 196, 189] };
pub const DestinationList: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2012286192, data2: 15797, data3: 18790, data4: [181, 32, 183, 197, 79, 211, 94, 214] };
pub const DocPropShellExtension: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2285073347, data2: 49033, data3: 4561, data4: [190, 53, 8, 0, 54, 177, 26, 3] };
pub const DriveSizeCategorizer: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2486532947, data2: 51753, data3: 19320, data4: [131, 174, 232, 254, 116, 9, 19, 79] };
pub const DriveTypeCategorizer: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2963862479, data2: 17203, data3: 19371, data4: [136, 115, 28, 203, 28, 173, 164, 139] };
...
pub const EP_AdvQueryPane: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3035224971, data2: 13498, data3: 19513, data4: [181, 204, 22, 161, 189, 44, 65, 28] };
pub const EP_Commands: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3648280680, data2: 51807, data3: 19062, data4: [145, 205, 245, 161, 41, 251, 176, 118] };
pub const EP_Commands_Organize: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1927812864, data2: 58348, data3: 18016, data4: [191, 36, 60, 59, 123, 100, 136, 6] };
pub const EP_Commands_View: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 569885485, data2: 61098, data3: 17307, data4: [187, 81, 55, 185, 111, 214, 169, 67] };
pub const EP_DetailsPane: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1135344011, data2: 35256, data3: 18221, data4: [185, 206, 230, 155, 130, 41, 240, 25] };
pub const EP_NavPane: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3409013538, data2: 9719, data3: 17080, data4: [138, 9, 84, 13, 35, 164, 60, 47] };
pub const EP_PreviewPane: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2302436305, data2: 17864, data3: 19735, data4: [190, 25, 34, 59, 231, 27, 227, 101] };
pub const EP_QueryPane: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1706876495, data2: 20231, data3: 20263, data4: [131, 167, 26, 252, 164, 223, 125, 221] };
pub const EP_Ribbon: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3530892456, data2: 51698, data3: 18484, data4: [161, 6, 223, 136, 137, 253, 79, 55] };
pub const EP_StatusBar: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1711167182, data2: 23806, data3: 19396, data4: [173, 138, 122, 227, 254, 126, 143, 124] };
pub const EXECUTE_E_LAUNCH_APPLICATION: ::windows_core_sys::HRESULT = -2144927487i32;
...
pub struct EXP_DARWIN_LINK {
    ...
    pub szDarwinID: [::win32_foundation_sys::CHAR; 260],
...
pub struct EXP_SZ_LINK {
    pub cbSize: u32,
    pub dwSignature: u32,
    pub szTarget: [::win32_foundation_sys::CHAR; 260],
...
pub struct EXTRASEARCH {
    pub guidSearch: ::windows_core_sys::GUID,
...
pub const E_ACTIVATIONDENIED_SHELLERROR: ::windows_core_sys::HRESULT = -2144927439i32;
pub const E_ACTIVATIONDENIED_SHELLNOTREADY: ::windows_core_sys::HRESULT = -2144927436i32;
pub const E_ACTIVATIONDENIED_SHELLRESTART: ::windows_core_sys::HRESULT = -2144927438i32;
pub const E_ACTIVATIONDENIED_UNEXPECTED: ::windows_core_sys::HRESULT = -2144927437i32;
pub const E_ACTIVATIONDENIED_USERCLOSE: ::windows_core_sys::HRESULT = -2144927440i32;
pub const E_FILE_PLACEHOLDER_NOT_INITIALIZED: ::windows_core_sys::HRESULT = -2144927472i32;
pub const E_FILE_PLACEHOLDER_SERVER_TIMED_OUT: ::windows_core_sys::HRESULT = -2144927470i32;
pub const E_FILE_PLACEHOLDER_STORAGEPROVIDER_NOT_FOUND: ::windows_core_sys::HRESULT = -2144927469i32;
pub const E_FILE_PLACEHOLDER_VERSION_MISMATCH: ::windows_core_sys::HRESULT = -2144927471i32;
pub const E_FLAGS: ::windows_core_sys::HRESULT = -2147217408i32;
pub const E_IMAGEFEED_CHANGEDISABLED: ::windows_core_sys::HRESULT = -2144926960i32;
pub const E_NOTVALIDFORANIMATEDIMAGE: ::windows_core_sys::HRESULT = -2147221503i32;
pub const E_PREVIEWHANDLER_CORRUPT: ::windows_core_sys::HRESULT = -2042494972i32;
pub const E_PREVIEWHANDLER_DRM_FAIL: ::windows_core_sys::HRESULT = -2042494975i32;
pub const E_PREVIEWHANDLER_NOAUTH: ::windows_core_sys::HRESULT = -2042494974i32;
pub const E_PREVIEWHANDLER_NOTFOUND: ::windows_core_sys::HRESULT = -2042494973i32;
pub const E_SHELL_EXTENSION_BLOCKED: ::windows_core_sys::HRESULT = -2144926975i32;
pub const E_TILE_NOTIFICATIONS_PLATFORM_FAILURE: ::windows_core_sys::HRESULT = -2144927159i32;
pub const E_USERTILE_CHANGEDISABLED: ::windows_core_sys::HRESULT = -2144927215i32;
pub const E_USERTILE_FILESIZE: ::windows_core_sys::HRESULT = -2144927212i32;
pub const E_USERTILE_LARGEORDYNAMIC: ::windows_core_sys::HRESULT = -2144927214i32;
pub const E_USERTILE_UNSUPPORTEDFILETYPE: ::windows_core_sys::HRESULT = -2144927216i32;
pub const E_USERTILE_VIDEOFRAMESIZE: ::windows_core_sys::HRESULT = -2144927213i32;
pub const EnumerableObjectCollection: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 758409409, data2: 13991, data3: 17334, data4: [172, 36, 211, 240, 47, 217, 96, 122] };
pub const ExecuteFolder: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 299611260, data2: 42277, data3: 16395, data4: [158, 128, 165, 70, 21, 160, 144, 192] };
pub const ExecuteUnknown: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3830354984, data2: 48572, data3: 18823, data4: [160, 153, 64, 220, 143, 210, 85, 231] };
pub const ExplorerBrowser: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1912169349, data2: 56790, data3: 18643, data4: [160, 193, 174, 6, 232, 176, 85, 251] };
...
pub const FMTID_Briefcase: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 848136993, data2: 30505, data3: 19452, data4: [149, 76, 144, 43, 50, 157, 86, 176] };
pub const FMTID_CustomImageProperties: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2127399694, data2: 49462, data3: 19099, data4: [148, 17, 78, 189, 102, 115, 204, 195] };
pub const FMTID_DRM: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2930514404, data2: 35246, data3: 17672, data4: [185, 183, 187, 134, 122, 190, 226, 237] };
pub const FMTID_Displaced: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2601995059, data2: 16639, data3: 4562, data4: [162, 126, 0, 192, 79, 195, 8, 113] };
pub const FMTID_ImageProperties: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 347610529, data2: 309, data3: 19761, data4: [150, 217, 108, 191, 201, 103, 26, 153] };
pub const FMTID_InternetSite: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 136353, data2: 0, data3: 0, data4: [192, 0, 0, 0, 0, 0, 0, 70] };
pub const FMTID_Intshcut: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 136352, data2: 0, data3: 0, data4: [192, 0, 0, 0, 0, 0, 0, 70] };
pub const FMTID_LibraryProperties: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1568061055, data2: 39741, data3: 17595, data4: [182, 174, 37, 218, 79, 99, 138, 103] };
pub const FMTID_MUSIC: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1453537070, data2: 52892, data3: 4562, data4: [159, 14, 0, 96, 151, 198, 134, 246] };
pub const FMTID_Misc: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2601995060, data2: 16639, data3: 4562, data4: [162, 126, 0, 192, 79, 195, 8, 113] };
pub const FMTID_Query: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1231625360, data2: 32279, data3: 4122, data4: [169, 28, 8, 0, 43, 46, 205, 169] };
pub const FMTID_ShellDetails: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 677604006, data2: 38205, data3: 4562, data4: [181, 214, 0, 192, 79, 217, 24, 208] };
pub const FMTID_Storage: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3072717104, data2: 18415, data3: 4122, data4: [165, 241, 2, 96, 140, 158, 235, 172] };
pub const FMTID_Volume: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2601995061, data2: 16639, data3: 4562, data4: [162, 126, 0, 192, 79, 195, 8, 113] };
pub const FMTID_WebView: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4062663808, data2: 63362, data3: 17041, data4: [189, 148, 241, 54, 147, 81, 58, 236] };
...
pub const FOLDERID_AccountPictures: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 9216177, data2: 21940, data3: 19542, data4: [184, 168, 77, 228, 178, 153, 211, 190] };
pub const FOLDERID_AddNewPrograms: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3730954609, data2: 24252, data3: 20226, data4: [163, 169, 108, 130, 137, 94, 92, 4] };
pub const FOLDERID_AdminTools: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1917776240, data2: 42029, data3: 20463, data4: [159, 38, 182, 14, 132, 111, 186, 79] };
pub const FOLDERID_AllAppMods: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2060875929, data2: 26287, data3: 17338, data4: [145, 86, 106, 173, 66, 230, 197, 150] };
pub const FOLDERID_AppCaptures: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3988848241, data2: 39128, data3: 20298, data4: [185, 32, 200, 220, 19, 60, 177, 101] };
pub const FOLDERID_AppDataDesktop: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2999313017, data2: 31453, data3: 17311, data4: [178, 140, 196, 31, 225, 187, 246, 114] };
pub const FOLDERID_AppDataDocuments: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2078369296, data2: 8063, data3: 17580, data4: [191, 240, 131, 225, 95, 47, 252, 161] };
pub const FOLDERID_AppDataFavorites: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2096885692, data2: 56863, data3: 17834, data4: [184, 67, 165, 66, 172, 83, 108, 201] };
pub const FOLDERID_AppDataProgramData: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1436369059, data2: 41014, data3: 16634, data4: [175, 97, 132, 203, 67, 10, 77, 52] };
pub const FOLDERID_AppUpdates: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2735066777, data2: 62759, data3: 18731, data4: [139, 26, 126, 118, 250, 152, 214, 228] };
pub const FOLDERID_ApplicationShortcuts: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2744223617, data2: 58866, data3: 18576, data4: [179, 217, 167, 229, 67, 50, 50, 140] };
pub const FOLDERID_AppsFolder: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 512184461, data2: 35266, data3: 17136, data4: [138, 126, 100, 90, 15, 80, 202, 88] };
pub const FOLDERID_CDBurning: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2656217872, data2: 63501, data3: 18911, data4: [172, 184, 67, 48, 245, 104, 120, 85] };
pub const FOLDERID_CameraRoll: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2875177083, data2: 31970, data3: 20355, data4: [145, 93, 85, 8, 70, 201, 83, 123] };
pub const FOLDERID_CameraRollLibrary: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 723574645, data2: 7898, data3: 16441, data4: [128, 151, 56, 121, 130, 39, 213, 183] };
pub const FOLDERID_ChangeRemovePrograms: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3748816556, data2: 37492, data3: 18535, data4: [141, 85, 59, 214, 97, 222, 135, 45] };
pub const FOLDERID_CommonAdminTools: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3493351037, data2: 47811, data3: 18327, data4: [143, 20, 203, 162, 41, 179, 146, 181] };
pub const FOLDERID_CommonOEMLinks: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3250250448, data2: 4319, data3: 17204, data4: [190, 221, 122, 162, 11, 34, 122, 157] };
pub const FOLDERID_CommonPrograms: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 20567118, data2: 27390, data3: 18930, data4: [134, 144, 61, 175, 202, 230, 255, 184] };
pub const FOLDERID_CommonStartMenu: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2752599833, data2: 54830, data3: 18717, data4: [170, 124, 231, 75, 139, 227, 176, 103] };
pub const FOLDERID_CommonStartMenuPlaces: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2755692447, data2: 34720, data3: 20349, data4: [183, 0, 2, 7, 185, 102, 25, 74] };
pub const FOLDERID_CommonStartup: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2191911477, data2: 55757, data3: 18373, data4: [150, 41, 225, 93, 47, 113, 78, 110] };
pub const FOLDERID_CommonTemplates: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3108124647, data2: 22444, data3: 17223, data4: [145, 81, 176, 140, 108, 50, 209, 247] };
pub const FOLDERID_ComputerFolder: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 180388732, data2: 48120, data3: 17706, data4: [133, 13, 121, 208, 142, 102, 124, 167] };
pub const FOLDERID_ConflictFolder: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1275001669, data2: 13437, data3: 16390, data4: [165, 190, 172, 12, 176, 86, 113, 146] };
pub const FOLDERID_ConnectionsFolder: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1863113003, data2: 11927, data3: 17873, data4: [136, 255, 176, 209, 134, 184, 222, 221] };
pub const FOLDERID_Contacts: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1450723412, data2: 50891, data3: 17963, data4: [129, 105, 136, 227, 80, 172, 184, 130] };
pub const FOLDERID_ControlPanelFolder: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2192001771, data2: 44724, data3: 18012, data4: [160, 20, 208, 151, 238, 52, 109, 99] };
pub const FOLDERID_Cookies: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 722433629, data2: 49385, data3: 16753, data4: [144, 142, 8, 166, 17, 184, 79, 246] };
pub const FOLDERID_CurrentAppMods: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1035209504, data2: 10800, data3: 19902, data4: [145, 126, 119, 29, 210, 29, 208, 153] };
pub const FOLDERID_Desktop: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3032468538, data2: 56108, data3: 16972, data4: [176, 41, 127, 233, 154, 135, 198, 65] };
pub const FOLDERID_DevelopmentFiles: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3689472142, data2: 12371, data3: 19388, data4: [177, 131, 42, 123, 43, 25, 30, 89] };
pub const FOLDERID_Device: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 472564188, data2: 17240, data3: 19308, data4: [151, 51, 175, 33, 21, 101, 118, 240] };
pub const FOLDERID_DeviceMetadataStore: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1558488553, data2: 58603, data3: 18333, data4: [184, 159, 19, 12, 2, 136, 97, 85] };
pub const FOLDERID_Documents: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4258503376, data2: 9103, data3: 18095, data4: [173, 180, 108, 133, 72, 3, 105, 199] };
pub const FOLDERID_DocumentsLibrary: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2064494973, data2: 40146, data3: 19091, data4: [151, 51, 70, 204, 137, 2, 46, 124] };
pub const FOLDERID_Downloads: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 927851152, data2: 4671, data3: 17765, data4: [145, 100, 57, 196, 146, 94, 70, 123] };
pub const FOLDERID_Favorites: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 393738081, data2: 26797, data3: 19850, data4: [135, 189, 48, 183, 89, 250, 51, 221] };
pub const FOLDERID_Fonts: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4246899895, data2: 44561, data3: 19171, data4: [134, 76, 22, 243, 145, 10, 184, 254] };
pub const FOLDERID_GameTasks: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 89108065, data2: 19928, data3: 18311, data4: [128, 182, 9, 2, 32, 196, 183, 0] };
pub const FOLDERID_Games: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3401919514, data2: 46397, data3: 20188, data4: [146, 215, 107, 46, 138, 193, 148, 52] };
pub const FOLDERID_History: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3655109179, data2: 46980, data3: 17198, data4: [167, 129, 90, 17, 48, 167, 89, 99] };
pub const FOLDERID_HomeGroup: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1381141099, data2: 47587, data3: 19165, data4: [182, 13, 88, 140, 45, 186, 132, 45] };
pub const FOLDERID_HomeGroupCurrentUser: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2608117411, data2: 3581, data3: 20241, data4: [158, 120, 95, 120, 0, 242, 231, 114] };
pub const FOLDERID_ImplicitAppShortcuts: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3165988207, data2: 31222, data3: 19694, data4: [183, 37, 220, 52, 228, 2, 253, 70] };
pub const FOLDERID_InternetCache: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 891585000, data2: 13246, data3: 16977, data4: [186, 133, 96, 7, 202, 237, 207, 157] };
pub const FOLDERID_InternetFolder: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1302296692, data2: 19980, data3: 18692, data4: [150, 123, 64, 176, 210, 12, 62, 75] };
pub const FOLDERID_Libraries: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 457090524, data2: 46471, data3: 18310, data4: [180, 239, 189, 29, 195, 50, 174, 174] };
pub const FOLDERID_Links: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3216627168, data2: 50857, data3: 16460, data4: [178, 178, 174, 109, 182, 175, 73, 104] };
pub const FOLDERID_LocalAppData: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4055050117, data2: 28602, data3: 20431, data4: [157, 85, 123, 142, 127, 21, 112, 145] };
pub const FOLDERID_LocalAppDataLow: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2770379172, data2: 6016, data3: 20470, data4: [189, 24, 22, 115, 67, 197, 175, 22] };
pub const FOLDERID_LocalDocuments: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4096713427, data2: 37023, data3: 18695, data4: [136, 113, 76, 34, 252, 11, 247, 86] };
pub const FOLDERID_LocalDownloads: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2105798299, data2: 8772, data3: 20080, data4: [177, 245, 83, 147, 4, 42, 241, 228] };
pub const FOLDERID_LocalMusic: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2697370265, data2: 8648, data3: 18033, data4: [135, 3, 121, 52, 22, 47, 207, 29] };
pub const FOLDERID_LocalPictures: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 232587613, data2: 45164, data3: 17877, data4: [140, 76, 245, 151, 19, 133, 70, 57] };
pub const FOLDERID_LocalStorage: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3018524883, data2: 41459, data3: 18795, data4: [134, 90, 66, 181, 54, 205, 160, 236] };
pub const FOLDERID_LocalVideos: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 891841128, data2: 15447, data3: 16801, data4: [187, 177, 14, 174, 115, 215, 108, 149] };
pub const FOLDERID_LocalizedResourcesDir: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 704657246, data2: 8780, data3: 18910, data4: [184, 209, 68, 13, 247, 239, 61, 220] };
pub const FOLDERID_Music: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1272501617, data2: 27929, data3: 18643, data4: [190, 151, 66, 34, 32, 8, 14, 67] };
pub const FOLDERID_MusicLibrary: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 554871562, data2: 51306, data3: 20478, data4: [163, 104, 13, 233, 110, 71, 1, 46] };
pub const FOLDERID_NetHood: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3316367187, data2: 57727, data3: 16673, data4: [137, 0, 134, 98, 111, 194, 201, 115] };
pub const FOLDERID_NetworkFolder: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3523997380, data2: 23720, data3: 18693, data4: [174, 59, 191, 37, 30, 160, 155, 83] };
pub const FOLDERID_Objects3D: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 834723109, data2: 37945, data3: 20242, data4: [191, 65, 127, 244, 237, 163, 135, 34] };
pub const FOLDERID_OneDrive: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2771106374, data2: 59873, data3: 17247, data4: [179, 217, 40, 218, 166, 72, 192, 246] };
pub const FOLDERID_OriginalImages: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 741785770, data2: 22546, data3: 19335, data4: [191, 208, 76, 208, 223, 177, 155, 57] };
pub const FOLDERID_PhotoAlbums: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1775423376, data2: 64563, data3: 20407, data4: [154, 12, 235, 176, 240, 252, 180, 60] };
pub const FOLDERID_Pictures: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 870482224, data2: 19998, data3: 18038, data4: [131, 90, 152, 57, 92, 59, 195, 187] };
pub const FOLDERID_PicturesLibrary: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2844831391, data2: 41019, data3: 20096, data4: [148, 188, 153, 18, 215, 80, 65, 4] };
pub const FOLDERID_Playlists: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3734159815, data2: 33663, data3: 20329, data4: [163, 187, 134, 230, 49, 32, 74, 35] };
pub const FOLDERID_PrintHood: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2457124237, data2: 53201, data3: 16835, data4: [179, 94, 177, 63, 85, 167, 88, 244] };
pub const FOLDERID_PrintersFolder: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1996246573, data2: 54957, data3: 17689, data4: [166, 99, 55, 189, 86, 6, 129, 133] };
pub const FOLDERID_Profile: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1584170383, data2: 3618, data3: 18272, data4: [154, 254, 234, 51, 23, 182, 113, 115] };
pub const FOLDERID_ProgramData: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1655397762, data2: 64961, data3: 19907, data4: [169, 221, 7, 13, 29, 73, 93, 151] };
pub const FOLDERID_ProgramFiles: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2422105014, data2: 49599, data3: 18766, data4: [178, 156, 101, 183, 50, 211, 210, 26] };
pub const FOLDERID_ProgramFilesCommon: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4159827205, data2: 40813, data3: 18338, data4: [170, 174, 41, 211, 23, 198, 240, 102] };
pub const FOLDERID_ProgramFilesCommonX64: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1667618215, data2: 3853, data3: 17893, data4: [135, 246, 13, 165, 107, 106, 79, 125] };
pub const FOLDERID_ProgramFilesCommonX86: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3734457636, data2: 55750, data3: 19774, data4: [191, 145, 244, 69, 81, 32, 185, 23] };
pub const FOLDERID_ProgramFilesX64: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1837142903, data2: 27376, data3: 17483, data4: [137, 87, 163, 119, 63, 2, 32, 14] };
pub const FOLDERID_ProgramFilesX86: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2086289647, data2: 41211, data3: 19452, data4: [135, 74, 192, 242, 224, 185, 250, 142] };
pub const FOLDERID_Programs: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2810142071, data2: 11819, data3: 17603, data4: [166, 162, 171, 166, 1, 5, 74, 81] };
pub const FOLDERID_Public: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3755964066, data2: 51242, data3: 19811, data4: [144, 106, 86, 68, 172, 69, 115, 133] };
pub const FOLDERID_PublicDesktop: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3299488781, data2: 61967, data3: 18531, data4: [175, 239, 248, 126, 242, 230, 186, 37] };
pub const FOLDERID_PublicDocuments: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3980928175, data2: 56548, data3: 17832, data4: [129, 226, 252, 121, 101, 8, 54, 52] };
pub const FOLDERID_PublicDownloads: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1029983387, data2: 8120, data3: 20272, data4: [155, 69, 246, 112, 35, 95, 121, 192] };
pub const FOLDERID_PublicGameTasks: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3737068854, data2: 57768, data3: 19545, data4: [182, 162, 65, 69, 134, 71, 106, 234] };
pub const FOLDERID_PublicLibraries: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1222309899, data2: 59087, data3: 20302, data4: [184, 0, 14, 105, 216, 78, 227, 132] };
pub const FOLDERID_PublicMusic: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 840235701, data2: 38743, data3: 17048, data4: [187, 97, 146, 169, 222, 170, 68, 255] };
pub const FOLDERID_PublicPictures: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3068918662, data2: 26887, data3: 16700, data4: [154, 247, 79, 194, 171, 240, 124, 197] };
pub const FOLDERID_PublicRingtones: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3847596896, data2: 5435, data3: 19735, data4: [159, 4, 165, 254, 153, 252, 21, 236] };
pub const FOLDERID_PublicUserTiles: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 75673452, data2: 2289, data3: 19508, data4: [140, 144, 225, 126, 201, 139, 30, 23] };
pub const FOLDERID_PublicVideos: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 603985978, data2: 24965, data3: 18939, data4: [162, 216, 74, 57, 42, 96, 43, 163] };
pub const FOLDERID_QuickLaunch: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1386541089, data2: 31605, data3: 18601, data4: [159, 107, 75, 135, 162, 16, 188, 143] };
pub const FOLDERID_Recent: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2924527745, data2: 60370, data3: 17290, data4: [134, 85, 138, 9, 46, 52, 152, 122] };
pub const FOLDERID_RecordedCalls: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 797655234, data2: 33773, data3: 18670, data4: [179, 131, 161, 241, 87, 236, 111, 154] };
pub const FOLDERID_RecordedTVLibrary: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 443538338, data2: 62509, data3: 17240, data4: [167, 152, 183, 77, 116, 89, 38, 197] };
pub const FOLDERID_RecycleBinFolder: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3075686470, data2: 16075, data3: 19480, data4: [190, 78, 100, 205, 76, 183, 214, 172] };
pub const FOLDERID_ResourceDir: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2328955953, data2: 10971, data3: 17046, data4: [168, 247, 228, 112, 18, 50, 201, 114] };
pub const FOLDERID_RetailDemo: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 315934366, data2: 9389, data3: 18723, data4: [190, 25, 49, 50, 28, 67, 167, 103] };
pub const FOLDERID_Ringtones: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3362784331, data2: 62622, data3: 16678, data4: [169, 195, 181, 42, 31, 244, 17, 232] };
pub const FOLDERID_RoamedTileImages: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2863191461, data2: 61910, data3: 16985, data4: [186, 168, 120, 231, 239, 96, 131, 94] };
pub const FOLDERID_RoamingAppData: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1052149211, data2: 26105, data3: 19702, data4: [160, 58, 227, 239, 101, 114, 159, 61] };
pub const FOLDERID_RoamingTiles: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 12385370, data2: 60820, data3: 20040, data4: [150, 161, 63, 98, 23, 242, 25, 144] };
pub const FOLDERID_SEARCH_CSC: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3996312646, data2: 12746, data3: 19130, data4: [129, 79, 165, 235, 210, 253, 109, 94] };
pub const FOLDERID_SEARCH_MAPI: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2565606936, data2: 8344, data3: 19780, data4: [134, 68, 102, 151, 147, 21, 162, 129] };
pub const FOLDERID_SampleMusic: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2991638120, data2: 62845, data3: 20193, data4: [166, 60, 41, 14, 231, 209, 170, 31] };
pub const FOLDERID_SamplePictures: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3297772864, data2: 9081, data3: 19573, data4: [132, 75, 100, 230, 250, 248, 113, 107] };
pub const FOLDERID_SamplePlaylists: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 365586867, data2: 12526, data3: 18881, data4: [172, 225, 107, 94, 195, 114, 175, 181] };
pub const FOLDERID_SampleVideos: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2241768852, data2: 11909, data3: 18605, data4: [167, 26, 9, 105, 203, 86, 166, 205] };
pub const FOLDERID_SavedGames: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1281110783, data2: 48029, data3: 17328, data4: [181, 180, 45, 114, 229, 78, 170, 164] };
pub const FOLDERID_SavedPictures: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 991508610, data2: 54189, data3: 20139, data4: [150, 90, 105, 130, 157, 31, 181, 159] };
pub const FOLDERID_SavedPicturesLibrary: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3797637138, data2: 48776, data3: 19417, data4: [148, 176, 41, 35, 52, 119, 182, 195] };
pub const FOLDERID_SavedSearches: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2099067396, data2: 57019, data3: 16661, data4: [149, 207, 47, 41, 218, 41, 32, 218] };
pub const FOLDERID_Screenshots: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3082739329, data2: 57236, data3: 18050, data4: [167, 216, 87, 165, 38, 32, 184, 111] };
pub const FOLDERID_SearchHistory: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 223100342, data2: 931, data3: 17967, data4: [160, 230, 8, 146, 76, 65, 181, 212] };
pub const FOLDERID_SearchHome: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 419641297, data2: 47306, data3: 16673, data4: [166, 57, 109, 71, 45, 22, 151, 42] };
pub const FOLDERID_SearchTemplates: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2120444926, data2: 57257, data3: 19806, data4: [180, 86, 215, 179, 152, 81, 216, 169] };
pub const FOLDERID_SendTo: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2307064684, data2: 10176, data3: 16459, data4: [143, 8, 16, 45, 16, 220, 253, 116] };
pub const FOLDERID_SidebarDefaultParts: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2067361364, data2: 40645, data3: 17152, data4: [190, 10, 36, 130, 235, 174, 26, 38] };
pub const FOLDERID_SidebarParts: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2807903790, data2: 20732, data3: 20407, data4: [172, 44, 168, 190, 170, 49, 68, 147] };
pub const FOLDERID_SkyDrive: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2771106374, data2: 59873, data3: 17247, data4: [179, 217, 40, 218, 166, 72, 192, 246] };
pub const FOLDERID_SkyDriveCameraRoll: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1987995665, data2: 18891, data3: 17011, data4: [135, 194, 32, 243, 85, 225, 8, 91] };
pub const FOLDERID_SkyDriveDocuments: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 618176036, data2: 12057, data3: 17716, data4: [157, 222, 106, 102, 113, 251, 184, 254] };
pub const FOLDERID_SkyDriveMusic: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3287434654, data2: 32982, data3: 17884, data4: [191, 239, 31, 118, 159, 43, 231, 48] };
pub const FOLDERID_SkyDrivePictures: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 865540533, data2: 35911, data3: 18580, data4: [148, 194, 216, 247, 122, 221, 68, 166] };
pub const FOLDERID_StartMenu: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1650152387, data2: 43848, data3: 20161, data4: [186, 31, 161, 239, 65, 70, 252, 25] };
pub const FOLDERID_StartMenuAllPrograms: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4066575855, data2: 26952, data3: 16569, data4: [178, 85, 129, 69, 61, 9, 199, 133] };
pub const FOLDERID_Startup: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3111985339, data2: 62570, data3: 19607, data4: [186, 16, 94, 54, 8, 67, 8, 84] };
pub const FOLDERID_SyncManagerFolder: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1130793976, data2: 49486, data3: 18866, data4: [151, 201, 116, 119, 132, 215, 132, 183] };
pub const FOLDERID_SyncResultsFolder: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 681220675, data2: 48708, data3: 16471, data4: [164, 27, 88, 122, 118, 215, 231, 249] };
pub const FOLDERID_SyncSetupFolder: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 253837624, data2: 45523, data3: 19088, data4: [187, 169, 39, 203, 192, 197, 56, 154] };
pub const FOLDERID_System: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 448876151, data2: 743, data3: 20061, data4: [183, 68, 46, 177, 174, 81, 152, 183] };
pub const FOLDERID_SystemX86: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3595710896, data2: 45809, data3: 18519, data4: [164, 206, 168, 231, 198, 234, 125, 39] };
pub const FOLDERID_Templates: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2788332520, data2: 26190, data3: 18651, data4: [160, 121, 223, 117, 158, 5, 9, 247] };
pub const FOLDERID_UserPinned: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2654573995, data2: 8092, data3: 20243, data4: [184, 39, 72, 178, 75, 108, 113, 116] };
pub const FOLDERID_UserProfiles: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 123916914, data2: 50442, data3: 19376, data4: [163, 130, 105, 125, 205, 114, 155, 128] };
pub const FOLDERID_UserProgramFiles: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1557638882, data2: 8729, data3: 19047, data4: [184, 93, 108, 156, 225, 86, 96, 203] };
pub const FOLDERID_UserProgramFilesCommon: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3166515287, data2: 51804, data3: 17954, data4: [180, 45, 188, 86, 219, 10, 229, 22] };
pub const FOLDERID_UsersFiles: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4090367868, data2: 18689, data3: 19148, data4: [134, 72, 213, 212, 75, 4, 239, 143] };
pub const FOLDERID_UsersLibraries: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2734838877, data2: 57087, data3: 17995, data4: [171, 232, 97, 200, 100, 141, 147, 155] };
pub const FOLDERID_Videos: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 412654365, data2: 39349, data3: 17755, data4: [132, 28, 171, 124, 116, 228, 221, 252] };
pub const FOLDERID_VideosLibrary: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1226740271, data2: 22083, data3: 19188, data4: [167, 235, 78, 122, 19, 141, 129, 116] };
pub const FOLDERID_Windows: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4086035460, data2: 7491, data3: 17138, data4: [147, 5, 103, 222, 11, 40, 252, 35] };
...
pub struct FOLDERSETDATA {
    ...
    pub _vidRestore: ::windows_core_sys::GUID,
...
pub const FOLDERTYPEID_AccountPictures: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3676986767, data2: 1766, data3: 16391, data4: [171, 166, 175, 135, 125, 82, 110, 166] };
pub const FOLDERTYPEID_Communications: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2437373925, data2: 22635, data3: 20154, data4: [141, 117, 209, 116, 52, 184, 205, 246] };
pub const FOLDERTYPEID_CompressedFolder: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2149662338, data2: 48381, data3: 19535, data4: [136, 23, 187, 39, 96, 18, 103, 169] };
pub const FOLDERTYPEID_Contacts: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3727388908, data2: 39927, data3: 19091, data4: [189, 61, 36, 63, 120, 129, 212, 146] };
pub const FOLDERTYPEID_ControlPanelCategory: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3729720928, data2: 64016, data3: 19343, data4: [164, 148, 6, 139, 32, 178, 35, 7] };
pub const FOLDERTYPEID_ControlPanelClassic: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 204969203, data2: 46405, data3: 17322, data4: [163, 41, 195, 116, 48, 197, 141, 42] };
pub const FOLDERTYPEID_Documents: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2101991206, data2: 15393, data3: 20229, data4: [153, 170, 253, 194, 201, 71, 70, 86] };
pub const FOLDERTYPEID_Downloads: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2287605870, data2: 42048, data3: 19162, data4: [129, 43, 219, 135, 27, 148, 34, 89] };
pub const FOLDERTYPEID_Games: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3062477008, data2: 30419, data3: 19643, data4: [135, 247, 88, 93, 14, 12, 224, 112] };
pub const FOLDERTYPEID_Generic: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1548691637, data2: 63593, data3: 20100, data4: [142, 96, 241, 29, 185, 124, 92, 199] };
pub const FOLDERTYPEID_GenericLibrary: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1598991258, data2: 26675, data3: 20321, data4: [137, 157, 49, 207, 70, 151, 157, 73] };
pub const FOLDERTYPEID_GenericSearchResults: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2145262110, data2: 35633, data3: 18853, data4: [147, 184, 107, 225, 76, 250, 73, 67] };
pub const FOLDERTYPEID_Invalid: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1468037272, data2: 35919, data3: 17506, data4: [187, 99, 113, 4, 35, 128, 177, 9] };
pub const FOLDERTYPEID_Music: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2497109452, data2: 19048, data3: 16757, data4: [163, 116, 189, 88, 74, 81, 11, 120] };
pub const FOLDERTYPEID_NetworkExplorer: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 634135595, data2: 39548, data3: 20305, data4: [128, 224, 122, 41, 40, 254, 190, 66] };
pub const FOLDERTYPEID_OpenSearch: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2410649129, data2: 6528, data3: 18175, data4: [128, 35, 157, 206, 171, 156, 62, 227] };
pub const FOLDERTYPEID_OtherUsers: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3006790912, data2: 40405, data3: 17973, data4: [166, 212, 218, 51, 253, 16, 43, 122] };
pub const FOLDERTYPEID_Pictures: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3010006616, data2: 59745, data3: 16955, data4: [182, 135, 56, 110, 191, 216, 50, 57] };
pub const FOLDERTYPEID_Printers: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 746307270, data2: 51268, data3: 18954, data4: [145, 250, 206, 246, 245, 156, 253, 161] };
pub const FOLDERTYPEID_PublishedItems: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2133810070, data2: 65396, data3: 16858, data4: [175, 216, 28, 120, 165, 243, 174, 162] };
pub const FOLDERTYPEID_RecordedTV: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1431806607, data2: 23974, data3: 20355, data4: [136, 9, 194, 201, 138, 17, 166, 250] };
pub const FOLDERTYPEID_RecycleBin: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3604602884, data2: 52615, data3: 17451, data4: [157, 87, 94, 10, 235, 79, 111, 114] };
pub const FOLDERTYPEID_SavedGames: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3493212935, data2: 10443, data3: 16646, data4: [159, 35, 41, 86, 227, 229, 224, 231] };
pub const FOLDERTYPEID_SearchConnector: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2552702446, data2: 28487, data3: 18334, data4: [180, 71, 129, 43, 250, 125, 46, 143] };
pub const FOLDERTYPEID_SearchHome: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2202896964, data2: 2420, data3: 20182, data4: [134, 110, 242, 3, 216, 11, 56, 16] };
pub const FOLDERTYPEID_Searches: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 185311971, data2: 16479, data3: 16734, data4: [166, 238, 202, 214, 37, 32, 120, 83] };
pub const FOLDERTYPEID_SoftwareExplorer: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3597941019, data2: 21209, data3: 19975, data4: [131, 78, 103, 201, 134, 16, 243, 157] };
pub const FOLDERTYPEID_StartMenu: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4018648267, data2: 62158, data3: 18309, data4: [134, 88, 76, 166, 198, 62, 56, 198] };
pub const FOLDERTYPEID_StorageProviderDocuments: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3714170214, data2: 28904, data3: 18653, data4: [150, 85, 101, 197, 225, 170, 194, 209] };
pub const FOLDERTYPEID_StorageProviderGeneric: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1325525957, data2: 9093, data3: 16882, data4: [162, 142, 44, 92, 145, 251, 86, 224] };
pub const FOLDERTYPEID_StorageProviderMusic: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1731120510, data2: 44804, data3: 17305, data4: [135, 92, 2, 144, 132, 91, 98, 71] };
pub const FOLDERTYPEID_StorageProviderPictures: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1909867177, data2: 62129, data3: 17101, data4: [173, 146, 235, 147, 0, 199, 204, 10] };
pub const FOLDERTYPEID_StorageProviderVideos: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1361661345, data2: 55217, data3: 18523, data4: [158, 154, 23, 207, 254, 51, 225, 135] };
pub const FOLDERTYPEID_UserFiles: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3440363163, data2: 29154, data3: 18149, data4: [150, 144, 91, 205, 159, 87, 170, 179] };
pub const FOLDERTYPEID_UsersLibraries: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3302592265, data2: 24868, data3: 20448, data4: [153, 66, 130, 100, 22, 8, 45, 169] };
pub const FOLDERTYPEID_Videos: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1604936711, data2: 32375, data3: 18492, data4: [172, 147, 105, 29, 5, 133, 13, 232] };
...
pub const FSCopyHandler: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3516348426, data2: 2681, data3: 19912, data4: [160, 51, 237, 136, 44, 47, 161, 75] };
...
pub const FileOpenDialog: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3692845724, data2: 59530, data3: 19934, data4: [165, 161, 96, 248, 42, 32, 174, 247] };
pub const FileOperation: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 986731893, data2: 34903, data3: 18512, data4: [146, 119, 17, 184, 91, 219, 142, 9] };
pub const FileSaveDialog: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3233080051, data2: 47649, data3: 18291, data4: [141, 186, 51, 94, 201, 70, 235, 139] };
pub const FileSearchBand: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3303944691, data2: 18280, data3: 4562, data4: [190, 92, 0, 160, 201, 168, 61, 161] };
...
pub const FolderViewHost: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 548522787, data2: 26984, data3: 20153, data4: [183, 212, 166, 109, 0, 208, 124, 238] };
pub const FrameworkInputPane: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3574729379, data2: 18106, data3: 17605, data4: [130, 45, 202, 128, 146, 193, 252, 114] };
pub const FreeSpaceCategorizer: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3042998163, data2: 9388, data3: 17607, data4: [130, 226, 131, 23, 38, 170, 108, 183] };
...
pub const GenericCredentialProvider: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 634108310, data2: 37613, data3: 17790, data4: [178, 140, 71, 116, 8, 75, 213, 98] };
...
pub struct HELPINFO {
    ...
    pub iCtrlId: i32,
    pub hItemHandle: ::win32_foundation_sys::HANDLE,
    pub dwContextId: usize,
    pub MousePos: ::win32_foundation_sys::POINT,
}
...
pub struct HELPWININFOA {
    ...
    pub dy: i32,
    pub wMax: i32,
    pub rgchMember: [::win32_foundation_sys::CHAR; 2],
}
...
pub struct HLBWINFO {
    pub cbSize: u32,
    pub grfHLBWIF: u32,
    pub rcFramePos: ::win32_foundation_sys::RECT,
    pub rcDocPos: ::win32_foundation_sys::RECT,
...
pub const HLINK_E_FIRST: ::windows_core_sys::HRESULT = -2147221248i32;
pub const HLINK_S_DONTHIDE: i32 = 262400i32;
pub const HLINK_S_FIRST: ::windows_core_sys::HRESULT = 262400i32;
#[repr(C)]
pub struct HLITEM {
    pub uHLID: u32,
...
pub struct HLTBINFO {
    pub uDockType: u32,
    pub rcTbPos: ::win32_foundation_sys::RECT,
}
...
pub const HideInputPaneAnimationCoordinator: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 944194225, data2: 10871, data3: 19635, data4: [140, 248, 17, 54, 245, 225, 126, 89] };
pub const HomeGroup: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3732388356, data2: 15506, data3: 19729, data4: [161, 165, 66, 53, 42, 83, 224, 227] };
...
pub const IENamespaceTreeControl: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2900700419, data2: 58829, data3: 19232, data4: [130, 255, 231, 27, 17, 190, 174, 29] };
...
pub const IMM_ACC_DOCKING_E_DOCKOCCUPIED: ::windows_core_sys::HRESULT = -2144927183i32;
pub const IMM_ACC_DOCKING_E_INSUFFICIENTHEIGHT: ::windows_core_sys::HRESULT = -2144927184i32;
pub const IMSC_E_SHELL_COMPONENT_STARTUP_FAILURE: ::windows_core_sys::HRESULT = -2144927181i32;
...
pub const IS_E_EXEC_FAILED: ::windows_core_sys::HRESULT = -2147213310i32;
...
pub const Identity_LocalUserProvider: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2711114395, data2: 29455, data3: 16521, data4: [182, 70, 161, 37, 87, 245, 102, 94] };
pub const ImageProperties: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2058842311, data2: 3619, data3: 19834, data4: [138, 162, 25, 191, 173, 71, 152, 41] };
pub const ImageRecompress: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1848838428, data2: 54008, data3: 18240, data4: [181, 94, 46, 17, 209, 71, 122, 44] };
pub const ImageTranscode: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 397889894, data2: 37519, data3: 16765, data4: [150, 133, 100, 170, 19, 85, 101, 193] };
pub const InputPanelConfiguration: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 676572627, data2: 61590, data3: 19555, data4: [167, 143, 127, 163, 234, 131, 127, 183] };
pub const InternetExplorer: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 188161, data2: 0, data3: 0, data4: [192, 0, 0, 0, 0, 0, 0, 70] };
pub const InternetExplorerMedium: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3588752413, data2: 37391, data3: 17897, data4: [184, 251, 177, 222, 184, 44, 110, 94] };
pub const InternetPrintOrdering: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2916313768, data2: 29978, data3: 17785, data4: [162, 102, 214, 111, 82, 2, 204, 187] };
pub const ItemCount_Property_GUID: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2881444933, data2: 23756, data3: 18359, data4: [187, 78, 135, 203, 135, 187, 209, 98] };
pub const ItemIndex_Property_GUID: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2459980762, data2: 10601, data3: 16417, data4: [191, 39, 81, 76, 252, 46, 74, 105] };
...
pub struct KNOWNFOLDER_DEFINITION {
    ...
    pub pszDescription: ::windows_core_sys::PWSTR,
    pub fidParent: ::windows_core_sys::GUID,
    pub pszRelativePath: ::windows_core_sys::PWSTR,
    pub pszParsingName: ::windows_core_sys::PWSTR,
    pub pszTooltip: ::windows_core_sys::PWSTR,
    pub pszLocalizedName: ::windows_core_sys::PWSTR,
    pub pszIcon: ::windows_core_sys::PWSTR,
    pub pszSecurity: ::windows_core_sys::PWSTR,
    pub dwAttributes: u32,
    pub kfdFlags: u32,
    pub ftidType: ::windows_core_sys::GUID,
}
...
pub const KnownFolderManager: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1307625264, data2: 57245, data3: 19171, data4: [145, 83, 170, 107, 130, 233, 121, 90] };
...
pub const LIBRARY_E_NO_ACCESSIBLE_LOCATION: ::windows_core_sys::HRESULT = -2144927231i32;
pub const LIBRARY_E_NO_SAVE_LOCATION: ::windows_core_sys::HRESULT = -2144927232i32;
pub const LINK_E_DELETE: ::windows_core_sys::HRESULT = -2144927485i32;
#[cfg(feature = "win32-system-sys")]
pub type LPFNDFMCALLBACK = ::core::option::Option<unsafe extern "system" fn(psf: IShellFolder, hwnd: ::win32_foundation_sys::HWND, pdtobj: ::win32_system_sys::Com::IDataObject, umsg: u32, wparam: ::win32_foundation_sys::WPARAM, lparam: ::win32_foundation_sys::LPARAM) -> ::windows_core_sys::HRESULT>;
#[cfg(feature = "win32-system-sys")]
pub type LPFNVIEWCALLBACK = ::core::option::Option<unsafe extern "system" fn(psvouter: IShellView, psf: IShellFolder, hwndmain: ::win32_foundation_sys::HWND, umsg: u32, wparam: ::win32_foundation_sys::WPARAM, lparam: ::win32_foundation_sys::LPARAM) -> ::windows_core_sys::HRESULT>;
pub const LocalThumbnailCache: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1357858116, data2: 44191, data3: 19086, data4: [178, 27, 138, 38, 24, 13, 177, 63] };
...
pub struct MULTIKEYHELPA {
    pub mkSize: u32,
    pub mkKeylist: ::win32_foundation_sys::CHAR,
    pub szKeyphrase: [::win32_foundation_sys::CHAR; 1],
}
...
pub const MailRecipient: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2656484960, data2: 50447, data3: 4559, data4: [154, 44, 0, 160, 201, 10, 144, 206] };
pub const MergedCategorizer: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2390916113, data2: 13287, data3: 19393, data4: [178, 66, 140, 217, 161, 194, 179, 4] };
...
pub const NETCACHE_E_NEGATIVE_CACHE: ::windows_core_sys::HRESULT = -2144927488i32;
#[repr(C, packed(1))]
#[cfg(feature = "win32-ui-sys")]
pub struct NEWCPLINFOA {
    ...
    pub szName: [::win32_foundation_sys::CHAR; 32],
    pub szInfo: [::win32_foundation_sys::CHAR; 64],
    pub szHelpFile: [::win32_foundation_sys::CHAR; 128],
}
#[cfg(feature = "win32-ui-sys")]
...
pub struct NOTIFYICONDATAA {
    ...
    pub uCallbackMessage: u32,
    pub hIcon: super::WindowsAndMessaging::HICON,
    pub szTip: [::win32_foundation_sys::CHAR; 128],
    pub dwState: u32,
    pub dwStateMask: u32,
    pub szInfo: [::win32_foundation_sys::CHAR; 256],
    pub Anonymous: NOTIFYICONDATAA_0,
    pub szInfoTitle: [::win32_foundation_sys::CHAR; 64],
    pub dwInfoFlags: u32,
    pub guidItem: ::windows_core_sys::GUID,
...
pub const NPCredentialProvider: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1037483712, data2: 33171, data3: 20478, data4: [174, 37, 224, 142, 57, 234, 64, 99] };
#[repr(C)]
#[cfg(feature = "win32-networkmanagement-sys")]
pub struct NRESARRAY {
    pub cItems: u32,
    pub nr: [::win32_networkmanagement_sys::WNet::NETRESOURCEA; 1],
}
#[cfg(feature = "win32-networkmanagement-sys")]
...
pub struct NSTCCUSTOMDRAW {
    ...
    pub uItemState: u32,
    pub nstcis: u32,
    pub pszText: ::windows_core_sys::PCWSTR,
    pub iImage: i32,
...
pub struct NT_CONSOLE_PROPS {
    ...
    pub dwScreenBufferSize: ::win32_system_sys::Console::COORD,
    pub dwWindowSize: ::win32_system_sys::Console::COORD,
    pub dwWindowOrigin: ::win32_system_sys::Console::COORD,
    pub nFont: u32,
    pub nInputBufferSize: u32,
    pub dwFontSize: ::win32_system_sys::Console::COORD,
    pub uFontFamily: u32,
    pub uFontWeight: u32,
    pub FaceName: [u16; 32],
    pub uCursorSize: u32,
    pub bFullScreen: ::win32_foundation_sys::BOOL,
    pub bQuickEdit: ::win32_foundation_sys::BOOL,
    pub bInsertMode: ::win32_foundation_sys::BOOL,
    pub bAutoPosition: ::win32_foundation_sys::BOOL,
    pub uHistoryBufferSize: u32,
    pub uNumberOfHistoryBuffers: u32,
    pub bHistoryNoDup: ::win32_foundation_sys::BOOL,
...
pub const NamespaceTreeControl: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2919580178, data2: 13621, data3: 17456, data4: [131, 237, 213, 1, 170, 102, 128, 230] };
pub const NamespaceWalker: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1928028640, data2: 34418, data3: 17155, data4: [145, 117, 242, 228, 198, 139, 46, 124] };
pub const NetworkConnections: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1879551175, data2: 12802, data3: 4561, data4: [170, 210, 0, 128, 95, 193, 39, 14] };
pub const NetworkExplorerFolder: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4029422093, data2: 48673, data3: 17232, data4: [136, 176, 115, 103, 252, 150, 239, 60] };
pub const NetworkPlaces: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 546122848, data2: 15082, data3: 4201, data4: [162, 215, 8, 0, 43, 48, 48, 157] };
...
pub struct OPENASINFO {
    pub pcszFile: ::windows_core_sys::PCWSTR,
    pub pcszClass: ::windows_core_sys::PCWSTR,
...
pub struct OPEN_PRINTER_PROPS_INFOA {
    pub dwSize: u32,
    pub pszSheetName: ::windows_core_sys::PSTR,
    pub uSheetIndex: u32,
    pub dwFlags: u32,
    pub bModal: ::win32_foundation_sys::BOOL,
}
#[cfg(any(target_arch = "aarch64", target_arch = "x86_64"))]
...
pub struct OPEN_PRINTER_PROPS_INFOW {
    pub dwSize: u32,
    pub pszSheetName: ::windows_core_sys::PWSTR,
    pub uSheetIndex: u32,
    pub dwFlags: u32,
    pub bModal: ::win32_foundation_sys::BOOL,
}
...
pub const OnexCredentialProvider: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 128583814, data2: 52365, data3: 19993, data4: [164, 16, 28, 117, 175, 104, 110, 98] };
pub const OnexPlapSmartcardCredentialProvider: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 868773078, data2: 28767, data3: 19361, data4: [154, 219, 103, 7, 11, 131, 119, 117] };
pub const OpenControlPanel: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 107097477, data2: 26710, data3: 17504, data4: [141, 225, 168, 25, 33, 180, 28, 75] };
...
pub type PAPPCONSTRAIN_CHANGE_ROUTINE = ::core::option::Option<unsafe extern "system" fn(constrained: ::win32_foundation_sys::BOOLEAN, context: *const ::core::ffi::c_void)>;
pub type PAPPSTATE_CHANGE_ROUTINE = ::core::option::Option<unsafe extern "system" fn(quiesced: ::win32_foundation_sys::BOOLEAN, context: *const ::core::ffi::c_void)>;
#[repr(C)]
pub struct PARSEDURLA {
    pub cbSize: u32,
    pub pszProtocol: ::windows_core_sys::PCSTR,
    pub cchProtocol: u32,
    pub pszSuffix: ::windows_core_sys::PCSTR,
    pub cchSuffix: u32,
    pub nScheme: u32,
}
...
pub struct PARSEDURLW {
    pub cbSize: u32,
    pub pszProtocol: ::windows_core_sys::PCWSTR,
    pub cchProtocol: u32,
    pub pszSuffix: ::windows_core_sys::PCWSTR,
    pub cchSuffix: u32,
    pub nScheme: u32,
}
...
pub type PFNCANSHAREFOLDERW = ::core::option::Option<unsafe extern "system" fn(pszpath: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::HRESULT>;
pub type PFNSHOWSHAREFOLDERUIW = ::core::option::Option<unsafe extern "system" fn(hwndparent: ::win32_foundation_sys::HWND, pszpath: ::windows_core_sys::PCWSTR) -> ::windows_core_sys::HRESULT>;
...
pub const PINLogonCredentialProvider: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3414354450, data2: 40817, data3: 17517, data4: [137, 225, 141, 9, 36, 225, 37, 110] };
...
pub struct PROFILEINFOA {
    pub dwSize: u32,
    pub dwFlags: u32,
    pub lpUserName: ::windows_core_sys::PSTR,
    pub lpProfilePath: ::windows_core_sys::PSTR,
    pub lpDefaultPath: ::windows_core_sys::PSTR,
    pub lpServerName: ::windows_core_sys::PSTR,
    pub lpPolicyPath: ::windows_core_sys::PSTR,
    pub hProfile: ::win32_foundation_sys::HANDLE,
}
...
pub struct PROFILEINFOW {
    pub dwSize: u32,
    pub dwFlags: u32,
    pub lpUserName: ::windows_core_sys::PWSTR,
    pub lpProfilePath: ::windows_core_sys::PWSTR,
    pub lpDefaultPath: ::windows_core_sys::PWSTR,
    pub lpServerName: ::windows_core_sys::PWSTR,
    pub lpPolicyPath: ::windows_core_sys::PWSTR,
    pub hProfile: ::win32_foundation_sys::HANDLE,
}
...
pub struct PUBAPPINFO {
    pub cbSize: u32,
    pub dwMask: u32,
    pub pszSource: ::windows_core_sys::PWSTR,
    pub stAssigned: ::win32_foundation_sys::SYSTEMTIME,
    pub stPublished: ::win32_foundation_sys::SYSTEMTIME,
    pub stScheduled: ::win32_foundation_sys::SYSTEMTIME,
    pub stExpire: ::win32_foundation_sys::SYSTEMTIME,
}
...
pub const PackageDebugSettings: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2981020015, data2: 9091, data3: 18514, data4: [176, 233, 143, 11, 29, 198, 107, 77] };
pub const PasswordCredentialProvider: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1622642312, data2: 60120, data3: 17500, data4: [156, 253, 11, 135, 247, 78, 166, 205] };
pub const PreviousVersions: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1500164194, data2: 46290, data3: 16917, data4: [159, 116, 233, 16, 155, 10, 129, 83] };
pub const PropertiesUI: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3641899215, data2: 918, data3: 18709, data4: [136, 78, 251, 66, 93, 50, 148, 59] };
pub const PublishDropTarget: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3429822459, data2: 17398, data3: 18117, data4: [150, 25, 81, 213, 113, 150, 127, 125] };
pub const PublishingWizard: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1798510140, data2: 30373, data3: 19308, data4: [191, 33, 69, 222, 156, 213, 3, 161] };
#[repr(C)]
#[cfg(feature = "win32-ui-sys")]
pub struct QCMINFO {
...
#[repr(C)]
pub struct QITAB {
    pub piid: *const ::windows_core_sys::GUID,
    pub dwOffset: u32,
}
...
pub const QueryCancelAutoPlay: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 857675624, data2: 1449, data3: 19933, data4: [184, 110, 218, 227, 77, 220, 153, 138] };
pub const RASProvider: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1429725827, data2: 45543, data3: 20216, data4: [156, 110, 122, 176, 175, 229, 5, 109] };
...
pub struct SHARDAPPIDINFO {
    pub psi: IShellItem,
    pub pszAppID: ::windows_core_sys::PCWSTR,
}
...
pub struct SHCOLUMNDATA {
    ...
    pub dwFileAttributes: u32,
    pub dwReserved: u32,
    pub pwszExt: ::windows_core_sys::PWSTR,
    pub wszFile: [u16; 260],
}
...
pub struct SHCREATEPROCESSINFOW {
    ...
    pub fMask: u32,
    pub hwnd: ::win32_foundation_sys::HWND,
    pub pszFile: ::windows_core_sys::PCWSTR,
    pub pszParameters: ::windows_core_sys::PCWSTR,
    pub pszCurrentDirectory: ::windows_core_sys::PCWSTR,
    pub hUserToken: ::win32_foundation_sys::HANDLE,
    pub lpProcessAttributes: *mut ::win32_security_sys::SECURITY_ATTRIBUTES,
    pub lpThreadAttributes: *mut ::win32_security_sys::SECURITY_ATTRIBUTES,
    pub bInheritHandles: ::win32_foundation_sys::BOOL,
    pub dwCreationFlags: u32,
    pub lpStartupInfo: *mut ::win32_system_sys::Threading::STARTUPINFOW,
    pub lpProcessInformation: *mut ::win32_system_sys::Threading::PROCESS_INFORMATION,
}
#[cfg(any(target_arch = "aarch64", target_arch = "x86_64"))]
#[cfg(all(feature = "win32-security-sys", feature = "win32-system-sys"))]
...
pub const SHC_E_SHELL_COMPONENT_STARTUP_FAILURE: ::windows_core_sys::HRESULT = -2144927180i32;
#[repr(C, packed(1))]
...
pub struct SHChangeNotifyEntry {
    pub pidl: *mut Common::ITEMIDLIST,
    pub fRecursive: ::win32_foundation_sys::BOOL,
}
#[cfg(feature = "win32-ui-sys")]
...
pub struct SHDRAGIMAGE {
    pub sizeDragImage: ::win32_foundation_sys::SIZE,
    pub ptOffset: ::win32_foundation_sys::POINT,
    pub hbmpDragImage: ::win32_graphics_sys::Gdi::HBITMAP,
    pub crColorKey: u32,
}
#[cfg(feature = "win32-graphics-sys")]
...
pub struct SHELLEXECUTEINFOA {
    ...
    pub hwnd: ::win32_foundation_sys::HWND,
    pub lpVerb: ::windows_core_sys::PCSTR,
    pub lpFile: ::windows_core_sys::PCSTR,
    pub lpParameters: ::windows_core_sys::PCSTR,
    pub lpDirectory: ::windows_core_sys::PCSTR,
    pub nShow: i32,
    pub hInstApp: ::win32_foundation_sys::HINSTANCE,
    pub lpIDList: *mut ::core::ffi::c_void,
    pub lpClass: ::windows_core_sys::PCSTR,
    pub hkeyClass: ::win32_system_sys::Registry::HKEY,
    pub dwHotKey: u32,
...
pub union SHELLEXECUTEINFOA_0 {
    pub hIcon: ::win32_foundation_sys::HANDLE,
    pub hMonitor: ::win32_foundation_sys::HANDLE,
}
#[cfg(any(target_arch = "aarch64", target_arch = "x86_64"))]
#[cfg(feature = "win32-system-sys")]
...
pub struct SHELLEXECUTEINFOW {
    ...
    pub fMask: u32,
    pub hwnd: ::win32_foundation_sys::HWND,
    pub lpVerb: ::windows_core_sys::PCWSTR,
    pub lpFile: ::windows_core_sys::PCWSTR,
    pub lpParameters: ::windows_core_sys::PCWSTR,
    pub lpDirectory: ::windows_core_sys::PCWSTR,
    pub nShow: i32,
    pub hInstApp: ::win32_foundation_sys::HINSTANCE,
    pub lpIDList: *mut ::core::ffi::c_void,
    pub lpClass: ::windows_core_sys::PCWSTR,
    pub hkeyClass: ::win32_system_sys::Registry::HKEY,
    pub dwHotKey: u32,
...
pub const SHELL_E_WRONG_BITDEPTH: ::windows_core_sys::HRESULT = -2144927486i32;
#[repr(C)]
...
pub struct SHFILEINFOA {
    ...
    pub iIcon: i32,
    pub dwAttributes: u32,
    pub szDisplayName: [::win32_foundation_sys::CHAR; 260],
    pub szTypeName: [::win32_foundation_sys::CHAR; 80],
}
#[cfg(any(target_arch = "aarch64", target_arch = "x86_64"))]
#[cfg(feature = "win32-ui-sys")]
...
pub struct SHFILEOPSTRUCTA {
    ...
    pub pTo: *mut i8,
    pub fFlags: u16,
    pub fAnyOperationsAborted: ::win32_foundation_sys::BOOL,
    pub hNameMappings: *mut ::core::ffi::c_void,
    pub lpszProgressTitle: ::windows_core_sys::PCSTR,
}
#[cfg(any(target_arch = "aarch64", target_arch = "x86_64"))]
...
pub struct SHFILEOPSTRUCTW {
    pub hwnd: ::win32_foundation_sys::HWND,
    pub wFunc: u32,
    pub pFrom: ::windows_core_sys::PCWSTR,
    pub pTo: ::windows_core_sys::PCWSTR,
    pub fFlags: u16,
    pub fAnyOperationsAborted: ::win32_foundation_sys::BOOL,
    pub hNameMappings: *mut ::core::ffi::c_void,
    pub lpszProgressTitle: ::windows_core_sys::PCWSTR,
}
#[cfg(any(target_arch = "aarch64", target_arch = "x86_64"))]
...
pub struct SHFOLDERCUSTOMSETTINGS {
    pub dwSize: u32,
    pub dwMask: u32,
    pub pvid: *mut ::windows_core_sys::GUID,
    pub pszWebViewTemplate: ::windows_core_sys::PWSTR,
    pub cchWebViewTemplate: u32,
    pub pszWebViewTemplateVersion: ::windows_core_sys::PWSTR,
    pub pszInfoTip: ::windows_core_sys::PWSTR,
    pub cchInfoTip: u32,
    pub pclsid: *mut ::windows_core_sys::GUID,
    pub dwFlags: u32,
    pub pszIconFile: ::windows_core_sys::PWSTR,
    pub cchIconFile: u32,
    pub iIconIndex: i32,
    pub pszLogo: ::windows_core_sys::PWSTR,
    pub cchLogo: u32,
}
...
pub struct SHNAMEMAPPINGA {
    pub pszOldPath: ::windows_core_sys::PSTR,
    pub pszNewPath: ::windows_core_sys::PSTR,
    pub cchOldPath: i32,
    pub cchNewPath: i32,
}
#[cfg(any(target_arch = "aarch64", target_arch = "x86_64"))]
...
pub struct SHNAMEMAPPINGW {
    pub pszOldPath: ::windows_core_sys::PWSTR,
    pub pszNewPath: ::windows_core_sys::PWSTR,
    pub cchOldPath: i32,
    pub cchNewPath: i32,
}
#[cfg(any(target_arch = "aarch64", target_arch = "x86_64"))]
...
pub const SID_CommandsPropertyBag: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1845768784, data2: 17430, data3: 18524, data4: [177, 67, 230, 42, 118, 13, 159, 229] };
pub const SID_CtxQueryAssociations: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4205706304, data2: 46967, data3: 19305, data4: [170, 129, 119, 3, 94, 240, 230, 232] };
pub const SID_DefView: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1829961344, data2: 30993, data3: 4559, data4: [149, 52, 0, 0, 192, 91, 174, 11] };
pub const SID_LaunchSourceAppUserModelId: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 753369104, data2: 29915, data3: 18620, data4: [156, 106, 16, 243, 114, 73, 87, 35] };
pub const SID_LaunchSourceViewSizePreference: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2153796754, data2: 26585, data3: 16719, data4: [175, 137, 161, 205, 241, 36, 43, 193] };
pub const SID_LaunchTargetViewSizePreference: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 651895922, data2: 47031, data3: 16491, data4: [151, 2, 115, 10, 78, 32, 211, 191] };
pub const SID_MenuShellFolder: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2797698740, data2: 11621, data3: 4562, data4: [131, 143, 0, 192, 79, 217, 24, 208] };
pub const SID_SCommDlgBrowser: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2163409459, data2: 47071, data3: 4562, data4: [163, 59, 0, 96, 151, 223, 91, 212] };
pub const SID_SCommandBarState: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3114183260, data2: 14416, data3: 17408, data4: [188, 51, 44, 229, 52, 4, 139, 248] };
pub const SID_SGetViewFromViewDual: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2291831645, data2: 38686, data3: 19218, data4: [185, 12, 36, 223, 201, 225, 229, 232] };
pub const SID_SInPlaceBrowser: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 489349163, data2: 13909, data3: 18124, data4: [182, 58, 40, 89, 136, 21, 59, 202] };
pub const SID_SMenuBandBKContextMenu: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 374062470, data2: 7437, data3: 19936, data4: [154, 59, 217, 114, 150, 71, 194, 184] };
pub const SID_SMenuBandBottom: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1950131812, data2: 3563, data3: 4561, data4: [152, 37, 0, 192, 79, 217, 25, 114] };
pub const SID_SMenuBandBottomSelected: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 375306996, data2: 27985, data3: 4562, data4: [131, 173, 0, 192, 79, 217, 24, 208] };
pub const SID_SMenuBandChild: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3986472992, data2: 2233, data3: 4561, data4: [152, 35, 0, 192, 79, 217, 25, 114] };
pub const SID_SMenuBandContextMenuModifier: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 961828980, data2: 29026, data3: 18014, data4: [183, 131, 42, 161, 135, 79, 239, 129] };
pub const SID_SMenuBandParent: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2351402732, data2: 16043, data3: 4561, data4: [140, 176, 0, 192, 79, 217, 24, 208] };
pub const SID_SMenuBandTop: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2492704784, data2: 60472, data3: 4560, data4: [188, 70, 0, 170, 0, 108, 226, 245] };
pub const SID_SMenuPopup: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3521621995, data2: 27182, data3: 4560, data4: [140, 120, 0, 192, 79, 217, 24, 180] };
pub const SID_SSearchBoxInfo: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 338537057, data2: 20843, data3: 18195, data4: [180, 156, 251, 152, 94, 248, 41, 152] };
pub const SID_STopLevelBrowser: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1284947520, data2: 37212, data3: 4559, data4: [153, 211, 0, 170, 0, 74, 232, 55] };
pub const SID_STopWindow: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1239528704, data2: 17974, data3: 4563, data4: [151, 247, 0, 192, 79, 69, 208, 179] };
pub const SID_ShellExecuteNamedPropertyStore: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3951340962, data2: 255, data3: 18834, data4: [131, 36, 237, 92, 224, 97, 203, 41] };
pub const SID_URLExecutionContext: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4217343676, data2: 48054, data3: 19728, data4: [164, 97, 119, 114, 145, 160, 144, 48] };
pub type SIGDN = i32;
...
pub struct SLOWAPPINFO {
    pub ullSize: u64,
    pub ftLastUsed: ::win32_foundation_sys::FILETIME,
    pub iTimesUsed: i32,
    pub pszImage: ::windows_core_sys::PWSTR,
}
...
pub const STORE_E_NEWER_VERSION_AVAILABLE: ::windows_core_sys::HRESULT = -2144927484i32;
...
pub type SUBCLASSPROC = ::core::option::Option<unsafe extern "system" fn(hwnd: ::win32_foundation_sys::HWND, umsg: u32, wparam: ::win32_foundation_sys::WPARAM, lparam: ::win32_foundation_sys::LPARAM, uidsubclass: usize, dwrefdata: usize) -> ::win32_foundation_sys::LRESULT>;
#[repr(C)]
#[cfg(feature = "win32-system-sys")]
pub struct SV2CVW2_PARAMS {
    ...
    pub prcView: *mut ::win32_foundation_sys::RECT,
    pub pvid: *const ::windows_core_sys::GUID,
    pub hwndView: ::win32_foundation_sys::HWND,
}
#[cfg(feature = "win32-system-sys")]
...
pub struct SYNCMGRITEM {
    pub cbSize: u32,
    pub dwFlags: u32,
    pub ItemID: ::windows_core_sys::GUID,
    pub dwItemState: u32,
    pub hIcon: super::WindowsAndMessaging::HICON,
    pub wszItemName: [u16; 128],
    pub ftLastUpdate: ::win32_foundation_sys::FILETIME,
}
#[cfg(feature = "win32-ui-sys")]
...
pub struct SYNCMGRPROGRESSITEM {
    pub cbSize: u32,
    pub mask: u32,
    pub lpcStatusText: ::windows_core_sys::PCWSTR,
...
pub struct SYNCMGR_CONFLICT_ID_INFO {
    pub pblobID: *mut ::win32_system_sys::Com::BYTE_BLOB,
    pub pblobExtra: *mut ::win32_system_sys::Com::BYTE_BLOB,
}
#[cfg(feature = "win32-system-sys")]
...
pub const SYNCMGR_OBJECTID_BrowseContent: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1472968068, data2: 59828, data3: 18350, data4: [161, 32, 196, 223, 51, 53, 222, 226] };
pub const SYNCMGR_OBJECTID_ConflictStore: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3615588852, data2: 9097, data3: 18404, data4: [169, 96, 96, 188, 194, 237, 147, 11] };
pub const SYNCMGR_OBJECTID_EventLinkClick: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 570670529, data2: 6897, data3: 16514, data4: [140, 48, 40, 57, 159, 65, 56, 76] };
pub const SYNCMGR_OBJECTID_EventStore: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1273967801, data2: 42886, data3: 16501, data4: [186, 136, 12, 43, 157, 137, 169, 143] };
pub const SYNCMGR_OBJECTID_Icon: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1841071555, data2: 23815, data3: 19570, data4: [167, 119, 127, 236, 120, 7, 44, 6] };
pub const SYNCMGR_OBJECTID_QueryBeforeActivate: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3632453643, data2: 59306, data3: 18925, data4: [134, 183, 230, 225, 247, 20, 205, 254] };
pub const SYNCMGR_OBJECTID_QueryBeforeDeactivate: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2700067458, data2: 24800, data3: 17934, data4: [147, 116, 234, 136, 81, 60, 252, 128] };
pub const SYNCMGR_OBJECTID_QueryBeforeDelete: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4151063447, data2: 44979, data3: 17879, data4: [165, 159, 90, 73, 233, 5, 67, 126] };
pub const SYNCMGR_OBJECTID_QueryBeforeDisable: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3143591082, data2: 61444, data3: 20149, data4: [142, 77, 38, 117, 25, 102, 52, 76] };
pub const SYNCMGR_OBJECTID_QueryBeforeEnable: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 80476144, data2: 23531, data3: 19937, data4: [188, 144, 144, 131, 69, 196, 128, 246] };
pub const SYNCMGR_OBJECTID_ShowSchedule: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3989238755, data2: 33857, data3: 16649, data4: [173, 243, 108, 28, 160, 183, 222, 71] };
...
pub const S_SYNCMGR_CANCELALL: ::windows_core_sys::HRESULT = 262660i32;
pub const S_SYNCMGR_CANCELITEM: ::windows_core_sys::HRESULT = 262659i32;
pub const S_SYNCMGR_ENUMITEMS: ::windows_core_sys::HRESULT = 262673i32;
pub const S_SYNCMGR_ITEMDELETED: ::windows_core_sys::HRESULT = 262672i32;
pub const S_SYNCMGR_MISSINGITEMS: ::windows_core_sys::HRESULT = 262657i32;
pub const S_SYNCMGR_RETRYSYNC: ::windows_core_sys::HRESULT = 262658i32;
pub const ScheduledTasks: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3592911248, data2: 19562, data3: 4559, data4: [141, 135, 0, 170, 0, 96, 245, 191] };
pub const SearchFolderItemFactory: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 335613442, data2: 48061, data3: 16880, data4: [136, 227, 237, 163, 113, 33, 101, 132] };
...
pub const SelectedItemCount_Property_GUID: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2414024402, data2: 3666, data3: 17930, data4: [156, 30, 72, 242, 115, 212, 112, 163] };
pub type ShFindChangeNotificationHandle = isize;
pub const SharedBitmap: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1303536758, data2: 26503, data3: 16454, data4: [184, 54, 232, 65, 42, 158, 138, 39] };
pub const SharingConfigurationManager: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1240691169, data2: 35932, data3: 19868, data4: [154, 59, 84, 166, 130, 127, 81, 60] };
pub const Shell: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 326145568, data2: 49785, data3: 4558, data4: [164, 158, 68, 69, 83, 84, 0, 0] };
pub const ShellBrowserWindow: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3230334352, data2: 62113, data3: 4561, data4: [132, 85, 0, 160, 201, 31, 56, 128] };
pub const ShellDesktop: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 136192, data2: 0, data3: 0, data4: [192, 0, 0, 0, 0, 0, 0, 70] };
pub const ShellDispatchInproc: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 176793696, data2: 55217, data3: 4558, data4: [131, 80, 68, 69, 83, 84, 0, 0] };
pub const ShellFSFolder: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4080421792, data2: 26041, data3: 4558, data4: [169, 186, 0, 170, 0, 74, 232, 55] };
pub const ShellFolderItem: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 803427050, data2: 64799, data3: 4562, data4: [177, 244, 0, 192, 79, 142, 235, 62] };
pub const ShellFolderView: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1645292193, data2: 60388, data3: 4559, data4: [165, 251, 0, 32, 175, 231, 41, 45] };
pub const ShellFolderViewOC: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2610977137, data2: 63144, data3: 4559, data4: [164, 66, 0, 160, 201, 10, 143, 57] };
...
pub const ShellImageDataFactory: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1726276859, data2: 62341, data3: 19920, data4: [141, 116, 162, 239, 209, 188, 97, 120] };
pub const ShellItem: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2596928481, data2: 57506, data3: 19158, data4: [180, 238, 226, 18, 1, 62, 169, 23] };
pub const ShellLibrary: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3652395293, data2: 58751, data3: 17446, data4: [170, 239, 48, 168, 6, 173, 211, 151] };
pub const ShellLink: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 136193, data2: 0, data3: 0, data4: [192, 0, 0, 0, 0, 0, 0, 70] };
pub const ShellLinkObject: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 287413280, data2: 5992, data3: 4561, data4: [149, 190, 0, 96, 151, 151, 234, 79] };
pub const ShellNameSpace: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1427335173, data2: 45790, data3: 4561, data4: [185, 242, 0, 160, 201, 139, 197, 71] };
...
pub const ShellUIHelper: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1688947639, data2: 4382, data3: 4561, data4: [143, 121, 0, 192, 79, 194, 251, 225] };
...
pub const ShellWindows: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2610977138, data2: 63144, data3: 4559, data4: [164, 66, 0, 160, 201, 10, 143, 57] };
pub const ShowInputPaneAnimationCoordinator: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 520383167, data2: 12802, data3: 19905, data4: [140, 181, 60, 103, 97, 124, 225, 250] };
pub const SimpleConflictPresenter: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2047830711, data2: 60804, data3: 18102, data4: [180, 126, 2, 170, 21, 154, 21, 43] };
pub const SizeCategorizer: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1440200786, data2: 63185, data3: 17138, data4: [170, 117, 135, 40, 161, 178, 210, 100] };
pub const SmartcardCredentialProvider: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2413289884, data2: 15351, data3: 18587, data4: [167, 44, 132, 106, 179, 103, 140, 150] };
pub const SmartcardPinProvider: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2488888446, data2: 14148, data3: 16846, data4: [137, 62, 187, 240, 145, 34, 247, 106] };
pub const SmartcardReaderSelectionProvider: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 455620705, data2: 30031, data3: 16418, data4: [173, 71, 165, 234, 170, 97, 136, 148] };
pub const SmartcardWinRTProvider: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 518468479, data2: 34220, data3: 17890, data4: [162, 60, 55, 199, 83, 32, 151, 105] };
pub const StartMenuPin: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2729006173, data2: 41154, data3: 17076, data4: [151, 8, 160, 178, 186, 221, 119, 200] };
pub const StorageProviderBanners: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2093873652, data2: 58742, data3: 17754, data4: [139, 199, 246, 236, 104, 214, 240, 99] };
pub const SuspensionDependencyManager: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1797734341, data2: 25085, data3: 18712, data4: [149, 162, 195, 181, 233, 215, 245, 129] };
pub const SyncMgr: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1653989159, data2: 13806, data3: 4561, data4: [135, 7, 0, 192, 79, 217, 51, 39] };
pub const SyncMgrClient: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 302177120, data2: 7596, data3: 17093, data4: [174, 213, 26, 189, 212, 50, 36, 142] };
pub const SyncMgrControl: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 438256134, data2: 1672, data3: 20095, data4: [190, 3, 216, 46, 198, 157, 249, 165] };
pub const SyncMgrFolder: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2624845285, data2: 31463, data3: 20018, data4: [168, 232, 141, 35, 184, 82, 85, 191] };
pub const SyncMgrScheduleWizard: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2374733360, data2: 50257, data3: 16923, data4: [133, 83, 210, 151, 106, 250, 100, 140] };
pub const SyncResultsFolder: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1910084708, data2: 15211, data3: 18268, data4: [178, 65, 225, 88, 131, 32, 117, 41] };
pub const SyncSetupFolder: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 782129600, data2: 46135, data3: 18817, data4: [166, 71, 156, 52, 185, 185, 8, 145] };
...
pub struct TOOLBARITEM {
    ...
    pub rcBorderTool: ::win32_foundation_sys::RECT,
    pub pwszItem: ::windows_core_sys::PWSTR,
    pub fShow: ::win32_foundation_sys::BOOL,
    pub hMon: ::win32_graphics_sys::Gdi::HMONITOR,
}
#[cfg(all(feature = "win32-graphics-sys", feature = "win32-system-sys"))]
...
pub const TaskbarList: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1459483460, data2: 64877, data3: 4560, data4: [149, 138, 0, 96, 151, 201, 160, 144] };
pub const ThumbnailStreamCache: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3420520147, data2: 19345, data3: 20112, data4: [131, 84, 138, 140, 132, 236, 104, 114] };
...
pub const TimeCategorizer: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1001656719, data2: 56829, data3: 19760, data4: [163, 72, 159, 181, 214, 191, 26, 254] };
pub const TrackShellMenu: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2188966193, data2: 10814, data3: 4562, data4: [131, 143, 0, 192, 79, 217, 24, 208] };
pub const TrayBandSiteService: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4127903904, data2: 58849, data3: 17867, data4: [181, 26, 225, 91, 159, 139, 41, 52] };
pub const TrayDeskBand: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3863225399, data2: 27752, data3: 20306, data4: [148, 221, 44, 254, 210, 103, 239, 185] };
...
pub const URL_E_INVALID_SYNTAX: ::windows_core_sys::HRESULT = -2147217407i32;
pub const URL_E_UNREGISTERED_PROTOCOL: ::windows_core_sys::HRESULT = -2147217406i32;
...
pub const UserNotification: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1083662, data2: 34697, data3: 16700, data4: [173, 188, 72, 245, 181, 17, 179, 175] };
pub const V1PasswordCredentialProvider: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1866849310, data2: 21380, data3: 17786, data4: [188, 19, 44, 216, 27, 13, 40, 237] };
pub const V1SmartcardCredentialProvider: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2348394768, data2: 43263, data3: 17791, data4: [153, 159, 165, 202, 16, 180, 168, 133] };
pub const V1WinBioCredentialProvider: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2889531977, data2: 59424, data3: 17219, data4: [166, 91, 55, 122, 198, 52, 220, 9] };
...
pub const VID_Content: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 818070580, data2: 2185, data3: 19597, data4: [152, 93, 169, 247, 24, 48, 176, 169] };
pub const VID_Details: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 327055104, data2: 13683, data3: 4559, data4: [174, 105, 8, 0, 43, 46, 18, 98] };
pub const VID_LargeIcons: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 5755104, data2: 13683, data3: 4559, data4: [174, 105, 8, 0, 43, 46, 18, 98] };
pub const VID_List: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 236955104, data2: 13683, data3: 4559, data4: [174, 105, 8, 0, 43, 46, 18, 98] };
pub const VID_SmallIcons: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 143655104, data2: 13683, data3: 4559, data4: [174, 105, 8, 0, 43, 46, 18, 98] };
pub const VID_ThumbStrip: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2398070308, data2: 53737, data3: 17499, data4: [148, 183, 116, 251, 206, 46, 161, 26] };
pub const VID_Thumbnails: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2347479696, data2: 21200, data3: 4560, data4: [183, 244, 0, 192, 79, 215, 6, 236] };
pub const VID_Tile: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1710302693, data2: 31713, data3: 18448, data4: [186, 157, 210, 113, 200, 67, 44, 227] };
...
pub const VaultProvider: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1345796560, data2: 19550, data3: 19709, data4: [179, 186, 216, 129, 51, 79, 13, 242] };
pub const VirtualDesktopManager: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2857406598, data2: 23721, data3: 19493, data4: [143, 149, 88, 157, 60, 7, 180, 138] };
...
pub struct WINDOWDATA {
    ...
    pub uiCP: u32,
    pub pidl: *mut Common::ITEMIDLIST,
    pub lpszUrl: ::windows_core_sys::PWSTR,
    pub lpszUrlLocation: ::windows_core_sys::PWSTR,
    pub lpszTitle: ::windows_core_sys::PWSTR,
}
#[cfg(feature = "win32-ui-sys")]
...
pub const WTS_E_DATAFILEUNAVAILABLE: ::windows_core_sys::HRESULT = -2147175932i32;
pub const WTS_E_EXTRACTIONBLOCKED: ::windows_core_sys::HRESULT = -2147175930i32;
pub const WTS_E_EXTRACTIONPENDING: ::windows_core_sys::HRESULT = -2147175931i32;
pub const WTS_E_EXTRACTIONTIMEDOUT: ::windows_core_sys::HRESULT = -2147175935i32;
pub const WTS_E_FAILEDEXTRACTION: ::windows_core_sys::HRESULT = -2147175936i32;
pub const WTS_E_FASTEXTRACTIONNOTSUPPORTED: ::windows_core_sys::HRESULT = -2147175933i32;
pub const WTS_E_NOSTORAGEPROVIDERTHUMBNAILHANDLER: ::windows_core_sys::HRESULT = -2147175929i32;
pub const WTS_E_SURROGATEUNAVAILABLE: ::windows_core_sys::HRESULT = -2147175934i32;
...
pub const WebBrowser: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2287401313, data2: 13322, data3: 4560, data4: [169, 107, 0, 192, 79, 215, 5, 162] };
pub const WebBrowser_V1: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3937544899, data2: 12481, data3: 4559, data4: [167, 235, 0, 0, 192, 91, 174, 11] };
pub const WebWizardHost: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3358060873, data2: 21953, data3: 19752, data4: [147, 94, 87, 228, 124, 174, 217, 115] };
pub const WinBioCredentialProvider: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3200291363, data2: 45080, data3: 16749, data4: [160, 172, 82, 57, 113, 182, 57, 245] };
#[repr(C)]
...
pub struct urlinvokecommandinfoA {
    ...
    pub pcszVerb: ::windows_core_sys::PCSTR,
}
...
pub struct urlinvokecommandinfoW {
    ...
    pub dwFlags: u32,
    pub hwndParent: ::win32_foundation_sys::HWND,
    pub pcszVerb: ::windows_core_sys::PCWSTR,
}
