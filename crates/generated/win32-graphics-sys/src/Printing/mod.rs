...
pub struct ADDJOB_INFO_1A {
    pub Path: ::windows_core_sys::PSTR,
    pub JobId: u32,
}
...
pub const BidiRequest: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3105237539, data2: 17913, data3: 18380, data4: [128, 245, 254, 15, 233, 185, 225, 162] };
pub const BidiRequestContainer: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4233857572, data2: 56069, data3: 18945, data4: [131, 136, 34, 237, 246, 194, 187, 186] };
pub const BidiSpl: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 711017024, data2: 42181, data3: 19507, data4: [189, 135, 27, 199, 9, 51, 22, 57] };
#[repr(C)]
...
pub struct BranchOfficeJobDataError {
    pub LastError: u32,
    pub pDocumentName: ::windows_core_sys::PWSTR,
    ...
    pub pMachineName: ::windows_core_sys::PWSTR,
    pub pJobError: ::windows_core_sys::PWSTR,
    pub pErrorDescription: ::windows_core_sys::PWSTR,
}
...
pub struct BranchOfficeJobDataPipelineFailed {
    pub pDocumentName: ::windows_core_sys::PWSTR,
    pub pPrinterName: ::windows_core_sys::PWSTR,
    pub pExtraErrorInfo: ::windows_core_sys::PWSTR,
}
...
pub struct BranchOfficeJobDataPrinted {
    ...
    pub pMachineName: ::windows_core_sys::PWSTR,
    pub pPrinterName: ::windows_core_sys::PWSTR,
    pub pPortName: ::windows_core_sys::PWSTR,
    pub Size: i64,
    pub TotalPages: u32,
}
...
pub const CLSID_OEMPTPROVIDER: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2440181906, data2: 17874, data3: 18658, data4: [158, 201, 86, 35, 121, 218, 249, 146] };
pub const CLSID_OEMRENDER: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1835712294, data2: 40760, data3: 4561, data4: [136, 42, 0, 192, 79, 185, 97, 236] };
pub const CLSID_OEMUI: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2882437335, data2: 40774, data3: 4561, data4: [136, 42, 0, 192, 79, 185, 97, 236] };
pub const CLSID_OEMUIMXDC: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1309950720, data2: 23363, data3: 17032, data4: [147, 42, 94, 77, 214, 216, 43, 237] };
pub const CLSID_PTPROVIDER: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1185682715, data2: 33936, data3: 17713, data4: [150, 204, 85, 191, 43, 241, 158, 17] };
...
pub struct DOC_INFO_1A {
    pub pDocName: ::windows_core_sys::PSTR,
    pub pOutputFile: ::windows_core_sys::PSTR,
...
pub struct DOC_INFO_1W {
    pub pDocName: ::windows_core_sys::PWSTR,
...
pub struct DRIVER_INFO_2A {
    pub cVersion: u32,
    pub pName: ::windows_core_sys::PSTR,
    pub pEnvironment: ::windows_core_sys::PSTR,
    pub pDriverPath: ::windows_core_sys::PSTR,
    pub pDataFile: ::windows_core_sys::PSTR,
    pub pConfigFile: ::windows_core_sys::PSTR,
}
...
pub struct DRIVER_INFO_2W {
    pub cVersion: u32,
    pub pName: ::windows_core_sys::PWSTR,
    pub pEnvironment: ::windows_core_sys::PWSTR,
    pub pDriverPath: ::windows_core_sys::PWSTR,
    pub pDataFile: ::windows_core_sys::PWSTR,
    pub pConfigFile: ::windows_core_sys::PWSTR,
}
...
pub struct DRIVER_INFO_3A {
    ...
    pub pDataFile: ::windows_core_sys::PSTR,
    pub pConfigFile: ::windows_core_sys::PSTR,
    pub pHelpFile: ::windows_core_sys::PSTR,
    pub pDependentFiles: ::windows_core_sys::PSTR,
...
pub struct DRIVER_INFO_3W {
    ...
    pub pDataFile: ::windows_core_sys::PWSTR,
    pub pConfigFile: ::windows_core_sys::PWSTR,
    pub pHelpFile: ::windows_core_sys::PWSTR,
    pub pDependentFiles: ::windows_core_sys::PWSTR,
...
pub struct DRIVER_INFO_8A {
    ...
    pub pszHardwareID: ::windows_core_sys::PSTR,
    pub pszProvider: ::windows_core_sys::PSTR,
    pub pszPrintProcessor: ::windows_core_sys::PSTR,
    pub pszVendorSetup: ::windows_core_sys::PSTR,
    pub pszzColorProfiles: ::windows_core_sys::PSTR,
...
pub struct DRIVER_INFO_8W {
    ...
    pub pszHardwareID: ::windows_core_sys::PWSTR,
    pub pszProvider: ::windows_core_sys::PWSTR,
    pub pszPrintProcessor: ::windows_core_sys::PWSTR,
    pub pszVendorSetup: ::windows_core_sys::PWSTR,
    pub pszzColorProfiles: ::windows_core_sys::PWSTR,
...
pub const FMTID_PrinterPropertyBag: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1979297226, data2: 2429, data3: 17859, data4: [166, 228, 186, 178, 158, 39, 111, 62] };
...
pub const GUID_DEVINTERFACE_IPPUSB_PRINT: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4076077953, data2: 62573, data3: 20049, data4: [188, 231, 98, 222, 108, 242, 208, 152] };
pub const GUID_DEVINTERFACE_USBPRINT: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 685215661, data2: 23058, data3: 4561, data4: [174, 91, 0, 0, 248, 3, 168, 194] };
...
pub struct JOB_INFO_1A {
    ...
    pub pMachineName: ::windows_core_sys::PSTR,
    pub pUserName: ::windows_core_sys::PSTR,
    pub pDocument: ::windows_core_sys::PSTR,
    pub pDatatype: ::windows_core_sys::PSTR,
...
pub struct JOB_INFO_1W {
    ...
    pub pMachineName: ::windows_core_sys::PWSTR,
    pub pUserName: ::windows_core_sys::PWSTR,
    pub pDocument: ::windows_core_sys::PWSTR,
    pub pDatatype: ::windows_core_sys::PWSTR,
...
pub struct JOB_INFO_2A {
    ...
    pub pUserName: ::windows_core_sys::PSTR,
    pub pDocument: ::windows_core_sys::PSTR,
    pub pNotifyName: ::windows_core_sys::PSTR,
    pub pDatatype: ::windows_core_sys::PSTR,
...
pub struct JOB_INFO_2W {
    ...
    pub pUserName: ::windows_core_sys::PWSTR,
    pub pDocument: ::windows_core_sys::PWSTR,
    pub pNotifyName: ::windows_core_sys::PWSTR,
    pub pDatatype: ::windows_core_sys::PWSTR,
...
pub struct MONITOR_INFO_2A {
    pub pName: ::windows_core_sys::PSTR,
    pub pEnvironment: ::windows_core_sys::PSTR,
    pub pDLLName: ::windows_core_sys::PSTR,
}
...
pub struct MONITOR_INFO_2W {
    pub pName: ::windows_core_sys::PWSTR,
    pub pEnvironment: ::windows_core_sys::PWSTR,
    pub pDLLName: ::windows_core_sys::PWSTR,
}
...
pub const NOTIFICATION_RELEASE: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3130675239, data2: 42766, data3: 19175, data4: [155, 125, 235, 62, 6, 173, 65, 87] };
...
pub struct PORT_INFO_2A {
    pub pPortName: ::windows_core_sys::PSTR,
    pub pMonitorName: ::windows_core_sys::PSTR,
    pub pDescription: ::windows_core_sys::PSTR,
    pub fPortType: u32,
    pub Reserved: u32,
}
...
pub struct PORT_INFO_2W {
    pub pPortName: ::windows_core_sys::PWSTR,
    pub pMonitorName: ::windows_core_sys::PWSTR,
    pub pDescription: ::windows_core_sys::PWSTR,
    pub fPortType: u32,
    pub Reserved: u32,
}
...
pub struct PORT_INFO_3W {
    pub dwStatus: u32,
    pub pszStatus: ::windows_core_sys::PWSTR,
    pub dwSeverity: u32,
}
...
pub struct PRINTER_CONNECTION_INFO_1A {
    pub dwFlags: u32,
    pub pszDriverName: ::windows_core_sys::PSTR,
}
...
pub struct PRINTER_CONNECTION_INFO_1W {
    pub dwFlags: u32,
    pub pszDriverName: ::windows_core_sys::PWSTR,
}
...
pub struct PRINTER_ENUM_VALUESA {
    pub pValueName: ::windows_core_sys::PSTR,
    pub cbValueName: u32,
    pub dwType: u32,
    pub pData: *mut u8,
    pub cbData: u32,
...
pub struct PRINTER_ENUM_VALUESW {
    pub pValueName: ::windows_core_sys::PWSTR,
    pub cbValueName: u32,
    pub dwType: u32,
    pub pData: *mut u8,
    pub cbData: u32,
...
pub const PRINTER_EXTENSION_DETAILEDREASON_PRINTER_STATUS: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1566185220, data2: 57297, data3: 16769, data4: [142, 238, 129, 92, 134, 237, 173, 49] };
pub const PRINTER_EXTENSION_REASON_DRIVER_EVENT: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 599462696, data2: 25566, data3: 17043, data4: [145, 91, 166, 162, 61, 146, 154, 203] };
pub const PRINTER_EXTENSION_REASON_PRINT_PREFERENCES: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3968804383, data2: 9852, data3: 18079, data4: [181, 214, 57, 51, 2, 60, 41, 204] };
#[repr(C)]
pub struct PRINTER_INFO_1A {
    pub Flags: u32,
    pub pDescription: ::windows_core_sys::PSTR,
    pub pName: ::windows_core_sys::PSTR,
    pub pComment: ::windows_core_sys::PSTR,
}
...
pub struct PRINTER_INFO_1W {
    ...
    pub pDescription: ::windows_core_sys::PWSTR,
    pub pName: ::windows_core_sys::PWSTR,
    pub pComment: ::windows_core_sys::PWSTR,
}
...
pub struct PRINTER_INFO_2A {
    ...
    pub pPrinterName: ::windows_core_sys::PSTR,
    pub pShareName: ::windows_core_sys::PSTR,
    pub pPortName: ::windows_core_sys::PSTR,
    pub pDriverName: ::windows_core_sys::PSTR,
    pub pComment: ::windows_core_sys::PSTR,
    pub pLocation: ::windows_core_sys::PSTR,
    pub pDevMode: *mut super::Gdi::DEVMODEA,
    pub pSepFile: ::windows_core_sys::PSTR,
    pub pPrintProcessor: ::windows_core_sys::PSTR,
    pub pDatatype: ::windows_core_sys::PSTR,
    pub pParameters: ::windows_core_sys::PSTR,
    pub pSecurityDescriptor: super::super::Security::PSECURITY_DESCRIPTOR,
...
pub struct PRINTER_INFO_2W {
    ...
    pub pPrinterName: ::windows_core_sys::PWSTR,
    pub pShareName: ::windows_core_sys::PWSTR,
    pub pPortName: ::windows_core_sys::PWSTR,
    pub pDriverName: ::windows_core_sys::PWSTR,
    pub pComment: ::windows_core_sys::PWSTR,
    pub pLocation: ::windows_core_sys::PWSTR,
    pub pDevMode: *mut super::Gdi::DEVMODEW,
    pub pSepFile: ::windows_core_sys::PWSTR,
    pub pPrintProcessor: ::windows_core_sys::PWSTR,
    pub pDatatype: ::windows_core_sys::PWSTR,
    pub pParameters: ::windows_core_sys::PWSTR,
    pub pSecurityDescriptor: super::super::Security::PSECURITY_DESCRIPTOR,
...
pub struct PRINTER_INFO_7A {
    pub pszObjectGUID: ::windows_core_sys::PSTR,
    pub dwAction: u32,
}
...
pub struct PRINTER_INFO_7W {
    pub pszObjectGUID: ::windows_core_sys::PWSTR,
    pub dwAction: u32,
}
...
pub const PRINT_APP_BIDI_NOTIFY_CHANNEL: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 716886563, data2: 47508, data3: 19146, data4: [130, 252, 69, 113, 177, 181, 133, 172] };
...
pub struct PRINT_FEATURE_OPTION {
    pub pszFeature: ::windows_core_sys::PCSTR,
    pub pszOption: ::windows_core_sys::PCSTR,
}
...
pub struct PROVIDOR_INFO_2A {
    pub pOrder: ::windows_core_sys::PSTR,
}
...
pub struct PROVIDOR_INFO_2W {
    pub pOrder: ::windows_core_sys::PWSTR,
}
...
pub struct PrintNamedProperty {
    pub propertyName: ::windows_core_sys::PWSTR,
...
pub union PrintPropertyValue_0 {
    pub propertyByte: u8,
    pub propertyString: ::windows_core_sys::PWSTR,
...
pub const PrintSchemaAsyncOperation: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1135802429, data2: 4338, data3: 18603, data4: [131, 27, 85, 253, 189, 189, 52, 164] };
...
pub const PrinterExtensionManager: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 857432282, data2: 40592, data3: 19920, data4: [156, 132, 234, 196, 230, 89, 182, 31] };
pub const PrinterQueue: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3948200496, data2: 31116, data3: 19614, data4: [180, 97, 41, 250, 208, 64, 57, 177] };
pub const PrinterQueueView: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3948200497, data2: 31116, data3: 19614, data4: [180, 97, 41, 250, 208, 64, 57, 177] };
...
pub const S_DEVCAP_OUTPUT_FULL_REPLACEMENT: ::windows_core_sys::HRESULT = 318465i32;
...
pub struct USERDATA {
    pub dwSize: u32,
    pub dwItemID: usize,
    pub pKeyWordName: ::windows_core_sys::PSTR,
