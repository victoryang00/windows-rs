#[link(name = "windows")]
extern "system" {
    pub fn AbortPath(hdc: HDC) -> ::win32_foundation_sys::BOOL;
    pub fn AddFontMemResourceEx(pfileview: *const ::core::ffi::c_void, cjsize: u32, pvresrved: *mut ::core::ffi::c_void, pnumfonts: *const u32) -> ::win32_foundation_sys::HANDLE;
    ...
    pub fn AlphaBlend(hdcdest: HDC, xorigindest: i32, yorigindest: i32, wdest: i32, hdest: i32, hdcsrc: HDC, xoriginsrc: i32, yoriginsrc: i32, wsrc: i32, hsrc: i32, ftn: BLENDFUNCTION) -> ::win32_foundation_sys::BOOL;
    pub fn AngleArc(hdc: HDC, x: i32, y: i32, r: u32, startangle: f32, sweepangle: f32) -> ::win32_foundation_sys::BOOL;
    pub fn AnimatePalette(hpal: HPALETTE, istartindex: u32, centries: u32, ppe: *const PALETTEENTRY) -> ::win32_foundation_sys::BOOL;
    pub fn Arc(hdc: HDC, x1: i32, y1: i32, x2: i32, y2: i32, x3: i32, y3: i32, x4: i32, y4: i32) -> ::win32_foundation_sys::BOOL;
    pub fn ArcTo(hdc: HDC, left: i32, top: i32, right: i32, bottom: i32, xr1: i32, yr1: i32, xr2: i32, yr2: i32) -> ::win32_foundation_sys::BOOL;
    pub fn BeginPaint(hwnd: ::win32_foundation_sys::HWND, lppaint: *mut PAINTSTRUCT) -> HDC;
    pub fn BeginPath(hdc: HDC) -> ::win32_foundation_sys::BOOL;
    pub fn BitBlt(hdc: HDC, x: i32, y: i32, cx: i32, cy: i32, hdcsrc: HDC, x1: i32, y1: i32, rop: ROP_CODE) -> ::win32_foundation_sys::BOOL;
    pub fn CancelDC(hdc: HDC) -> ::win32_foundation_sys::BOOL;
    pub fn ChangeDisplaySettingsA(lpdevmode: *const DEVMODEA, dwflags: CDS_TYPE) -> DISP_CHANGE;
    pub fn ChangeDisplaySettingsExA(lpszdevicename: ::windows_core_sys::PCSTR, lpdevmode: *const DEVMODEA, hwnd: ::win32_foundation_sys::HWND, dwflags: CDS_TYPE, lparam: *const ::core::ffi::c_void) -> DISP_CHANGE;
    pub fn ChangeDisplaySettingsExW(lpszdevicename: ::windows_core_sys::PCWSTR, lpdevmode: *const DEVMODEW, hwnd: ::win32_foundation_sys::HWND, dwflags: CDS_TYPE, lparam: *const ::core::ffi::c_void) -> DISP_CHANGE;
    pub fn ChangeDisplaySettingsW(lpdevmode: *const DEVMODEW, dwflags: CDS_TYPE) -> DISP_CHANGE;
    pub fn Chord(hdc: HDC, x1: i32, y1: i32, x2: i32, y2: i32, x3: i32, y3: i32, x4: i32, y4: i32) -> ::win32_foundation_sys::BOOL;
    pub fn ClientToScreen(hwnd: ::win32_foundation_sys::HWND, lppoint: *mut ::win32_foundation_sys::POINT) -> ::win32_foundation_sys::BOOL;
    pub fn CloseEnhMetaFile(hdc: HDC) -> HENHMETAFILE;
    pub fn CloseFigure(hdc: HDC) -> ::win32_foundation_sys::BOOL;
    ...
    pub fn CombineTransform(lpxfout: *mut XFORM, lpxf1: *const XFORM, lpxf2: *const XFORM) -> ::win32_foundation_sys::BOOL;
    ...
    pub fn CopyRect(lprcdst: *mut ::win32_foundation_sys::RECT, lprcsrc: *const ::win32_foundation_sys::RECT) -> ::win32_foundation_sys::BOOL;
    ...
    pub fn CreateDIBSection(hdc: HDC, pbmi: *const BITMAPINFO, usage: DIB_USAGE, ppvbits: *mut *mut ::core::ffi::c_void, hsection: ::win32_foundation_sys::HANDLE, offset: u32) -> HBITMAP;
    ...
    pub fn CreateEllipticRgnIndirect(lprect: *const ::win32_foundation_sys::RECT) -> HRGN;
    pub fn CreateEnhMetaFileA(hdc: HDC, lpfilename: ::windows_core_sys::PCSTR, lprc: *const ::win32_foundation_sys::RECT, lpdesc: ::windows_core_sys::PCSTR) -> HdcMetdataEnhFileHandle;
    pub fn CreateEnhMetaFileW(hdc: HDC, lpfilename: ::windows_core_sys::PCWSTR, lprc: *const ::win32_foundation_sys::RECT, lpdesc: ::windows_core_sys::PCWSTR) -> HdcMetdataEnhFileHandle;
    ...
    pub fn CreatePolyPolygonRgn(pptl: *const ::win32_foundation_sys::POINT, pc: *const i32, cpoly: i32, imode: CREATE_POLYGON_RGN_MODE) -> HRGN;
    pub fn CreatePolygonRgn(pptl: *const ::win32_foundation_sys::POINT, cpoint: i32, imode: CREATE_POLYGON_RGN_MODE) -> HRGN;
    pub fn CreateRectRgn(x1: i32, y1: i32, x2: i32, y2: i32) -> HRGN;
    pub fn CreateRectRgnIndirect(lprect: *const ::win32_foundation_sys::RECT) -> HRGN;
    pub fn CreateRoundRectRgn(x1: i32, y1: i32, x2: i32, y2: i32, w: i32, h: i32) -> HRGN;
    pub fn CreateScalableFontResourceA(fdwhidden: u32, lpszfont: ::windows_core_sys::PCSTR, lpszfile: ::windows_core_sys::PCSTR, lpszpath: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn CreateScalableFontResourceW(fdwhidden: u32, lpszfont: ::windows_core_sys::PCWSTR, lpszfile: ::windows_core_sys::PCWSTR, lpszpath: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn CreateSolidBrush(color: u32) -> HBRUSH;
    pub fn DPtoLP(hdc: HDC, lppt: *mut ::win32_foundation_sys::POINT, c: i32) -> ::win32_foundation_sys::BOOL;
    pub fn DeleteDC(hdc: CreatedHDC) -> ::win32_foundation_sys::BOOL;
    pub fn DeleteEnhMetaFile(hmf: HENHMETAFILE) -> ::win32_foundation_sys::BOOL;
    pub fn DeleteMetaFile(hmf: HMETAFILE) -> ::win32_foundation_sys::BOOL;
    pub fn DeleteObject(ho: HGDIOBJ) -> ::win32_foundation_sys::BOOL;
    pub fn DrawAnimatedRects(hwnd: ::win32_foundation_sys::HWND, idani: i32, lprcfrom: *const ::win32_foundation_sys::RECT, lprcto: *const ::win32_foundation_sys::RECT) -> ::win32_foundation_sys::BOOL;
    pub fn DrawCaption(hwnd: ::win32_foundation_sys::HWND, hdc: HDC, lprect: *const ::win32_foundation_sys::RECT, flags: DRAW_CAPTION_FLAGS) -> ::win32_foundation_sys::BOOL;
    pub fn DrawEdge(hdc: HDC, qrc: *mut ::win32_foundation_sys::RECT, edge: DRAWEDGE_FLAGS, grfflags: DRAW_EDGE_FLAGS) -> ::win32_foundation_sys::BOOL;
    pub fn DrawEscape(hdc: HDC, iescape: i32, cjin: i32, lpin: ::windows_core_sys::PCSTR) -> i32;
    pub fn DrawFocusRect(hdc: HDC, lprc: *const ::win32_foundation_sys::RECT) -> ::win32_foundation_sys::BOOL;
    pub fn DrawFrameControl(param0: HDC, param1: *mut ::win32_foundation_sys::RECT, param2: DFC_TYPE, param3: DFCS_STATE) -> ::win32_foundation_sys::BOOL;
    pub fn DrawStateA(hdc: HDC, hbrfore: HBRUSH, qfncallback: DRAWSTATEPROC, ldata: ::win32_foundation_sys::LPARAM, wdata: ::win32_foundation_sys::WPARAM, x: i32, y: i32, cx: i32, cy: i32, uflags: DRAWSTATE_FLAGS) -> ::win32_foundation_sys::BOOL;
    pub fn DrawStateW(hdc: HDC, hbrfore: HBRUSH, qfncallback: DRAWSTATEPROC, ldata: ::win32_foundation_sys::LPARAM, wdata: ::win32_foundation_sys::WPARAM, x: i32, y: i32, cx: i32, cy: i32, uflags: DRAWSTATE_FLAGS) -> ::win32_foundation_sys::BOOL;
    pub fn DrawTextA(hdc: HDC, lpchtext: ::windows_core_sys::PCSTR, cchtext: i32, lprc: *mut ::win32_foundation_sys::RECT, format: DRAW_TEXT_FORMAT) -> i32;
    pub fn DrawTextExA(hdc: HDC, lpchtext: ::windows_core_sys::PSTR, cchtext: i32, lprc: *mut ::win32_foundation_sys::RECT, format: DRAW_TEXT_FORMAT, lpdtp: *const DRAWTEXTPARAMS) -> i32;
    pub fn DrawTextExW(hdc: HDC, lpchtext: ::windows_core_sys::PWSTR, cchtext: i32, lprc: *mut ::win32_foundation_sys::RECT, format: DRAW_TEXT_FORMAT, lpdtp: *const DRAWTEXTPARAMS) -> i32;
    pub fn DrawTextW(hdc: HDC, lpchtext: ::windows_core_sys::PCWSTR, cchtext: i32, lprc: *mut ::win32_foundation_sys::RECT, format: DRAW_TEXT_FORMAT) -> i32;
    pub fn Ellipse(hdc: HDC, left: i32, top: i32, right: i32, bottom: i32) -> ::win32_foundation_sys::BOOL;
    pub fn EndPaint(hwnd: ::win32_foundation_sys::HWND, lppaint: *const PAINTSTRUCT) -> ::win32_foundation_sys::BOOL;
    pub fn EndPath(hdc: HDC) -> ::win32_foundation_sys::BOOL;
    pub fn EnumDisplayDevicesA(lpdevice: ::windows_core_sys::PCSTR, idevnum: u32, lpdisplaydevice: *mut DISPLAY_DEVICEA, dwflags: u32) -> ::win32_foundation_sys::BOOL;
    pub fn EnumDisplayDevicesW(lpdevice: ::windows_core_sys::PCWSTR, idevnum: u32, lpdisplaydevice: *mut DISPLAY_DEVICEW, dwflags: u32) -> ::win32_foundation_sys::BOOL;
    pub fn EnumDisplayMonitors(hdc: HDC, lprcclip: *const ::win32_foundation_sys::RECT, lpfnenum: MONITORENUMPROC, dwdata: ::win32_foundation_sys::LPARAM) -> ::win32_foundation_sys::BOOL;
    pub fn EnumDisplaySettingsA(lpszdevicename: ::windows_core_sys::PCSTR, imodenum: ENUM_DISPLAY_SETTINGS_MODE, lpdevmode: *mut DEVMODEA) -> ::win32_foundation_sys::BOOL;
    pub fn EnumDisplaySettingsExA(lpszdevicename: ::windows_core_sys::PCSTR, imodenum: ENUM_DISPLAY_SETTINGS_MODE, lpdevmode: *mut DEVMODEA, dwflags: u32) -> ::win32_foundation_sys::BOOL;
    pub fn EnumDisplaySettingsExW(lpszdevicename: ::windows_core_sys::PCWSTR, imodenum: ENUM_DISPLAY_SETTINGS_MODE, lpdevmode: *mut DEVMODEW, dwflags: u32) -> ::win32_foundation_sys::BOOL;
    pub fn EnumDisplaySettingsW(lpszdevicename: ::windows_core_sys::PCWSTR, imodenum: ENUM_DISPLAY_SETTINGS_MODE, lpdevmode: *mut DEVMODEW) -> ::win32_foundation_sys::BOOL;
    pub fn EnumEnhMetaFile(hdc: HDC, hmf: HENHMETAFILE, proc: ENHMFENUMPROC, param3: *const ::core::ffi::c_void, lprect: *const ::win32_foundation_sys::RECT) -> ::win32_foundation_sys::BOOL;
    pub fn EnumFontFamiliesA(hdc: HDC, lplogfont: ::windows_core_sys::PCSTR, lpproc: FONTENUMPROCA, lparam: ::win32_foundation_sys::LPARAM) -> i32;
    pub fn EnumFontFamiliesExA(hdc: HDC, lplogfont: *const LOGFONTA, lpproc: FONTENUMPROCA, lparam: ::win32_foundation_sys::LPARAM, dwflags: u32) -> i32;
    pub fn EnumFontFamiliesExW(hdc: HDC, lplogfont: *const LOGFONTW, lpproc: FONTENUMPROCW, lparam: ::win32_foundation_sys::LPARAM, dwflags: u32) -> i32;
    pub fn EnumFontFamiliesW(hdc: HDC, lplogfont: ::windows_core_sys::PCWSTR, lpproc: FONTENUMPROCW, lparam: ::win32_foundation_sys::LPARAM) -> i32;
    pub fn EnumFontsA(hdc: HDC, lplogfont: ::windows_core_sys::PCSTR, lpproc: FONTENUMPROCA, lparam: ::win32_foundation_sys::LPARAM) -> i32;
    pub fn EnumFontsW(hdc: HDC, lplogfont: ::windows_core_sys::PCWSTR, lpproc: FONTENUMPROCW, lparam: ::win32_foundation_sys::LPARAM) -> i32;
    pub fn EnumMetaFile(hdc: HDC, hmf: HMETAFILE, proc: MFENUMPROC, param3: ::win32_foundation_sys::LPARAM) -> ::win32_foundation_sys::BOOL;
    pub fn EnumObjects(hdc: HDC, ntype: OBJ_TYPE, lpfunc: GOBJENUMPROC, lparam: ::win32_foundation_sys::LPARAM) -> i32;
    pub fn EqualRect(lprc1: *const ::win32_foundation_sys::RECT, lprc2: *const ::win32_foundation_sys::RECT) -> ::win32_foundation_sys::BOOL;
    pub fn EqualRgn(hrgn1: HRGN, hrgn2: HRGN) -> ::win32_foundation_sys::BOOL;
    pub fn ExcludeClipRect(hdc: HDC, left: i32, top: i32, right: i32, bottom: i32) -> i32;
    pub fn ExcludeUpdateRgn(hdc: HDC, hwnd: ::win32_foundation_sys::HWND) -> i32;
    ...
    pub fn ExtFloodFill(hdc: HDC, x: i32, y: i32, color: u32, r#type: EXT_FLOOD_FILL_TYPE) -> ::win32_foundation_sys::BOOL;
    pub fn ExtSelectClipRgn(hdc: HDC, hrgn: HRGN, mode: RGN_COMBINE_MODE) -> i32;
    pub fn ExtTextOutA(hdc: HDC, x: i32, y: i32, options: ETO_OPTIONS, lprect: *const ::win32_foundation_sys::RECT, lpstring: ::windows_core_sys::PCSTR, c: u32, lpdx: *const i32) -> ::win32_foundation_sys::BOOL;
    pub fn ExtTextOutW(hdc: HDC, x: i32, y: i32, options: ETO_OPTIONS, lprect: *const ::win32_foundation_sys::RECT, lpstring: ::windows_core_sys::PCWSTR, c: u32, lpdx: *const i32) -> ::win32_foundation_sys::BOOL;
    pub fn FillPath(hdc: HDC) -> ::win32_foundation_sys::BOOL;
    pub fn FillRect(hdc: HDC, lprc: *const ::win32_foundation_sys::RECT, hbr: HBRUSH) -> i32;
    pub fn FillRgn(hdc: HDC, hrgn: HRGN, hbr: HBRUSH) -> ::win32_foundation_sys::BOOL;
    pub fn FixBrushOrgEx(hdc: HDC, x: i32, y: i32, ptl: *const ::win32_foundation_sys::POINT) -> ::win32_foundation_sys::BOOL;
    pub fn FlattenPath(hdc: HDC) -> ::win32_foundation_sys::BOOL;
    pub fn FloodFill(hdc: HDC, x: i32, y: i32, color: u32) -> ::win32_foundation_sys::BOOL;
    pub fn FrameRect(hdc: HDC, lprc: *const ::win32_foundation_sys::RECT, hbr: HBRUSH) -> i32;
    pub fn FrameRgn(hdc: HDC, hrgn: HRGN, hbr: HBRUSH, w: i32, h: i32) -> ::win32_foundation_sys::BOOL;
    pub fn GdiAlphaBlend(hdcdest: HDC, xorigindest: i32, yorigindest: i32, wdest: i32, hdest: i32, hdcsrc: HDC, xoriginsrc: i32, yoriginsrc: i32, wsrc: i32, hsrc: i32, ftn: BLENDFUNCTION) -> ::win32_foundation_sys::BOOL;
    pub fn GdiComment(hdc: HDC, nsize: u32, lpdata: *const u8) -> ::win32_foundation_sys::BOOL;
    pub fn GdiFlush() -> ::win32_foundation_sys::BOOL;
    pub fn GdiGetBatchLimit() -> u32;
    pub fn GdiGradientFill(hdc: HDC, pvertex: *const TRIVERTEX, nvertex: u32, pmesh: *const ::core::ffi::c_void, ncount: u32, ulmode: GRADIENT_FILL) -> ::win32_foundation_sys::BOOL;
    pub fn GdiSetBatchLimit(dw: u32) -> u32;
    pub fn GdiTransparentBlt(hdcdest: HDC, xorigindest: i32, yorigindest: i32, wdest: i32, hdest: i32, hdcsrc: HDC, xoriginsrc: i32, yoriginsrc: i32, wsrc: i32, hsrc: i32, crtransparent: u32) -> ::win32_foundation_sys::BOOL;
    pub fn GetArcDirection(hdc: HDC) -> i32;
    pub fn GetAspectRatioFilterEx(hdc: HDC, lpsize: *mut ::win32_foundation_sys::SIZE) -> ::win32_foundation_sys::BOOL;
    pub fn GetBitmapBits(hbit: HBITMAP, cb: i32, lpvbits: *mut ::core::ffi::c_void) -> i32;
    pub fn GetBitmapDimensionEx(hbit: HBITMAP, lpsize: *mut ::win32_foundation_sys::SIZE) -> ::win32_foundation_sys::BOOL;
    pub fn GetBkColor(hdc: HDC) -> u32;
    pub fn GetBkMode(hdc: HDC) -> i32;
    pub fn GetBoundsRect(hdc: HDC, lprect: *mut ::win32_foundation_sys::RECT, flags: u32) -> u32;
    pub fn GetBrushOrgEx(hdc: HDC, lppt: *mut ::win32_foundation_sys::POINT) -> ::win32_foundation_sys::BOOL;
    pub fn GetCharABCWidthsA(hdc: HDC, wfirst: u32, wlast: u32, lpabc: *mut ABC) -> ::win32_foundation_sys::BOOL;
    pub fn GetCharABCWidthsFloatA(hdc: HDC, ifirst: u32, ilast: u32, lpabc: *mut ABCFLOAT) -> ::win32_foundation_sys::BOOL;
    pub fn GetCharABCWidthsFloatW(hdc: HDC, ifirst: u32, ilast: u32, lpabc: *mut ABCFLOAT) -> ::win32_foundation_sys::BOOL;
    pub fn GetCharABCWidthsI(hdc: HDC, gifirst: u32, cgi: u32, pgi: *const u16, pabc: *mut ABC) -> ::win32_foundation_sys::BOOL;
    pub fn GetCharABCWidthsW(hdc: HDC, wfirst: u32, wlast: u32, lpabc: *mut ABC) -> ::win32_foundation_sys::BOOL;
    pub fn GetCharWidth32A(hdc: HDC, ifirst: u32, ilast: u32, lpbuffer: *mut i32) -> ::win32_foundation_sys::BOOL;
    pub fn GetCharWidth32W(hdc: HDC, ifirst: u32, ilast: u32, lpbuffer: *mut i32) -> ::win32_foundation_sys::BOOL;
    pub fn GetCharWidthA(hdc: HDC, ifirst: u32, ilast: u32, lpbuffer: *mut i32) -> ::win32_foundation_sys::BOOL;
    pub fn GetCharWidthFloatA(hdc: HDC, ifirst: u32, ilast: u32, lpbuffer: *mut f32) -> ::win32_foundation_sys::BOOL;
    pub fn GetCharWidthFloatW(hdc: HDC, ifirst: u32, ilast: u32, lpbuffer: *mut f32) -> ::win32_foundation_sys::BOOL;
    pub fn GetCharWidthI(hdc: HDC, gifirst: u32, cgi: u32, pgi: *const u16, piwidths: *mut i32) -> ::win32_foundation_sys::BOOL;
    pub fn GetCharWidthW(hdc: HDC, ifirst: u32, ilast: u32, lpbuffer: *mut i32) -> ::win32_foundation_sys::BOOL;
    ...
    pub fn GetClipBox(hdc: HDC, lprect: *mut ::win32_foundation_sys::RECT) -> i32;
    pub fn GetClipRgn(hdc: HDC, hrgn: HRGN) -> i32;
    pub fn GetColorAdjustment(hdc: HDC, lpca: *mut COLORADJUSTMENT) -> ::win32_foundation_sys::BOOL;
    pub fn GetCurrentObject(hdc: HDC, r#type: OBJ_TYPE) -> HGDIOBJ;
    pub fn GetCurrentPositionEx(hdc: HDC, lppt: *mut ::win32_foundation_sys::POINT) -> ::win32_foundation_sys::BOOL;
    pub fn GetDC(hwnd: ::win32_foundation_sys::HWND) -> HDC;
    pub fn GetDCBrushColor(hdc: HDC) -> u32;
    pub fn GetDCEx(hwnd: ::win32_foundation_sys::HWND, hrgnclip: HRGN, flags: GET_DCX_FLAGS) -> HDC;
    pub fn GetDCOrgEx(hdc: HDC, lppt: *mut ::win32_foundation_sys::POINT) -> ::win32_foundation_sys::BOOL;
    ...
    pub fn GetMiterLimit(hdc: HDC, plimit: *mut f32) -> ::win32_foundation_sys::BOOL;
    pub fn GetMonitorInfoA(hmonitor: HMONITOR, lpmi: *mut MONITORINFO) -> ::win32_foundation_sys::BOOL;
    pub fn GetMonitorInfoW(hmonitor: HMONITOR, lpmi: *mut MONITORINFO) -> ::win32_foundation_sys::BOOL;
    ...
    pub fn GetPath(hdc: HDC, apt: *mut ::win32_foundation_sys::POINT, aj: *mut u8, cpt: i32) -> i32;
    ...
    pub fn GetRasterizerCaps(lpraststat: *mut RASTERIZER_STATUS, cjbytes: u32) -> ::win32_foundation_sys::BOOL;
    pub fn GetRegionData(hrgn: HRGN, ncount: u32, lprgndata: *mut RGNDATA) -> u32;
    pub fn GetRgnBox(hrgn: HRGN, lprc: *mut ::win32_foundation_sys::RECT) -> i32;
    ...
    pub fn GetTextExtentExPointA(hdc: HDC, lpszstring: ::windows_core_sys::PCSTR, cchstring: i32, nmaxextent: i32, lpnfit: *mut i32, lpndx: *mut i32, lpsize: *mut ::win32_foundation_sys::SIZE) -> ::win32_foundation_sys::BOOL;
    pub fn GetTextExtentExPointI(hdc: HDC, lpwszstring: *const u16, cwchstring: i32, nmaxextent: i32, lpnfit: *mut i32, lpndx: *mut i32, lpsize: *mut ::win32_foundation_sys::SIZE) -> ::win32_foundation_sys::BOOL;
    pub fn GetTextExtentExPointW(hdc: HDC, lpszstring: ::windows_core_sys::PCWSTR, cchstring: i32, nmaxextent: i32, lpnfit: *mut i32, lpndx: *mut i32, lpsize: *mut ::win32_foundation_sys::SIZE) -> ::win32_foundation_sys::BOOL;
    pub fn GetTextExtentPoint32A(hdc: HDC, lpstring: ::windows_core_sys::PCSTR, c: i32, psizl: *mut ::win32_foundation_sys::SIZE) -> ::win32_foundation_sys::BOOL;
    pub fn GetTextExtentPoint32W(hdc: HDC, lpstring: ::windows_core_sys::PCWSTR, c: i32, psizl: *mut ::win32_foundation_sys::SIZE) -> ::win32_foundation_sys::BOOL;
    pub fn GetTextExtentPointA(hdc: HDC, lpstring: ::windows_core_sys::PCSTR, c: i32, lpsz: *mut ::win32_foundation_sys::SIZE) -> ::win32_foundation_sys::BOOL;
    pub fn GetTextExtentPointI(hdc: HDC, pgiin: *const u16, cgi: i32, psize: *mut ::win32_foundation_sys::SIZE) -> ::win32_foundation_sys::BOOL;
    pub fn GetTextExtentPointW(hdc: HDC, lpstring: ::windows_core_sys::PCWSTR, c: i32, lpsz: *mut ::win32_foundation_sys::SIZE) -> ::win32_foundation_sys::BOOL;
    ...
    pub fn GetTextMetricsA(hdc: HDC, lptm: *mut TEXTMETRICA) -> ::win32_foundation_sys::BOOL;
    pub fn GetTextMetricsW(hdc: HDC, lptm: *mut TEXTMETRICW) -> ::win32_foundation_sys::BOOL;
    pub fn GetUpdateRect(hwnd: ::win32_foundation_sys::HWND, lprect: *mut ::win32_foundation_sys::RECT, berase: ::win32_foundation_sys::BOOL) -> ::win32_foundation_sys::BOOL;
    pub fn GetUpdateRgn(hwnd: ::win32_foundation_sys::HWND, hrgn: HRGN, berase: ::win32_foundation_sys::BOOL) -> i32;
    pub fn GetViewportExtEx(hdc: HDC, lpsize: *mut ::win32_foundation_sys::SIZE) -> ::win32_foundation_sys::BOOL;
    pub fn GetViewportOrgEx(hdc: HDC, lppoint: *mut ::win32_foundation_sys::POINT) -> ::win32_foundation_sys::BOOL;
    pub fn GetWinMetaFileBits(hemf: HENHMETAFILE, cbdata16: u32, pdata16: *mut u8, imapmode: i32, hdcref: HDC) -> u32;
    pub fn GetWindowDC(hwnd: ::win32_foundation_sys::HWND) -> HDC;
    pub fn GetWindowExtEx(hdc: HDC, lpsize: *mut ::win32_foundation_sys::SIZE) -> ::win32_foundation_sys::BOOL;
    pub fn GetWindowOrgEx(hdc: HDC, lppoint: *mut ::win32_foundation_sys::POINT) -> ::win32_foundation_sys::BOOL;
    pub fn GetWindowRgn(hwnd: ::win32_foundation_sys::HWND, hrgn: HRGN) -> i32;
    pub fn GetWindowRgnBox(hwnd: ::win32_foundation_sys::HWND, lprc: *mut ::win32_foundation_sys::RECT) -> i32;
    pub fn GetWorldTransform(hdc: HDC, lpxf: *mut XFORM) -> ::win32_foundation_sys::BOOL;
    pub fn GradientFill(hdc: HDC, pvertex: *const TRIVERTEX, nvertex: u32, pmesh: *const ::core::ffi::c_void, nmesh: u32, ulmode: GRADIENT_FILL) -> ::win32_foundation_sys::BOOL;
    pub fn GrayStringA(hdc: HDC, hbrush: HBRUSH, lpoutputfunc: GRAYSTRINGPROC, lpdata: ::win32_foundation_sys::LPARAM, ncount: i32, x: i32, y: i32, nwidth: i32, nheight: i32) -> ::win32_foundation_sys::BOOL;
    pub fn GrayStringW(hdc: HDC, hbrush: HBRUSH, lpoutputfunc: GRAYSTRINGPROC, lpdata: ::win32_foundation_sys::LPARAM, ncount: i32, x: i32, y: i32, nwidth: i32, nheight: i32) -> ::win32_foundation_sys::BOOL;
    pub fn InflateRect(lprc: *mut ::win32_foundation_sys::RECT, dx: i32, dy: i32) -> ::win32_foundation_sys::BOOL;
    pub fn IntersectClipRect(hdc: HDC, left: i32, top: i32, right: i32, bottom: i32) -> i32;
    pub fn IntersectRect(lprcdst: *mut ::win32_foundation_sys::RECT, lprcsrc1: *const ::win32_foundation_sys::RECT, lprcsrc2: *const ::win32_foundation_sys::RECT) -> ::win32_foundation_sys::BOOL;
    pub fn InvalidateRect(hwnd: ::win32_foundation_sys::HWND, lprect: *const ::win32_foundation_sys::RECT, berase: ::win32_foundation_sys::BOOL) -> ::win32_foundation_sys::BOOL;
    pub fn InvalidateRgn(hwnd: ::win32_foundation_sys::HWND, hrgn: HRGN, berase: ::win32_foundation_sys::BOOL) -> ::win32_foundation_sys::BOOL;
    pub fn InvertRect(hdc: HDC, lprc: *const ::win32_foundation_sys::RECT) -> ::win32_foundation_sys::BOOL;
    pub fn InvertRgn(hdc: HDC, hrgn: HRGN) -> ::win32_foundation_sys::BOOL;
    pub fn IsRectEmpty(lprc: *const ::win32_foundation_sys::RECT) -> ::win32_foundation_sys::BOOL;
    pub fn LPtoDP(hdc: HDC, lppt: *mut ::win32_foundation_sys::POINT, c: i32) -> ::win32_foundation_sys::BOOL;
    pub fn LineDDA(xstart: i32, ystart: i32, xend: i32, yend: i32, lpproc: LINEDDAPROC, data: ::win32_foundation_sys::LPARAM) -> ::win32_foundation_sys::BOOL;
    pub fn LineTo(hdc: HDC, x: i32, y: i32) -> ::win32_foundation_sys::BOOL;
    pub fn LoadBitmapA(hinstance: ::win32_foundation_sys::HINSTANCE, lpbitmapname: ::windows_core_sys::PCSTR) -> HBITMAP;
    pub fn LoadBitmapW(hinstance: ::win32_foundation_sys::HINSTANCE, lpbitmapname: ::windows_core_sys::PCWSTR) -> HBITMAP;
    pub fn LockWindowUpdate(hwndlock: ::win32_foundation_sys::HWND) -> ::win32_foundation_sys::BOOL;
    pub fn MapWindowPoints(hwndfrom: ::win32_foundation_sys::HWND, hwndto: ::win32_foundation_sys::HWND, lppoints: *mut ::win32_foundation_sys::POINT, cpoints: u32) -> i32;
    pub fn MaskBlt(hdcdest: HDC, xdest: i32, ydest: i32, width: i32, height: i32, hdcsrc: HDC, xsrc: i32, ysrc: i32, hbmmask: HBITMAP, xmask: i32, ymask: i32, rop: u32) -> ::win32_foundation_sys::BOOL;
    ...
    pub fn ModifyWorldTransform(hdc: HDC, lpxf: *const XFORM, mode: MODIFY_WORLD_TRANSFORM_MODE) -> ::win32_foundation_sys::BOOL;
    pub fn MonitorFromPoint(pt: ::win32_foundation_sys::POINT, dwflags: MONITOR_FROM_FLAGS) -> HMONITOR;
    pub fn MonitorFromRect(lprc: *const ::win32_foundation_sys::RECT, dwflags: MONITOR_FROM_FLAGS) -> HMONITOR;
    pub fn MonitorFromWindow(hwnd: ::win32_foundation_sys::HWND, dwflags: MONITOR_FROM_FLAGS) -> HMONITOR;
    pub fn MoveToEx(hdc: HDC, x: i32, y: i32, lppt: *mut ::win32_foundation_sys::POINT) -> ::win32_foundation_sys::BOOL;
    pub fn OffsetClipRgn(hdc: HDC, x: i32, y: i32) -> i32;
    pub fn OffsetRect(lprc: *mut ::win32_foundation_sys::RECT, dx: i32, dy: i32) -> ::win32_foundation_sys::BOOL;
    pub fn OffsetRgn(hrgn: HRGN, x: i32, y: i32) -> i32;
    pub fn OffsetViewportOrgEx(hdc: HDC, x: i32, y: i32, lppt: *mut ::win32_foundation_sys::POINT) -> ::win32_foundation_sys::BOOL;
    pub fn OffsetWindowOrgEx(hdc: HDC, x: i32, y: i32, lppt: *mut ::win32_foundation_sys::POINT) -> ::win32_foundation_sys::BOOL;
    pub fn PaintDesktop(hdc: HDC) -> ::win32_foundation_sys::BOOL;
    pub fn PaintRgn(hdc: HDC, hrgn: HRGN) -> ::win32_foundation_sys::BOOL;
    pub fn PatBlt(hdc: HDC, x: i32, y: i32, w: i32, h: i32, rop: ROP_CODE) -> ::win32_foundation_sys::BOOL;
    pub fn PathToRegion(hdc: HDC) -> HRGN;
    pub fn Pie(hdc: HDC, left: i32, top: i32, right: i32, bottom: i32, xr1: i32, yr1: i32, xr2: i32, yr2: i32) -> ::win32_foundation_sys::BOOL;
    pub fn PlayEnhMetaFile(hdc: HDC, hmf: HENHMETAFILE, lprect: *const ::win32_foundation_sys::RECT) -> ::win32_foundation_sys::BOOL;
    pub fn PlayEnhMetaFileRecord(hdc: HDC, pht: *const HANDLETABLE, pmr: *const ENHMETARECORD, cht: u32) -> ::win32_foundation_sys::BOOL;
    pub fn PlayMetaFile(hdc: HDC, hmf: HMETAFILE) -> ::win32_foundation_sys::BOOL;
    pub fn PlayMetaFileRecord(hdc: HDC, lphandletable: *const HANDLETABLE, lpmr: *const METARECORD, noobjs: u32) -> ::win32_foundation_sys::BOOL;
    pub fn PlgBlt(hdcdest: HDC, lppoint: *const ::win32_foundation_sys::POINT, hdcsrc: HDC, xsrc: i32, ysrc: i32, width: i32, height: i32, hbmmask: HBITMAP, xmask: i32, ymask: i32) -> ::win32_foundation_sys::BOOL;
    pub fn PolyBezier(hdc: HDC, apt: *const ::win32_foundation_sys::POINT, cpt: u32) -> ::win32_foundation_sys::BOOL;
    pub fn PolyBezierTo(hdc: HDC, apt: *const ::win32_foundation_sys::POINT, cpt: u32) -> ::win32_foundation_sys::BOOL;
    pub fn PolyDraw(hdc: HDC, apt: *const ::win32_foundation_sys::POINT, aj: *const u8, cpt: i32) -> ::win32_foundation_sys::BOOL;
    pub fn PolyPolygon(hdc: HDC, apt: *const ::win32_foundation_sys::POINT, asz: *const i32, csz: i32) -> ::win32_foundation_sys::BOOL;
    pub fn PolyPolyline(hdc: HDC, apt: *const ::win32_foundation_sys::POINT, asz: *const u32, csz: u32) -> ::win32_foundation_sys::BOOL;
    pub fn PolyTextOutA(hdc: HDC, ppt: *const POLYTEXTA, nstrings: i32) -> ::win32_foundation_sys::BOOL;
    pub fn PolyTextOutW(hdc: HDC, ppt: *const POLYTEXTW, nstrings: i32) -> ::win32_foundation_sys::BOOL;
    pub fn Polygon(hdc: HDC, apt: *const ::win32_foundation_sys::POINT, cpt: i32) -> ::win32_foundation_sys::BOOL;
    pub fn Polyline(hdc: HDC, apt: *const ::win32_foundation_sys::POINT, cpt: i32) -> ::win32_foundation_sys::BOOL;
    pub fn PolylineTo(hdc: HDC, apt: *const ::win32_foundation_sys::POINT, cpt: u32) -> ::win32_foundation_sys::BOOL;
    pub fn PtInRect(lprc: *const ::win32_foundation_sys::RECT, pt: ::win32_foundation_sys::POINT) -> ::win32_foundation_sys::BOOL;
    pub fn PtInRegion(hrgn: HRGN, x: i32, y: i32) -> ::win32_foundation_sys::BOOL;
    pub fn PtVisible(hdc: HDC, x: i32, y: i32) -> ::win32_foundation_sys::BOOL;
    pub fn RealizePalette(hdc: HDC) -> u32;
    pub fn RectInRegion(hrgn: HRGN, lprect: *const ::win32_foundation_sys::RECT) -> ::win32_foundation_sys::BOOL;
    pub fn RectVisible(hdc: HDC, lprect: *const ::win32_foundation_sys::RECT) -> ::win32_foundation_sys::BOOL;
    pub fn Rectangle(hdc: HDC, left: i32, top: i32, right: i32, bottom: i32) -> ::win32_foundation_sys::BOOL;
    pub fn RedrawWindow(hwnd: ::win32_foundation_sys::HWND, lprcupdate: *const ::win32_foundation_sys::RECT, hrgnupdate: HRGN, flags: REDRAW_WINDOW_FLAGS) -> ::win32_foundation_sys::BOOL;
    pub fn ReleaseDC(hwnd: ::win32_foundation_sys::HWND, hdc: HDC) -> i32;
    pub fn RemoveFontMemResourceEx(h: ::win32_foundation_sys::HANDLE) -> ::win32_foundation_sys::BOOL;
    pub fn RemoveFontResourceA(lpfilename: ::windows_core_sys::PCSTR) -> ::win32_foundation_sys::BOOL;
    pub fn RemoveFontResourceExA(name: ::windows_core_sys::PCSTR, fl: u32, pdv: *mut ::core::ffi::c_void) -> ::win32_foundation_sys::BOOL;
    pub fn RemoveFontResourceExW(name: ::windows_core_sys::PCWSTR, fl: u32, pdv: *mut ::core::ffi::c_void) -> ::win32_foundation_sys::BOOL;
    pub fn RemoveFontResourceW(lpfilename: ::windows_core_sys::PCWSTR) -> ::win32_foundation_sys::BOOL;
    pub fn ResetDCA(hdc: HDC, lpdm: *const DEVMODEA) -> HDC;
    pub fn ResetDCW(hdc: HDC, lpdm: *const DEVMODEW) -> HDC;
    pub fn ResizePalette(hpal: HPALETTE, n: u32) -> ::win32_foundation_sys::BOOL;
    pub fn RestoreDC(hdc: HDC, nsaveddc: i32) -> ::win32_foundation_sys::BOOL;
    pub fn RoundRect(hdc: HDC, left: i32, top: i32, right: i32, bottom: i32, width: i32, height: i32) -> ::win32_foundation_sys::BOOL;
    pub fn SaveDC(hdc: HDC) -> i32;
    pub fn ScaleViewportExtEx(hdc: HDC, xn: i32, dx: i32, yn: i32, yd: i32, lpsz: *mut ::win32_foundation_sys::SIZE) -> ::win32_foundation_sys::BOOL;
    pub fn ScaleWindowExtEx(hdc: HDC, xn: i32, xd: i32, yn: i32, yd: i32, lpsz: *mut ::win32_foundation_sys::SIZE) -> ::win32_foundation_sys::BOOL;
    pub fn ScreenToClient(hwnd: ::win32_foundation_sys::HWND, lppoint: *mut ::win32_foundation_sys::POINT) -> ::win32_foundation_sys::BOOL;
    pub fn SelectClipPath(hdc: HDC, mode: RGN_COMBINE_MODE) -> ::win32_foundation_sys::BOOL;
    pub fn SelectClipRgn(hdc: HDC, hrgn: HRGN) -> i32;
    pub fn SelectObject(hdc: HDC, h: HGDIOBJ) -> HGDIOBJ;
    pub fn SelectPalette(hdc: HDC, hpal: HPALETTE, bforcebkgd: ::win32_foundation_sys::BOOL) -> HPALETTE;
    ...
    pub fn SetBitmapDimensionEx(hbm: HBITMAP, w: i32, h: i32, lpsz: *mut ::win32_foundation_sys::SIZE) -> ::win32_foundation_sys::BOOL;
    pub fn SetBkColor(hdc: HDC, color: u32) -> u32;
    pub fn SetBkMode(hdc: HDC, mode: BACKGROUND_MODE) -> i32;
    pub fn SetBoundsRect(hdc: HDC, lprect: *const ::win32_foundation_sys::RECT, flags: SET_BOUNDS_RECT_FLAGS) -> u32;
    pub fn SetBrushOrgEx(hdc: HDC, x: i32, y: i32, lppt: *mut ::win32_foundation_sys::POINT) -> ::win32_foundation_sys::BOOL;
    pub fn SetColorAdjustment(hdc: HDC, lpca: *const COLORADJUSTMENT) -> ::win32_foundation_sys::BOOL;
    ...
    pub fn SetMiterLimit(hdc: HDC, limit: f32, old: *mut f32) -> ::win32_foundation_sys::BOOL;
    ...
    pub fn SetPixelV(hdc: HDC, x: i32, y: i32, color: u32) -> ::win32_foundation_sys::BOOL;
    pub fn SetPolyFillMode(hdc: HDC, mode: CREATE_POLYGON_RGN_MODE) -> i32;
    pub fn SetROP2(hdc: HDC, rop2: R2_MODE) -> i32;
    pub fn SetRect(lprc: *mut ::win32_foundation_sys::RECT, xleft: i32, ytop: i32, xright: i32, ybottom: i32) -> ::win32_foundation_sys::BOOL;
    pub fn SetRectEmpty(lprc: *mut ::win32_foundation_sys::RECT) -> ::win32_foundation_sys::BOOL;
    pub fn SetRectRgn(hrgn: HRGN, left: i32, top: i32, right: i32, bottom: i32) -> ::win32_foundation_sys::BOOL;
    ...
    pub fn SetTextJustification(hdc: HDC, extra: i32, count: i32) -> ::win32_foundation_sys::BOOL;
    pub fn SetViewportExtEx(hdc: HDC, x: i32, y: i32, lpsz: *mut ::win32_foundation_sys::SIZE) -> ::win32_foundation_sys::BOOL;
    pub fn SetViewportOrgEx(hdc: HDC, x: i32, y: i32, lppt: *mut ::win32_foundation_sys::POINT) -> ::win32_foundation_sys::BOOL;
    pub fn SetWindowExtEx(hdc: HDC, x: i32, y: i32, lpsz: *mut ::win32_foundation_sys::SIZE) -> ::win32_foundation_sys::BOOL;
    pub fn SetWindowOrgEx(hdc: HDC, x: i32, y: i32, lppt: *mut ::win32_foundation_sys::POINT) -> ::win32_foundation_sys::BOOL;
    pub fn SetWindowRgn(hwnd: ::win32_foundation_sys::HWND, hrgn: HRGN, bredraw: ::win32_foundation_sys::BOOL) -> i32;
    pub fn SetWorldTransform(hdc: HDC, lpxf: *const XFORM) -> ::win32_foundation_sys::BOOL;
    pub fn StretchBlt(hdcdest: HDC, xdest: i32, ydest: i32, wdest: i32, hdest: i32, hdcsrc: HDC, xsrc: i32, ysrc: i32, wsrc: i32, hsrc: i32, rop: ROP_CODE) -> ::win32_foundation_sys::BOOL;
    ...
    pub fn StrokeAndFillPath(hdc: HDC) -> ::win32_foundation_sys::BOOL;
    pub fn StrokePath(hdc: HDC) -> ::win32_foundation_sys::BOOL;
    pub fn SubtractRect(lprcdst: *mut ::win32_foundation_sys::RECT, lprcsrc1: *const ::win32_foundation_sys::RECT, lprcsrc2: *const ::win32_foundation_sys::RECT) -> ::win32_foundation_sys::BOOL;
    ...
    pub fn TTDeleteEmbeddedFont(hfontreference: ::win32_foundation_sys::HANDLE, ulflags: u32, pulstatus: *mut u32) -> i32;
    ...
    pub fn TTEnableEmbeddingForFacename(lpszfacename: ::windows_core_sys::PCSTR, benable: ::win32_foundation_sys::BOOL) -> i32;
    ...
    pub fn TTGetNewFontName(phfontreference: *const ::win32_foundation_sys::HANDLE, wzwinfamilyname: ::windows_core_sys::PWSTR, cchmaxwinname: i32, szmacfamilyname: ::windows_core_sys::PSTR, cchmaxmacname: i32) -> i32;
    pub fn TTIsEmbeddingEnabled(hdc: HDC, pbenabled: *mut ::win32_foundation_sys::BOOL) -> i32;
    pub fn TTIsEmbeddingEnabledForFacename(lpszfacename: ::windows_core_sys::PCSTR, pbenabled: *mut ::win32_foundation_sys::BOOL) -> i32;
    pub fn TTLoadEmbeddedFont(phfontreference: *mut ::win32_foundation_sys::HANDLE, ulflags: u32, pulprivstatus: *mut EMBEDDED_FONT_PRIV_STATUS, ulprivs: FONT_LICENSE_PRIVS, pulstatus: *mut TTLOAD_EMBEDDED_FONT_STATUS, lpfnreadfromstream: READEMBEDPROC, lpvreadstream: *const ::core::ffi::c_void, szwinfamilyname: ::windows_core_sys::PCWSTR, szmacfamilyname: ::windows_core_sys::PCSTR, pttloadinfo: *const TTLOADINFO) -> i32;
    ...
    pub fn TextOutA(hdc: HDC, x: i32, y: i32, lpstring: ::windows_core_sys::PCSTR, c: i32) -> ::win32_foundation_sys::BOOL;
    pub fn TextOutW(hdc: HDC, x: i32, y: i32, lpstring: ::windows_core_sys::PCWSTR, c: i32) -> ::win32_foundation_sys::BOOL;
    pub fn TransparentBlt(hdcdest: HDC, xorigindest: i32, yorigindest: i32, wdest: i32, hdest: i32, hdcsrc: HDC, xoriginsrc: i32, yoriginsrc: i32, wsrc: i32, hsrc: i32, crtransparent: u32) -> ::win32_foundation_sys::BOOL;
    pub fn UnionRect(lprcdst: *mut ::win32_foundation_sys::RECT, lprcsrc1: *const ::win32_foundation_sys::RECT, lprcsrc2: *const ::win32_foundation_sys::RECT) -> ::win32_foundation_sys::BOOL;
    pub fn UnrealizeObject(h: HGDIOBJ) -> ::win32_foundation_sys::BOOL;
    pub fn UpdateColors(hdc: HDC) -> ::win32_foundation_sys::BOOL;
    pub fn UpdateWindow(hwnd: ::win32_foundation_sys::HWND) -> ::win32_foundation_sys::BOOL;
    pub fn ValidateRect(hwnd: ::win32_foundation_sys::HWND, lprect: *const ::win32_foundation_sys::RECT) -> ::win32_foundation_sys::BOOL;
    pub fn ValidateRgn(hwnd: ::win32_foundation_sys::HWND, hrgn: HRGN) -> ::win32_foundation_sys::BOOL;
    pub fn WidenPath(hdc: HDC) -> ::win32_foundation_sys::BOOL;
    pub fn WindowFromDC(hdc: HDC) -> ::win32_foundation_sys::HWND;
...
pub struct DEVMODEA_0_1 {
    pub dmPosition: ::win32_foundation_sys::POINTL,
...
pub struct DIBSECTION {
    ...
    pub dshSection: ::win32_foundation_sys::HANDLE,
    pub dsOffset: u32,
}
...
pub struct DISPLAY_DEVICEA {
    ...
    pub DeviceString: [::win32_foundation_sys::CHAR; 128],
    pub StateFlags: u32,
    pub DeviceID: [::win32_foundation_sys::CHAR; 128],
    pub DeviceKey: [::win32_foundation_sys::CHAR; 128],
}
...
pub type DRAWSTATEPROC = ::core::option::Option<unsafe extern "system" fn(hdc: HDC, ldata: ::win32_foundation_sys::LPARAM, wdata: ::win32_foundation_sys::WPARAM, cx: i32, cy: i32) -> ::win32_foundation_sys::BOOL>;
...
pub struct EMRANGLEARC {
    pub emr: EMR,
    pub ptlCenter: ::win32_foundation_sys::POINTL,
    pub nRadius: u32,
    pub eStartAngle: f32,
    pub eSweepAngle: f32,
}
...
pub struct EMRARC {
    pub emr: EMR,
    pub rclBox: ::win32_foundation_sys::RECTL,
    pub ptlStart: ::win32_foundation_sys::POINTL,
    pub ptlEnd: ::win32_foundation_sys::POINTL,
}
...
pub struct EMREXCLUDECLIPRECT {
    pub emr: EMR,
    pub rclClip: ::win32_foundation_sys::RECTL,
}
...
pub struct EMRFRAMERGN {
    ...
    pub cbRgnData: u32,
    pub ihBrush: u32,
    pub szlStroke: ::win32_foundation_sys::SIZE,
    pub RgnData: [u8; 1],
}
...
pub struct EMROFFSETCLIPRGN {
    pub emr: EMR,
    pub ptlOffset: ::win32_foundation_sys::POINTL,
}
...
pub struct EMRPLGBLT {
    pub emr: EMR,
    pub rclBounds: ::win32_foundation_sys::RECTL,
    pub aptlDest: [::win32_foundation_sys::POINTL; 3],
    pub xSrc: i32,
    pub ySrc: i32,
    pub cxSrc: i32,
    pub cySrc: i32,
...
pub struct EMRPOLYDRAW {
    ...
    pub rclBounds: ::win32_foundation_sys::RECTL,
    pub cptl: u32,
    pub aptl: [::win32_foundation_sys::POINTL; 1],
    pub abTypes: [u8; 1],
}
...
pub struct EMRPOLYDRAW16 {
    ...
    pub rclBounds: ::win32_foundation_sys::RECTL,
    pub cpts: u32,
    pub apts: [::win32_foundation_sys::POINTS; 1],
    pub abTypes: [u8; 1],
}
...
pub struct EMRROUNDRECT {
    pub emr: EMR,
    pub rclBox: ::win32_foundation_sys::RECTL,
    pub szlCorner: ::win32_foundation_sys::SIZE,
}
...
pub struct EMRSETPIXELV {
    pub emr: EMR,
    pub ptlPixel: ::win32_foundation_sys::POINTL,
    pub crColor: u32,
}
...
pub struct EMRSETVIEWPORTEXTEX {
    pub emr: EMR,
    pub szlExtent: ::win32_foundation_sys::SIZE,
}
...
#[repr(C)]
pub struct EMRTEXT {
    pub ptlReference: ::win32_foundation_sys::POINTL,
    pub nChars: u32,
    pub offString: u32,
    pub fOptions: u32,
    pub rcl: ::win32_foundation_sys::RECTL,
    pub offDx: u32,
}
...
pub struct ENHMETAHEADER {
    ...
    pub nSize: u32,
    pub rclBounds: ::win32_foundation_sys::RECTL,
    pub rclFrame: ::win32_foundation_sys::RECTL,
    pub dSignature: u32,
    pub nVersion: u32,
    pub nBytes: u32,
    pub nRecords: u32,
    ...
    pub nPalEntries: u32,
    pub szlDevice: ::win32_foundation_sys::SIZE,
    pub szlMillimeters: ::win32_foundation_sys::SIZE,
    pub cbPixelFormat: u32,
    pub offPixelFormat: u32,
    pub bOpenGL: u32,
    pub szlMicrometers: ::win32_foundation_sys::SIZE,
}
...
pub type ENHMFENUMPROC = ::core::option::Option<unsafe extern "system" fn(hdc: HDC, lpht: *const HANDLETABLE, lpmr: *const ENHMETARECORD, nhandles: i32, data: ::win32_foundation_sys::LPARAM) -> i32>;
#[repr(C)]
...
pub type FONTENUMPROCA = ::core::option::Option<unsafe extern "system" fn(param0: *const LOGFONTA, param1: *const TEXTMETRICA, param2: u32, param3: ::win32_foundation_sys::LPARAM) -> i32>;
pub type FONTENUMPROCW = ::core::option::Option<unsafe extern "system" fn(param0: *const LOGFONTW, param1: *const TEXTMETRICW, param2: u32, param3: ::win32_foundation_sys::LPARAM) -> i32>;
...
pub struct GLYPHMETRICS {
    pub gmBlackBoxX: u32,
    pub gmBlackBoxY: u32,
    pub gmptGlyphOrigin: ::win32_foundation_sys::POINT,
    pub gmCellIncX: i16,
    pub gmCellIncY: i16,
}
...
pub type GOBJENUMPROC = ::core::option::Option<unsafe extern "system" fn(param0: *mut ::core::ffi::c_void, param1: ::win32_foundation_sys::LPARAM) -> i32>;
...
pub type GRAYSTRINGPROC = ::core::option::Option<unsafe extern "system" fn(param0: HDC, param1: ::win32_foundation_sys::LPARAM, param2: i32) -> ::win32_foundation_sys::BOOL>;
...
pub type LINEDDAPROC = ::core::option::Option<unsafe extern "system" fn(param0: i32, param1: i32, param2: ::win32_foundation_sys::LPARAM)>;
#[repr(C)]
pub struct LOGBRUSH {
    pub lbStyle: u32,
    pub lbColor: u32,
...
pub struct LOGFONTA {
    ...
    pub lfFaceName: [::win32_foundation_sys::CHAR; 32],
}
...
pub struct LOGPEN {
    pub lopnStyle: u32,
    pub lopnWidth: ::win32_foundation_sys::POINT,
    pub lopnColor: u32,
}
...
pub type LPFNDEVMODE = ::core::option::Option<unsafe extern "system" fn(param0: ::win32_foundation_sys::HWND, param1: ::win32_foundation_sys::HINSTANCE, param2: *mut DEVMODEA, param3: ::windows_core_sys::PCSTR, param4: ::windows_core_sys::PCSTR, param5: *mut DEVMODEA, param6: ::windows_core_sys::PCSTR, param7: u32) -> u32>;
...
pub type MFENUMPROC = ::core::option::Option<unsafe extern "system" fn(hdc: HDC, lpht: *const HANDLETABLE, lpmr: *const METARECORD, nobj: i32, param4: ::win32_foundation_sys::LPARAM) -> i32>;
...
pub type MONITORENUMPROC = ::core::option::Option<unsafe extern "system" fn(param0: HMONITOR, param1: HDC, param2: *mut ::win32_foundation_sys::RECT, param3: ::win32_foundation_sys::LPARAM) -> ::win32_foundation_sys::BOOL>;
#[repr(C)]
pub struct MONITORINFO {
    pub cbSize: u32,
    pub rcMonitor: ::win32_foundation_sys::RECT,
    pub rcWork: ::win32_foundation_sys::RECT,
    pub dwFlags: u32,
}
...
pub struct MONITORINFOEXA {
    ...
    pub szDevice: [::win32_foundation_sys::CHAR; 32],
}
...
pub struct OUTLINETEXTMETRICA {
    ...
    pub otmsXHeight: u32,
    pub otmrcFontBox: ::win32_foundation_sys::RECT,
    pub otmMacAscent: i32,
    pub otmMacDescent: i32,
    pub otmMacLineGap: u32,
    pub otmusMinimumPPEM: u32,
    pub otmptSubscriptSize: ::win32_foundation_sys::POINT,
    pub otmptSubscriptOffset: ::win32_foundation_sys::POINT,
    pub otmptSuperscriptSize: ::win32_foundation_sys::POINT,
    pub otmptSuperscriptOffset: ::win32_foundation_sys::POINT,
...
pub struct PAINTSTRUCT {
    pub hdc: HDC,
    pub fErase: ::win32_foundation_sys::BOOL,
    pub rcPaint: ::win32_foundation_sys::RECT,
    pub fRestore: ::win32_foundation_sys::BOOL,
    pub fIncUpdate: ::win32_foundation_sys::BOOL,
...
pub struct POLYTEXTA {
    ...
    pub uiFlags: u32,
    pub rcl: ::win32_foundation_sys::RECT,
    pub pdx: *mut i32,
}
...
pub struct RGNDATAHEADER {
    ...
    pub nCount: u32,
    pub nRgnSize: u32,
    pub rcBound: ::win32_foundation_sys::RECT,
}
