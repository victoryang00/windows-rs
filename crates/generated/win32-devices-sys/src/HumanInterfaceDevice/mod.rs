...
pub const CLSID_DirectInput: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 635832800, data2: 45657, data3: 4559, data4: [191, 199, 68, 69, 83, 84, 0, 0] };
pub const CLSID_DirectInput8: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 635832804, data2: 45657, data3: 4559, data4: [191, 199, 68, 69, 83, 84, 0, 0] };
pub const CLSID_DirectInputDevice: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 635832801, data2: 45657, data3: 4559, data4: [191, 199, 68, 69, 83, 84, 0, 0] };
pub const CLSID_DirectInputDevice8: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 635832805, data2: 45657, data3: 4559, data4: [191, 199, 68, 69, 83, 84, 0, 0] };
#[repr(C)]
pub struct CPOINT {
    pub lP: i32,
    pub dwLog: u32,
...
pub const DEVPKEY_DeviceInterface_HID_BackgroundAccess: super::Properties::DEVPROPKEY = super::Properties::DEVPROPKEY { fmtid: ::windows_core_sys::GUID { data1: 3421733648, data2: 18967, data3: 17168, data4: [161, 235, 36, 127, 11, 103, 89, 59] }, pid: 8u32 };
#[cfg(feature = "win32-devices-sys")]
pub const DEVPKEY_DeviceInterface_HID_IsReadOnly: super::Properties::DEVPROPKEY = super::Properties::DEVPROPKEY { fmtid: ::windows_core_sys::GUID { data1: 3421733648, data2: 18967, data3: 17168, data4: [161, 235, 36, 127, 11, 103, 89, 59] }, pid: 4u32 };
#[cfg(feature = "win32-devices-sys")]
pub const DEVPKEY_DeviceInterface_HID_ProductId: super::Properties::DEVPROPKEY = super::Properties::DEVPROPKEY { fmtid: ::windows_core_sys::GUID { data1: 3421733648, data2: 18967, data3: 17168, data4: [161, 235, 36, 127, 11, 103, 89, 59] }, pid: 6u32 };
#[cfg(feature = "win32-devices-sys")]
pub const DEVPKEY_DeviceInterface_HID_UsageId: super::Properties::DEVPROPKEY = super::Properties::DEVPROPKEY { fmtid: ::windows_core_sys::GUID { data1: 3421733648, data2: 18967, data3: 17168, data4: [161, 235, 36, 127, 11, 103, 89, 59] }, pid: 3u32 };
#[cfg(feature = "win32-devices-sys")]
pub const DEVPKEY_DeviceInterface_HID_UsagePage: super::Properties::DEVPROPKEY = super::Properties::DEVPROPKEY { fmtid: ::windows_core_sys::GUID { data1: 3421733648, data2: 18967, data3: 17168, data4: [161, 235, 36, 127, 11, 103, 89, 59] }, pid: 2u32 };
#[cfg(feature = "win32-devices-sys")]
pub const DEVPKEY_DeviceInterface_HID_VendorId: super::Properties::DEVPROPKEY = super::Properties::DEVPROPKEY { fmtid: ::windows_core_sys::GUID { data1: 3421733648, data2: 18967, data3: 17168, data4: [161, 235, 36, 127, 11, 103, 89, 59] }, pid: 5u32 };
#[cfg(feature = "win32-devices-sys")]
pub const DEVPKEY_DeviceInterface_HID_VersionNumber: super::Properties::DEVPROPKEY = super::Properties::DEVPROPKEY { fmtid: ::windows_core_sys::GUID { data1: 3421733648, data2: 18967, data3: 17168, data4: [161, 235, 36, 127, 11, 103, 89, 59] }, pid: 7u32 };
#[cfg(feature = "win32-devices-sys")]
pub const DEVPKEY_DeviceInterface_HID_WakeScreenOnInputCapable: super::Properties::DEVPROPKEY = super::Properties::DEVPROPKEY { fmtid: ::windows_core_sys::GUID { data1: 3421733648, data2: 18967, data3: 17168, data4: [161, 235, 36, 127, 11, 103, 89, 59] }, pid: 9u32 };
...
pub union DIACTIONA_0 {
    pub lptszActionName: ::windows_core_sys::PCSTR,
...
pub struct DIACTIONFORMATA {
    ...
    pub guidActionMap: ::windows_core_sys::GUID,
    pub dwGenre: u32,
...
pub union DIACTIONW_0 {
    pub lptszActionName: ::windows_core_sys::PCWSTR,
    pub uResIdString: u32,
}
...
pub const DIERR_ACQUIRED: ::windows_core_sys::HRESULT = -2147024726i32;
pub const DIERR_ALREADYINITIALIZED: ::windows_core_sys::HRESULT = -2147023649i32;
pub const DIERR_BADDRIVERVER: ::windows_core_sys::HRESULT = -2147024777i32;
pub const DIERR_BADINF: i32 = -2147220478i32;
pub const DIERR_BETADIRECTINPUTVERSION: ::windows_core_sys::HRESULT = -2147023743i32;
...
pub const DIERR_INPUTLOST: ::windows_core_sys::HRESULT = -2147024866i32;
...
pub const DIERR_NOMOREITEMS: ::windows_core_sys::HRESULT = -2147024637i32;
pub const DIERR_NOTACQUIRED: ::windows_core_sys::HRESULT = -2147024884i32;
...
pub const DIERR_NOTFOUND: ::windows_core_sys::HRESULT = -2147024894i32;
pub const DIERR_NOTINITIALIZED: ::windows_core_sys::HRESULT = -2147024875i32;
pub const DIERR_OBJECTNOTFOUND: ::windows_core_sys::HRESULT = -2147024894i32;
pub const DIERR_OLDDIRECTINPUTVERSION: ::windows_core_sys::HRESULT = -2147023746i32;
...
pub struct DIHIDFFINITINFO {
    pub dwSize: u32,
    pub pwszDeviceInterface: ::windows_core_sys::PWSTR,
    pub GuidInstance: ::windows_core_sys::GUID,
}
...
pub struct DIJOYCONFIG {
    ...
    pub guidGameport: ::windows_core_sys::GUID,
}
...
pub struct DIJOYTYPEINFO {
    ...
    pub clsidConfig: ::windows_core_sys::GUID,
...
pub struct DIOBJECTDATAFORMAT {
    pub pguid: *const ::windows_core_sys::GUID,
    pub dwOfs: u32,
    pub dwType: u32,
    pub dwFlags: u32,
}
...
pub struct DIPROPGUIDANDPATH {
    pub diph: DIPROPHEADER,
    pub guidClass: ::windows_core_sys::GUID,
    pub wszPath: [u16; 260],
}
...
pub const DI_DOWNLOADSKIPPED: ::windows_core_sys::HRESULT = 3i32;
pub const DI_EFFECTRESTARTED: ::windows_core_sys::HRESULT = 4i32;
...
pub const DI_POLLEDDEVICE: ::windows_core_sys::HRESULT = 2i32;
pub const DI_PROPNOEFFECT: i32 = 1i32;
pub const DI_SECONDS: u32 = 1000000u32;
pub const DI_SETTINGSNOTSAVED: ::windows_core_sys::HRESULT = 11i32;
pub const DI_TRUNCATED: ::windows_core_sys::HRESULT = 8i32;
pub const DI_TRUNCATEDANDRESTARTED: ::windows_core_sys::HRESULT = 12i32;
pub const DI_WRITEPROTECT: ::windows_core_sys::HRESULT = 19i32;
...
pub const GUID_Button: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2741830384, data2: 51699, data3: 4559, data4: [191, 199, 68, 69, 83, 84, 0, 0] };
pub const GUID_ConstantForce: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 324279328, data2: 36403, data3: 4560, data4: [154, 208, 0, 160, 201, 160, 110, 53] };
pub const GUID_CustomForce: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 324279339, data2: 36403, data3: 4560, data4: [154, 208, 0, 160, 201, 160, 110, 53] };
pub const GUID_DEVINTERFACE_HID: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1293833650, data2: 61807, data3: 4559, data4: [136, 203, 0, 17, 17, 0, 0, 48] };
pub const GUID_DEVINTERFACE_KEYBOARD: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2286655171, data2: 22255, data3: 4561, data4: [188, 140, 0, 160, 201, 20, 5, 221] };
pub const GUID_DEVINTERFACE_MOUSE: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 932045900, data2: 22255, data3: 4561, data4: [188, 140, 0, 160, 201, 20, 5, 221] };
pub const GUID_Damper: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 324279336, data2: 36403, data3: 4560, data4: [154, 208, 0, 160, 201, 160, 110, 53] };
pub const GUID_Friction: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 324279338, data2: 36403, data3: 4560, data4: [154, 208, 0, 160, 201, 160, 110, 53] };
pub const GUID_HIDClass: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1952061344, data2: 29907, data3: 4560, data4: [182, 254, 0, 160, 201, 15, 87, 218] };
pub const GUID_HID_INTERFACE_HIDPARSE: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4123202981, data2: 27052, data3: 19394, data4: [146, 121, 208, 182, 69, 118, 244, 75] };
pub const GUID_HID_INTERFACE_NOTIFY: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 743321224, data2: 9702, data3: 19507, data4: [136, 47, 61, 130, 230, 7, 54, 129] };
pub const GUID_Inertia: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 324279337, data2: 36403, data3: 4560, data4: [154, 208, 0, 160, 201, 160, 110, 53] };
pub const GUID_Joystick: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1864182640, data2: 54688, data3: 4559, data4: [191, 199, 68, 69, 83, 84, 0, 0] };
pub const GUID_Key: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1433567776, data2: 54076, data3: 4559, data4: [191, 199, 68, 69, 83, 84, 0, 0] };
pub const GUID_KeyboardClass: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1295444331, data2: 58149, data3: 4558, data4: [191, 193, 8, 0, 43, 225, 3, 24] };
pub const GUID_MediaClass: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1295444332, data2: 58149, data3: 4558, data4: [191, 193, 8, 0, 43, 225, 3, 24] };
pub const GUID_MouseClass: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1295444335, data2: 58149, data3: 4558, data4: [191, 193, 8, 0, 43, 225, 3, 24] };
pub const GUID_POV: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2741830386, data2: 51699, data3: 4559, data4: [191, 199, 68, 69, 83, 84, 0, 0] };
pub const GUID_RampForce: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 324279329, data2: 36403, data3: 4560, data4: [154, 208, 0, 160, 201, 160, 110, 53] };
pub const GUID_RxAxis: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2741830388, data2: 51699, data3: 4559, data4: [191, 199, 68, 69, 83, 84, 0, 0] };
pub const GUID_RyAxis: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2741830389, data2: 51699, data3: 4559, data4: [191, 199, 68, 69, 83, 84, 0, 0] };
pub const GUID_RzAxis: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2741830371, data2: 51699, data3: 4559, data4: [191, 199, 68, 69, 83, 84, 0, 0] };
pub const GUID_SawtoothDown: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 324279334, data2: 36403, data3: 4560, data4: [154, 208, 0, 160, 201, 160, 110, 53] };
pub const GUID_SawtoothUp: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 324279333, data2: 36403, data3: 4560, data4: [154, 208, 0, 160, 201, 160, 110, 53] };
pub const GUID_Sine: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 324279331, data2: 36403, data3: 4560, data4: [154, 208, 0, 160, 201, 160, 110, 53] };
pub const GUID_Slider: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2741830372, data2: 51699, data3: 4559, data4: [191, 199, 68, 69, 83, 84, 0, 0] };
pub const GUID_Spring: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 324279335, data2: 36403, data3: 4560, data4: [154, 208, 0, 160, 201, 160, 110, 53] };
pub const GUID_Square: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 324279330, data2: 36403, data3: 4560, data4: [154, 208, 0, 160, 201, 160, 110, 53] };
pub const GUID_SysKeyboard: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1864182625, data2: 54688, data3: 4559, data4: [191, 199, 68, 69, 83, 84, 0, 0] };
pub const GUID_SysKeyboardEm: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1864182658, data2: 54688, data3: 4559, data4: [191, 199, 68, 69, 83, 84, 0, 0] };
pub const GUID_SysKeyboardEm2: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1864182659, data2: 54688, data3: 4559, data4: [191, 199, 68, 69, 83, 84, 0, 0] };
pub const GUID_SysMouse: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1864182624, data2: 54688, data3: 4559, data4: [191, 199, 68, 69, 83, 84, 0, 0] };
pub const GUID_SysMouseEm: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1864182656, data2: 54688, data3: 4559, data4: [191, 199, 68, 69, 83, 84, 0, 0] };
pub const GUID_SysMouseEm2: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1864182657, data2: 54688, data3: 4559, data4: [191, 199, 68, 69, 83, 84, 0, 0] };
pub const GUID_Triangle: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 324279332, data2: 36403, data3: 4560, data4: [154, 208, 0, 160, 201, 160, 110, 53] };
pub const GUID_Unknown: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2741830387, data2: 51699, data3: 4559, data4: [191, 199, 68, 69, 83, 84, 0, 0] };
pub const GUID_XAxis: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2741830368, data2: 51699, data3: 4559, data4: [191, 199, 68, 69, 83, 84, 0, 0] };
pub const GUID_YAxis: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2741830369, data2: 51699, data3: 4559, data4: [191, 199, 68, 69, 83, 84, 0, 0] };
pub const GUID_ZAxis: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2741830370, data2: 51699, data3: 4559, data4: [191, 199, 68, 69, 83, 84, 0, 0] };
#[repr(C)]
