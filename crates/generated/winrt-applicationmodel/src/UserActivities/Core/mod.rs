...
impl CoreUserActivityManager {
    ...
    pub fn DeleteUserActivitySessionsInTimeRangeAsync<'a, Param0: ::windows_core::IntoParam<'a, super::UserActivityChannel>, Param1: ::windows_core::IntoParam<'a, ::winrt_foundation::DateTime>, Param2: ::windows_core::IntoParam<'a, ::winrt_foundation::DateTime>>(channel: Param0, starttime: Param1, endtime: Param2) -> ::windows_core::Result<::winrt_foundation::IAsyncAction> {
        Self::ICoreUserActivityManagerStatics(|this| unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<::windows_core::RawPtr>::zeroed();
            (::windows_core::Interface::vtable(this).DeleteUserActivitySessionsInTimeRangeAsync)(::windows_core::Interface::as_raw(this), channel.into_param().abi(), starttime.into_param().abi(), endtime.into_param().abi(), result__.as_mut_ptr()).from_abi::<::winrt_foundation::IAsyncAction>(result__)
        })
    }
...
pub struct ICoreUserActivityManagerStatics_Vtbl {
    ...
    pub DeleteUserActivitySessionsInTimeRangeAsync: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, channel: ::windows_core::RawPtr, starttime: ::winrt_foundation::DateTime, endtime: ::winrt_foundation::DateTime, result__: *mut ::windows_core::RawPtr) -> ::windows_core::HRESULT,
}
