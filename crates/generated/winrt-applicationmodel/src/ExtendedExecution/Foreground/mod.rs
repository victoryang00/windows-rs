...
impl ExtendedExecutionForegroundSession {
    ...
    pub fn Revoked<'a, Param0: ::windows_core::IntoParam<'a, ::winrt_foundation::TypedEventHandler<::windows_core::IInspectable, ExtendedExecutionForegroundRevokedEventArgs>>>(&self, handler: Param0) -> ::windows_core::Result<::winrt_foundation::EventRegistrationToken> {
        let this = self;
        unsafe {
    ...
    pub fn RequestExtensionAsync(&self) -> ::windows_core::Result<::winrt_foundation::IAsyncOperation<ExtendedExecutionForegroundResult>> {
        let this = self;
        unsafe {
            let mut result__ = ::core::mem::MaybeUninit::<::windows_core::RawPtr>::zeroed();
            (::windows_core::Interface::vtable(this).RequestExtensionAsync)(::windows_core::Interface::as_raw(this), result__.as_mut_ptr()).from_abi::<::winrt_foundation::IAsyncOperation<ExtendedExecutionForegroundResult>>(result__)
        }
    }
...
impl ::core::convert::TryFrom<ExtendedExecutionForegroundSession> for ::winrt_foundation::IClosable {
...
impl<'a> ::windows_core::IntoParam<'a, ::winrt_foundation::IClosable> for ExtendedExecutionForegroundSession {
