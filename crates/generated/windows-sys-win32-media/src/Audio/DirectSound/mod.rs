#[link(name = "windows")]
extern "system" {
    pub fn DirectSoundCaptureCreate(pcguiddevice: *const ::windows_sys_core::GUID, ppdsc: *mut IDirectSoundCapture, punkouter: ::windows_sys_core::IUnknown) -> ::windows_sys_core::HRESULT;
    pub fn DirectSoundCaptureCreate8(pcguiddevice: *const ::windows_sys_core::GUID, ppdsc8: *mut IDirectSoundCapture, punkouter: ::windows_sys_core::IUnknown) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn DirectSoundCaptureEnumerateA(pdsenumcallback: LPDSENUMCALLBACKA, pcontext: *const ::core::ffi::c_void) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn DirectSoundCaptureEnumerateW(pdsenumcallback: LPDSENUMCALLBACKW, pcontext: *const ::core::ffi::c_void) -> ::windows_sys_core::HRESULT;
    pub fn DirectSoundCreate(pcguiddevice: *const ::windows_sys_core::GUID, ppds: *mut IDirectSound, punkouter: ::windows_sys_core::IUnknown) -> ::windows_sys_core::HRESULT;
    pub fn DirectSoundCreate8(pcguiddevice: *const ::windows_sys_core::GUID, ppds8: *mut IDirectSound8, punkouter: ::windows_sys_core::IUnknown) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn DirectSoundEnumerateA(pdsenumcallback: LPDSENUMCALLBACKA, pcontext: *const ::core::ffi::c_void) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn DirectSoundEnumerateW(pdsenumcallback: LPDSENUMCALLBACKW, pcontext: *const ::core::ffi::c_void) -> ::windows_sys_core::HRESULT;
    #[cfg(feature = "Win32_Foundation")]
    pub fn DirectSoundFullDuplexCreate(pcguidcapturedevice: *const ::windows_sys_core::GUID, pcguidrenderdevice: *const ::windows_sys_core::GUID, pcdscbufferdesc: *const DSCBUFFERDESC, pcdsbufferdesc: *const DSBUFFERDESC, hwnd: super::super::super::Foundation::HWND, dwlevel: u32, ppdsfd: *mut IDirectSoundFullDuplex, ppdscbuffer8: *mut IDirectSoundCaptureBuffer8, ppdsbuffer8: *mut IDirectSoundBuffer8, punkouter: ::windows_sys_core::IUnknown) -> ::windows_sys_core::HRESULT;
    pub fn GetDeviceID(pguidsrc: *const ::windows_sys_core::GUID, pguiddest: *mut ::windows_sys_core::GUID) -> ::windows_sys_core::HRESULT;
}
pub const CLSID_DirectSound: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 1205131590, data2: 25320, data3: 4559, data4: [147, 188, 68, 69, 83, 84, 0, 0] };
pub const CLSID_DirectSound8: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 956419135, data2: 33973, data3: 20388, data4: [186, 53, 170, 129, 114, 184, 160, 155] };
pub const CLSID_DirectSoundCapture: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 2954954624, data2: 35277, data3: 4560, data4: [175, 8, 0, 160, 201, 37, 205, 22] };
pub const CLSID_DirectSoundCapture8: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3837570067, data2: 32665, data3: 18696, data4: [154, 142, 116, 227, 191, 36, 182, 225] };
pub const CLSID_DirectSoundFullDuplex: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 4272173068, data2: 31065, data3: 16711, data4: [178, 106, 35, 119, 185, 231, 169, 29] };
pub const DIRECTSOUND_VERSION: u32 = 1792u32;
pub const DS3DALG_HRTF_FULL: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3259052864, data2: 7195, data3: 4562, data4: [148, 245, 0, 192, 79, 194, 138, 202] };
pub const DS3DALG_HRTF_LIGHT: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3259052866, data2: 7195, data3: 4562, data4: [148, 245, 0, 192, 79, 194, 138, 202] };
pub const DS3DALG_NO_VIRTUALIZATION: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3259052863, data2: 7195, data3: 4562, data4: [148, 245, 0, 192, 79, 194, 138, 202] };
#[repr(C)]
...
pub struct DSBUFFERDESC {
    ...
    pub guid3DAlgorithm: ::windows_sys_core::GUID,
}
...
pub struct DSCEFFECTDESC {
    pub dwSize: u32,
    pub dwFlags: u32,
    pub guidDSCFXClass: ::windows_sys_core::GUID,
    pub guidDSCFXInstance: ::windows_sys_core::GUID,
    pub dwReserved1: u32,
    pub dwReserved2: u32,
}
...
pub const DSDEVID_DefaultCapture: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3740270593, data2: 40045, data3: 18413, data4: [170, 241, 77, 218, 143, 43, 92, 3] };
pub const DSDEVID_DefaultPlayback: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3740270592, data2: 40045, data3: 18413, data4: [170, 241, 77, 218, 143, 43, 92, 3] };
pub const DSDEVID_DefaultVoiceCapture: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3740270595, data2: 40045, data3: 18413, data4: [170, 241, 77, 218, 143, 43, 92, 3] };
pub const DSDEVID_DefaultVoicePlayback: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3740270594, data2: 40045, data3: 18413, data4: [170, 241, 77, 218, 143, 43, 92, 3] };
#[repr(C)]
pub struct DSEFFECTDESC {
    pub dwSize: u32,
    pub dwFlags: u32,
    pub guidDSFXClass: ::windows_sys_core::GUID,
...
pub const DS_NO_VIRTUALIZATION: ::windows_sys_core::HRESULT = 142082058i32;
pub const DS_UNCERTIFIED: u32 = 1u32;
pub const GUID_All_Objects: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 2853260773, data2: 49762, data3: 16745, data4: [161, 200, 35, 214, 152, 204, 115, 181] };
pub const GUID_DSCFX_CLASS_AEC: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3214294400, data2: 50521, data3: 4560, data4: [138, 43, 0, 160, 201, 37, 90, 193] };
pub const GUID_DSCFX_CLASS_NS: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3766456383, data2: 25341, data3: 20064, data4: [140, 221, 222, 167, 35, 102, 101, 181] };
pub const GUID_DSCFX_MS_AEC: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3454777625, data2: 14234, data3: 18570, data4: [135, 101, 245, 60, 253, 54, 222, 64] };
pub const GUID_DSCFX_MS_NS: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 298174267, data2: 26345, data3: 19361, data4: [160, 186, 232, 20, 198, 238, 217, 45] };
pub const GUID_DSCFX_SYSTEM_AEC: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 472040813, data2: 39033, data3: 20315, data4: [163, 137, 39, 153, 109, 220, 40, 16] };
pub const GUID_DSCFX_SYSTEM_NS: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 1521518638, data2: 29300, data3: 17686, data4: [135, 125, 78, 238, 153, 186, 79, 208] };
pub const GUID_DSFX_STANDARD_CHORUS: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 4024853148, data2: 33271, data3: 17025, data4: [189, 145, 201, 214, 4, 169, 90, 246] };
pub const GUID_DSFX_STANDARD_COMPRESSOR: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 4009828217, data2: 16384, data3: 16493, data4: [135, 175, 191, 251, 63, 195, 157, 87] };
pub const GUID_DSFX_STANDARD_DISTORTION: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 4010888336, data2: 52509, data3: 18510, data4: [150, 229, 9, 207, 175, 145, 42, 33] };
pub const GUID_DSFX_STANDARD_ECHO: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 4013855532, data2: 54283, data3: 20305, data4: [140, 207, 63, 152, 241, 178, 157, 93] };
pub const GUID_DSFX_STANDARD_FLANGER: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 4023008658, data2: 57304, data3: 18034, data4: [166, 3, 116, 32, 137, 75, 173, 152] };
pub const GUID_DSFX_STANDARD_GARGLE: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3674046992, data2: 22289, data3: 19345, data4: [159, 227, 247, 91, 122, 226, 121, 191] };
pub const GUID_DSFX_STANDARD_I3DL2REVERB: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 4019740273, data2: 54727, data3: 17108, data4: [186, 77, 45, 7, 62, 46, 150, 244] };
pub const GUID_DSFX_STANDARD_PARAMEQ: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 302837129, data2: 15348, data3: 16755, data4: [161, 50, 60, 180, 6, 207, 50, 49] };
pub const GUID_DSFX_WAVES_REVERB: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 2281439848, data2: 39509, data3: 17248, data4: [149, 170, 0, 74, 29, 157, 226, 108] };
...
#[cfg(feature = "Win32_Foundation")]
pub type LPDSENUMCALLBACKA = ::core::option::Option<unsafe extern "system" fn(param0: *mut ::windows_sys_core::GUID, param1: ::windows_sys_core::PCSTR, param2: ::windows_sys_core::PCSTR, param3: *mut ::core::ffi::c_void) -> super::super::super::Foundation::BOOL>;
#[cfg(feature = "Win32_Foundation")]
pub type LPDSENUMCALLBACKW = ::core::option::Option<unsafe extern "system" fn(param0: *mut ::windows_sys_core::GUID, param1: ::windows_sys_core::PCWSTR, param2: ::windows_sys_core::PCWSTR, param3: *mut ::core::ffi::c_void) -> super::super::super::Foundation::BOOL>;
