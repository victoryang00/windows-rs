...
pub struct INET_FIREWALL_AC_BINARIES {
    pub count: u32,
    pub binaries: *mut ::windows_core_sys::PWSTR,
}
...
pub struct NETCON_PROPERTIES {
    ...
    pub pszwName: ::windows_core_sys::PWSTR,
    pub pszwDeviceName: ::windows_core_sys::PWSTR,
    pub Status: NETCON_STATUS,
    pub MediaType: NETCON_MEDIATYPE,
    pub dwCharacter: u32,
    pub clsidThisObject: ::windows_core_sys::GUID,
    pub clsidUiObject: ::windows_core_sys::GUID,
}
...
pub const NetFwAuthorizedApplication: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3969402547, data2: 10082, data3: 19051, data4: [162, 20, 106, 203, 96, 52, 98, 210] };
pub const NetFwMgr: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 810346818, data2: 28217, data3: 16600, data4: [148, 58, 185, 19, 196, 12, 156, 212] };
pub const NetFwOpenPort: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 212157894, data2: 14253, data3: 19052, data4: [191, 146, 159, 118, 16, 6, 126, 245] };
pub const NetFwPolicy2: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3803433343, data2: 27361, data3: 16812, data4: [129, 122, 246, 249, 33, 102, 215, 221] };
pub const NetFwProduct: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2641649368, data2: 50452, data3: 19741, data4: [191, 66, 117, 31, 237, 45, 90, 199] };
...
pub const S_OBJECT_NO_LONGER_VALID: ::windows_core_sys::HRESULT = 2i32;
pub const UPnPNAT: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2921201834, data2: 16341, data3: 16444, data4: [138, 39, 43, 189, 195, 12, 208, 225] };
#[repr(C)]
pub struct _tag_FW_DYNAMIC_KEYWORD_ADDRESS0 {
    pub id: ::windows_core_sys::GUID,
    pub keyword: ::windows_core_sys::PCWSTR,
    pub flags: u32,
    pub addresses: ::windows_core_sys::PCWSTR,
}
