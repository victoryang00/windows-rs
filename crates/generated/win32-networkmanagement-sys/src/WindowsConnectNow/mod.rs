...
pub const PKEY_WCN_DeviceType_Category: super::super::UI::Shell::PropertiesSystem::PROPERTYKEY = super::super::UI::Shell::PropertiesSystem::PROPERTYKEY { fmtid: ::windows_sys_core::GUID { data1: 2283342731, data2: 18052, data3: 4570, data4: [162, 106, 0, 2, 179, 152, 142, 129] }, pid: 16u32 };
#[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
pub const PKEY_WCN_DeviceType_SubCategory: super::super::UI::Shell::PropertiesSystem::PROPERTYKEY = super::super::UI::Shell::PropertiesSystem::PROPERTYKEY { fmtid: ::windows_sys_core::GUID { data1: 2283342731, data2: 18052, data3: 4570, data4: [162, 106, 0, 2, 179, 152, 142, 129] }, pid: 18u32 };
#[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
pub const PKEY_WCN_DeviceType_SubCategoryOUI: super::super::UI::Shell::PropertiesSystem::PROPERTYKEY = super::super::UI::Shell::PropertiesSystem::PROPERTYKEY { fmtid: ::windows_sys_core::GUID { data1: 2283342731, data2: 18052, data3: 4570, data4: [162, 106, 0, 2, 179, 152, 142, 129] }, pid: 17u32 };
#[cfg(feature = "Win32_UI_Shell_PropertiesSystem")]
pub const PKEY_WCN_SSID: super::super::UI::Shell::PropertiesSystem::PROPERTYKEY = super::super::UI::Shell::PropertiesSystem::PROPERTYKEY { fmtid: ::windows_sys_core::GUID { data1: 2283342731, data2: 18052, data3: 4570, data4: [162, 106, 0, 2, 179, 152, 142, 129] }, pid: 32u32 };
pub const SID_WcnProvider: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3238051530, data2: 54074, data3: 19019, data4: [191, 35, 187, 239, 70, 99, 208, 23] };
pub const WCNDeviceObject: ::windows_sys_core::GUID = ::windows_sys_core::GUID { data1: 3238051495, data2: 54074, data3: 19019, data4: [191, 35, 187, 239, 70, 99, 208, 23] };
...
pub const WCN_E_AUTHENTICATION_FAILED: ::windows_sys_core::HRESULT = -2147206142i32;
pub const WCN_E_CONNECTION_REJECTED: ::windows_sys_core::HRESULT = -2147206141i32;
pub const WCN_E_PEER_NOT_FOUND: ::windows_sys_core::HRESULT = -2147206143i32;
pub const WCN_E_PROTOCOL_ERROR: ::windows_sys_core::HRESULT = -2147206139i32;
pub const WCN_E_SESSION_TIMEDOUT: ::windows_sys_core::HRESULT = -2147206140i32;
