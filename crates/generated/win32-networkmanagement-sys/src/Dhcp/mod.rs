...
extern "system" {
    ...
    pub fn DhcpAddSubnetElementV4(serveripaddress: ::windows_core_sys::PCWSTR, subnetaddress: u32, addelementinfo: *const DHCP_SUBNET_ELEMENT_DATA_V4) -> u32;
    pub fn DhcpAddSubnetElementV5(serveripaddress: ::windows_core_sys::PCWSTR, subnetaddress: u32, addelementinfo: *const DHCP_SUBNET_ELEMENT_DATA_V5) -> u32;
    pub fn DhcpAddSubnetElementV6(serveripaddress: ::windows_core_sys::PCWSTR, subnetaddress: DHCP_IPV6_ADDRESS, addelementinfo: *mut DHCP_SUBNET_ELEMENT_DATA_V6) -> u32;
    pub fn DhcpAuditLogGetParams(serveripaddress: ::windows_core_sys::PCWSTR, flags: u32, auditlogdir: *mut ::windows_core_sys::PWSTR, diskcheckinterval: *mut u32, maxlogfilessize: *mut u32, minspaceondisk: *mut u32) -> u32;
    ...
    pub fn DhcpCreateOptionV6(serveripaddress: ::windows_core_sys::PCWSTR, flags: u32, optionid: u32, classname: ::windows_core_sys::PCWSTR, vendorname: ::windows_core_sys::PCWSTR, optioninfo: *mut DHCP_OPTION) -> u32;
    pub fn DhcpCreateSubnet(serveripaddress: ::windows_core_sys::PCWSTR, subnetaddress: u32, subnetinfo: *const DHCP_SUBNET_INFO) -> u32;
    pub fn DhcpCreateSubnetV6(serveripaddress: ::windows_core_sys::PCWSTR, subnetaddress: DHCP_IPV6_ADDRESS, subnetinfo: *mut DHCP_SUBNET_INFO_V6) -> u32;
    pub fn DhcpCreateSubnetVQ(serveripaddress: ::windows_core_sys::PCWSTR, subnetaddress: u32, subnetinfo: *const DHCP_SUBNET_INFO_VQ) -> u32;
    pub fn DhcpDeRegisterParamChange(flags: u32, reserved: *mut ::core::ffi::c_void, event: *mut ::core::ffi::c_void) -> u32;
    pub fn DhcpDeleteClass(serveripaddress: ::windows_core_sys::PCWSTR, reservedmustbezero: u32, classname: ::windows_core_sys::PCWSTR) -> u32;
    ...
    pub fn DhcpDeleteSubnetV6(serveripaddress: ::windows_core_sys::PCWSTR, subnetaddress: DHCP_IPV6_ADDRESS, forceflag: DHCP_FORCE_FLAG) -> u32;
    ...
    pub fn DhcpEnumOptionValuesV6(serveripaddress: ::windows_core_sys::PCWSTR, flags: u32, classname: ::windows_core_sys::PCWSTR, vendorname: ::windows_core_sys::PCWSTR, scopeinfo: *mut DHCP_OPTION_SCOPE_INFO6, resumehandle: *mut u32, preferredmaximum: u32, optionvalues: *mut *mut DHCP_OPTION_VALUE_ARRAY, optionsread: *mut u32, optionstotal: *mut u32) -> u32;
    pub fn DhcpEnumOptions(serveripaddress: ::windows_core_sys::PCWSTR, resumehandle: *mut u32, preferredmaximum: u32, options: *mut *mut DHCP_OPTION_ARRAY, optionsread: *mut u32, optionstotal: *mut u32) -> u32;
    pub fn DhcpEnumOptionsV5(serveripaddress: ::windows_core_sys::PCWSTR, flags: u32, classname: ::windows_core_sys::PCWSTR, vendorname: ::windows_core_sys::PCWSTR, resumehandle: *mut u32, preferredmaximum: u32, options: *mut *mut DHCP_OPTION_ARRAY, optionsread: *mut u32, optionstotal: *mut u32) -> u32;
    ...
    pub fn DhcpEnumSubnetElementsV5(serveripaddress: ::windows_core_sys::PCWSTR, subnetaddress: u32, enumelementtype: DHCP_SUBNET_ELEMENT_TYPE, resumehandle: *mut u32, preferredmaximum: u32, enumelementinfo: *mut *mut DHCP_SUBNET_ELEMENT_INFO_ARRAY_V5, elementsread: *mut u32, elementstotal: *mut u32) -> u32;
    ...
    pub fn DhcpGetMibInfoV6(serveripaddress: ::windows_core_sys::PCWSTR, mibinfo: *mut *mut DHCP_MIB_INFO_V6) -> u32;
    pub fn DhcpGetOptionInfo(serveripaddress: ::windows_core_sys::PCWSTR, optionid: u32, optioninfo: *mut *mut DHCP_OPTION) -> u32;
    pub fn DhcpGetOptionInfoV5(serveripaddress: ::windows_core_sys::PCWSTR, flags: u32, optionid: u32, classname: ::windows_core_sys::PCWSTR, vendorname: ::windows_core_sys::PCWSTR, optioninfo: *mut *mut DHCP_OPTION) -> u32;
    pub fn DhcpGetOptionInfoV6(serveripaddress: ::windows_core_sys::PCWSTR, flags: u32, optionid: u32, classname: ::windows_core_sys::PCWSTR, vendorname: ::windows_core_sys::PCWSTR, optioninfo: *mut *mut DHCP_OPTION) -> u32;
    pub fn DhcpGetOptionValue(serveripaddress: ::windows_core_sys::PCWSTR, optionid: u32, scopeinfo: *const DHCP_OPTION_SCOPE_INFO, optionvalue: *mut *mut DHCP_OPTION_VALUE) -> u32;
    ...
    pub fn DhcpGetSubnetInfo(serveripaddress: ::windows_core_sys::PCWSTR, subnetaddress: u32, subnetinfo: *mut *mut DHCP_SUBNET_INFO) -> u32;
    pub fn DhcpGetSubnetInfoV6(serveripaddress: ::windows_core_sys::PCWSTR, subnetaddress: DHCP_IPV6_ADDRESS, subnetinfo: *mut *mut DHCP_SUBNET_INFO_V6) -> u32;
    pub fn DhcpGetSubnetInfoVQ(serveripaddress: ::windows_core_sys::PCWSTR, subnetaddress: u32, subnetinfo: *mut *mut DHCP_SUBNET_INFO_VQ) -> u32;
    ...
    pub fn DhcpRemoveOptionV5(serveripaddress: ::windows_core_sys::PCWSTR, flags: u32, optionid: u32, classname: ::windows_core_sys::PCWSTR, vendorname: ::windows_core_sys::PCWSTR) -> u32;
    pub fn DhcpRemoveOptionV6(serveripaddress: ::windows_core_sys::PCWSTR, flags: u32, optionid: u32, classname: ::windows_core_sys::PCWSTR, vendorname: ::windows_core_sys::PCWSTR) -> u32;
    pub fn DhcpRemoveOptionValue(serveripaddress: ::windows_core_sys::PCWSTR, optionid: u32, scopeinfo: *const DHCP_OPTION_SCOPE_INFO) -> u32;
    pub fn DhcpRemoveOptionValueV5(serveripaddress: ::windows_core_sys::PCWSTR, flags: u32, optionid: u32, classname: ::windows_core_sys::PCWSTR, vendorname: ::windows_core_sys::PCWSTR, scopeinfo: *mut DHCP_OPTION_SCOPE_INFO) -> u32;
    pub fn DhcpRemoveOptionValueV6(serveripaddress: ::windows_core_sys::PCWSTR, flags: u32, optionid: u32, classname: ::windows_core_sys::PCWSTR, vendorname: ::windows_core_sys::PCWSTR, scopeinfo: *mut DHCP_OPTION_SCOPE_INFO6) -> u32;
    pub fn DhcpRemoveSubnetElement(serveripaddress: ::windows_core_sys::PCWSTR, subnetaddress: u32, removeelementinfo: *const DHCP_SUBNET_ELEMENT_DATA, forceflag: DHCP_FORCE_FLAG) -> u32;
    ...
    pub fn DhcpSetOptionInfoV6(serveripaddress: ::windows_core_sys::PCWSTR, flags: u32, optionid: u32, classname: ::windows_core_sys::PCWSTR, vendorname: ::windows_core_sys::PCWSTR, optioninfo: *mut DHCP_OPTION) -> u32;
    pub fn DhcpSetOptionValue(serveripaddress: ::windows_core_sys::PCWSTR, optionid: u32, scopeinfo: *const DHCP_OPTION_SCOPE_INFO, optionvalue: *const DHCP_OPTION_DATA) -> u32;
    pub fn DhcpSetOptionValueV5(serveripaddress: ::windows_core_sys::PCWSTR, flags: u32, optionid: u32, classname: ::windows_core_sys::PCWSTR, vendorname: ::windows_core_sys::PCWSTR, scopeinfo: *mut DHCP_OPTION_SCOPE_INFO, optionvalue: *mut DHCP_OPTION_DATA) -> u32;
    ...
    pub fn DhcpV4FailoverCreateRelationship(serveripaddress: ::windows_core_sys::PCWSTR, prelationship: *const DHCP_FAILOVER_RELATIONSHIP) -> u32;
    pub fn DhcpV4FailoverDeleteRelationship(serveripaddress: ::windows_core_sys::PCWSTR, prelationshipname: ::windows_core_sys::PCWSTR) -> u32;
    ...
    pub fn DhcpV4FailoverGetScopeStatistics(serveripaddress: ::windows_core_sys::PCWSTR, scopeid: u32, pstats: *mut *mut DHCP_FAILOVER_STATISTICS) -> u32;
...
pub struct DHCPDS_SERVER {
    ...
    pub Flags: u32,
    pub State: u32,
    pub DsLocation: ::windows_core_sys::PWSTR,
    pub DsLocType: u32,
}
...
pub struct DHCPV4_FAILOVER_CLIENT_INFO {
    ...
    pub ClientName: ::windows_core_sys::PWSTR,
    pub ClientComment: ::windows_core_sys::PWSTR,
...
pub struct DHCP_FAILOVER_RELATIONSHIP {
    ...
    pub Mclt: u32,
    pub SafePeriod: u32,
    pub RelationshipName: ::windows_core_sys::PWSTR,
    pub PrimaryServerName: ::windows_core_sys::PWSTR,
    pub SecondaryServerName: ::windows_core_sys::PWSTR,
    pub pScopes: *mut DHCP_IP_ARRAY,
    pub Percentage: u8,
    pub SharedSecret: ::windows_core_sys::PWSTR,
}
...
pub struct DHCP_IP_RESERVATION_INFO {
    ...
    pub ReservedClientName: ::windows_core_sys::PWSTR,
    pub ReservedClientDesc: ::windows_core_sys::PWSTR,
...
pub struct DHCP_OPTION {
    pub OptionID: u32,
    pub OptionName: ::windows_core_sys::PWSTR,
    pub OptionComment: ::windows_core_sys::PWSTR,
...
pub union DHCP_OPTION_DATA_ELEMENT_0 {
    ...
    pub StringDataOption: ::windows_core_sys::PWSTR,
    pub BinaryDataOption: DHCP_BINARY_DATA,
    pub EncapsulatedDataOption: DHCP_BINARY_DATA,
    pub Ipv6AddressDataOption: ::windows_core_sys::PWSTR,
}
...
pub union DHCP_OPTION_SCOPE_INFO_0 {
    ...
    pub MScopeInfo: ::windows_core_sys::PWSTR,
}
...
pub union DHCP_PROPERTY_0 {
    ...
    pub WordValue: u16,
    pub DWordValue: u32,
    pub StringValue: ::windows_core_sys::PWSTR,
...
pub struct DHCP_SERVER_CONFIG_INFO {
    ...
    pub DatabasePath: ::windows_core_sys::PWSTR,
    pub BackupPath: ::windows_core_sys::PWSTR,
...
pub struct DHCP_SERVER_OPTIONS {
    ...
    pub MachineName: ::windows_core_sys::PSTR,
    ...
    pub ClassIdentifier: ::windows_core_sys::PSTR,
...
pub struct DHCP_SERVER_SPECIFIC_STRINGS {
    pub DefaultVendorClassName: ::windows_core_sys::PWSTR,
    pub DefaultUserClassName: ::windows_core_sys::PWSTR,
}
...
pub struct DHCP_SUBNET_INFO {
    ...
    pub SubnetMask: u32,
    pub SubnetName: ::windows_core_sys::PWSTR,
    pub SubnetComment: ::windows_core_sys::PWSTR,
...
pub struct DHCP_SUPER_SCOPE_TABLE_ENTRY {
    ...
    pub SuperScopeName: ::windows_core_sys::PWSTR,
}
