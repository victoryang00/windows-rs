...
extern "system" {
    ...
    pub fn RasValidateEntryNameA(param0: ::windows_core_sys::PCSTR, param1: ::windows_core_sys::PCSTR) -> u32;
...
pub struct MPR_DEVICE_1 {
    ...
    pub szAlternates: ::windows_core_sys::PWSTR,
}
...
pub struct RASDIALPARAMSW {
    ...
    pub dwCallbackId: usize,
    pub dwIfIndex: u32,
    pub szEncPassword: ::windows_core_sys::PWSTR,
}
