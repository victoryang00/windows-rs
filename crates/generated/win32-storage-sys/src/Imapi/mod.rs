...
extern "system" {
    ...
    pub fn GetAttribIMsgOnIStg(lpobject: *mut ::core::ffi::c_void, lpproptagarray: *mut ::win32_system_sys::AddressBook::SPropTagArray, lpppropattrarray: *mut *mut SPropAttrArray) -> ::windows_core_sys::HRESULT;
    pub fn MapStorageSCode(stgscode: i32) -> i32;
    #[cfg(all(feature = "win32-system-sys", feature = "win32-system-sys"))]
    pub fn OpenIMsgOnIStg(lpmsgsess: *mut _MSGSESS, lpallocatebuffer: ::win32_system_sys::AddressBook::LPALLOCATEBUFFER, lpallocatemore: ::win32_system_sys::AddressBook::LPALLOCATEMORE, lpfreebuffer: ::win32_system_sys::AddressBook::LPFREEBUFFER, lpmalloc: ::win32_system_sys::Com::IMalloc, lpmapisup: *mut ::core::ffi::c_void, lpstg: ::win32_system_sys::Com::StructuredStorage::IStorage, lpfmsgcallrelease: *mut MSGCALLRELEASE, ulcallerdata: u32, ulflags: u32, lppmsg: *mut ::win32_system_sys::AddressBook::IMessage) -> i32;
    #[cfg(feature = "win32-system-sys")]
    pub fn OpenIMsgSession(lpmalloc: ::win32_system_sys::Com::IMalloc, ulflags: u32, lppmsgsess: *mut *mut _MSGSESS) -> i32;
    #[cfg(feature = "win32-system-sys")]
    pub fn SetAttribIMsgOnIStg(lpobject: *mut ::core::ffi::c_void, lpproptags: *mut ::win32_system_sys::AddressBook::SPropTagArray, lppropattrs: *mut SPropAttrArray, lpppropproblems: *mut *mut ::win32_system_sys::AddressBook::SPropProblemArray) -> ::windows_core_sys::HRESULT;
}
pub const BlockRange: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3037186599, data2: 8708, data3: 4573, data4: [150, 106, 0, 26, 160, 27, 188, 88] };
pub const BlockRangeList: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3037186600, data2: 8708, data3: 4573, data4: [150, 106, 0, 26, 160, 27, 188, 88] };
pub const BootOptions: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 747904974, data2: 38747, data3: 22974, data4: [169, 96, 154, 42, 38, 40, 83, 165] };
pub const CATID_SMTP_DNSRESOLVERRECORDSINK: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3171631974, data2: 36355, data3: 4562, data4: [148, 246, 0, 192, 79, 121, 241, 214] };
pub const CATID_SMTP_DSN: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 582309681, data2: 62968, data3: 19747, data4: [189, 143, 135, 181, 35, 113, 167, 58] };
pub const CATID_SMTP_GET_AUX_DOMAIN_INFO_FLAGS: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2231318154, data2: 64179, data3: 17367, data4: [188, 223, 105, 44, 91, 70, 230, 177] };
pub const CATID_SMTP_LOG: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2479924536, data2: 11294, data3: 19304, data4: [167, 201, 215, 58, 138, 166, 238, 151] };
pub const CATID_SMTP_MAXMSGSIZE: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3958462942, data2: 42622, data3: 4562, data4: [148, 247, 0, 192, 79, 121, 241, 214] };
pub const CATID_SMTP_MSGTRACKLOG: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3336524458, data2: 32176, data3: 4562, data4: [148, 244, 0, 192, 79, 121, 241, 214] };
pub const CATID_SMTP_ON_BEFORE_DATA: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4133653650, data2: 3422, data3: 4562, data4: [170, 104, 0, 192, 79, 163, 91, 130] };
pub const CATID_SMTP_ON_INBOUND_COMMAND: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4133653645, data2: 3422, data3: 4562, data4: [170, 104, 0, 192, 79, 163, 91, 130] };
pub const CATID_SMTP_ON_MESSAGE_START: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4133653648, data2: 3422, data3: 4562, data4: [170, 104, 0, 192, 79, 163, 91, 130] };
pub const CATID_SMTP_ON_PER_RECIPIENT: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4133653649, data2: 3422, data3: 4562, data4: [170, 104, 0, 192, 79, 163, 91, 130] };
pub const CATID_SMTP_ON_SERVER_RESPONSE: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4133653646, data2: 3422, data3: 4562, data4: [170, 104, 0, 192, 79, 163, 91, 130] };
pub const CATID_SMTP_ON_SESSION_END: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4133653651, data2: 3422, data3: 4562, data4: [170, 104, 0, 192, 79, 163, 91, 130] };
pub const CATID_SMTP_ON_SESSION_START: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4133653647, data2: 3422, data3: 4562, data4: [170, 104, 0, 192, 79, 163, 91, 130] };
pub const CATID_SMTP_STORE_DRIVER: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1494702160, data2: 58675, data3: 4561, data4: [170, 103, 0, 192, 79, 163, 69, 246] };
pub const CATID_SMTP_TRANSPORT_CATEGORIZE: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2516734627, data2: 2618, data3: 4562, data4: [158, 0, 0, 192, 79, 163, 34, 186] };
pub const CATID_SMTP_TRANSPORT_POSTCATEGORIZE: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1987155540, data2: 1446, data3: 4562, data4: [157, 253, 0, 192, 79, 163, 34, 186] };
pub const CATID_SMTP_TRANSPORT_PRECATEGORIZE: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2746022669, data2: 33791, data3: 4562, data4: [158, 20, 0, 192, 79, 163, 34, 186] };
pub const CATID_SMTP_TRANSPORT_ROUTER: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 674509001, data2: 6224, data3: 4562, data4: [158, 3, 0, 192, 79, 163, 34, 186] };
pub const CATID_SMTP_TRANSPORT_SUBMISSION: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4282165795, data2: 185, data3: 4562, data4: [157, 251, 0, 192, 79, 163, 34, 186] };
pub const CLSID_SmtpCat: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2990290359, data2: 37401, data3: 4562, data4: [158, 23, 0, 192, 79, 163, 34, 186] };
...
pub const EnumFsiItems: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 747904966, data2: 38747, data3: 22974, data4: [169, 96, 154, 42, 38, 40, 83, 165] };
pub const EnumProgressItems: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 747904970, data2: 38747, data3: 22974, data4: [169, 96, 154, 42, 38, 40, 83, 165] };
pub const FileSystemImageResult: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 747904972, data2: 38747, data3: 22974, data4: [169, 96, 154, 42, 38, 40, 83, 165] };
pub const FsiDirectoryItem: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 747904968, data2: 38747, data3: 22974, data4: [169, 96, 154, 42, 38, 40, 83, 165] };
pub const FsiFileItem: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 747904967, data2: 38747, data3: 22974, data4: [169, 96, 154, 42, 38, 40, 83, 165] };
...
pub const FsiNamedStreams: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3333880045, data2: 27929, data3: 17588, data4: [181, 57, 177, 89, 183, 147, 163, 45] };
pub const FsiStream: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 747904973, data2: 38747, data3: 22974, data4: [169, 96, 154, 42, 38, 40, 83, 165] };
pub const GUID_SMTPSVC_SOURCE: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 456918630, data2: 58480, data3: 4561, data4: [170, 103, 0, 192, 79, 163, 69, 246] };
pub const GUID_SMTP_SOURCE_TYPE: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4217750748, data2: 58472, data3: 4561, data4: [170, 103, 0, 192, 79, 163, 69, 246] };
...
pub const IMAPI_E_ALREADYOPEN: ::windows_core_sys::HRESULT = -2147220958i32;
pub const IMAPI_E_BADJOLIETNAME: ::windows_core_sys::HRESULT = -2147220963i32;
pub const IMAPI_E_BOOTIMAGE_AND_NONBLANK_DISC: ::windows_core_sys::HRESULT = -2147220946i32;
pub const IMAPI_E_CANNOT_WRITE_TO_MEDIA: ::windows_core_sys::HRESULT = -2147220948i32;
pub const IMAPI_E_COMPRESSEDSTASH: ::windows_core_sys::HRESULT = -2147220952i32;
pub const IMAPI_E_DEVICE_INVALIDTYPE: ::windows_core_sys::HRESULT = -2147220972i32;
pub const IMAPI_E_DEVICE_NOPROPERTIES: ::windows_core_sys::HRESULT = -2147220975i32;
pub const IMAPI_E_DEVICE_NOTACCESSIBLE: ::windows_core_sys::HRESULT = -2147220974i32;
pub const IMAPI_E_DEVICE_NOTPRESENT: ::windows_core_sys::HRESULT = -2147220973i32;
pub const IMAPI_E_DEVICE_STILL_IN_USE: ::windows_core_sys::HRESULT = -2147220954i32;
pub const IMAPI_E_DISCFULL: ::windows_core_sys::HRESULT = -2147220964i32;
pub const IMAPI_E_DISCINFO: ::windows_core_sys::HRESULT = -2147220967i32;
pub const IMAPI_E_ENCRYPTEDSTASH: ::windows_core_sys::HRESULT = -2147220951i32;
pub const IMAPI_E_FILEACCESS: ::windows_core_sys::HRESULT = -2147220968i32;
pub const IMAPI_E_FILEEXISTS: ::windows_core_sys::HRESULT = -2147220956i32;
pub const IMAPI_E_FILESYSTEM: ::windows_core_sys::HRESULT = -2147220969i32;
pub const IMAPI_E_GENERIC: ::windows_core_sys::HRESULT = -2147220978i32;
pub const IMAPI_E_INITIALIZE_ENDWRITE: ::windows_core_sys::HRESULT = -2147220970i32;
pub const IMAPI_E_INITIALIZE_WRITE: ::windows_core_sys::HRESULT = -2147220971i32;
pub const IMAPI_E_INVALIDIMAGE: ::windows_core_sys::HRESULT = -2147220962i32;
pub const IMAPI_E_LOSS_OF_STREAMING: ::windows_core_sys::HRESULT = -2147220953i32;
pub const IMAPI_E_MEDIUM_INVALIDTYPE: ::windows_core_sys::HRESULT = -2147220976i32;
pub const IMAPI_E_MEDIUM_NOTPRESENT: ::windows_core_sys::HRESULT = -2147220977i32;
pub const IMAPI_E_NOACTIVEFORMAT: ::windows_core_sys::HRESULT = -2147220961i32;
pub const IMAPI_E_NOACTIVERECORDER: ::windows_core_sys::HRESULT = -2147220960i32;
pub const IMAPI_E_NOTENOUGHDISKFORSTASH: ::windows_core_sys::HRESULT = -2147220950i32;
pub const IMAPI_E_NOTINITIALIZED: ::windows_core_sys::HRESULT = -2147220980i32;
pub const IMAPI_E_NOTOPENED: ::windows_core_sys::HRESULT = -2147220981i32;
pub const IMAPI_E_REMOVABLESTASH: ::windows_core_sys::HRESULT = -2147220949i32;
pub const IMAPI_E_STASHINUSE: ::windows_core_sys::HRESULT = -2147220955i32;
pub const IMAPI_E_TRACKNOTOPEN: ::windows_core_sys::HRESULT = -2147220966i32;
pub const IMAPI_E_TRACKOPEN: ::windows_core_sys::HRESULT = -2147220965i32;
pub const IMAPI_E_TRACK_NOT_BIG_ENOUGH: ::windows_core_sys::HRESULT = -2147220947i32;
pub const IMAPI_E_USERABORT: ::windows_core_sys::HRESULT = -2147220979i32;
pub const IMAPI_E_WRONGDISC: ::windows_core_sys::HRESULT = -2147220957i32;
pub const IMAPI_E_WRONGFORMAT: ::windows_core_sys::HRESULT = -2147220959i32;
...
pub const IMAPI_S_BUFFER_TO_SMALL: ::windows_core_sys::HRESULT = 262657i32;
pub const IMAPI_S_PROPERTIESIGNORED: ::windows_core_sys::HRESULT = 262656i32;
...
pub struct IMMP_MPV_STORE_DRIVER_HANDLE {
    pub guidSignature: ::windows_core_sys::GUID,
}
...
pub const MSDiscMasterObj: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1376569955, data2: 20901, data3: 4563, data4: [145, 68, 0, 16, 75, 161, 28, 94] };
pub const MSDiscRecorderObj: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1376569953, data2: 20901, data3: 4563, data4: [145, 68, 0, 16, 75, 161, 28, 94] };
pub const MSEnumDiscRecordersObj: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2315474554, data2: 25547, data3: 19368, data4: [186, 246, 82, 17, 152, 22, 209, 239] };
#[cfg(feature = "win32-system-sys")]
pub type MSGCALLRELEASE = ::core::option::Option<unsafe extern "system" fn(ulcallerdata: u32, lpmessage: ::win32_system_sys::AddressBook::IMessage)>;
pub const MsftDiscFormat2Data: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 657801514, data2: 32612, data3: 23311, data4: [143, 0, 93, 119, 175, 190, 38, 30] };
pub const MsftDiscFormat2Erase: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 657801515, data2: 32612, data3: 23311, data4: [143, 0, 93, 119, 175, 190, 38, 30] };
pub const MsftDiscFormat2RawCD: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 657801512, data2: 32612, data3: 23311, data4: [143, 0, 93, 119, 175, 190, 38, 30] };
pub const MsftDiscFormat2TrackAtOnce: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 657801513, data2: 32612, data3: 23311, data4: [143, 0, 93, 119, 175, 190, 38, 30] };
pub const MsftDiscMaster2: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 657801518, data2: 32612, data3: 23311, data4: [143, 0, 93, 119, 175, 190, 38, 30] };
pub const MsftDiscRecorder2: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 657801517, data2: 32612, data3: 23311, data4: [143, 0, 93, 119, 175, 190, 38, 30] };
pub const MsftFileSystemImage: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 747904965, data2: 38747, data3: 22974, data4: [169, 96, 154, 42, 38, 40, 83, 165] };
pub const MsftIsoImageManager: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3471719266, data2: 36694, data3: 16470, data4: [134, 155, 239, 22, 145, 126, 62, 252] };
pub const MsftMultisessionRandomWrite: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3037186596, data2: 8708, data3: 4573, data4: [150, 106, 0, 26, 160, 27, 188, 88] };
pub const MsftMultisessionSequential: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 657801506, data2: 32612, data3: 23311, data4: [143, 0, 93, 119, 175, 190, 38, 30] };
pub const MsftRawCDImageCreator: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 630732129, data2: 40293, data3: 18894, data4: [179, 53, 64, 99, 13, 144, 18, 39] };
pub const MsftStreamConcatenate: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 657801509, data2: 32612, data3: 23311, data4: [143, 0, 93, 119, 175, 190, 38, 30] };
pub const MsftStreamInterleave: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 657801508, data2: 32612, data3: 23311, data4: [143, 0, 93, 119, 175, 190, 38, 30] };
pub const MsftStreamPrng001: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 657801510, data2: 32612, data3: 23311, data4: [143, 0, 93, 119, 175, 190, 38, 30] };
pub const MsftStreamZero: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 657801511, data2: 32612, data3: 23311, data4: [143, 0, 93, 119, 175, 190, 38, 30] };
pub const MsftWriteEngine2: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 657801516, data2: 32612, data3: 23311, data4: [143, 0, 93, 119, 175, 190, 38, 30] };
pub const MsftWriteSpeedDescriptor: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 657801507, data2: 32612, data3: 23311, data4: [143, 0, 93, 119, 175, 190, 38, 30] };
...
pub const ProgressItem: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 747904971, data2: 38747, data3: 22974, data4: [169, 96, 154, 42, 38, 40, 83, 165] };
pub const ProgressItems: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 747904969, data2: 38747, data3: 22974, data4: [169, 96, 154, 42, 38, 40, 83, 165] };
...
pub const tagIMMPID_CPV_STRUCT: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2728880938, data2: 58669, data3: 4561, data4: [170, 100, 0, 192, 79, 163, 91, 130] };
#[repr(C)]
...
pub const tagIMMPID_MPV_STRUCT: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3420886790, data2: 51645, data3: 4561, data4: [159, 242, 0, 192, 79, 163, 115, 72] };
pub const tagIMMPID_MP_STRUCT: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 322456816, data2: 46020, data3: 4561, data4: [170, 146, 0, 170, 0, 107, 200, 11] };
pub const tagIMMPID_NMP_STRUCT: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 1949542826, data2: 8418, data3: 4562, data4: [148, 214, 0, 192, 79, 163, 121, 241] };
pub const tagIMMPID_RPV_STRUCT: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2045255753, data2: 54048, data3: 4561, data4: [159, 244, 0, 192, 79, 163, 115, 72] };
pub const tagIMMPID_RP_STRUCT: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2045255752, data2: 54048, data3: 4561, data4: [159, 244, 0, 192, 79, 163, 115, 72] };
