pub const AdSyncTask: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 719734609, data2: 46888, data3: 19819, data4: [151, 160, 178, 218, 46, 125, 42, 59] };
...
pub const FSRM_E_ADR_MAX_EMAILS_SENT: ::windows_core_sys::HRESULT = -2147200130i32;
pub const FSRM_E_ADR_NOT_DOMAIN_JOINED: ::windows_core_sys::HRESULT = -2147200110i32;
pub const FSRM_E_ADR_PATH_IS_LOCAL: ::windows_core_sys::HRESULT = -2147200111i32;
pub const FSRM_E_ADR_SRV_NOT_SUPPORTED: ::windows_core_sys::HRESULT = -2147200112i32;
pub const FSRM_E_ALREADY_EXISTS: ::windows_core_sys::HRESULT = -2147200253i32;
pub const FSRM_E_AUTO_QUOTA: ::windows_core_sys::HRESULT = 283419i32;
pub const FSRM_E_CACHE_INVALID: ::windows_core_sys::HRESULT = -2147200187i32;
pub const FSRM_E_CACHE_MODULE_ALREADY_EXISTS: ::windows_core_sys::HRESULT = -2147200186i32;
pub const FSRM_E_CANNOT_AGGREGATE: ::windows_core_sys::HRESULT = -2147200201i32;
pub const FSRM_E_CANNOT_ALLOW_REPARSE_POINT_TAG: ::windows_core_sys::HRESULT = -2147200170i32;
pub const FSRM_E_CANNOT_CHANGE_PROPERTY_TYPE: ::windows_core_sys::HRESULT = -2147200197i32;
pub const FSRM_E_CANNOT_CREATE_TEMP_COPY: ::windows_core_sys::HRESULT = -2147200132i32;
pub const FSRM_E_CANNOT_DELETE_SYSTEM_PROPERTY: ::windows_core_sys::HRESULT = -2147200135i32;
pub const FSRM_E_CANNOT_REMOVE_READONLY: ::windows_core_sys::HRESULT = -2147200109i32;
pub const FSRM_E_CANNOT_RENAME_PROPERTY: ::windows_core_sys::HRESULT = -2147200198i32;
pub const FSRM_E_CANNOT_STORE_PROPERTIES: ::windows_core_sys::HRESULT = -2147200171i32;
pub const FSRM_E_CANNOT_USE_DELETED_PROPERTY: ::windows_core_sys::HRESULT = -2147200143i32;
pub const FSRM_E_CANNOT_USE_DEPRECATED_PROPERTY: ::windows_core_sys::HRESULT = -2147200145i32;
pub const FSRM_E_CLASSIFICATION_ALREADY_RUNNING: ::windows_core_sys::HRESULT = -2147200195i32;
pub const FSRM_E_CLASSIFICATION_CANCELED: ::windows_core_sys::HRESULT = -2147200141i32;
pub const FSRM_E_CLASSIFICATION_NOT_RUNNING: ::windows_core_sys::HRESULT = -2147200194i32;
pub const FSRM_E_CLASSIFICATION_PARTIAL_BATCH: ::windows_core_sys::HRESULT = -2147200136i32;
pub const FSRM_E_CLASSIFICATION_SCAN_FAIL: ::windows_core_sys::HRESULT = -2147200148i32;
pub const FSRM_E_CLASSIFICATION_TIMEOUT: ::windows_core_sys::HRESULT = -2147200137i32;
pub const FSRM_E_CLUSTER_NOT_RUNNING: ::windows_core_sys::HRESULT = -2147200210i32;
pub const FSRM_E_CSC_PATH_NOT_SUPPORTED: ::windows_core_sys::HRESULT = -2147200106i32;
pub const FSRM_E_DIFFERENT_CLUSTER_GROUP: ::windows_core_sys::HRESULT = -2147200207i32;
pub const FSRM_E_DRIVER_NOT_READY: ::windows_core_sys::HRESULT = -2147200237i32;
pub const FSRM_E_DUPLICATE_NAME: ::windows_core_sys::HRESULT = -2147200240i32;
pub const FSRM_E_EMAIL_NOT_SENT: ::windows_core_sys::HRESULT = -2147200228i32;
pub const FSRM_E_ENUM_PROPERTIES_FAILED: ::windows_core_sys::HRESULT = -2147200173i32;
pub const FSRM_E_ERROR_NOT_ENABLED: ::windows_core_sys::HRESULT = -2147200133i32;
pub const FSRM_E_EXPIRATION_PATH_NOT_WRITEABLE: ::windows_core_sys::HRESULT = -2147200105i32;
pub const FSRM_E_EXPIRATION_PATH_TOO_LONG: ::windows_core_sys::HRESULT = -2147200104i32;
pub const FSRM_E_EXPIRATION_VOLUME_NOT_NTFS: ::windows_core_sys::HRESULT = -2147200103i32;
pub const FSRM_E_FAIL_BATCH: ::windows_core_sys::HRESULT = -2147200247i32;
pub const FSRM_E_FILE_ENCRYPTED: ::windows_core_sys::HRESULT = -2147200156i32;
pub const FSRM_E_FILE_IN_USE: ::windows_core_sys::HRESULT = -2147200134i32;
pub const FSRM_E_FILE_MANAGEMENT_ACTION_GET_EXITCODE_FAILED: ::windows_core_sys::HRESULT = -2147200152i32;
pub const FSRM_E_FILE_MANAGEMENT_ACTION_TIMEOUT: ::windows_core_sys::HRESULT = -2147200153i32;
pub const FSRM_E_FILE_MANAGEMENT_EXPIRATION_DIR_IN_SCOPE: ::windows_core_sys::HRESULT = -2147200185i32;
pub const FSRM_E_FILE_MANAGEMENT_JOB_ALREADY_EXISTS: ::windows_core_sys::HRESULT = -2147200184i32;
pub const FSRM_E_FILE_MANAGEMENT_JOB_ALREADY_RUNNING: ::windows_core_sys::HRESULT = -2147200193i32;
pub const FSRM_E_FILE_MANAGEMENT_JOB_CUSTOM: ::windows_core_sys::HRESULT = -2147200191i32;
pub const FSRM_E_FILE_MANAGEMENT_JOB_DEPRECATED: ::windows_core_sys::HRESULT = -2147200102i32;
pub const FSRM_E_FILE_MANAGEMENT_JOB_EXPIRATION: ::windows_core_sys::HRESULT = -2147200192i32;
pub const FSRM_E_FILE_MANAGEMENT_JOB_INVALID_CONTINUOUS_CONFIG: ::windows_core_sys::HRESULT = -2147200108i32;
pub const FSRM_E_FILE_MANAGEMENT_JOB_MAX_FILE_CONDITIONS: ::windows_core_sys::HRESULT = -2147200146i32;
pub const FSRM_E_FILE_MANAGEMENT_JOB_NOTIFICATION: ::windows_core_sys::HRESULT = -2147200190i32;
pub const FSRM_E_FILE_MANAGEMENT_JOB_NOT_LEGACY_ACCESSIBLE: ::windows_core_sys::HRESULT = -2147200147i32;
pub const FSRM_E_FILE_MANAGEMENT_JOB_RMS: ::windows_core_sys::HRESULT = -2147200120i32;
pub const FSRM_E_FILE_OPEN_ERROR: ::windows_core_sys::HRESULT = -2147200189i32;
pub const FSRM_E_FILE_SYSTEM_CORRUPT: ::windows_core_sys::HRESULT = -2147200225i32;
pub const FSRM_E_INCOMPATIBLE_FORMAT: ::windows_core_sys::HRESULT = -2147200157i32;
pub const FSRM_E_INPROC_MODULE_BLOCKED: ::windows_core_sys::HRESULT = -2147200174i32;
pub const FSRM_E_INSECURE_PATH: ::windows_core_sys::HRESULT = -2147200233i32;
pub const FSRM_E_INSUFFICIENT_DISK: ::windows_core_sys::HRESULT = -2147200236i32;
pub const FSRM_E_INVALID_AD_CLAIM: ::windows_core_sys::HRESULT = -2147200142i32;
pub const FSRM_E_INVALID_COMBINATION: ::windows_core_sys::HRESULT = -2147200241i32;
pub const FSRM_E_INVALID_DATASCREEN_DEFINITION: ::windows_core_sys::HRESULT = -2147200220i32;
pub const FSRM_E_INVALID_EMAIL_ADDRESS: ::windows_core_sys::HRESULT = -2147200226i32;
pub const FSRM_E_INVALID_FILEGROUP_DEFINITION: ::windows_core_sys::HRESULT = -2147200223i32;
pub const FSRM_E_INVALID_FILENAME: ::windows_core_sys::HRESULT = -2147200214i32;
pub const FSRM_E_INVALID_FOLDER_PROPERTY_STORE: ::windows_core_sys::HRESULT = -2147200140i32;
pub const FSRM_E_INVALID_IMPORT_VERSION: ::windows_core_sys::HRESULT = -2147200245i32;
pub const FSRM_E_INVALID_LIMIT: ::windows_core_sys::HRESULT = -2147200249i32;
pub const FSRM_E_INVALID_NAME: ::windows_core_sys::HRESULT = -2147200248i32;
pub const FSRM_E_INVALID_PATH: ::windows_core_sys::HRESULT = -2147200250i32;
pub const FSRM_E_INVALID_REPORT_DESC: ::windows_core_sys::HRESULT = -2147200215i32;
pub const FSRM_E_INVALID_REPORT_FORMAT: ::windows_core_sys::HRESULT = -2147200216i32;
pub const FSRM_E_INVALID_SCHEDULER_ARGUMENT: ::windows_core_sys::HRESULT = -2147200254i32;
pub const FSRM_E_INVALID_SMTP_SERVER: ::windows_core_sys::HRESULT = -2147200232i32;
pub const FSRM_E_INVALID_TEXT: ::windows_core_sys::HRESULT = -2147200246i32;
pub const FSRM_E_INVALID_USER: ::windows_core_sys::HRESULT = -2147200251i32;
pub const FSRM_E_LAST_ACCESS_UPDATE_DISABLED: ::windows_core_sys::HRESULT = -2147200176i32;
pub const FSRM_E_LEGACY_SCHEDULE: ::windows_core_sys::HRESULT = -2147200107i32;
pub const FSRM_E_LOADING_DISABLED_MODULE: ::windows_core_sys::HRESULT = -2147200202i32;
pub const FSRM_E_LONG_CMDLINE: ::windows_core_sys::HRESULT = -2147200224i32;
pub const FSRM_E_MAX_PROPERTY_DEFINITIONS: ::windows_core_sys::HRESULT = -2147200196i32;
pub const FSRM_E_MESSAGE_LIMIT_EXCEEDED: ::windows_core_sys::HRESULT = -2147200200i32;
pub const FSRM_E_MODULE_INITIALIZATION: ::windows_core_sys::HRESULT = -2147200150i32;
pub const FSRM_E_MODULE_INVALID_PARAM: ::windows_core_sys::HRESULT = -2147200151i32;
pub const FSRM_E_MODULE_SESSION_INITIALIZATION: ::windows_core_sys::HRESULT = -2147200149i32;
pub const FSRM_E_MODULE_TIMEOUT: ::windows_core_sys::HRESULT = -2147200101i32;
pub const FSRM_E_NOT_CLUSTER_VOLUME: ::windows_core_sys::HRESULT = -2147200208i32;
pub const FSRM_E_NOT_FOUND: ::windows_core_sys::HRESULT = -2147200255i32;
pub const FSRM_E_NOT_SUPPORTED: ::windows_core_sys::HRESULT = -2147200239i32;
pub const FSRM_E_NO_EMAIL_ADDRESS: ::windows_core_sys::HRESULT = -2147200131i32;
pub const FSRM_E_NO_PROPERTY_VALUE: ::windows_core_sys::HRESULT = -2147200175i32;
pub const FSRM_E_OBJECT_IN_USE: ::windows_core_sys::HRESULT = -2147200199i32;
pub const FSRM_E_OUT_OF_RANGE: ::windows_core_sys::HRESULT = -2147200243i32;
pub const FSRM_E_PARTIAL_CLASSIFICATION_PROPERTY_NOT_FOUND: ::windows_core_sys::HRESULT = -2147200169i32;
pub const FSRM_E_PATH_NOT_FOUND: ::windows_core_sys::HRESULT = -2147200252i32;
pub const FSRM_E_PATH_NOT_IN_NAMESPACE: ::windows_core_sys::HRESULT = -2147200129i32;
pub const FSRM_E_PERSIST_PROPERTIES_FAILED: ::windows_core_sys::HRESULT = -2147200155i32;
pub const FSRM_E_PERSIST_PROPERTIES_FAILED_ENCRYPTED: ::windows_core_sys::HRESULT = -2147200166i32;
pub const FSRM_E_PROPERTY_DELETED: ::windows_core_sys::HRESULT = -2147200183i32;
pub const FSRM_E_PROPERTY_MUST_APPLY_TO_FILES: ::windows_core_sys::HRESULT = -2147200138i32;
pub const FSRM_E_PROPERTY_MUST_APPLY_TO_FOLDERS: ::windows_core_sys::HRESULT = -2147200124i32;
pub const FSRM_E_PROPERTY_MUST_BE_GLOBAL: ::windows_core_sys::HRESULT = -2147200122i32;
pub const FSRM_E_PROPERTY_MUST_BE_SECURE: ::windows_core_sys::HRESULT = -2147200123i32;
pub const FSRM_E_REBUILDING_FODLER_TYPE_INDEX: ::windows_core_sys::HRESULT = -2147200139i32;
pub const FSRM_E_REPORT_GENERATION_ERR: ::windows_core_sys::HRESULT = -2147200204i32;
pub const FSRM_E_REPORT_JOB_ALREADY_RUNNING: ::windows_core_sys::HRESULT = -2147200205i32;
pub const FSRM_E_REPORT_TASK_TRIGGER: ::windows_core_sys::HRESULT = -2147200203i32;
pub const FSRM_E_REPORT_TYPE_ALREADY_EXISTS: ::windows_core_sys::HRESULT = -2147200206i32;
pub const FSRM_E_REQD_PARAM_MISSING: ::windows_core_sys::HRESULT = -2147200242i32;
pub const FSRM_E_RMS_NO_PROTECTORS_INSTALLED: ::windows_core_sys::HRESULT = -2147200126i32;
pub const FSRM_E_RMS_NO_PROTECTOR_INSTALLED_FOR_FILE: ::windows_core_sys::HRESULT = -2147200125i32;
pub const FSRM_E_RMS_TEMPLATE_NOT_FOUND: ::windows_core_sys::HRESULT = -2147200128i32;
pub const FSRM_E_SECURE_PROPERTIES_NOT_SUPPORTED: ::windows_core_sys::HRESULT = -2147200127i32;
pub const FSRM_E_SET_PROPERTY_FAILED: ::windows_core_sys::HRESULT = -2147200172i32;
pub const FSRM_E_SHADOW_COPY: ::windows_core_sys::HRESULT = -2147200212i32;
pub const FSRM_E_STORE_NOT_INSTALLED: ::windows_core_sys::HRESULT = -2147200209i32;
pub const FSRM_E_SYNC_TASK_HAD_ERRORS: ::windows_core_sys::HRESULT = -2147200119i32;
pub const FSRM_E_SYNC_TASK_TIMEOUT: ::windows_core_sys::HRESULT = -2147200144i32;
pub const FSRM_E_TEXTREADER_FILENAME_TOO_LONG: ::windows_core_sys::HRESULT = -2147200158i32;
pub const FSRM_E_TEXTREADER_IFILTER_CLSID_MALFORMED: ::windows_core_sys::HRESULT = -2147200160i32;
pub const FSRM_E_TEXTREADER_IFILTER_NOT_FOUND: ::windows_core_sys::HRESULT = -2147200167i32;
pub const FSRM_E_TEXTREADER_NOT_INITIALIZED: ::windows_core_sys::HRESULT = -2147200168i32;
pub const FSRM_E_TEXTREADER_STREAM_ERROR: ::windows_core_sys::HRESULT = -2147200159i32;
pub const FSRM_E_UNEXPECTED: ::windows_core_sys::HRESULT = -2147200234i32;
pub const FSRM_E_UNSECURE_LINK_TO_HOSTED_MODULE: ::windows_core_sys::HRESULT = -2147200188i32;
pub const FSRM_E_VOLUME_OFFLINE: ::windows_core_sys::HRESULT = -2147200154i32;
pub const FSRM_E_VOLUME_UNSUPPORTED: ::windows_core_sys::HRESULT = -2147200235i32;
pub const FSRM_E_WMI_FAILURE: ::windows_core_sys::HRESULT = -2147200121i32;
pub const FSRM_E_XML_CORRUPTED: ::windows_core_sys::HRESULT = -2147200211i32;
pub const FSRM_S_CLASSIFICATION_SCAN_FAILURES: ::windows_core_sys::HRESULT = 283398i32;
pub const FSRM_S_PARTIAL_BATCH: ::windows_core_sys::HRESULT = 283396i32;
pub const FSRM_S_PARTIAL_CLASSIFICATION: ::windows_core_sys::HRESULT = 283397i32;
pub const FsrmAccessDeniedRemediationClient: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 269176776, data2: 29889, data3: 18191, data4: [177, 183, 221, 123, 107, 174, 121, 189] };
...
pub const FsrmClassificationManager: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2975600199, data2: 50065, data3: 17849, data4: [149, 200, 235, 89, 108, 133, 63, 58] };
...
pub const FsrmExportImport: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 344120375, data2: 64233, data3: 18311, data4: [144, 37, 140, 228, 224, 36, 171, 86] };
...
pub const FsrmFileGroupManager: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2400412662, data2: 25967, data3: 17558, data4: [146, 38, 19, 174, 203, 215, 113, 143] };
pub const FsrmFileManagementJobManager: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3944282546, data2: 19514, data3: 17185, data4: [178, 3, 32, 81, 32, 207, 246, 20] };
...
pub const FsrmFileScreenManager: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2509508995, data2: 56147, data3: 19551, data4: [179, 123, 125, 9, 33, 207, 157, 199] };
pub const FsrmFileScreenTemplateManager: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 607195615, data2: 58484, data3: 18090, data4: [160, 84, 234, 163, 62, 220, 41, 42] };
...
pub const FsrmPathMapper: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4089332413, data2: 35522, data3: 16542, data4: [187, 216, 250, 249, 182, 180, 31, 235] };
pub const FsrmPipelineModuleConnector: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3345232757, data2: 7861, data3: 17630, data4: [160, 98, 98, 53, 71, 217, 51, 188] };
...
pub const FsrmQuotaManager: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2430380927, data2: 13436, data3: 19452, data4: [181, 67, 84, 3, 38, 48, 95, 190] };
pub const FsrmQuotaTemplateManager: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 2547242051, data2: 9500, data3: 17207, data4: [129, 231, 179, 46, 143, 78, 230, 94] };
...
pub const FsrmReportManager: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 5828407, data2: 43622, data3: 19528, data4: [189, 91, 47, 206, 67, 42, 176, 200] };
...
pub const FsrmReportScheduler: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 3928355256, data2: 7053, data3: 17040, data4: [142, 232, 225, 124, 18, 194, 254, 32] };
...
pub const FsrmSetting: ::windows_core_sys::GUID = ::windows_core_sys::GUID { data1: 4116109064, data2: 27981, data3: 17812, data4: [156, 97, 125, 187, 13, 174, 42, 70] };
