...
use windows_core::{IAgileObject, Interface, RuntimeName};
...
fn uri() -> windows_core::Result<()> {
    ...
    assert_eq!(
        Uri::IID,
        windows_core::GUID::from("9E365E57-48B2-4160-956F-C7385120BBFC") // IUriRuntimeClass
    );
...
#[test]
fn interface_conversion() -> windows_core::Result<()> {
